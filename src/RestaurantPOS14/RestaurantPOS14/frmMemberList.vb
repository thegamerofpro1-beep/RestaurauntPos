...
Namespace RestaurantPOS14
    ...
    Public Class frmMemberList
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmMemberList.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmMemberList.__ENCList
                If RestaurantPOS14.frmMemberList.__ENCList.Count = RestaurantPOS14.frmMemberList.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmMemberList.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmMemberList.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmMemberList.__ENCList(num) = RestaurantPOS14.frmMemberList.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmMemberList.__ENCList.RemoveRange(num, RestaurantPOS14.frmMemberList.__ENCList.Count - num)
                    RestaurantPOS14.frmMemberList.__ENCList.Capacity = RestaurantPOS14.frmMemberList.__ENCList.Count
                End If

                Call RestaurantPOS14.frmMemberList.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    MyBase.Hide()
                    Call RestaurantPOS14.My.MyProject.Forms.frmMemberLedger.Show()
                    RestaurantPOS14.My.MyProject.Forms.frmMemberLedger.txtMemberID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmMemberLedger.txtMemberName.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
                End If
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmMemberList))
