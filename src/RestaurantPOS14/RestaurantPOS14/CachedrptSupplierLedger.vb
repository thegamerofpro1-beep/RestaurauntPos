...
Namespace RestaurantPOS14
    ...
    Public Class CachedrptSupplierLedger
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.CachedrptSupplierLedger.__ENCList
                If RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Count = RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.CachedrptSupplierLedger.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.CachedrptSupplierLedger.__ENCList(num) = RestaurantPOS14.CachedrptSupplierLedger.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.CachedrptSupplierLedger.__ENCList.RemoveRange(num, RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Count - num)
                    RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Capacity = RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Count
                End If

                Call RestaurantPOS14.CachedrptSupplierLedger.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.CachedrptSupplierLedger.__ENCAddToList(Me)
        End Sub

        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument
            Return New RestaurantPOS14.rptSupplierLedger With {.Site = MyBase.Site}
        End Function
