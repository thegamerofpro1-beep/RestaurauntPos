...
Namespace RestaurantPOS14
    ...
    Public Class frmEnterQtyX
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmEnterQtyX.__ENCAddToList(Me)
            Me.sign_Indicator = 0
            Me.fl = False
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmEnterQtyX.__ENCList
                If RestaurantPOS14.frmEnterQtyX.__ENCList.Count = RestaurantPOS14.frmEnterQtyX.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmEnterQtyX.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmEnterQtyX.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmEnterQtyX.__ENCList(num) = RestaurantPOS14.frmEnterQtyX.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmEnterQtyX.__ENCList.RemoveRange(num, RestaurantPOS14.frmEnterQtyX.__ENCList.Count - num)
                    RestaurantPOS14.frmEnterQtyX.__ENCList.Capacity = RestaurantPOS14.frmEnterQtyX.__ENCList.Count
                End If

                Call RestaurantPOS14.frmEnterQtyX.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnOkay_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                ElseIf Microsoft.VisualBasic.Conversion.Val(Me.txtQ.Text) < Microsoft.VisualBasic.Conversion.Val(Me.txtQty.Text) Then
                    ...
                    Me.txtQty.Text = ""
                Else
                    If RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView1.Rows.Count <= 0 Then
                        Return
                    End If
                    ...
                    For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView2.Rows, System.Collections.IEnumerable)
                        ...
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.txtRate_Food.Text = dataGridViewRow2.Cells(CInt((1))).Value.ToString()
                        ...
                        Dim dataGridViewCell2 As System.Windows.Forms.DataGridViewCell = dataGridViewRow.Cells(3)
                        ...
                        Dim dataGridViewCell3 As System.Windows.Forms.DataGridViewCell = dataGridViewRow.Cells(9)
                        ...
                        Dim dataGridViewCell4 As System.Windows.Forms.DataGridViewCell = dataGridViewRow.Cells(12)
                        ...
                        Dim value As Double = RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.GrandTotal_Food1X()
                        value = System.Math.Round(value, 2)
                        RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.lblBalance2.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(value)
                        RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView2.CurrentCell = RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView2.Rows(CInt((RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView2.Rows.Count - 1))).Cells(1)
                        Dim dataGridViewCell5 As System.Windows.Forms.DataGridViewCell = dataGridViewRow2.Cells(2)
                        ...
                        If Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow2.Cells(CInt((2))).Value)) = 0.0 Then
                            For Each dataGridViewRow3 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView1.SelectedRows
                                Call RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView1.Rows.Remove(dataGridViewRow3)
                            Next
                        End If

                        Dim value2 As Double = RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.GrandTotal_Food1()
                        value2 = System.Math.Round(value2, 2)
                        RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.lblBalance1.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(value2)
                        Return
                    Next
                    ...
                    If Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow4.Cells(CInt((2))).Value)) = 0.0 Then
                        For Each dataGridViewRow5 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView1.SelectedRows
                            Call RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.DataGridView1.Rows.Remove(dataGridViewRow5)
                        Next
                    End If

                    Dim value4 As Double = RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.GrandTotal_Food1()
                    value4 = System.Math.Round(value4, 2)
                    RestaurantPOS14.My.MyProject.Forms.frmItemsTransfer.lblBalance1.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(value4)
                    MyBase.Close()
                End If
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmEnterQtyX))
            ...
            location = New System.Drawing.Point(129, 52)
            ...
            location = New System.Drawing.Point(140, 76)
            ...
            location = New System.Drawing.Point(233, 52)
