...
Namespace RestaurantPOS14
    ...
    Public Class frmStockAdjustment_MI
        ...
        Friend Overridable Property cmbItemName As System.Windows.Forms.ComboBox
            ...
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.EventHandler = AddressOf Me.cmbDishName_SelectedIndexChanged
                Dim value3 As System.Windows.Forms.ListControlConvertEventHandler = AddressOf Me.cmbDishName_Format
                If Me._cmbItemName IsNot Nothing Then
                    RemoveHandler Me._cmbItemName.SelectedIndexChanged, value2
                    RemoveHandler Me._cmbItemName.Format, value3
                End If

                Me._cmbItemName = value
                If Me._cmbItemName IsNot Nothing Then
                    AddHandler Me._cmbItemName.SelectedIndexChanged, value2
                    AddHandler Me._cmbItemName.Format, value3
                End If
            End Set
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmStockAdjustment_MI_Load
            Call RestaurantPOS14.frmStockAdjustment_MI.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockAdjustment_MI.__ENCList
                If RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Count = RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockAdjustment_MI.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockAdjustment_MI.__ENCList(num) = RestaurantPOS14.frmStockAdjustment_MI.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockAdjustment_MI.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Count - num)
                    RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Capacity = RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockAdjustment_MI.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(SA_ID) FROM StockAdjustment_MI")
        ...
        Public Sub Reset()
            Me.cmbItemName.SelectedIndex = -1
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from StockAdjustment_MI where SA_ID=@d1")
                ...
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    If Me.rbPlus.Checked Then
                        RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                        RestaurantPOS14.ModClasses.con.Open()
                        RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Temp_Stock_Store set qty=qty - " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQty.Text)) & " where Dish=@d1")
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.cmbItemName.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please select Dish name", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into StockAdjustment_MI(SA_ID, Dish, Date, AdjustmentType, Qty, Reason) VALUES (@d1,@d2,@d4,@d5,@d6,@d7)")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtAdjustmentID.Text))
        ...
        Public Sub fillCombo()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT DishName FROM Dish,Temp_Stock_Store where Dish.DishName=Temp_Stock_Store.Dish order by 1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                Me.cmbItemName.Items.Clear()
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.cmbItemName.Items.Add(RestaurantPOS14.ModClasses.rdr(CInt((0))).ToString())
                End While
        ...
        Private Sub cmbDishName_Format(sender As Object, e As System.Windows.Forms.ListControlConvertEventArgs)
            If e.DesiredType Is GetType(String) Then
                e.Value = e.Value.ToString().Trim()
            End If
        End Sub

        Private Sub cmbDishName_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            Me.txtQty.Focus()
            Me.GetQty_S()
        End Sub
        ...
        Public Sub GetQty_S()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd.CommandText = "Select IsNull(Sum(Qty),0) from Temp_Stock_Store,Dish where Temp_Stock_Store.Dish=Dish.DishName and Dish=@d1 group by Dish"
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbItemName.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Me.lblQty_S.Visible = True
                    Me.lblQty_S.Text = RestaurantPOS14.ModClasses.rdr.GetValue(CInt((0))).ToString()
                Else
                    Me.lblQty_S.Visible = True
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update StockAdjustment_MI set Dish=@d2, Date=@d4, AdjustmentType=@d5, Qty=@d6, Reason=@d7 where SA_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtAdjustmentID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbItemName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.dtpDate.Value.[Date])
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d5", Me.str)
                ...
                If Me.rbPlus.Checked Then
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Temp_Stock_Store set qty=qty + ( " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQty.Text)) & " - " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQ.Text)) & ") where Dish=@d1")
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbItemName.Text)
                    RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                    RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery()
                    RestaurantPOS14.ModClasses.con.Close()
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_MI_Record.lblSet.Text = "SA"
            RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_MI_Record.lblUser.Text = Me.lblUser.Text
            Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_MI_Record.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_MI_Record.ShowDialog()
        End Sub

        Private Sub frmStockAdjustment_MI_Load(sender As Object, e As System.EventArgs)
            Me.fillCombo()
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockAdjustment_MI))
            ...
            Me.cmbItemName.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Dim label13 As System.Windows.Forms.Label = Me.Label34
            location = New System.Drawing.Point(12, 79)
            label13.Location = location
            Me.Label34.Name = "Label34"
            Dim label14 As System.Windows.Forms.Label = Me.Label34
            size = New System.Drawing.Size(94, 13)
            label14.Size = size
            Me.Label34.TabIndex = 332
            Me.Label34.Text = "Menu Item Name :"
            ...
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtQ
            location = New System.Drawing.Point(55, 19)
            textBox7.Location = location
            Me.txtQ.Name = "txtQ"
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtQ
            ...
            Dim label16 As System.Windows.Forms.Label = Me.lblUserType
            ...
            Dim label19 As System.Windows.Forms.Label = Me.Label1
            ...
            Me.Label1.Text = "Stock Adjustment (Menu Items)"
            ...
            MyBase.Name = "frmStockAdjustment_MI"
