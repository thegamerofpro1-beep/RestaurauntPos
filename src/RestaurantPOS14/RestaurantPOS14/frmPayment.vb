...
Namespace RestaurantPOS14
    ...
    Public Class frmPayment
        ...
        Public Sub New()
            Call RestaurantPOS14.frmPayment.__ENCAddToList(Me)
            Me.i = 0
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPayment.__ENCList
                If RestaurantPOS14.frmPayment.__ENCList.Count = RestaurantPOS14.frmPayment.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPayment.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPayment.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPayment.__ENCList(num) = RestaurantPOS14.frmPayment.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPayment.__ENCList.RemoveRange(num, RestaurantPOS14.frmPayment.__ENCList.Count - num)
                    RestaurantPOS14.frmPayment.__ENCList.Capacity = RestaurantPOS14.frmPayment.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPayment.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Function GenerateID() As String
            ...
            Try
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT TOP 1 T_ID FROM Payment ORDER BY T_ID DESC", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
        ...
        Public Sub auto()
            Try
                ...
                Me.txtTransactionNo.Text = "T-" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.GenerateID()))
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        End Sub
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from Payment where T_ID=@d1")
                ...
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    RestaurantPOS14.ModFunc.LedgerDelete(Me.txtTransactionNo.Text, "Payment")
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "deleted the payment record having transaction No. '" & Me.txtTransactionNo.Text & "'")
        ...
        Private Sub btnSelection_Click(sender As Object, e As System.EventArgs)
            Me.Reset()
            RestaurantPOS14.My.MyProject.Forms.frmSupplierRecord.lblSet.Text = "Payment"
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.txtTransactionAmount.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please enter transaction amount", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtTransactionAmount.Focus()
                Return
            End If

            If Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text) = 0.0 Then
                Call System.Windows.Forms.MessageBox.Show("Transaction amount must be greater than zero", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtTransactionAmount.Focus()
                Return
            End If

            If Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text) > Microsoft.VisualBasic.Conversion.Val(Me.lblBalance.Text) Then
                Call System.Windows.Forms.MessageBox.Show("Transaction amount can not be more than balance", "Input Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                Me.txtTransactionAmount.Focus()
                Return
            End If
            ...
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into Payment(T_ID, TransactionID, Date, PaymentMode, SupplierID, Amount,Remarks,PaymentModeDetails) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8)")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtT_ID.Text))
                ...
                RestaurantPOS14.ModClasses.con.Close()
                RestaurantPOS14.ModFunc.LedgerSave(Me.dtpTranactionDate.Value.[Date], "Cash", Me.txtTransactionNo.Text, "Payment", 0D, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text)), "", Me.txtSupplierName.Text)
                RestaurantPOS14.ModFunc.LedgerSave(Me.dtpTranactionDate.Value.[Date], Me.txtSupplierName.Text, Me.txtTransactionNo.Text, "Payment", New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text)), 0D, Me.txtSupplierID.Text, "Cash")
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "added the new payment having transaction No. '" & Me.txtTransactionNo.Text & "'")
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            If Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text) - Microsoft.VisualBasic.Conversion.Val(Me.txtTempAmt.Text) > Microsoft.VisualBasic.Conversion.Val(Me.lblBalance.Text) Then
                Call System.Windows.Forms.MessageBox.Show("Transaction amount can not be more than balance", "Input Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                Me.txtTransactionAmount.Focus()
                Return
            End If
            ...
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Payment set TransactionID=@d2, Date=@d3, PaymentMode=@d4, SupplierID=@d5, Amount=@d6,Remarks=@d7,PaymentModeDetails=@d8 where T_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtT_ID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtTransactionNo.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.dtpTranactionDate.Value)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.cmbPaymentMode.Text)
                ...
                RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery()
                RestaurantPOS14.ModClasses.con.Close()
                RestaurantPOS14.ModFunc.LedgerUpdate1(Me.dtpTranactionDate.Value.[Date], "Cash", 0D, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text)), "", Me.txtTransactionNo.Text, "Payment")
                RestaurantPOS14.ModFunc.LedgerUpdate1(Me.dtpTranactionDate.Value.[Date], Me.txtSupplierName.Text, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtTransactionAmount.Text)), 0D, Me.txtSupplierID.Text, Me.txtTransactionNo.Text, "Payment")
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "updated payment record having transaction No. '" & Me.txtTransactionNo.Text & "'")
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            Me.Reset()
            RestaurantPOS14.My.MyProject.Forms.frmPaymentRecord.lblSet.Text = "Payment"
            RestaurantPOS14.My.MyProject.Forms.frmPaymentRecord.lblUser.Text = Me.lblUser.Text
            Call RestaurantPOS14.My.MyProject.Forms.frmPaymentRecord.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmPaymentRecord.ShowDialog()
        End Sub
        ...
        Private Sub btnPrint_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                Dim rptPaymentInvoice2 As RestaurantPOS14.rptPaymentInvoice = New RestaurantPOS14.rptPaymentInvoice()
                ...
                sqlCommand.CommandText = "SELECT Payment.T_ID, Payment.TransactionID, Payment.Date, Payment.PaymentMode, Payment.SupplierID, Payment.Amount, Payment.Remarks, Payment.PaymentModeDetails, Supplier.ID, Supplier.SupplierID AS Expr1,Supplier.Name, Supplier.Address, Supplier.City, Supplier.State, Supplier.ZipCode, Supplier.ContactNo, Supplier.EmailID, Supplier.Remarks AS Expr2, Supplier.TIN, Supplier.STNo, Supplier.CST, Supplier.PAN,Supplier.AccountName, Supplier.AccountNumber, Supplier.Bank, Supplier.Branch, Supplier.IFSCCode, Supplier.OpeningBalance, Supplier.OpeningBalanceType FROM Payment INNER JOIN Supplier ON Payment.SupplierID = Supplier.ID where T_ID=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtT_ID.Text))
                sqlCommand2.CommandText = "SELECT * from Hotel"
                sqlCommand.CommandType = System.Data.CommandType.Text
                sqlCommand2.CommandType = System.Data.CommandType.Text
                sqlDataAdapter.SelectCommand = sqlCommand
                sqlDataAdapter2.SelectCommand = sqlCommand2
                sqlDataAdapter.Fill(dataSet, "Payment")
                sqlDataAdapter.Fill(dataSet, "Supplier")
                sqlDataAdapter2.Fill(dataSet, "Hotel")
                rptPaymentInvoice2.SetDataSource(dataSet)
                Me.GetSupplierBalance()
                rptPaymentInvoice2.SetParameterValue("p1", Me.lblBalance.Text)
                ...
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    ...
                    rptPaymentInvoice2.PrintOptions.PrinterName = Me.s4
                    rptPaymentInvoice2.PrintToPrinter(1, collated:=False, 0, 0)
                End If
                ...
                rptPaymentInvoice2.Close()
                rptPaymentInvoice2.Dispose()
                Me.Reset()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPayment))
            ...
            Dim textBox3 As System.Windows.Forms.TextBox = Me.txtSupplierID
            location = New System.Drawing.Point(95, 25)
            textBox3.Location = location
            Me.txtSupplierID.Name = "txtSupplierID"
            Me.txtSupplierID.[ReadOnly] = True
            Dim textBox4 As System.Windows.Forms.TextBox = Me.txtSupplierID
            ...
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtSupplierName
            location = New System.Drawing.Point(95, 52)
            textBox7.Location = location
            Me.txtSupplierName.Name = "txtSupplierName"
            Me.txtSupplierName.[ReadOnly] = True
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtSupplierName
            size = New System.Drawing.Size(315, 21)
            textBox8.Size = size
            ...
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtCity
            location = New System.Drawing.Point(95, 106)
            textBox9.Location = location
            Me.txtCity.Name = "txtCity"
            Me.txtCity.[ReadOnly] = True
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtCity
            size = New System.Drawing.Size(315, 21)
            textBox10.Size = size
            ...
            size = New System.Drawing.Size(423, 288)
            groupBox6.Size = size
            ...
            size = New System.Drawing.Size(379, 128)
            ...
            Dim textBox13 As System.Windows.Forms.TextBox = Me.txtTransactionNo
            location = New System.Drawing.Point(109, 26)
            textBox13.Location = location
            Me.txtTransactionNo.Name = "txtTransactionNo"
            Dim textBox14 As System.Windows.Forms.TextBox = Me.txtTransactionNo
            size = New System.Drawing.Size(124, 21)
            textBox14.Size = size
            ...
            Dim textBox15 As System.Windows.Forms.TextBox = Me.txtTransactionAmount
            location = New System.Drawing.Point(109, 103)
            textBox15.Location = location
            Me.txtTransactionAmount.Name = "txtTransactionAmount"
            Dim textBox16 As System.Windows.Forms.TextBox = Me.txtTransactionAmount
            size = New System.Drawing.Size(88, 20)
            textBox16.Size = size
            ...
            Dim textBox17 As System.Windows.Forms.TextBox = Me.TextBox3
            location = New System.Drawing.Point(523, 9)
            textBox17.Location = location
            Me.TextBox3.Name = "TextBox3"
            Dim textBox18 As System.Windows.Forms.TextBox = Me.TextBox3
            size = New System.Drawing.Size(31, 20)
            textBox18.Size = size
            Me.TextBox3.TabIndex = 315
            Me.TextBox3.Visible = False
            Dim textBox19 As System.Windows.Forms.TextBox = Me.TextBox2
            location = New System.Drawing.Point(582, 0)
            textBox19.Location = location
            Me.TextBox2.Name = "TextBox2"
            Dim textBox20 As System.Windows.Forms.TextBox = Me.TextBox2
            size = New System.Drawing.Size(31, 20)
            textBox20.Size = size
            Me.TextBox2.TabIndex = 314
            Me.TextBox2.Visible = False
            Dim textBox21 As System.Windows.Forms.TextBox = Me.TextBox1
            location = New System.Drawing.Point(560, 16)
            textBox21.Location = location
            Me.TextBox1.Name = "TextBox1"
            Dim textBox22 As System.Windows.Forms.TextBox = Me.TextBox1
            size = New System.Drawing.Size(31, 20)
            textBox22.Size = size
            ...
            size = New System.Drawing.Size(228, 24)
            label32.Size = size
            Me.Label1.TabIndex = 0
            Me.Label1.Text = "Supplier Payment Entry"
            ...
            location = New System.Drawing.Point(9, 233)
