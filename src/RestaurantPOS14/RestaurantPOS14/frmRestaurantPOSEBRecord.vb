...
Namespace RestaurantPOS14
    ...
    Public Class frmRestaurantPOSEBRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList
                If RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Count = RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList(num) = RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Capacity = RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRestaurantPOSEBRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Reset()
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card from RestaurantPOS_BillingInfoEB where (DATEDIFF(d,BillDate,GetDate())= 0) Order by BillDate Desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card from RestaurantPOS_BillingInfoEB where (DATEDIFF(d,BillDate,GetDate())= 0) and Operator=@d4 order by BillDate desc")
            End If
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBDiscountPer.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBDiscountAmount.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblBalance3.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGrandTotal3.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtCash3.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtChange3.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblPaymentMode3.Text = dataGridViewRow.Cells(CInt((8))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.flpCategoriesEB.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView5.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnSave4.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnUpdateEB.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnPrint4.Enabled = True
                    If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.btnDelete4.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.btnDelete4.Enabled = False
                    End If

                    If((Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Super Admin", TextCompare:=False) = 0) And (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((12))).Value.ToString(), "Void", TextCompare:=False) <> 0)) Or ((Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Admin", TextCompare:=False) = 0) And (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((12))).Value.ToString(), "Void", TextCompare:=False) <> 0)) Then
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.btnVoid2.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.btnVoid2.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblSet.Text = "Not Allowed"
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes) from RestaurantPOS_BillingInfoEB,RestaurantPOS_OrderedProductBillEB where RestaurantPOS_BillingInfoEB.Id=RestaurantPOS_OrderedProductBillEB.BillID and RestaurantPOS_BillingInfoEB.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by Dish")), RestaurantPOS14.ModClasses.con)
                    RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                    ...
                    RestaurantPOS14.ModClasses.con.Close()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblBalance3.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.My.MyProject.Forms.frmPOS.GrandTotal_Food4())
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGrandTotal3.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.My.MyProject.Forms.frmPOS.GrandTotal_Food4())
                    Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Calc3()
                    If Microsoft.VisualBasic.CompilerServices.Operators.ConditionalCompareObjectEqual(dataGridViewRow.Cells(CInt((12))).Value, "Unpaid", TextCompare:=False) Then
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.flpEB.Visible = True
                        Call RestaurantPOS14.My.MyProject.Forms.frmPOS.fillCurrencyEB()
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.flpEB.Visible = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBContactNo.Text = dataGridViewRow.Cells(CInt((13))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtStatus.Text = dataGridViewRow.Cells(CInt((12))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblMemberID.Text = dataGridViewRow.Cells(CInt((14))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtLP3.Text = dataGridViewRow.Cells(CInt((15))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtLA3.Text = dataGridViewRow.Cells(CInt((16))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGFID3.Text = dataGridViewRow.Cells(CInt((17))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGFA3.Text = dataGridViewRow.Cells(CInt((18))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBCustomerName.Text = dataGridViewRow.Cells(CInt((19))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtCard3.Text = dataGridViewRow.Cells(CInt((20))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtTip3.Text = dataGridViewRow.Cells(CInt((21))).Value.ToString()
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.flpItemsEB.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtItemsEB.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnHold4.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnRecall4.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btn1CS1.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnPizza4.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnOpenFoods4.Enabled = False
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where  BillDate >=@d1 and BillDate < @d2 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where  BillDate >=@d1 and BillDate < @d2 and Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub cmbBillNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where BillNo=@d3 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where BillNo=@d3 and Operator=@d4 order by BillDate")
            End If
        End Sub

        Private Sub btnShowAllBills_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoEB order by 1")
            Else
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoEB where Operator=@d1 order by 1")
            End If
        End Sub

        Private Sub Button3_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_PhoneNo like N'%" & Me.txtContactNo.Text & "%' Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_Status),RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_PhoneNo like N'%" & Me.txtContactNo.Text & "%' and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRestaurantPOSEBRecord))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(1008, 580)
            panel2.Size = size
            ...
            location = New System.Drawing.Point(661, 174)
            ...
            location = New System.Drawing.Point(7, 151)
            groupBox.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox2 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(386, 93)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(223, 23)
            ...
            location = New System.Drawing.Point(526, 174)
            ...
            size = New System.Drawing.Size(995, 34)
            label2.Size = size
            ...
            location = New System.Drawing.Point(414, 174)
            ...
            size = New System.Drawing.Size(687, 109)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(71, -1)
            ...
            location = New System.Drawing.Point(274, 27)
            ...
            location = New System.Drawing.Point(565, 27)
            button9.Location = location
            Me.Button1.Name = "Button1"
            Dim button10 As System.Windows.Forms.Button = Me.Button1
            size = New System.Drawing.Size(112, 64)
            button10.Size = size
            ...
            location = New System.Drawing.Point(698, 40)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(271, 109)
            groupBox6.Size = size
            ...
            location = New System.Drawing.Point(172, 50)
            ...
            size = New System.Drawing.Size(150, 33)
            comboBox2.Size = size
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column9, Me.Column13, Me.Column5, Me.Column7, Me.Column8, Me.Column10, Me.Column6, Me.Column11, Me.Column12, Me.Column4, Me.Column14, Me.Column15, Me.Column16, Me.Column17, Me.Column18, Me.Column19, Me.Column20, Me.Column21, Me.Column22)
            ...
            location = New System.Drawing.Point(4, 250)
            ...
            size = New System.Drawing.Size(993, 322)
            ...
            size = New System.Drawing.Size(1014, 588)
            ...
            MyBase.Name = "frmRestaurantPOSEBRecord"
