...
Namespace RestaurantPOS14
    ...
    Public Class CachedrptPayment_WithdrawalReceipt
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList
                If RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Count = RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList(num) = RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.RemoveRange(num, RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Count - num)
                    RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Capacity = RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Count
                End If

                Call RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.CachedrptPayment_WithdrawalReceipt.__ENCAddToList(Me)
        End Sub

        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument
            Return New RestaurantPOS14.rptPayment_WithdrawalReceipt With {.Site = MyBase.Site}
        End Function
