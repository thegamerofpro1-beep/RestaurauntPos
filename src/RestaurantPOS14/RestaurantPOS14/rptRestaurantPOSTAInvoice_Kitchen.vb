...
Namespace RestaurantPOS14
    ...
    Public Class rptRestaurantPOSTAInvoice_Kitchen
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList
                If RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Count = RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList(num) = RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRestaurantPOSTAInvoice_Kitchen.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
