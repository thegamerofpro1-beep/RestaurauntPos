...
Namespace RestaurantPOS14
    ...
    Public Class frmExpiredProductsRecord
        ...
        Friend Overridable Property txtWarehouse As System.Windows.Forms.TextBox
            ...
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtWarehouse_TextChanged
                If Me._txtWarehouse IsNot Nothing Then
                    RemoveHandler Me._txtWarehouse.TextChanged, value2
                End If

                Me._txtWarehouse = value
                If Me._txtWarehouse IsNot Nothing Then
                    AddHandler Me._txtWarehouse.TextChanged, value2
                End If
            End Set
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmExpiredProductsRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmExpiredProductsRecord.__ENCList
                If RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Count = RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmExpiredProductsRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmExpiredProductsRecord.__ENCList(num) = RestaurantPOS14.frmExpiredProductsRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmExpiredProductsRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Capacity = RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmExpiredProductsRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Warehouse),RTRIM(ProductCode),RTRIM(ProductName),RTRIM(ExpiryDate),RTRIM(Convert(nvarchar(50),Qty) + ' ' + Convert(Nvarchar(50),Unit)) from temp_stock,Product where Temp_Stock.ProductID=Product.PID and Qty > 0 and Convert(Datetime,ExpiryDate,103) < GetDate() and ExpiryDate <>'' and ExpiryDate is not null order by Warehouse,ProductName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub txtWarehouse_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Warehouse),RTRIM(ProductCode),RTRIM(ProductName),RTRIM(ExpiryDate),RTRIM(Convert(nvarchar(50),Qty) + ' ' + Convert(Nvarchar(50),Unit)) from temp_stock,Product where Temp_Stock.ProductID=Product.PID and Qty > 0 and Warehouse like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtWarehouse.Text) & "%' and Convert(Datetime,ExpiryDate,103) < GetDate() and ExpiryDate <>'' and ExpiryDate is not null order by Warehouse,ProductName", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)))
        ...
        Private Sub txtProductName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Warehouse),RTRIM(ProductCode),RTRIM(ProductName),RTRIM(ExpiryDate),RTRIM(Convert(nvarchar(50),Qty) + ' ' + Convert(Nvarchar(50),Unit)) from temp_stock,Product where Temp_Stock.ProductID=Product.PID and Qty > 0 and ProductName like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtProductName.Text) & "%' and Convert(Datetime,ExpiryDate,103) < GetDate() and ExpiryDate <>'' and ExpiryDate is not null order by Warehouse,ProductName", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)))
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Warehouse),RTRIM(ProductCode),RTRIM(ProductName),RTRIM(ExpiryDate),RTRIM(Convert(nvarchar(50),Qty) + ' ' + Convert(Nvarchar(50),Unit)) from temp_stock,Product where Temp_Stock.ProductID=Product.PID and Qty > 0 and Convert(Datetime,ExpiryDate,103) >=@d1 and Convert(Datetime,ExpiryDate,103) < @d2 and ExpiryDate <>'' and ExpiryDate is not null order by Warehouse,ProductName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmExpiredProductsRecord))
            ...
            size = New System.Drawing.Size(372, 100)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(156, 47)
            ...
            location = New System.Drawing.Point(16, 47)
            ...
            location = New System.Drawing.Point(153, 28)
            ...
            location = New System.Drawing.Point(284, 47)
            ...
            location = New System.Drawing.Point(385, 38)
            groupBox3.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox4 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(225, 109)
            groupBox4.Size = size
            ...
            size = New System.Drawing.Size(188, 33)
            textBox2.Size = size
            ...
            size = New System.Drawing.Size(1002, 34)
            label6.Size = size
            ...
            location = New System.Drawing.Point(616, 38)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(394, 109)
            groupBox6.Size = size
            Me.GroupBox1.TabIndex = 109
            Me.GroupBox1.TabStop = False
            Me.GroupBox1.Text = "Search By Warehouse :"
            Dim textBox3 As System.Windows.Forms.TextBox = Me.txtWarehouse
            location = New System.Drawing.Point(16, 46)
            textBox3.Location = location
            Me.txtWarehouse.Name = "txtWarehouse"
            Dim textBox4 As System.Windows.Forms.TextBox = Me.txtWarehouse
            size = New System.Drawing.Size(159, 33)
            textBox4.Size = size
            ...
            location = New System.Drawing.Point(292, 34)
            button3.Location = location
            Me.btnExportExcel.Name = "btnExportExcel"
            Dim button4 As System.Windows.Forms.Button = Me.btnExportExcel
            size = New System.Drawing.Size(93, 64)
            button4.Size = size
            ...
            location = New System.Drawing.Point(181, 34)
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column4, Me.Column5)
            ...
            MyBase.Name = "frmExpiredProductsRecord"
