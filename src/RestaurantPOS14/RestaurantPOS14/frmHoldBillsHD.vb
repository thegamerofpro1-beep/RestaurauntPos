...
Namespace RestaurantPOS14
    ...
    Public Class frmHoldBillsHD
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmHoldBillsHD.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmHoldBillsHD.__ENCList
                If RestaurantPOS14.frmHoldBillsHD.__ENCList.Count = RestaurantPOS14.frmHoldBillsHD.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmHoldBillsHD.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmHoldBillsHD.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmHoldBillsHD.__ENCList(num) = RestaurantPOS14.frmHoldBillsHD.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmHoldBillsHD.__ENCList.RemoveRange(num, RestaurantPOS14.frmHoldBillsHD.__ENCList.Count - num)
                    RestaurantPOS14.frmHoldBillsHD.__ENCList.Capacity = RestaurantPOS14.frmHoldBillsHD.__ENCList.Count
                End If

                Call RestaurantPOS14.frmHoldBillsHD.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(HoldID),Date,RTRIM(UserID),RTRIM(TaxType),RTRIM(CName),RTRIM(Address),RTRIM(Cno) from HoldBill where BillType='Home Delivery' order by 2", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub DataGridView1_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtCustomerName.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtAddress.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtContactNo.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtSubTotal.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.ModFunc.GetHoldBillTotal(dataGridViewRow.Cells(CInt((0))).Value.ToString()))
                RestaurantPOS14.My.MyProject.Forms.frmPOS.lblBalance2.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.ModFunc.GetHoldBillTotal(dataGridViewRow.Cells(CInt((0))).Value.ToString()))
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGrandTotal2.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.ModFunc.GetHoldBillTotal(dataGridViewRow.Cells(CInt((0))).Value.ToString()))
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmHoldBillsHD))
            ...
            Me.DataGridView1.Columns.AddRange(Me.Column1, Me.Column5, Me.Column4, Me.Column6, Me.Column7, Me.Column2, Me.Column3)
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(919, 358)
            ...
            Me.Column7.HeaderText = "Customer Name"
            ...
            size = New System.Drawing.Size(864, 46)
            panel2.Size = size
            ...
            size = New System.Drawing.Size(924, 413)
