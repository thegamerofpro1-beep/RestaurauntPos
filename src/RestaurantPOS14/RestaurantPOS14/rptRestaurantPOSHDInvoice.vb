...
Namespace RestaurantPOS14
    Public Class rptRestaurantPOSHDInvoice
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOSHDInvoice.rpt"
            End Get
        ...
        <System.ComponentModel.DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>
        <System.ComponentModel.BrowsableAttribute(False)>
        Public ReadOnly Property Parameter_DP As CrystalDecisions.[Shared].IParameterField
            Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList
                If RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Count = RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList(num) = RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRestaurantPOSHDInvoice.__ENCAddToList(Me)
            ...
            Catch reportInitializationException As System.Exception
                RestaurantPOS14.Diagnostics.ApplicationDiagnostics.ReportNonFatal("Initialize rptRestaurantPOSHDInvoice", reportInitializationException)
            End Try
        End Sub
