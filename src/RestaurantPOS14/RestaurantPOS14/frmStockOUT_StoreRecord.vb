...
Namespace RestaurantPOS14
    ...
    Public Class frmStockOUT_StoreRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmStockOUT_StoreRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList
                If RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Count = RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList(num) = RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Capacity = RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockOUT_StoreRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Dish),RTRIM(Category) from temp_stock_Store,Dish where Temp_Stock_Store.Dish=Dish.DishName and Qty <= 0 order by Dish", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub txtItemName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Dish),RTRIM(Category) from temp_stock_Store,Dish where Temp_Stock_Store.Dish=Dish.DishName and Qty <= 0 and Dish like N'%" & Me.txtItemName.Text & "%' order by Dish", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)))
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockOUT_StoreRecord))
            ...
            Me.Label1.Text = "Out of Stock Items Record(Store)"
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column3)
            ...
            MyBase.Name = "frmStockOUT_StoreRecord"
