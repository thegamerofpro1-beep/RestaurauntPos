...
Namespace RestaurantPOS14
    ...
    Public Class frmStockAdjustment_Warehouse
        ...
        Friend Overridable Property cmbWarehouse As System.Windows.Forms.ComboBox
            ...
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.EventHandler = AddressOf Me.cmbWarehouse_SelectedIndexChanged
                If Me._cmbWarehouse IsNot Nothing Then
                    RemoveHandler Me._cmbWarehouse.SelectedIndexChanged, value2
                End If

                Me._cmbWarehouse = value
                If Me._cmbWarehouse IsNot Nothing Then
                    AddHandler Me._cmbWarehouse.SelectedIndexChanged, value2
                End If
            End Set
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmStockAdjustment_Warehouse_Load
            Call RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList
                If RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Count = RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList(num) = RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Count - num)
                    RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Capacity = RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockAdjustment_Warehouse.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(SA_ID) FROM StockAdjustment_Warehouse")
        ...
        Public Sub FillWarehouse()
            Try
                ...
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(WarehouseName) FROM Warehouse order by 1", sqlConnection)
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from StockAdjustment_Warehouse where SA_ID=@d1")
                ...
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    If Me.rbPlus.Checked Then
                        RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                        RestaurantPOS14.ModClasses.con.Open()
                        RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Temp_Stock set qty=qty - " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQty.Text)) & " where ProductID=@d1 and Warehouse=@d3")
                        RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtProductID.Text))
                        RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.cmbWarehouse.Text)
                        RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                    ...
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "Deleted the Stock Adjustment(W) record having adjustment id '" & Me.txtAdjustmentID.Text & "'")
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into StockAdjustment_Warehouse(SA_ID, ProductID, Date, AdjustmentType, Qty, Reason,Warehouse) VALUES (@d1,@d2,@d4,@d5,@d6,@d7,@d8)")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtAdjustmentID.Text))
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d8", Me.cmbWarehouse.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery()
                RestaurantPOS14.ModClasses.con.Close()
                If Me.rbPlus.Checked Then
                ...
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "added the new Stock Adjustment(W) record having adjustment id '" & Me.txtAdjustmentID.Text & "'")
        ...
        Public Sub fillCombo()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT ProductName FROM Product,Temp_Stock where Product.PID=Temp_Stock.ProductID and Warehouse=@d1 order by 1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbWarehouse.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
        ...
        Private Sub cmbProductName_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.cmd.CommandText = "SELECT PID,RTRIM(ProductCode) from Product,Temp_Stock where Product.PID=Temp_Stock.ProductID and ProductName=@d1 and Warehouse=@d2"
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbProductName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbWarehouse.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
        ...
        Public Sub GetQty_S()
            Try
                ...
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = RestaurantPOS14.ModClasses.con.CreateCommand()
                RestaurantPOS14.ModClasses.cmd.CommandText = "Select IsNull(Sum(Qty),0),RTRIM(Unit) from Temp_Stock,Product where Temp_Stock.ProductID=Product.PID and ProductID=@d1 and Warehouse=@d2 group by ProductID,Unit"
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtProductID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbWarehouse.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update StockAdjustment_Warehouse set ProductID=@d2, Date=@d4, AdjustmentType=@d5, Qty=@d6, Reason=@d7,Warehouse=@d8 where SA_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtAdjustmentID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Microsoft.VisualBasic.Conversion.Val(Me.txtProductID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.dtpDate.Value.[Date])
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d5", Me.str)
                ...
                If Me.rbPlus.Checked Then
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Temp_Stock set qty=qty + ( " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQty.Text)) & " - " & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtQ.Text)) & ") where ProductID=@d1 and Warehouse=@d2")
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtProductID.Text))
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbWarehouse.Text)
                    RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                    RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery()
                ...
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, "Updated the Stock Adjustment(W) record having adjustment id '" & Me.txtAdjustmentID.Text & "'")
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse_Record.lblSet.Text = "SA"
            RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse_Record.lblUser.Text = Me.lblUser.Text
            Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse_Record.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse_Record.ShowDialog()
        End Sub

        Private Sub frmStockAdjustment_Warehouse_Load(sender As Object, e As System.EventArgs)
            Me.FillWarehouse()
        End Sub

        Private Sub cmbWarehouse_SelectedIndexChanged(sender As Object, e As System.EventArgs)
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockAdjustment_Warehouse))
            ...
            Dim location As System.Drawing.Point = New System.Drawing.Point(6, 53)
            ...
            size = New System.Drawing.Size(673, 196)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(239, 51)
            ...
            location = New System.Drawing.Point(237, 33)
            ...
            Dim label3 As System.Windows.Forms.Label = Me.lblQty_S
            location = New System.Drawing.Point(442, 95)
            label3.Location = location
            Me.lblQty_S.Name = "lblQty_S"
            Dim label4 As System.Windows.Forms.Label = Me.lblQty_S
            ...
            location = New System.Drawing.Point(310, 147)
            ...
            location = New System.Drawing.Point(306, 124)
            ...
            location = New System.Drawing.Point(213, 147)
            ...
            location = New System.Drawing.Point(209, 123)
            ...
            Dim label15 As System.Windows.Forms.Label = Me.Label8
            ...
            Dim label19 As System.Windows.Forms.Label = Me.lblUserType
            location = New System.Drawing.Point(142, 16)
            label19.Location = location
            Me.lblUserType.Name = "lblUserType"
            Dim label20 As System.Windows.Forms.Label = Me.lblUserType
            ...
            Dim label21 As System.Windows.Forms.Label = Me.lblUser
            location = New System.Drawing.Point(142, 29)
            label21.Location = location
            Me.lblUser.Name = "lblUser"
            Dim label22 As System.Windows.Forms.Label = Me.lblUser
            ...
            Dim label24 As System.Windows.Forms.Label = Me.Label1
            size = New System.Drawing.Size(759, 50)
            label24.Size = size
            ...
            size = New System.Drawing.Size(820, 303)
            ...
            MyBase.Name = "frmStockAdjustment_Warehouse"
