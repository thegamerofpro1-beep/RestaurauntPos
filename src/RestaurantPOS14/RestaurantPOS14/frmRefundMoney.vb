...
Namespace RestaurantPOS14
    ...
    Public Class frmRefundMoney
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRefundMoney.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRefundMoney.__ENCList
                If RestaurantPOS14.frmRefundMoney.__ENCList.Count = RestaurantPOS14.frmRefundMoney.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRefundMoney.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRefundMoney.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRefundMoney.__ENCList(num) = RestaurantPOS14.frmRefundMoney.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRefundMoney.__ENCList.RemoveRange(num, RestaurantPOS14.frmRefundMoney.__ENCList.Count - num)
                    RestaurantPOS14.frmRefundMoney.__ENCList.Capacity = RestaurantPOS14.frmRefundMoney.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRefundMoney.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                Me.auto()
                RestaurantPOS14.ModFunc.LedgerSave(Me.dtpEntryDate.Value, Me.txtMemberName.Text, Me.txtID.Text, "Money Refunded as Cash", New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), 0D, Me.txtMemberID.Text, "Cash")
                RestaurantPOS14.ModFunc.LedgerSave(Me.dtpEntryDate.Value, "Cash", Me.txtID.Text, "Money Refunded as Cash", 0D, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), Me.txtMemberID.Text, Me.txtMemberName.Text)
                RestaurantPOS14.ModFunc.MemberLedgerSave(Me.dtpEntryDate.Value, CInt(System.Math.Round(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text))), Me.txtID.Text, "Money Refunded as Cash", New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), 0D, Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(Me.txtMemberID.Text))
                Dim st As String = "Money Refunded as Cash having transaction id '" & Me.txtID.Text & "'"
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                RestaurantPOS14.ModFunc.LedgerUpdate(Me.dtpEntryDate.Value, Me.txtMemberName.Text, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), 0D, Me.txtMemberID.Text, Me.txtID.Text, "Money Refunded as Cash")
                RestaurantPOS14.ModFunc.LedgerUpdate(Me.dtpEntryDate.Value, "Cash", 0D, New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), Me.txtMemberID.Text, Me.txtID.Text, "Money Refunded as Cash")
                RestaurantPOS14.ModFunc.MemberLedgerUpdate(Me.dtpEntryDate.Value, CInt(System.Math.Round(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text))), New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), 0D, Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(Me.txtMemberID.Text), Me.txtID.Text, "Money Refunded as Cash")
                Dim st As String = "updated the Member's Account (refund Entry) having id '" & Me.txtID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from MemberLedger where id=" & Me.txtID.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    RestaurantPOS14.ModFunc.LedgerDelete(Me.txtID.Text, "Money Refunded as Cash")
                    RestaurantPOS14.ModFunc.MemberLedgerDelete(Me.txtID.Text, "Money Refunded as Cash")
                    Dim st As String = "Deleted the Member's Account (refund Entry) having id '" & Me.txtID.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            RestaurantPOS14.My.MyProject.Forms.frmRefundMoneyRecord.lblSet.Text = "Refund"
            RestaurantPOS14.My.MyProject.Forms.frmRefundMoneyRecord.lblUser.Text = Me.lblUser.Text
            Call RestaurantPOS14.My.MyProject.Forms.frmRefundMoneyRecord.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmRefundMoneyRecord.ShowDialog()
        End Sub
        ...
        Private Sub txtSearchByMemberName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(Member.MemberID),RTRIM(Name),IsNull(sum(Credit)-sum(Debit),0) FROM Member left join MemberLedger on Member.MemberID=MemberLedger.MemberID where Name like N'%" & Me.txtSearchByMemberName.Text & "%' group by name,Member.MemberID order by Name", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)))
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRefundMoney))
            ...
            Me.Label1.Text = "Member's Account (Refund)"
