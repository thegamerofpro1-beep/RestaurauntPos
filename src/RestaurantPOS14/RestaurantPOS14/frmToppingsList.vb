...
Namespace RestaurantPOS14
    ...
    Public Class frmToppingsList
        ...
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmToppingsList_Load
            Call RestaurantPOS14.frmToppingsList.__ENCAddToList(Me)
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmToppingsList.__ENCList
                If RestaurantPOS14.frmToppingsList.__ENCList.Count = RestaurantPOS14.frmToppingsList.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmToppingsList.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmToppingsList.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmToppingsList.__ENCList(num) = RestaurantPOS14.frmToppingsList.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmToppingsList.__ENCList.RemoveRange(num, RestaurantPOS14.frmToppingsList.__ENCList.Count - num)
                    RestaurantPOS14.frmToppingsList.__ENCList.Capacity = RestaurantPOS14.frmToppingsList.__ENCList.Count
                End If

                Call RestaurantPOS14.frmToppingsList.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnTopping_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                Me.Compute()
                Me.DataGridView1.Rows.Add(text, Me.lblToppingSize.Text, Me.Rate, 1, Me.Amount, Me.DiscountPer, Me.Discount, Me.HSTPer, Me.HST, Me.TotalAmount, "Extra Topping")
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        End Sub
        ...
        Private Sub frmToppingsList_Load(sender As Object, e As System.EventArgs)
            Me.lblToppingSize.Text = ""
            Me.FillToppingSize()
            Me.FillToppings()
            Me.GetTaxType()
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmToppingsList))
            ...
            Me.Label5.Text = "List of Extra Toppings"
            ...
            Me.btnDone.Font = New System.Drawing.Font("Segoe UI Semibold", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Me.btnDone.TextSmoothingMode = System.Drawing.Text.TextRenderingHint.SystemDefault
            ...
            Me.btnReset.Font = New System.Drawing.Font("Segoe UI Semibold", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Me.btnRemove.Enabled = False
            Me.btnRemove.Font = New System.Drawing.Font("Segoe UI Semibold", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Me.btnRemove.TextSmoothingMode = System.Drawing.Text.TextRenderingHint.SystemDefault
