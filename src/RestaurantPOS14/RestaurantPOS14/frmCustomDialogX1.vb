...
Namespace RestaurantPOS14
    ...
    Public Class frmCustomDialogX1
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmCustomDialogX1.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCustomDialogX1.__ENCList
                If RestaurantPOS14.frmCustomDialogX1.__ENCList.Count = RestaurantPOS14.frmCustomDialogX1.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCustomDialogX1.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCustomDialogX1.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCustomDialogX1.__ENCList(num) = RestaurantPOS14.frmCustomDialogX1.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCustomDialogX1.__ENCList.RemoveRange(num, RestaurantPOS14.frmCustomDialogX1.__ENCList.Count - num)
                    RestaurantPOS14.frmCustomDialogX1.__ENCList.Capacity = RestaurantPOS14.frmCustomDialogX1.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCustomDialogX1.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub LogOut()
            Try
                Call RestaurantPOS14.My.MyProject.Forms.frmFrontOffice.Hide()
                Dim st As String = "Successfully clocked out"
                ...
                Call RestaurantPOS14.My.MyProject.Forms.frmLogin.UserID.Focus()
        ...
        Private Sub btnOK_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    ...
                    RestaurantPOS14.ModFunc.ClockOUTSave(Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(Me.txtClockInID.Text))
                    Me.LogOut()
                    MyBase.Close()
        ...
        Private Sub InitializeComponent()
            ...
            Me.Label2.Text = "Are you sure want to" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Clock Out ?"
            ...
            location = New System.Drawing.Point(70, 166)
            ...
            Me.Panel1.Controls.Add(Me.txtClockInID)
            ...
            Dim textBox As System.Windows.Forms.TextBox = Me.txtClockInID
            location = New System.Drawing.Point(267, 95)
            textBox.Location = location
            Me.txtClockInID.Name = "txtClockInID"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtClockInID
            size = New System.Drawing.Size(100, 20)
            textBox2.Size = size
            Me.txtClockInID.TabIndex = 322
