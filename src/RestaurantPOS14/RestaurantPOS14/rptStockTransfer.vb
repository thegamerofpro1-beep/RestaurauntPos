...
Namespace RestaurantPOS14
    ...
    Public Class rptStockTransfer
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptStockTransfer.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptStockTransfer.__ENCList
                If RestaurantPOS14.rptStockTransfer.__ENCList.Count = RestaurantPOS14.rptStockTransfer.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptStockTransfer.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptStockTransfer.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptStockTransfer.__ENCList(num) = RestaurantPOS14.rptStockTransfer.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptStockTransfer.__ENCList.RemoveRange(num, RestaurantPOS14.rptStockTransfer.__ENCList.Count - num)
                    RestaurantPOS14.rptStockTransfer.__ENCList.Capacity = RestaurantPOS14.rptStockTransfer.__ENCList.Count
                End If

                Call RestaurantPOS14.rptStockTransfer.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptStockTransfer.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
