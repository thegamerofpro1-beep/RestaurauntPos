...
Namespace RestaurantPOS14
    ...
    Public Class rptRPOSByKitchen
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRPOSByKitchen.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRPOSByKitchen.__ENCList
                If RestaurantPOS14.rptRPOSByKitchen.__ENCList.Count = RestaurantPOS14.rptRPOSByKitchen.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRPOSByKitchen.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRPOSByKitchen.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRPOSByKitchen.__ENCList(num) = RestaurantPOS14.rptRPOSByKitchen.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRPOSByKitchen.__ENCList.RemoveRange(num, RestaurantPOS14.rptRPOSByKitchen.__ENCList.Count - num)
                    RestaurantPOS14.rptRPOSByKitchen.__ENCList.Capacity = RestaurantPOS14.rptRPOSByKitchen.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRPOSByKitchen.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRPOSByKitchen.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
