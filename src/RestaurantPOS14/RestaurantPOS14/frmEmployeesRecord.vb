...
Namespace RestaurantPOS14
    ...
    Public Class frmEmployeesRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmEmployeesRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmEmployeesRecord.__ENCList
                If RestaurantPOS14.frmEmployeesRecord.__ENCList.Count = RestaurantPOS14.frmEmployeesRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmEmployeesRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmEmployeesRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmEmployeesRecord.__ENCList(num) = RestaurantPOS14.frmEmployeesRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmEmployeesRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmEmployeesRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmEmployeesRecord.__ENCList.Capacity = RestaurantPOS14.frmEmployeesRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmEmployeesRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select EmpID,RTRIM(EmployeeID),RTRIM(EmployeeName),RTRIM(Address),RTRIM(City),RTRIM(ContactNo),RTRIM(Email),DateofJoining,RTRIM(Active) from EmployeeRegistration order by EmployeeName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Employee", TextCompare:=False) = 0 Then
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtEmployeeName.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtAddress.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtCity.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtContactNo.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtEmail.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.dtpDateOfJoining.Value = Microsoft.VisualBasic.CompilerServices.Conversions.ToDate(dataGridViewRow.Cells(CInt((7))).Value)
                    If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((8))).Value.ToString(), "Yes", TextCompare:=False) = 0 Then
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.chkActive.Checked = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.chkActive.Checked = False
                    End If

                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Home Delivery") Then
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.btnDelete.Enabled = False
                    End If

                    If RestaurantPOS14.ModFunc.IsUpdateAllowed(Me.lblUser.Text, "Home Delivery") Then
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.btnUpdate.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.btnUpdate.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.btnSave.Enabled = False
                    Call RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.txtEmployeeName.Focus()
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("SELECT Photo from EmployeeRegistration where EmployeeRegistration.EmployeeID='", dataGridViewRow.Cells(CInt((1))).Value), "'")), RestaurantPOS14.ModClasses.con)
                    RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                    While RestaurantPOS14.ModClasses.rdr.Read()
                        Dim stream As System.IO.MemoryStream = New System.IO.MemoryStream(CType(RestaurantPOS14.ModClasses.rdr(0), Byte()))
                        RestaurantPOS14.My.MyProject.Forms.frmEmployeeRegistration.Picture.Image = System.Drawing.Image.FromStream(stream)
                    End While
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmEmployeesRecord))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(990, 582)
            panel2.Size = size
            Me.Panel1.TabIndex = 2
            Me.lblUser.AutoSize = True
            Dim label As System.Windows.Forms.Label = Me.lblUser
            location = New System.Drawing.Point(594, 80)
            ...
            location = New System.Drawing.Point(594, 62)
            ...
            size = New System.Drawing.Size(976, 34)
            label6.Size = size
            ...
            location = New System.Drawing.Point(224, 44)
            ...
            Me.btnExportExcel.Font = New System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0)
            ...
            location = New System.Drawing.Point(181, 11)
            button.Location = location
            Me.btnExportExcel.Name = "btnExportExcel"
            Dim button2 As System.Windows.Forms.Button = Me.btnExportExcel
            size = New System.Drawing.Size(129, 48)
            button2.Size = size
            ...
            location = New System.Drawing.Point(96, 11)
            button3.Location = location
            Me.btnClose.Name = "btnClose"
            Dim button4 As System.Windows.Forms.Button = Me.btnClose
            size = New System.Drawing.Size(80, 48)
            button4.Size = size
            ...
            size = New System.Drawing.Size(82, 48)
            button6.Size = size
            ...
            location = New System.Drawing.Point(5, 44)
            ...
            Me.txtEmployeeName.Font = New System.Drawing.Font("Microsoft Sans Serif", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column4, Me.Column5, Me.Column6, Me.Column7, Me.Column8, Me.Column9)
            ...
            size = New System.Drawing.Size(978, 454)
            ...
            size = New System.Drawing.Size(1000, 591)
