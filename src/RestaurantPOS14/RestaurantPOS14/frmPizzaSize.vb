...
Namespace RestaurantPOS14
    ...
    Public Class frmPizzaSize
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSize")>
        Private _txtSize As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtSize As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSize
            End Get
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmPizzaSize.__ENCAddToList(Me)
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPizzaSize.__ENCList
                If RestaurantPOS14.frmPizzaSize.__ENCList.Count = RestaurantPOS14.frmPizzaSize.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPizzaSize.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPizzaSize.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPizzaSize.__ENCList(num) = RestaurantPOS14.frmPizzaSize.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPizzaSize.__ENCList.RemoveRange(num, RestaurantPOS14.frmPizzaSize.__ENCList.Count - num)
                    RestaurantPOS14.frmPizzaSize.__ENCList.Capacity = RestaurantPOS14.frmPizzaSize.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPizzaSize.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Private Sub btnClose_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Pizza", TextCompare:=False) = 0 Then
                Call RestaurantPOS14.My.MyProject.Forms.frmPizzaMaster.fillCombo()
            End If

            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Toppings", TextCompare:=False) = 0 Then
                Call RestaurantPOS14.My.MyProject.Forms.frmPizzaToppings.fillCombo()
            End If
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.txtPizzaSize.Text, "", TextCompare:=False) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please enter Pizza Size", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtPizzaSize.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into PizzaSize(Size) VALUES (@d1)")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtPizzaSize.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                Dim st As String = "added the new Pizza Size '" & Me.txtPizzaSize.Text & "'"
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update PizzaSize set Size=@d1 where Size=@d2")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtPizzaSize.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtSize.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "updated the Pizza Size '" & Me.txtPizzaSize.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Size from PizzaSize,PizzaTopping where PizzaSize.Size=PizzaTopping.PizzaSize and Size=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtSize.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Call System.Windows.Forms.MessageBox.Show("Unable to delete..Already in use in Pizza Toppings", "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Size from PizzaSize,PizzaMaster where PizzaSize.Size=PizzaMaster.PizzaSize and Size=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtSize.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Call System.Windows.Forms.MessageBox.Show("Unable to delete..Already in use in Pizza Master", "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                    If RestaurantPOS14.ModClasses.rdr IsNot Nothing Then
                        RestaurantPOS14.ModClasses.rdr.Close()
                    End If
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from PizzaSize where Size=@d1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtSize.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the Pizza Size '" & Me.txtPizzaSize.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtSize.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    Me.txtPizzaSize.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(Size) from PizzaSize order by Size", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPizzaSize))
            ...
            Me.txtPizzaSize.Font = New System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox As System.Windows.Forms.TextBox = Me.txtPizzaSize
            location = New System.Drawing.Point(12, 24)
            textBox.Location = location
            Me.txtPizzaSize.Name = "txtPizzaSize"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtPizzaSize
            size = New System.Drawing.Size(198, 26)
            textBox2.Size = size
            Me.txtPizzaSize.TabIndex = 0
            Dim textBox3 As System.Windows.Forms.TextBox = Me.txtSize
            location = New System.Drawing.Point(260, 244)
            textBox3.Location = location
            Me.txtSize.Name = "txtSize"
            Dim textBox4 As System.Windows.Forms.TextBox = Me.txtSize
            ...
            location = New System.Drawing.Point(261, 2)
            ...
            Me.Label1.Font = New System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Me.Label1.ForeColor = System.Drawing.Color.White
            Dim label3 As System.Windows.Forms.Label = Me.Label1
            location = New System.Drawing.Point(49, 7)
