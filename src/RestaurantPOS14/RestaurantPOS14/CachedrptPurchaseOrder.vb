...
Namespace RestaurantPOS14
    ...
    Public Class CachedrptPurchaseOrder
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.CachedrptPurchaseOrder.__ENCList
                If RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Count = RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.CachedrptPurchaseOrder.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.CachedrptPurchaseOrder.__ENCList(num) = RestaurantPOS14.CachedrptPurchaseOrder.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.RemoveRange(num, RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Count - num)
                    RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Capacity = RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Count
                End If

                Call RestaurantPOS14.CachedrptPurchaseOrder.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.CachedrptPurchaseOrder.__ENCAddToList(Me)
        End Sub

        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument
            Return New RestaurantPOS14.rptPurchaseOrder With {.Site = MyBase.Site}
        End Function
