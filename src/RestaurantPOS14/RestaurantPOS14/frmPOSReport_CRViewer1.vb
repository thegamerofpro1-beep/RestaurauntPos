...
Namespace RestaurantPOS14
    ...
    Public Class frmPOSReport_CRViewer1
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmPOSReport_CRViewer1.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList
                If RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Count = RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If num4 > num5 Then
                            Exit While
                        End If
                        If RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList(num) = RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList(num3)
                            End If
                            num += 1
                        End If
                        num3 += 1
                    End While
                    Call RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.RemoveRange(num, RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Count - num)
                    RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Capacity = RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Count
                End If
                Call RestaurantPOS14.frmPOSReport_CRViewer1.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                If sqlDataReader.Read() Then
                    ...
                    Dim text As String = RestaurantPOS14.Customization.CrystalReportExporter.Export(reportSource, reportSource.GetType().Name, "POSReport")
                    RestaurantPOS14.ModFunc.SendMail1(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(sqlDataReader.GetValue(0)), Me.txtEmailID.Text, "Please find the attachment below", text, "POS Report", Microsoft.VisualBasic.CompilerServices.Conversions.ToString(sqlDataReader.GetValue(2)), Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(sqlDataReader.GetValue(3)), Microsoft.VisualBasic.CompilerServices.Conversions.ToString(sqlDataReader.GetValue(0)), RestaurantPOS14.ModFunc.Decrypt(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(sqlDataReader.GetValue(1))))
                    sqlDataReader?.Close()
        ...
        Private Sub btnPrint_Click(sender As Object, e As System.EventArgs)
            Dim textObject As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text As String = Nothing, fieldHeadingObject As CrystalDecisions.CrystalReports.Engine.FieldHeadingObject = Nothing, text3 As String = Nothing, textObject2 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text4 As String = Nothing, fieldHeadingObject2 As CrystalDecisions.CrystalReports.Engine.FieldHeadingObject = Nothing, text6 As String = Nothing, textObject3 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text7 As String = Nothing, fieldHeadingObject3 As CrystalDecisions.CrystalReports.Engine.FieldHeadingObject = Nothing, text9 As String = Nothing, textObject4 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text10 As String = Nothing, fieldHeadingObject4 As CrystalDecisions.CrystalReports.Engine.FieldHeadingObject = Nothing, text12 As String = Nothing
            Try
                MyBase.Cursor = System.Windows.Forms.Cursors.WaitCursor
                Me.Timer1.Enabled = True
                ...
                sqlCommand.Parameters.Add(CStr(("@d1")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand.Parameters.Add(CStr(("@d2")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand3.Parameters.Add(CStr(("@d1")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand3.Parameters.Add(CStr(("@d2")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand4.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand4.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand5.Parameters.Add(CStr(("@d5")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand5.Parameters.Add(CStr(("@d6")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand6.Parameters.Add(CStr(("@d7")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand6.Parameters.Add(CStr(("@d8")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand7.Parameters.Add(CStr(("@d11")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand7.Parameters.Add(CStr(("@d12")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand8.Parameters.Add(CStr(("@d9")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand8.Parameters.Add(CStr(("@d10")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand9.Parameters.Add(CStr(("@d11")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand9.Parameters.Add(CStr(("@d12")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand10.Parameters.Add(CStr(("@d13")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand10.Parameters.Add(CStr(("@d14")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand11.Parameters.Add(CStr(("@d13")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand11.Parameters.Add(CStr(("@d14")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand12.Parameters.Add(CStr(("@d13")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand12.Parameters.Add(CStr(("@d14")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand13.Parameters.Add(CStr(("@d13")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand13.Parameters.Add(CStr(("@d14")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand14.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand14.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand15.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand15.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand16.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand16.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand17.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand17.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand18.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand18.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand19.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand19.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand20.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand20.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand21.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand21.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand22.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand22.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand23.Parameters.Add(CStr(("@d9")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand23.Parameters.Add(CStr(("@d10")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand24.Parameters.Add(CStr(("@d13")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand24.Parameters.Add(CStr(("@d14")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                sqlCommand25.Parameters.Add(CStr(("@d3")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateFrom.Value
                sqlCommand25.Parameters.Add(CStr(("@d4")), CType((System.Data.SqlDbType.DateTime), System.Data.SqlDbType), CInt((30)), CStr(("DateIN"))).Value = Me.dtpDateTo.Value
                ...
                End If
                RestaurantPOS14.ModClasses.con.Close()
                Me.S1 = RestaurantPOS14.ModFunc.GetParamValue("select IsNull(Sum(Amount),0) from Payment where Date >=@d1 and Date < @d2", Me.dtpDateFrom.Value, Me.dtpDateTo.Value)
                Me.S2 = RestaurantPOS14.ModFunc.GetParamValue("select IsNull(Sum(Amount),0) from CreditCustomerPayment where Date >=@d1 and Date < @d2", Me.dtpDateFrom.Value, Me.dtpDateTo.Value)
                Me.S3 = RestaurantPOS14.ModFunc.GetParamValue("select IsNull(Sum(GrandTotal),0) from Voucher where Date >=@d1 and Date < @d2", Me.dtpDateFrom.Value, Me.dtpDateTo.Value)
                Me.S4 = RestaurantPOS14.ModFunc.GetParamValue("select IsNull(Sum(GrandTotal),0) from RestaurantPOS_BillingInfoHD where BillDate >=@d1 and BillDate < @d2 and HD_Status not in ('Cancelled') and PaymentMode in ('Cash')", Me.dtpDateFrom.Value, Me.dtpDateTo.Value)
                Me.S5 = RestaurantPOS14.ModFunc.GetParamValue("select IsNull(Sum(GrandTotal),0)-IsNull(Sum(AmtReceived),0) from RestaurantPOS_BillingInfoHD where BillDate >=@d1 and BillDate < @d2 and HD_Status not in ('Cancelled') and PaymentMode in ('Cash')", Me.dtpDateFrom.Value, Me.dtpDateTo.Value)
                ...
                For Each section As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.ReportDefinition.Sections
                    For Each reportObject As CrystalDecisions.CrystalReports.Engine.ReportObject In section.ReportObjects
                        ...
                        If textObject IsNot Nothing AndAlso text IsNot Nothing Then
                            If Not Equals(text, Nothing) AndAlso text.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                            ...
                            If Not Equals(text2, Nothing) AndAlso text2.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text2.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                textObject.Text = System.Text.RegularExpressions.Regex.Replace(text2, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                                If textObject.Text.Equals(text2, System.StringComparison.Ordinal) Then
                        ...
                        If Not (fieldHeadingObject IsNot Nothing AndAlso text3 IsNot Nothing) Then
                            Continue For
                        End If
                        If Not Equals(text3, Nothing) AndAlso text3.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                        ...
                        End If
                        If Not Equals(text3, Nothing) AndAlso text3.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text3.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                ...
                For i As Integer = 0 To rptRPOS3.Subreports.Count - 1
                    For Each section2 As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.Subreports(CInt((i))).ReportDefinition.Sections
                        For Each reportObject2 As CrystalDecisions.CrystalReports.Engine.ReportObject In section2.ReportObjects
                            ...
                            If textObject2 IsNot Nothing AndAlso text4 IsNot Nothing Then
                                If Not Equals(text4, Nothing) AndAlso text4.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                                ...
                                If Not Equals(text5, Nothing) AndAlso text5.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text5.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                    textObject2.Text = System.Text.RegularExpressions.Regex.Replace(text5, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                                    If textObject2.Text.Equals(text5, System.StringComparison.Ordinal) Then
                            ...
                            If Not (fieldHeadingObject2 IsNot Nothing AndAlso text6 IsNot Nothing) Then
                                Continue For
                            End If
                            If Not Equals(text6, Nothing) AndAlso text6.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                            ...
                            End If
                            If Not Equals(text6, Nothing) AndAlso text6.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text6.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                    ...
                    Next
                Next
                For Each section3 As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.ReportDefinition.Sections
                    For Each reportObject3 As CrystalDecisions.CrystalReports.Engine.ReportObject In section3.ReportObjects
                        textObject3 = TryCast(reportObject3, CrystalDecisions.CrystalReports.Engine.TextObject)
                        text7 = If(textObject3 Is Nothing, Nothing, textObject3.Text)
                        If textObject3 IsNot Nothing AndAlso text7 IsNot Nothing Then
                            If Not Equals(text7, Nothing) AndAlso text7.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                                textObject3.Text = text7.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                            End If
                            Dim text8 As String = textObject3.Text
                            If Not Equals(text8, Nothing) AndAlso text8.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text8.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                textObject3.Text = System.Text.RegularExpressions.Regex.Replace(text8, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                                If textObject3.Text.Equals(text8, System.StringComparison.Ordinal) Then
                                    textObject3.Text = "service charge"
                                End If
                            End If
                        End If

                        fieldHeadingObject3 = TryCast(reportObject3, CrystalDecisions.CrystalReports.Engine.FieldHeadingObject)
                        text9 = If(fieldHeadingObject3 Is Nothing, Nothing, fieldHeadingObject3.Text)
                        If Not (fieldHeadingObject3 IsNot Nothing AndAlso text9 IsNot Nothing) Then
                            Continue For
                        End If
                        If Not Equals(text9, Nothing) AndAlso text9.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                            fieldHeadingObject3.Text = text9.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                        End If
                        If Not Equals(text9, Nothing) AndAlso text9.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text9.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                            fieldHeadingObject3.Text = System.Text.RegularExpressions.Regex.Replace(text9, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                            If fieldHeadingObject3.Text.Equals(text9, System.StringComparison.Ordinal) Then
                                fieldHeadingObject3.Text = "service charge"
                            End If
                        End If
                    Next
                Next
                For j As Integer = 0 To rptRPOS3.Subreports.Count - 1
                    For Each section4 As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.Subreports(CInt((j))).ReportDefinition.Sections
                        For Each reportObject4 As CrystalDecisions.CrystalReports.Engine.ReportObject In section4.ReportObjects
                            textObject4 = TryCast(reportObject4, CrystalDecisions.CrystalReports.Engine.TextObject)
                            text10 = If(textObject4 Is Nothing, Nothing, textObject4.Text)
                            If textObject4 IsNot Nothing AndAlso text10 IsNot Nothing Then
                                If Not Equals(text10, Nothing) AndAlso text10.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                                    textObject4.Text = text10.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                                End If
                                Dim text11 As String = textObject4.Text
                                If Not Equals(text11, Nothing) AndAlso text11.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text11.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                    textObject4.Text = System.Text.RegularExpressions.Regex.Replace(text11, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                                    If textObject4.Text.Equals(text11, System.StringComparison.Ordinal) Then
                                        textObject4.Text = "service charge"
                                    End If
                                End If
                            End If

                            fieldHeadingObject4 = TryCast(reportObject4, CrystalDecisions.CrystalReports.Engine.FieldHeadingObject)
                            text12 = If(fieldHeadingObject4 Is Nothing, Nothing, fieldHeadingObject4.Text)
                            If Not (fieldHeadingObject4 IsNot Nothing AndAlso text12 IsNot Nothing) Then
                                Continue For
                            End If
                            If Not Equals(text12, Nothing) AndAlso text12.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                                fieldHeadingObject4.Text = text12.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                            End If
                            If Not Equals(text12, Nothing) AndAlso text12.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text12.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                fieldHeadingObject4.Text = System.Text.RegularExpressions.Regex.Replace(text12, "(?i)service\s*charge(\s*%)?\s*:", "service charge")
                                If fieldHeadingObject4.Text.Equals(text12, System.StringComparison.Ordinal) Then
                                    fieldHeadingObject4.Text = "service charge"
                                End If
                            End If
                        Next
                    Next
                Next
                rptRPOS3.SetParameterValue("p1", Me.dtpDateFrom.Value.ToString("dd/MM/yyyy hh:mm:ss tt"))
                rptRPOS3.SetParameterValue("p2", Me.dtpDateTo.Value.ToString("dd/MM/yyyy hh:mm:ss tt"))
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPOSReport_CRViewer1))
            ...
            location = New System.Drawing.Point(589, 4)
            ...
            location = New System.Drawing.Point(614, 120)
            ...
            location = New System.Drawing.Point(614, 146)
            ...
            location = New System.Drawing.Point(283, 5)
            ...
            MyBase.Name = "frmPOSReport_CRViewer1"
            Me.Text = "POS Report"
