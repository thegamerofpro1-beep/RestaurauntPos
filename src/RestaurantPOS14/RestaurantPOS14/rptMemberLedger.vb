...
Namespace RestaurantPOS14
    ...
    Public Class rptMemberLedger
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptMemberLedger.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptMemberLedger.__ENCList
                If RestaurantPOS14.rptMemberLedger.__ENCList.Count = RestaurantPOS14.rptMemberLedger.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptMemberLedger.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptMemberLedger.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptMemberLedger.__ENCList(num) = RestaurantPOS14.rptMemberLedger.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptMemberLedger.__ENCList.RemoveRange(num, RestaurantPOS14.rptMemberLedger.__ENCList.Count - num)
                    RestaurantPOS14.rptMemberLedger.__ENCList.Capacity = RestaurantPOS14.rptMemberLedger.__ENCList.Count
                End If

                Call RestaurantPOS14.rptMemberLedger.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptMemberLedger.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
