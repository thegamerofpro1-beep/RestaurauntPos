...
Namespace RestaurantPOS14
    ...
    Public Class frmPizzaToppingsExportImport
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList
                If RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Count = RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList(num) = RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.RemoveRange(num, RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Count - num)
                    RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Capacity = RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPizzaToppingsExportImport.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(ToppingName), RTRIM(PizzaSize),RTRIM(ToppingSize),Rate from PizzaTopping order by ToppingName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmMenuItemsExportImport_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmPizzaToppings.Getdata()
        End Sub
                ...
                For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(Me.DataGridView1.Rows, System.Collections.IEnumerable)
                    If Not dataGridViewRow.IsNewRow Then
                        ...
                        If Not RestaurantPOS14.ModClasses.rdr.Read() Then
                            ...
                            RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                            RestaurantPOS14.ModClasses.con.Open()
                            RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Insert Into PizzaTopping(T_ID,ToppingName,PizzaSize,ToppingSize,Rate,BackColor) Values(@d3,@d1,@d2,@d4," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow.Cells(CInt((3))).Value))) & ",-10065303)")
                            RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", dataGridViewRow.Cells(CInt((0))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", dataGridViewRow.Cells(CInt((1))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", dataGridViewRow.Cells(CInt((2))).Value.ToString())
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPizzaToppingsExportImport))
            ...
            Dim textBox As System.Windows.Forms.TextBox = Me.txtToppingID
            location = New System.Drawing.Point(558, 41)
            textBox.Location = location
            Me.txtToppingID.Name = "txtToppingID"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtToppingID
            ...
            Me.Column4.HeaderText = "Topping Size"
            ...
            MyBase.Name = "frmPizzaToppingsExportImport"
