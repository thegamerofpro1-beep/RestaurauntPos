...
Namespace RestaurantPOS14
    ...
    Public Class frmPrintVIPMemberCard
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmPrintVIPMemberCard.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPrintVIPMemberCard.__ENCList
                If RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Count = RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPrintVIPMemberCard.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPrintVIPMemberCard.__ENCList(num) = RestaurantPOS14.frmPrintVIPMemberCard.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.RemoveRange(num, RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Count - num)
                    RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Capacity = RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPrintVIPMemberCard.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnGenerateBarcode_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select MemberID,RTRIM(Name),RTRIM(Address),RTRIM(ContactNo) from Member where MemberID in (" & text & ") order by Name", RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.ModClasses.ds.WriteXmlSchema("RPOSCard.xml")
                Dim rptRPOSCard2 As RestaurantPOS14.rptRPOSCard = New RestaurantPOS14.rptRPOSCard()
                rptRPOSCard2.SetDataSource(RestaurantPOS14.ModClasses.ds)
                rptRPOSCard2.SetParameterValue("p1", Me.txtHotelName.Text)
                RestaurantPOS14.My.MyProject.Forms.frmReport.CrystalReportViewer1.ReportSource = rptRPOSCard2
                Call RestaurantPOS14.My.MyProject.Forms.frmReport.ShowDialog()
                rptRPOSCard2.Close()
                rptRPOSCard2.Dispose()
        ...
        Private Sub txtMemberName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(MemberID),RTRIM(Name),RTRIM(Address),RTRIM(ContactNo) from Member where Name like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtMemberName.Text) & "%' order by Name", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub txtMemberID_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(MemberID),RTRIM(Name),RTRIM(Address),RTRIM(ContactNo) from Member where MemberID like '" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtMemberID.Text) & "%'  order by Name", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                Me.listView1.Items.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Dim listViewItem As System.Windows.Forms.ListViewItem = New System.Windows.Forms.ListViewItem()
        ...
        Public Sub GetData()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(MemberID),RTRIM(Name),RTRIM(Address),RTRIM(ContactNo) from Member order by Name", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                Me.listView1.Items.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Dim listViewItem As System.Windows.Forms.ListViewItem = New System.Windows.Forms.ListViewItem()
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPrintVIPMemberCard))
            ...
            MyBase.Name = "frmPrintVIPMemberCard"
            MyBase.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
            Me.Text = "VIP Member Card"
