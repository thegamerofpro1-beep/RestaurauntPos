...
Namespace RestaurantPOS14
    ...
    Public Class frmPizzaModifiers
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtModifierName")>
        Private _txtModifierName As System.Windows.Forms.TextBox
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtPM_ID")>
        Private _txtPM_ID As System.Windows.Forms.TextBox

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("lblUser")>
        Private _lblUser As System.Windows.Forms.Label

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSearchByModifier")>
        Private _txtSearchByModifier As System.Windows.Forms.TextBox

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("cmbPizzaName")>
        Private _cmbPizzaName As System.Windows.Forms.ComboBox
        ...
        Friend Overridable Property txtModifierName As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtModifierName
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtModifierName_LostFocus
                If Me._txtModifierName IsNot Nothing Then
                    RemoveHandler Me._txtModifierName.LostFocus, value2
                End If

                Me._txtModifierName = value
                If Me._txtModifierName IsNot Nothing Then
                    AddHandler Me._txtModifierName.LostFocus, value2
                End If
            End Set
        End Property
        ...
        Friend Overridable Property txtPM_ID As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtPM_ID
            End Get
        ...
        Friend Overridable Property txtSearchByModifier As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSearchByModifier
            End Get
            ...
            Set(value As System.Windows.Forms.TextBox)
                ...
                If Me._txtSearchByModifier IsNot Nothing Then
                    RemoveHandler Me._txtSearchByModifier.TextChanged, value2
                End If

                Me._txtSearchByModifier = value
                If Me._txtSearchByModifier IsNot Nothing Then
                    AddHandler Me._txtSearchByModifier.TextChanged, value2
                End If
            End Set
        End Property

        Friend Overridable Property cmbPizzaName As System.Windows.Forms.ComboBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._cmbPizzaName
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.EventHandler = AddressOf Me.cmbPizzaName_SelectedIndexChanged
                If Me._cmbPizzaName IsNot Nothing Then
                    RemoveHandler Me._cmbPizzaName.SelectedIndexChanged, value2
                End If

                Me._cmbPizzaName = value
                If Me._cmbPizzaName IsNot Nothing Then
                    AddHandler Me._cmbPizzaName.SelectedIndexChanged, value2
                End If
            End Set
        End Property
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPizzaModifiers.__ENCList
                If RestaurantPOS14.frmPizzaModifiers.__ENCList.Count = RestaurantPOS14.frmPizzaModifiers.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPizzaModifiers.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPizzaModifiers.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPizzaModifiers.__ENCList(num) = RestaurantPOS14.frmPizzaModifiers.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPizzaModifiers.__ENCList.RemoveRange(num, RestaurantPOS14.frmPizzaModifiers.__ENCList.Count - num)
                    RestaurantPOS14.frmPizzaModifiers.__ENCList.Capacity = RestaurantPOS14.frmPizzaModifiers.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPizzaModifiers.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(PM_ID) FROM PizzaModifier")
        ...
        Public Sub fillCombo()
            Try
                ...
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(PizzaName) FROM PizzaMaster order by 1", sqlConnection)
                ...
                Me.cmbPizzaName.Items.Clear()
                For Each dataRow As System.Data.DataRow In dataTable.Rows
                    Me.cmbPizzaName.Items.Add(dataRow(CInt((0))).ToString())
                Next
        ...
        Public Sub Reset()
            Me.cmbPizzaName.SelectedIndex = -1
            Me.cmbPizzaSize.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
            Me.cmbPizzaSize.SelectedIndex = -1
            Me.cmbPizzaSize.Enabled = False
            Me.txtRate.Text = ""
            Me.txtSearchByModifier.Text = ""
            Me.txtModifierName.Text = ""
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.txtModifierName.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please enter modifier name", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtModifierName.Focus()
                Return
            End If

            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.cmbPizzaName.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please select pizza name", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.cmbPizzaName.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select ModifierName,PizzaID from PizzaModifier where ModifierName=@d1 and PizzaID=@d2")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Microsoft.VisualBasic.Conversion.Val(Me.txtPizzaID.Text))
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into PizzaModifier(PM_ID,PizzaID,Rate,BackColor,ModifierName) VALUES (" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtPM_ID.Text)) & ",@d1," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",@d2,@d3)")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtPizzaID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.btnUIColor.BackColor.ToArgb())
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "added the new modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtPM_ID.Text & "'"
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from PizzaModifier where PM_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtPM_ID.Text))
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtPM_ID.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update PizzaModifier set ModifierName=@d1,PizzaID=@d2,Rate=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",BackColor=@d4 where PM_ID=@d3")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Microsoft.VisualBasic.Conversion.Val(Me.txtPizzaID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Microsoft.VisualBasic.Conversion.Val(Me.txtPM_ID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.btnUIColor.BackColor.ToArgb())
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "Updated the modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtPM_ID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                Call System.Windows.Forms.MessageBox.Show("Successfully updated", "modifier Info", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk)
                Me.Reset()
                Me.AutoComplete()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT PM_ID, RTRIM(ModifierName), PizzaID,RTRIM(PizzaName),RTRIM(PizzaSize),PizzaModifier.Rate,PizzaModifier.BackColor from PizzaModifier,PizzaMaster where PizzaMaster.Pizza_ID=PizzaModifier.PizzaID order by ModifierName,PizzaName,PizzaSize", RestaurantPOS14.ModClasses.con)
        ...
        Public Sub AutoComplete()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Distinct (ModifierName) FROM PizzaModifier order by 1", RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.ModClasses.adp.Fill(RestaurantPOS14.ModClasses.ds, "Modifiers")
                ...
                While True
                    ...
                    autoCompleteStringCollection.Add(RestaurantPOS14.ModClasses.ds.Tables(CInt((0))).Rows(CInt((num2)))(CStr(("ModifierName"))).ToString())
                    num2 += 1
                End While

                Me.txtModifierName.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.CustomSource
                Me.txtModifierName.AutoCompleteCustomSource = autoCompleteStringCollection
                Me.txtModifierName.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest
                RestaurantPOS14.ModClasses.con.Close()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtPizzaID.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    Me.cmbPizzaName.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    Me.cmbPizzaSize.Enabled = False
                    Me.cmbPizzaSize.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDown
                    Me.cmbPizzaSize.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    Me.txtRate.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    Dim backColor As System.Drawing.Color = System.Drawing.Color.FromArgb(Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(dataGridViewRow.Cells(CInt((6))).Value))
        ...
        Private Sub txtModifierName_LostFocus(sender As Object, e As System.EventArgs)
            Me.txtModifierName.Text = Me.txtModifierName.Text.Trim()
        End Sub

        Private Sub cmbPizzaName_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select RTRIM(PizzaSize) from PizzaMaster where PizzaName=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbPizzaName.Text)
                Me.cmbPizzaSize.Items.Clear()
                Me.cmbPizzaSize.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
                Me.cmbPizzaSize.Enabled = True
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.cmbPizzaSize.Items.Add(RestaurantPOS14.ModClasses.rdr.GetValue(CInt((0))).ToString())
                End While
        ...
        Public Sub getPizzaID()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Pizza_ID from PizzaMaster where PizzaName=@d1 and PizzaSize=@d2")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbPizzaSize.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbPizzaName.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Me.txtPizzaID.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.ModClasses.rdr.GetValue(0))
                End If
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            ...
            RestaurantPOS14.My.MyProject.Forms.frmPizzaMaster.lblSet.Text = "Modifier"
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPizzaModifiers))
            ...
            Me.cmbPizzaName = New System.Windows.Forms.ComboBox()
            ...
            Me.Panel1.Controls.Add(Me.txtPM_ID)
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(650, 653)
            panel2.Size = size
            Me.Panel1.TabIndex = 2
            Dim textBox As System.Windows.Forms.TextBox = Me.txtPizzaID
            location = New System.Drawing.Point(450, 264)
            ...
            Me.GroupBox2.Controls.Add(Me.cmbPizzaName)
            ...
            size = New System.Drawing.Size(432, 194)
            groupBox4.Size = size
            ...
            Dim comboBox As System.Windows.Forms.ComboBox = Me.cmbPizzaSize
            location = New System.Drawing.Point(125, 80)
            comboBox.Location = location
            Me.cmbPizzaSize.Name = "cmbPizzaSize"
            Dim comboBox2 As System.Windows.Forms.ComboBox = Me.cmbPizzaSize
            ...
            location = New System.Drawing.Point(121, 157)
            ...
            Dim button9 As System.Windows.Forms.Button = Me.btnUIColor
            location = New System.Drawing.Point(9, 149)
            button9.Location = location
            Me.btnUIColor.Name = "btnUIColor"
            Dim button10 As System.Windows.Forms.Button = Me.btnUIColor
            ...
            Me.txtModifierName.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox3 As System.Windows.Forms.TextBox = Me.txtModifierName
            location = New System.Drawing.Point(125, 23)
            textBox3.Location = location
            Me.txtModifierName.Name = "txtModifierName"
            Dim textBox4 As System.Windows.Forms.TextBox = Me.txtModifierName
            ...
            Dim textBox5 As System.Windows.Forms.TextBox = Me.txtRate
            location = New System.Drawing.Point(125, 109)
            textBox5.Location = location
            Me.txtRate.Name = "txtRate"
            Dim textBox6 As System.Windows.Forms.TextBox = Me.txtRate
            size = New System.Drawing.Size(98, 23)
            textBox6.Size = size
            Me.txtRate.TabIndex = 3
            Me.txtRate.TextAlign = System.Windows.Forms.HorizontalAlignment.Right
            Me.cmbPizzaName.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
            Me.cmbPizzaName.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Me.cmbPizzaName.FormattingEnabled = True
            Dim comboBox3 As System.Windows.Forms.ComboBox = Me.cmbPizzaName
            location = New System.Drawing.Point(125, 51)
            comboBox3.Location = location
            Me.cmbPizzaName.Name = "cmbPizzaName"
            Dim comboBox4 As System.Windows.Forms.ComboBox = Me.cmbPizzaName
            size = New System.Drawing.Size(257, 23)
            comboBox4.Size = size
            Me.cmbPizzaName.TabIndex = 1
            ...
            location = New System.Drawing.Point(4, 238)
            ...
            Me.txtSearchByModifier.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtSearchByModifier
            location = New System.Drawing.Point(22, 29)
            textBox7.Location = location
            Me.txtSearchByModifier.Name = "txtSearchByModifier"
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtSearchByModifier
            ...
            location = New System.Drawing.Point(559, 3)
            ...
            Me.dgw.Columns.AddRange(Me.Column4, Me.Column1, Me.Column7, Me.Column2, Me.Column6, Me.Column3, Me.Column5)
            Me.dgw.Cursor = System.Windows.Forms.Cursors.Hand
            Me.dgw.EnableHeadersVisualStyles = False
            Me.dgw.GridColor = System.Drawing.Color.White
            Dim dataGridView As System.Windows.Forms.DataGridView = Me.dgw
            location = New System.Drawing.Point(4, 312)
            ...
            size = New System.Drawing.Size(640, 332)
            ...
            Me.Column7.HeaderText = "Pizza ID"
            Me.Column7.Name = "Column7"
            Me.Column7.[ReadOnly] = True
            Me.Column7.Visible = False
            Me.Column2.HeaderText = "Pizza Name"
            Me.Column2.Name = "Column2"
            Me.Column2.[ReadOnly] = True
            Me.Column2.Width = 200
            Me.Column6.HeaderText = "Pizza Size"
            ...
            size = New System.Drawing.Size(549, 28)
            panel4.Size = size
            ...
            Me.Label1.Text = "Pizza Modifiers"
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtPM_ID
            location = New System.Drawing.Point(450, 238)
            textBox9.Location = location
            Me.txtPM_ID.Name = "txtPM_ID"
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtPM_ID
            size = New System.Drawing.Size(40, 20)
            textBox10.Size = size
            Me.txtPM_ID.TabIndex = 4
            Me.txtPM_ID.Visible = False
            ...
            Dim button13 As System.Windows.Forms.Button = Me.Button1
            location = New System.Drawing.Point(388, 51)
            button13.Location = location
            Me.Button1.Name = "Button1"
            Dim button14 As System.Windows.Forms.Button = Me.Button1
            ...
            size = New System.Drawing.Size(657, 660)
