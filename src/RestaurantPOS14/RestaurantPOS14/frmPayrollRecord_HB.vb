...
Namespace RestaurantPOS14
    ...
    Public Class frmPayrollRecord_HB
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmPayrollRecord_HB_Load
            Call RestaurantPOS14.frmPayrollRecord_HB.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPayrollRecord_HB.__ENCList
                If RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Count = RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPayrollRecord_HB.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPayrollRecord_HB.__ENCList(num) = RestaurantPOS14.frmPayrollRecord_HB.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPayrollRecord_HB.__ENCList.RemoveRange(num, RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Count - num)
                    RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Capacity = RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPayrollRecord_HB.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Payroll.ID as [ID],RTRIM(PaymentID) as [Payment ID],RTRIM(Registration.UserID) as [Employee ID],RTRIM(Name) as [Employee Name],RTRIM(SSN) as [SIN],Hours as [Working Hours],Rate as [Rate/Hour],GrossSalary as [Gross Pay],CPPPer as [CPP %],CPP as [CPP],EIPer as [EI %],EI as [EI],FedTaxPer as [FedTax %],FedTax as [Fed Tax],VPPer as [VP %],VP as [VP],Convert(DateTime,paymentdate,131) as [Payment Date],RTRIM(PaymentMode) as [Payment Mode],RTRIM(Remarks) as [Payment Mode Details],NetPay as [Net Pay] from Payroll,Registration where Registration.UserID=Payroll.UserID order by paymentdate", RestaurantPOS14.ModClasses.con)
                ...
                Me.dgw.DataSource = dataSet.Tables(CStr(("Payroll"))).DefaultView
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 AndAlso Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Payment", TextCompare:=False) = 0 Then
                    ...
                    MyBase.Hide()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtPaymentID.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtEmployeeID.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtEmployeeName.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtSIN.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtWorkingHours.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtRate.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtGrossPay.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtCPPPer.Text = dataGridViewRow.Cells(CInt((8))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtCPP.Text = dataGridViewRow.Cells(CInt((9))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtEIPer.Text = dataGridViewRow.Cells(CInt((10))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtEI.Text = dataGridViewRow.Cells(CInt((11))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtFedTaxPer.Text = dataGridViewRow.Cells(CInt((12))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtFedTax.Text = dataGridViewRow.Cells(CInt((13))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtVPPer.Text = dataGridViewRow.Cells(CInt((14))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtVP.Text = dataGridViewRow.Cells(CInt((15))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.dtpPaymentDate.Value = Microsoft.VisualBasic.CompilerServices.Conversions.ToDate(dataGridViewRow.Cells(CInt((16))).Value)
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.cmbPaymentmode.Text = dataGridViewRow.Cells(CInt((17))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtPaymentModeDetails.Text = dataGridViewRow.Cells(CInt((18))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.txtNetPay.Text = dataGridViewRow.Cells(CInt((19))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.btnSave.Enabled = False
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Payment") Then
                        RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.btnDelete.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.btnPrint.Enabled = True
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.dtpPaymentDate.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPayroll_HB.dgw.Enabled = False
                    Me.lblSet.Text = ""
                End If
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
        ...
        Private Sub txtEmployeeName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Payroll.ID as [ID],RTRIM(PaymentID) as [Payment ID],RTRIM(Registration.UserID) as [Employee ID],RTRIM(Name) as [Employee Name],RTRIM(SSN) as [SIN],Hours as [Working Hours],Rate as [Rate/Hour],GrossSalary as [Gross Pay],CPPPer as [CPP %],CPP as [CPP],EIPer as [EI %],EI as [EI],FedTaxPer as [FedTax %],FedTax as [Fed Tax],VPPer as [VP %],VP as [VP],Convert(DateTime,paymentdate,131) as [Payment Date],RTRIM(PaymentMode) as [Payment Mode],RTRIM(Remarks) as [Payment Mode Details],NetPay as [Net Pay] from Payroll,Registration where Registration.UserID=Payroll.UserID and Name like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtEmployeeName.Text) & "%' order by paymentdate", RestaurantPOS14.ModClasses.con)
                Dim sqlDataAdapter As System.Data.SqlClient.SqlDataAdapter = New System.Data.SqlClient.SqlDataAdapter(RestaurantPOS14.ModClasses.cmd)
                Dim dataSet As System.Data.DataSet = New System.Data.DataSet()
                sqlDataAdapter.Fill(dataSet, "Payroll")
                sqlDataAdapter.Fill(dataSet, "Registration")
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Payroll.ID as [ID],RTRIM(PaymentID) as [Payment ID],RTRIM(Registration.UserID) as [Employee ID],RTRIM(Name) as [Employee Name],RTRIM(SSN) as [SIN],Hours as [Working Hours],Rate as [Rate/Hour],GrossSalary as [Gross Pay],CPPPer as [CPP %],CPP as [CPP],EIPer as [EI %],EI as [EI],FedTaxPer as [FedTax %],FedTax as [Fed Tax],VPPer as [VP %],VP as [VP],Convert(DateTime,paymentdate,131) as [Payment Date],RTRIM(PaymentMode) as [Payment Mode],RTRIM(Remarks) as [Payment Mode Details],NetPay as [Net Pay] from Payroll,Registration where Registration.UserID=Payroll.UserID and PaymentDate >=@d1 and PaymentDate < @d2 order by paymentdate", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmPayrollRecord_HB_Load(sender As Object, e As System.EventArgs)
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPayrollRecord_HB))
            ...
            MyBase.Name = "frmPayrollRecord_HB"
