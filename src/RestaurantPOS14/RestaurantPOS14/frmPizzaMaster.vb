...
Namespace RestaurantPOS14
    ...
    Public Class frmPizzaMaster
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txPizzaID")>
        Private _txPizzaID As System.Windows.Forms.TextBox

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("lblUser")>
        Private _lblUser As System.Windows.Forms.Label

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSearchByPizza")>
        Private _txtSearchByPizza As System.Windows.Forms.TextBox
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtDiscountPer")>
        Private _txtDiscountPer As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtPizzaName As System.Windows.Forms.TextBox
            ...
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtPizzaName_LostFocus
                If Me._txtPizzaName IsNot Nothing Then
                    RemoveHandler Me._txtPizzaName.LostFocus, value2
                End If

                Me._txtPizzaName = value
                If Me._txtPizzaName IsNot Nothing Then
                    AddHandler Me._txtPizzaName.LostFocus, value2
                End If
            End Set
        End Property
        ...
        Friend Overridable Property txPizzaID As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txPizzaID
            End Get
        ...
        Friend Overridable Property txtSearchByPizza As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSearchByPizza
            End Get
            ...
            Set(value As System.Windows.Forms.TextBox)
                ...
                If Me._txtSearchByPizza IsNot Nothing Then
                    RemoveHandler Me._txtSearchByPizza.TextChanged, value2
                End If

                Me._txtSearchByPizza = value
                If Me._txtSearchByPizza IsNot Nothing Then
                    AddHandler Me._txtSearchByPizza.TextChanged, value2
                End If
            End Set
        End Property
        ...
        Friend Overridable Property txtDiscountPer As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtDiscountPer
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.Windows.Forms.KeyPressEventHandler = AddressOf Me.txtDiscountPer_KeyPress
                If Me._txtDiscountPer IsNot Nothing Then
                    RemoveHandler Me._txtDiscountPer.KeyPress, value2
                End If

                Me._txtDiscountPer = value
                If Me._txtDiscountPer IsNot Nothing Then
                    AddHandler Me._txtDiscountPer.KeyPress, value2
                End If
            End Set
        End Property
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPizzaMaster.__ENCList
                If RestaurantPOS14.frmPizzaMaster.__ENCList.Count = RestaurantPOS14.frmPizzaMaster.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPizzaMaster.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPizzaMaster.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPizzaMaster.__ENCList(num) = RestaurantPOS14.frmPizzaMaster.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPizzaMaster.__ENCList.RemoveRange(num, RestaurantPOS14.frmPizzaMaster.__ENCList.Count - num)
                    RestaurantPOS14.frmPizzaMaster.__ENCList.Capacity = RestaurantPOS14.frmPizzaMaster.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPizzaMaster.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                Else
                    ...
                    Me.txPizzaID.Text = num.ToString()
                End If
        ...
        Public Sub Reset()
            ...
            Me.txtRate.Text = ""
            Me.txtSearchByPizza.Text = ""
            Me.txtDescription.Text = ""
            Me.txtPizzaName.Text = ""
            Me.txtDiscountPer.Text = "0.00"
            Me.txtPizzaName.Focus()
        ...
        Private Sub btnClose_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Modifier", TextCompare:=False) = 0 Then
                Call RestaurantPOS14.My.MyProject.Forms.frmPizzaModifiers.fillCombo()
            End If
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.txtPizzaName.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please enter Pizza name", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtPizzaName.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into PizzaMaster(Pizza_ID,PizzaName,PizzaSize,Rate,BackColor,Description,Discount) VALUES (" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txPizzaID.Text)) & ",@d1,@d2," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",@d3,@d4,@d5)")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtPizzaName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbPizzaSize.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.btnUIColor.BackColor.ToArgb())
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.txtDescription.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d5", 0)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "added the new Pizza '" & Me.txtPizzaName.Text & "' having Pizza id='" & Me.txPizzaID.Text & "'"
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Pizza_ID from PizzaMaster,PizzaModifier where PizzaMaster.Pizza_ID=PizzaModifier.PizzaID and Pizza_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txPizzaID.Text))
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Call System.Windows.Forms.MessageBox.Show("Unable to delete..Already in use in Pizza Modifiers", "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                    If RestaurantPOS14.ModClasses.rdr IsNot Nothing Then
                        RestaurantPOS14.ModClasses.rdr.Close()
                    End If
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from PizzaMaster where Pizza_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txPizzaID.Text))
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the Pizza '" & Me.txtPizzaName.Text & "' having Pizza id='" & Me.txPizzaID.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update PizzaMaster set PizzaName=@d1,PizzaSize=@d2,Rate=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",BackColor=@d4,Description=@d5,Discount= 0 where Pizza_ID=@d3")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtPizzaName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbPizzaSize.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Microsoft.VisualBasic.Conversion.Val(Me.txPizzaID.Text))
                ...
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "Updated the Pizza '" & Me.txtPizzaName.Text & "' having Pizza id='" & Me.txPizzaID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                Call System.Windows.Forms.MessageBox.Show("Successfully updated", "Pizza Info", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk)
                Me.Reset()
                Me.AutoComplete()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Pizza_ID, RTRIM(PizzaName),RTRIM(Description), RTRIM(PizzaSize), RTRIM(Rate),Discount,BackColor from PizzaMaster order by PizzaName", RestaurantPOS14.ModClasses.con)
        ...
        Public Sub AutoComplete()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Distinct (PizzaName) FROM PizzaMaster order by 1", RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.ModClasses.adp.Fill(RestaurantPOS14.ModClasses.ds, "PizzaMaster")
                ...
                While True
                    ...
                    autoCompleteStringCollection.Add(RestaurantPOS14.ModClasses.ds.Tables(CInt((0))).Rows(CInt((num2)))(CStr(("PizzaName"))).ToString())
                    num2 += 1
                End While

                Me.txtPizzaName.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.CustomSource
                Me.txtPizzaName.AutoCompleteCustomSource = autoCompleteStringCollection
                Me.txtPizzaName.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest
                RestaurantPOS14.ModClasses.con.Close()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtDescription.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    Me.cmbPizzaSize.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    Me.txtRate.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    Me.txtDiscountPer.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
        ...
        Private Sub txtPizzaName_LostFocus(sender As Object, e As System.EventArgs)
            Me.txtPizzaName.Text = Me.txtPizzaName.Text.Trim()
        End Sub

        Private Sub txtDiscountPer_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs)
            Dim keyChar As Char = e.KeyChar
            If Char.IsControl(keyChar) Then
                Return
            End If
            ...
            If Char.IsDigit(keyChar) OrElse keyChar = "."c Then
                Dim text As String = Me.txtDiscountPer.Text
                Dim selectionStart As Integer = Me.txtDiscountPer.SelectionStart
                Dim selectionLength As Integer = Me.txtDiscountPer.SelectionLength
                text = text.Substring(0, selectionStart) & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(keyChar) & text.Substring(selectionStart + selectionLength)
                Dim s As String = text
                Dim num As Integer = 0
                If Integer.TryParse(s, num) AndAlso text.Length > 16 Then
        ...
        Private Sub btnExportExcel_Click(sender As Object, e As System.EventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmPizzasExportImport.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmPizzasExportImport.ShowDialog()
        End Sub
        ...
        Private Sub btnAdd_Click(sender As Object, e As System.EventArgs)
            ...
            RestaurantPOS14.My.MyProject.Forms.frmPizzaSize.lblSet.Text = "Pizza"
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPizzaMaster))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(547, 653)
            panel2.Size = size
            ...
            location = New System.Drawing.Point(214, 298)
            ...
            Me.txtDiscountPer.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox As System.Windows.Forms.TextBox = Me.txtDiscountPer
            location = New System.Drawing.Point(442, 256)
            textBox.Location = location
            Me.txtDiscountPer.Name = "txtDiscountPer"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtDiscountPer
            ...
            size = New System.Drawing.Size(432, 241)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(125, 53)
            ...
            Me.txtPizzaName.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            location = New System.Drawing.Point(125, 168)
            ...
            location = New System.Drawing.Point(3, 285)
            ...
            Me.txtSearchByPizza.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtSearchByPizza
            location = New System.Drawing.Point(22, 29)
            textBox7.Location = location
            Me.txtSearchByPizza.Name = "txtSearchByPizza"
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtSearchByPizza
            ...
            location = New System.Drawing.Point(460, 4)
            ...
            Me.dgw.Columns.AddRange(Me.Column4, Me.Column1, Me.Column6, Me.Column2, Me.Column3, Me.Column7, Me.Column5)
            Me.dgw.Cursor = System.Windows.Forms.Cursors.Hand
            Me.dgw.EnableHeadersVisualStyles = False
            Me.dgw.GridColor = System.Drawing.Color.White
            Dim dataGridView As System.Windows.Forms.DataGridView = Me.dgw
            location = New System.Drawing.Point(4, 359)
            ...
            size = New System.Drawing.Size(537, 285)
            ...
            size = New System.Drawing.Size(454, 28)
            panel4.Size = size
            ...
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txPizzaID
            location = New System.Drawing.Point(442, 285)
            textBox9.Location = location
            Me.txPizzaID.Name = "txPizzaID"
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txPizzaID
            ...
            location = New System.Drawing.Point(498, 285)
            ...
            location = New System.Drawing.Point(296, 137)
            ...
            location = New System.Drawing.Point(198, 113)
            ...
            size = New System.Drawing.Size(553, 660)
