...
Namespace RestaurantPOS14
    ...
    Public Class frmRawMaterialsUsed
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRawMaterialsUsed.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRawMaterialsUsed.__ENCList
                If RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Count = RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRawMaterialsUsed.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRawMaterialsUsed.__ENCList(num) = RestaurantPOS14.frmRawMaterialsUsed.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRawMaterialsUsed.__ENCList.RemoveRange(num, RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Count - num)
                    RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Capacity = RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRawMaterialsUsed.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(ProductName),RTRIM(Category),Sum(Quantity),RTRIM(Unit) from RM_Used,RM_Used_Join,Product where RM_Used.RM_ID=RM_Used_Join.RawMaterialID and product.PID=RM_Used_Join.ProductID group by Productname,Category,Unit order by 1", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(ProductName),RTRIM(Category),Sum(Quantity),RTRIM(Unit) from RM_Used,RM_Used_Join,Product where RM_Used.RM_ID=RM_Used_Join.RawMaterialID and product.PID=RM_Used_Join.ProductID and BillDate >=@d1 and BillDate < @d2  group by Productname,Category,Unit order by 1", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRawMaterialsUsed))
            ...
            size = New System.Drawing.Size(527, 102)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(361, 32)
            ...
            size = New System.Drawing.Size(1008, 34)
            label6.Size = size
            ...
            location = New System.Drawing.Point(659, 66)
            ...
            location = New System.Drawing.Point(549, 66)
            ...
            MyBase.Name = "frmRawMaterialsUsed"
