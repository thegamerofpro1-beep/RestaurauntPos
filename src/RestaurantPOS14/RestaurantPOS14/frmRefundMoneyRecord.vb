...
Namespace RestaurantPOS14
    ...
    Public Class frmRefundMoneyRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRefundMoneyRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRefundMoneyRecord.__ENCList
                If RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Count = RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRefundMoneyRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRefundMoneyRecord.__ENCList(num) = RestaurantPOS14.frmRefundMoneyRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRefundMoneyRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Capacity = RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRefundMoneyRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT ID,Date, RTRIM(Member.MemberID),RTRIM(Name),Debit FROM Member Inner join MemberLedger on Member.MemberID=MemberLedger.MemberID where Label like 'Money Refunded%' order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 AndAlso Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Refund", TextCompare:=False) = 0 Then
                    If Me.dgw.SelectedRows.Count = 0 Then Return
                    Dim dataGridViewRow As System.Windows.Forms.DataGridViewRow = Me.dgw.SelectedRows(0)
                    MyBase.Hide()
                    Call RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.Show()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.txtID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.dtpEntryDate.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.txtMemberID.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.txtMemberName.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.txtAmount.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.btnSave.Enabled = False
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "VIP Member Card") Then
                        RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.btnDelete.Enabled = False
                    End If

                    If RestaurantPOS14.ModFunc.IsUpdateAllowed(Me.lblUser.Text, "VIP Member Card") Then
                        RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.btnUpdate.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.btnUpdate.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmRefundMoney.dtpEntryDate.Enabled = False
                End If
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub txtGuestName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT ID,Date, RTRIM(Member.MemberID),RTRIM(Name),Debit FROM Member Inner join MemberLedger on Member.MemberID=MemberLedger.MemberID where Label like 'Money Refunded%' and Name like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtMemberName.Text) & "%' order by Date", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)))
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT ID,Date, RTRIM(Member.MemberID),RTRIM(Name),Debit FROM Member Inner join MemberLedger on Member.MemberID=MemberLedger.MemberID where Label like 'Money Refunded%' and Date >=@d1 and Date < @d2 order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRefundMoneyRecord))
            ...
            location = New System.Drawing.Point(295, 3)
            ...
            Me.Label1.Text = "List of Refund Entries"
            Me.lblUser.AutoSize = True
            Dim label9 As System.Windows.Forms.Label = Me.lblUser
            location = New System.Drawing.Point(172, 32)
            ...
            MyBase.Name = "frmRefundMoneyRecord"
