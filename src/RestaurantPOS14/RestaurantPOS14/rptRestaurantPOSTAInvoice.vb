...
Namespace RestaurantPOS14
    Public Class rptRestaurantPOSTAInvoice
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOSTAInvoice.rpt"
            End Get
        ...
        Public ReadOnly Property Section4 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(19)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection2 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(20)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection8 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(21)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection9 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(22)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection10 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(23)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection11 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(24)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection12 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(25)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection13 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(26)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection14 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(27)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection4 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(28)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection3 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(29)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection7 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(30)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection5 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(31)
            End Get
        End Property
        ...
        Public ReadOnly Property ReportFooterSection6 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(32)
            End Get
        End Property
        ...
        Public ReadOnly Property PageFooterSection2 As CrystalDecisions.CrystalReports.Engine.Section
            Get
                Return MyBase.ReportDefinition.Sections(33)
            End Get
        End Property
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList
                If RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Count = RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList(num) = RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRestaurantPOSTAInvoice.__ENCAddToList(Me)
                ...
                For Each reportObject As CrystalDecisions.CrystalReports.Engine.ReportObject In section.ReportObjects
                    ...
                    If textObject IsNot Nothing AndAlso text IsNot Nothing Then
                        ...
                        If text.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                            textObject.Text = text.Replace(CStr(("Service Charge :")), CStr(("service charge"))).Replace("Service Charge", "service charge")
                            text = textObject.Text
                        End If
            ...
            For i As Integer = 0 To MyBase.Subreports.Count - 1
                For Each section2 As CrystalDecisions.CrystalReports.Engine.Section In MyBase.Subreports(CInt((i))).ReportDefinition.Sections
                    For Each reportObject2 As CrystalDecisions.CrystalReports.Engine.ReportObject In section2.ReportObjects
                        ...
                        If textObject2 IsNot Nothing AndAlso text2 IsNot Nothing Then
                            ...
                            If text2.IndexOf("Service Charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text2.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                textObject2.Text = text2.Replace(CStr(("Service Charge :")), CStr(("service charge"))).Replace("Service Charge", "service charge")
                                text2 = textObject2.Text
                            End If

                            If (text2.IndexOf("visit", System.StringComparison.OrdinalIgnoreCase) >= 0 OrElse text2.IndexOf("thank", System.StringComparison.OrdinalIgnoreCase) >= 0) AndAlso text2.IndexOf("Developed by Hitech Computer Centre", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                textObject2.Text = text2 & System.Environment.NewLine & "Developed by Hitech Computer Centre"
                ...
                Next
            Next
            Dim textObject3 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text3 As String = Nothing
            ...
            Try
                For Each reportObject3 As CrystalDecisions.CrystalReports.Engine.ReportObject In MyBase.ReportDefinition.Sections(CInt((MyBase.ReportDefinition.Sections.Count - 1))).ReportObjects
                    ...
                    If textObject3 IsNot Nothing AndAlso text3 IsNot Nothing Then
                        If Not Equals(text3, Nothing) AndAlso text3.IndexOf("Developed by Hitech Computer Centre", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                            textObject3.Text = (If(String.IsNullOrEmpty(text3), "", (text3 & System.Environment.NewLine))) & "Developed by Hitech Computer Centre"
            ...
            Catch reportInitializationException As System.Exception
                RestaurantPOS14.Diagnostics.ApplicationDiagnostics.ReportNonFatal("Initialize rptRestaurantPOSTAInvoice", reportInitializationException)
            End Try
        End Sub
