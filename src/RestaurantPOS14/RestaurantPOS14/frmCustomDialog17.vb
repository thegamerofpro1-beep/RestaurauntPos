...
Namespace RestaurantPOS14
    ...
    Public Class frmCustomDialog17
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmCustomDialog17.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCustomDialog17.__ENCList
                If RestaurantPOS14.frmCustomDialog17.__ENCList.Count = RestaurantPOS14.frmCustomDialog17.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCustomDialog17.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCustomDialog17.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCustomDialog17.__ENCList(num) = RestaurantPOS14.frmCustomDialog17.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCustomDialog17.__ENCList.RemoveRange(num, RestaurantPOS14.frmCustomDialog17.__ENCList.Count - num)
                    RestaurantPOS14.frmCustomDialog17.__ENCList.Capacity = RestaurantPOS14.frmCustomDialog17.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCustomDialog17.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub LogOut()
            Try
                Call RestaurantPOS14.My.MyProject.Forms.frmBackOffice.Hide()
                ...
                RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.Text = ""
                RestaurantPOS14.My.MyProject.Forms.frmLogin.cmbLoginType.SelectedIndex = 0
                If RestaurantPOS14.My.MyProject.Forms.frmLogin.cmbLoginType.SelectedIndex = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.PasswordChar = Global.Microsoft.VisualBasic.Strings.ChrW(0)
                    RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.Text = "ENTER PIN"
                    Call RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.Focus()
                End If

                If RestaurantPOS14.My.MyProject.Forms.frmLogin.cmbLoginType.SelectedIndex = 1 Then
                    RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.PasswordChar = Global.Microsoft.VisualBasic.Strings.ChrW(0)
                    RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.Text = "SCAN CARD"
                    Call RestaurantPOS14.My.MyProject.Forms.frmLogin.Password.Focus()
                End If
        ...
        Private Sub InitializeComponent()
            ...
            Me.Label2.Text = "Are you sure want to" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "logout ?"
