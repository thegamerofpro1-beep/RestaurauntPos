...
Namespace RestaurantPOS14
    ...
    Public Class frmRestaurantPOSHDRecord1
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("cmbDeliveryPerson")>
        Private _cmbDeliveryPerson As System.Windows.Forms.ComboBox
        ...
        Friend Overridable Property cmbDeliveryPerson As System.Windows.Forms.ComboBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._cmbDeliveryPerson
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.EventHandler = AddressOf Me.cmbDeliveryPerson_SelectedIndexChanged
                If Me._cmbDeliveryPerson IsNot Nothing Then
                    RemoveHandler Me._cmbDeliveryPerson.SelectedIndexChanged, value2
                End If

                Me._cmbDeliveryPerson = value
                If Me._cmbDeliveryPerson IsNot Nothing Then
                    AddHandler Me._cmbDeliveryPerson.SelectedIndexChanged, value2
                End If
            End Set
        End Property
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmRestaurantPOSHDRecord1_Load
            Call RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList
                If RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Count = RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList(num) = RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.RemoveRange(num, RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Count - num)
                    RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Capacity = RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRestaurantPOSHDRecord1.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub fillDP()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(EmployeeName) FROM EmployeeRegistration order by 1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                Me.cmbDeliveryPerson.Items.Clear()
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.cmbDeliveryPerson.Items.Add(RestaurantPOS14.ModClasses.rdr(CInt((0))).ToString())
                End While
        ...
        Public Sub GetData(st As String)
            Try
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.cmbDeliveryPerson.Text)
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and  BillDate >=@d1 and BillDate < @d2 and HD_Status in ('Confirmed','Prepared','Dispatched') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and  BillDate >=@d1 and BillDate < @d2 and HD_Status in ('Confirmed','Prepared','Dispatched') and Operator=@d4 order by BillDate")
            End If
        End Sub

        Private Sub btnShowAllBills_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and HD_Status in ('Confirmed','Prepared','Dispatched') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and HD_Status in ('Confirmed','Prepared','Dispatched') and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub Button3_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and RestaurantPOS_BillingInfoHD.ContactNo like N'%" & Me.txtContactNo.Text & "%' and HD_Status in ('Confirmed','Prepared','Dispatched') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and RestaurantPOS_BillingInfoHD.ContactNo like N'%" & Me.txtContactNo.Text & "%' and HD_Status in ('Confirmed','Prepared','Dispatched') and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub cmbDeliveryPerson_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and EmployeeName=@d3 and HD_Status in ('Confirmed','Prepared','Dispatched') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoHD.Id), RTRIM(BillNo),BillDate,RTRIM(Customername),RTRIM(RestaurantPOS_BillingInfoHD.Address),RTRIM(RestaurantPOS_BillingInfoHD.ContactNo),HDDiscountPer,HDDiscountAmt,(RestaurantPOS_BillingInfoHD.SubTotal),HomeDeliveryCharges,GrandTotal,Employee_ID,RTRIM(EmployeeName),RTRIM(PaymentMode),RTRIM(Operator),RTRIM(Member_ID),RTRIM(HD_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,IsNULL(Tip,0),IsNULL(AmtReceived,0) from RestaurantPOS_BillingInfoHD,EmployeeRegistration where RestaurantPOS_BillingInfoHD.Employee_ID=EmployeeRegistration.EmpID and EmployeeName=@d3 and HD_Status in ('Confirmed','Prepared','Dispatched') and Operator=@d4 order by BillDate")
            End If
        End Sub

        Private Sub frmRestaurantPOSHDRecord1_Load(sender As Object, e As System.EventArgs)
            Me.fillDP()
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRestaurantPOSHDRecord1))
            ...
            Me.Label1.Text = "List of Today's Undelivered Home Delivery Bills"
            ...
            size = New System.Drawing.Size(679, 109)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(276, 29)
            ...
            size = New System.Drawing.Size(255, 33)
            ...
            location = New System.Drawing.Point(553, 34)
            button9.Location = location
            Me.Button1.Name = "Button1"
            Dim button10 As System.Windows.Forms.Button = Me.Button1
            size = New System.Drawing.Size(114, 64)
            button10.Size = size
            ...
            location = New System.Drawing.Point(689, 41)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(310, 109)
            groupBox6.Size = size
            Me.GroupBox1.TabIndex = 109
            Me.GroupBox1.TabStop = False
            Me.GroupBox1.Text = "Search By Delivery Person :"
            Me.cmbDeliveryPerson.AutoCompleteMode = System.Windows.Forms.AutoCompleteMode.Suggest
            Me.cmbDeliveryPerson.AutoCompleteSource = System.Windows.Forms.AutoCompleteSource.ListItems
            Me.cmbDeliveryPerson.FormattingEnabled = True
            Dim comboBox As System.Windows.Forms.ComboBox = Me.cmbDeliveryPerson
            location = New System.Drawing.Point(16, 50)
            comboBox.Location = location
            Me.cmbDeliveryPerson.Name = "cmbDeliveryPerson"
            Dim comboBox2 As System.Windows.Forms.ComboBox = Me.cmbDeliveryPerson
            size = New System.Drawing.Size(288, 33)
            comboBox2.Size = size
            Me.cmbDeliveryPerson.TabIndex = 1
            ...
            MyBase.Name = "frmRestaurantPOSHDRecord1"
