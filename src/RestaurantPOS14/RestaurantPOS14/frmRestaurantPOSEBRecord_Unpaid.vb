...
Namespace RestaurantPOS14
    ...
    Public Class frmRestaurantPOSEBRecord_Unpaid
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList
                If RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Count = RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList(num) = RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.RemoveRange(num, RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Count - num)
                    RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Capacity = RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Reset()
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and (DATEDIFF(d,BillDate,GetDate())= 0) Order by BillDate Desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and (DATEDIFF(d,BillDate,GetDate())= 0) and Operator=@d4 order by BillDate desc")
            End If
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBContactNo.Text = dataGridViewRow.Cells(CInt((12))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.lblMemberID.Text = dataGridViewRow.Cells(CInt((13))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtLP3.Text = dataGridViewRow.Cells(CInt((14))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtLA3.Text = dataGridViewRow.Cells(CInt((15))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGFID3.Text = dataGridViewRow.Cells(CInt((16))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtGFA3.Text = dataGridViewRow.Cells(CInt((17))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBCustomerName.Text = dataGridViewRow.Cells(CInt((18))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtCard3.Text = dataGridViewRow.Cells(CInt((19))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtTip3.Text = dataGridViewRow.Cells(CInt((20))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnSave4.Enabled = False
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnUpdateEB.Enabled = True
                ...
                If(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Super Admin", TextCompare:=False) = 0) Or (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Admin", TextCompare:=False) = 0) Then
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.txtColoredCustomerDisplay.Text, "Yes", TextCompare:=False) = 0 Then
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes),RTRIM(Category) from RestaurantPOS_BillingInfoEB,RestaurantPOS_OrderedProductBillEB where RestaurantPOS_BillingInfoEB.Id=RestaurantPOS_OrderedProductBillEB.BillID and RestaurantPOS_BillingInfoEB.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by Op_ID")), RestaurantPOS14.ModClasses.con)
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.txtColoredCustomerDisplay.Text, "Yes", TextCompare:=False) = 0 Then
                    ...
                    p = New System.Drawing.Point(100, 100)
                    obj3.Location = location3 + CType(p, System.Drawing.Size)
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnDebitCard3.Enabled = True
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Calc3()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Visible = True
                Dim point As System.Drawing.Point = New System.Drawing.Point(CInt(System.Math.Round(CDbl(MyBase.ClientSize.Width) / 2.0 - CDbl(RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Size.Width) / 2.0)), CInt(System.Math.Round(CDbl(MyBase.ClientSize.Height) / 2.0 - CDbl(RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Size.Height) / 2.0)))
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Location = point
                p = point
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Anchor = System.Windows.Forms.AnchorStyles.None
                RestaurantPOS14.My.MyProject.Forms.frmPOS.lblModeX.Text = "Update"
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnSendOrder1.Text = "Update Order"
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnPizza4.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnOpenFoods4.Enabled = True
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.CalcItemsAndQty()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.TabControl1.SelectedIndex = 4
                MyBase.Close()
            Catch ex As System.Exception
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and  BillDate >=@d1 and BillDate < @d2 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and  BillDate >=@d1 and BillDate < @d2 and Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub cmbBillNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and BillNo=@d3 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and BillNo=@d3 and Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub txtContactNo_TextChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and EB_PhoneNo like N'%" & Me.txtContactNo.Text & "%' Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and EB_PhoneNo like N'%" & Me.txtContactNo.Text & "%' and Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub btnShowAllBills_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoEB.Id), RTRIM(BillNo),BillDate,EBDiscountPer,EBDiscountAmt,(RestaurantPOS_BillingInfoEB.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(EB_PhoneNo),RTRIM(Member_ID),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNull(Tip,0) from RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') order by 1")
            Else
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoEB where EB_Status in ('Unpaid','Prepared') and Operator=@d1 order by 1")
            End If
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRestaurantPOSEBRecord_Unpaid))
            ...
            location = New System.Drawing.Point(512, 177)
            ...
            size = New System.Drawing.Size(238, 93)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(265, 176)
            ...
            size = New System.Drawing.Size(707, 109)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(122, 5)
            ...
            location = New System.Drawing.Point(285, 27)
            ...
            size = New System.Drawing.Size(268, 33)
            ...
            location = New System.Drawing.Point(289, 50)
            ...
            location = New System.Drawing.Point(561, 31)
            ...
            location = New System.Drawing.Point(717, 41)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(277, 109)
            groupBox6.Size = size
            ...
            size = New System.Drawing.Size(99, 33)
            button10.Size = size
            ...
            size = New System.Drawing.Size(148, 33)
            comboBox2.Size = size
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column4, Me.Column9, Me.Column5, Me.Column7, Me.Column8, Me.Column10, Me.Column6, Me.Column11, Me.Column12, Me.Column13, Me.Column14, Me.Column15, Me.Column16, Me.Column17, Me.Column18, Me.Column19, Me.Column20, Me.Column21)
            ...
            MyBase.Name = "frmRestaurantPOSEBRecord_Unpaid"
