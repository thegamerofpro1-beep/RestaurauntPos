...
Namespace RestaurantPOS14
    ...
    Public Class frmStockTransferRecord
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("cmbTransferID")>
        Private _cmbTransferID As System.Windows.Forms.ComboBox
        ...
        Friend Overridable Property cmbTransferID As System.Windows.Forms.ComboBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._cmbTransferID
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.Windows.Forms.ListControlConvertEventHandler = AddressOf Me.cmbTicketNo_Format
                Dim value3 As System.EventHandler = AddressOf Me.cmbTicketNo_SelectedIndexChanged
                If Me._cmbTransferID IsNot Nothing Then
                    RemoveHandler Me._cmbTransferID.Format, value2
                    RemoveHandler Me._cmbTransferID.SelectedIndexChanged, value3
                End If

                Me._cmbTransferID = value
                If Me._cmbTransferID IsNot Nothing Then
                    AddHandler Me._cmbTransferID.Format, value2
                    AddHandler Me._cmbTransferID.SelectedIndexChanged, value3
                End If
            End Set
        End Property
        ...
        Friend Overridable Property cmbKitchen As System.Windows.Forms.ComboBox
            ...
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.ComboBox)
                Dim value2 As System.EventHandler = AddressOf Me.cmbStore_SelectedIndexChanged
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmStockTransferRecord_Load
            Call RestaurantPOS14.frmStockTransferRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockTransferRecord.__ENCList
                If RestaurantPOS14.frmStockTransferRecord.__ENCList.Count = RestaurantPOS14.frmStockTransferRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockTransferRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockTransferRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockTransferRecord.__ENCList(num) = RestaurantPOS14.frmStockTransferRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockTransferRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockTransferRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmStockTransferRecord.__ENCList.Capacity = RestaurantPOS14.frmStockTransferRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockTransferRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub fillTransferID()
            Try
                ...
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(St_ID) FROM StockTransfer order by 1", sqlConnection)
        ...
        Public Sub fillStore()
            Try
                ...
                sqlConnection.Open()
                RestaurantPOS14.ModClasses.adp = New System.Data.SqlClient.SqlDataAdapter()
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(Kitchen) FROM StockTransfer order by 1", sqlConnection)
                RestaurantPOS14.ModClasses.ds = New System.Data.DataSet("ds")
                RestaurantPOS14.ModClasses.adp.Fill(RestaurantPOS14.ModClasses.ds)
                RestaurantPOS14.ModClasses.dtable = RestaurantPOS14.ModClasses.ds.Tables(0)
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ST_ID,Date,RTRIM(Kitchen) from StockTransfer order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    MyBase.Hide()
                    Call RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.Show()
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.txtID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.dtpDate.Value = Microsoft.VisualBasic.CompilerServices.Conversions.ToDate(dataGridViewRow.Cells(CInt((1))).Value.ToString())
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.cmbKitchen.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.btnSave.Enabled = False
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Stock Transfer") Then
                        RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.btnDelete.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.btnPrint.Enabled = True
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.btnAdd.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.lblSet.Text = "Not allowed"
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Warehouse),(PID),RTRIM(ProductName),RTRIM(ExpiryDate),Qty from Product,StockTransfer,StockTransfer_Join where Product.PID=StockTransfer_Join.ProductID and StockTransfer.ST_ID=StockTransfer_Join.StockTransferID and ST_ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by ProductName")), RestaurantPOS14.ModClasses.con)
                    RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                    Call RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.dgw.Rows.Clear()
                    While RestaurantPOS14.ModClasses.rdr.Read()
                        Call RestaurantPOS14.My.MyProject.Forms.frmStockTransfer.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)))
                    End While
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ST_ID,Date,RTRIM(Kitchen) from StockTransfer where Date between @d1 and @d2 order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub cmbTicketNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ST_ID,Date,RTRIM(Kitchen) from StockTransfer where ST_ID=@d1 order by Date", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.cmbTransferID.Text))
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)))
        ...
        Private Sub cmbStore_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ST_ID,Date,RTRIM(Kitchen) from StockTransfer where Kitchen=@d1 order by Date", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbKitchen.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)))
        ...
        Private Sub frmStockTransferRecord_Load(sender As Object, e As System.EventArgs)
            Me.fillTransferID()
            Me.fillStore()
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockTransferRecord))
            ...
            location = New System.Drawing.Point(3, 150)
            groupBox.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox2 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(300, 109)
            groupBox2.Size = size
            ...
            Dim comboBox3 As System.Windows.Forms.ComboBox = Me.cmbTransferID
            location = New System.Drawing.Point(16, 50)
            comboBox3.Location = location
            Me.cmbTransferID.Name = "cmbTransferID"
            Dim comboBox4 As System.Windows.Forms.ComboBox = Me.cmbTransferID
            ...
            location = New System.Drawing.Point(4, 266)
            ...
            size = New System.Drawing.Size(1006, 306)
            ...
            MyBase.Name = "frmStockTransferRecord"
