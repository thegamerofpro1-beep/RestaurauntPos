...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class RestaurantPOS_OrderedProductBillEBTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_OrderedProductBillEB] ([BillID], [Dish], [Rate], [Quantity], [Amount], [VATPer], [VATAmount], [STPer], [STAmount], [SCPer], [SCAmount], [DiscountPer], [DiscountAmount], [TotalAmount], [Notes], [Category]) VALUES (@BillID, @Dish, @Rate, @Quantity, @Amount, @VATPer, @VATAmount, @STPer, @STAmount, @SCPer, @SCAmount, @DiscountPer, @DiscountAmount, @TotalAmount, @Notes, @Category);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category FROM RestaurantPOS_OrderedProductBillEB WHERE (OP_ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_OrderedProductBillEB] SET [BillID] = @BillID, [Dish] = @Dish, [Rate] = @Rate, [Quantity] = @Quantity, [Amount] = @Amount, [VATPer] = @VATPer, [VATAmount] = @VATAmount, [STPer] = @STPer, [STAmount] = @STAmount, [SCPer] = @SCPer, [SCAmount] = @SCAmount, [DiscountPer] = @DiscountPer, [DiscountAmount] = @DiscountAmount, [TotalAmount] = @TotalAmount, [Notes] = @Notes, [Category] = @Category WHERE (([OP_ID] = @Original_OP_ID) AND ((@IsNull_BillID = 1 AND [BillID] IS NULL) OR ([BillID] = @Original_BillID)) AND ((@IsNull_Dish = 1 AND [Dish] IS NULL) OR ([Dish] = @Original_Dish)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_VATPer = 1 AND [VATPer] IS NULL) OR ([VATPer] = @Original_VATPer)) AND ((@IsNull_VATAmount = 1 AND [VATAmount] IS NULL) OR ([VATAmount] = @Original_VATAmount)) AND ((@IsNull_STPer = 1 AND [STPer] IS NULL) OR ([STPer] = @Original_STPer)) AND ((@IsNull_STAmount = 1 AND [STAmount] IS NULL) OR ([STAmount] = @Original_STAmount)) AND ((@IsNull_SCPer = 1 AND [SCPer] IS NULL) OR ([SCPer] = @Original_SCPer)) AND ((@IsNull_SCAmount = 1 AND [SCAmount] IS NULL) OR ([SCAmount] = @Original_SCAmount)) AND ((@IsNull_DiscountPer = 1 AND [DiscountPer] IS NULL) OR ([DiscountPer] = @Original_DiscountPer)) AND ((@IsNull_DiscountAmount = 1 AND [DiscountAmount] IS NULL) OR ([DiscountAmount] = @Original_DiscountAmount)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category FROM RestaurantPOS_OrderedProductBillEB WHERE (OP_ID = @OP_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category FROM dbo.RestaurantPOS_OrderedProductBillEB"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.RestaurantPOS_OrderedProductBillEBDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.RestaurantPOS_OrderedProductBillEBDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_OrderedProductBillEBDataTable As RestaurantPOS14.RPOS_DBDataSet.RestaurantPOS_OrderedProductBillEBDataTable = New RestaurantPOS14.RPOS_DBDataSet.RestaurantPOS_OrderedProductBillEBDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.RestaurantPOS_OrderedProductBillEBDataTable) As Integer
