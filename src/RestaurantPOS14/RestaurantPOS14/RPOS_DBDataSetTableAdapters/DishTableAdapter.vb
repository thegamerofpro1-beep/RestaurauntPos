...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class DishTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.DishTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Dish] ([DishName], [Category], [DIRate], [TARate], [HDRate], [BackColor], [Barcode], [MI_Status], [DishID]) VALUES (@DishName, @Category, @DIRate, @TARate, @HDRate, @BackColor, @Barcode, @MI_Status, @DishID);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT DishName, Category, DIRate, TARate, HDRate, BackColor, Barcode, MI_Status, DishID FROM Dish WHERE (DishName = @DishName)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Dish] SET [DishName] = @DishName, [Category] = @Category, [DIRate] = @DIRate, [TARate] = @TARate, [HDRate] = @HDRate, [BackColor] = @BackColor, [Barcode] = @Barcode, [MI_Status] = @MI_Status, [DishID] = @DishID WHERE (([DishName] = @Original_DishName) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_DIRate = 1 AND [DIRate] IS NULL) OR ([DIRate] = @Original_DIRate)) AND ((@IsNull_TARate = 1 AND [TARate] IS NULL) OR ([TARate] = @Original_TARate)) AND ((@IsNull_HDRate = 1 AND [HDRate] IS NULL) OR ([HDRate] = @Original_HDRate)) AND ((@IsNull_BackColor = 1 AND [BackColor] IS NULL) OR ([BackColor] = @Original_BackColor)) AND ((@IsNull_Barcode = 1 AND [Barcode] IS NULL) OR ([Barcode] = @Original_Barcode)) AND ((@IsNull_MI_Status = 1 AND [MI_Status] IS NULL) OR ([MI_Status] = @Original_MI_Status)) AND ((@IsNull_DishID = 1 AND [DishID] IS NULL) OR ([DishID] = @Original_DishID)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT DishName, Category, DIRate, TARate, HDRate, BackColor, Barcode, MI_Status, DishID FROM Dish WHERE (DishName = @DishName)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT DishName, Category, DIRate, TARate, HDRate, BackColor, Barcode, MI_Status, DishID FROM dbo.Dish"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.DishDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.DishDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dishDataTable As RestaurantPOS14.RPOS_DBDataSet.DishDataTable = New RestaurantPOS14.RPOS_DBDataSet.DishDataTable()
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.DishDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_DishName As String, Original_Category As String, Original_DIRate As Decimal?, Original_TARate As Decimal?, Original_HDRate As Decimal?, Original_BackColor As Integer?, Original_Barcode As String, Original_MI_Status As String, Original_DishID As Integer?) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(DishName As String, Category As String, DIRate As Decimal?, TARate As Decimal?, HDRate As Decimal?, BackColor As Integer?, Barcode As String, MI_Status As String, DishID As Integer?) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(DishName As String, Category As String, DIRate As Decimal?, TARate As Decimal?, HDRate As Decimal?, BackColor As Integer?, Barcode As String, MI_Status As String, DishID As Integer?, Original_DishName As String, Original_Category As String, Original_DIRate As Decimal?, Original_TARate As Decimal?, Original_HDRate As Decimal?, Original_BackColor As Integer?, Original_Barcode As String, Original_MI_Status As String, Original_DishID As Integer?) As Integer
            If Equals(DishName, Nothing) Then
                Throw New System.ArgumentNullException("DishName")
            End If
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = Original_DishName
            If Equals(Original_Category, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_Category
            End If

            If Original_DIRate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_DIRate.Value
            Else
            ...
            If Original_TARate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_TARate.Value
            Else
            ...
            If Original_HDRate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_HDRate.Value
            Else
            ...
            If Original_BackColor.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_BackColor.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = Original_Barcode
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = Original_MI_Status
            End If

            If Original_DishID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = Original_DishID.Value
            Else
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Category As String, DIRate As Decimal?, TARate As Decimal?, HDRate As Decimal?, BackColor As Integer?, Barcode As String, MI_Status As String, DishID As Integer?, Original_DishName As String, Original_Category As String, Original_DIRate As Decimal?, Original_TARate As Decimal?, Original_HDRate As Decimal?, Original_BackColor As Integer?, Original_Barcode As String, Original_MI_Status As String, Original_DishID As Integer?) As Integer
            Return Me.Update(Original_DishName, Category, DIRate, TARate, HDRate, BackColor, Barcode, MI_Status, DishID, Original_DishName, Original_Category, Original_DIRate, Original_TARate, Original_HDRate, Original_BackColor, Original_Barcode, Original_MI_Status, Original_DishID)
        End Function
    End Class
End Namespace
