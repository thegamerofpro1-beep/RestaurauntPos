...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class LoyaltyMemberTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.LoyaltyMemberTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoyaltyMember] WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LoyaltyMember] ([MemberID], [Name], [ContactNo], [Address], [RegistrationDate], [Active]) VALUES (@MemberID, @Name, @ContactNo, @Address, @RegistrationDate, @Active);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM LoyaltyMember WHERE (MemberID = @MemberID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LoyaltyMember] SET [MemberID] = @MemberID, [Name] = @Name, [ContactNo] = @ContactNo, [Address] = @Address, [RegistrationDate] = @RegistrationDate, [Active] = @Active WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM LoyaltyMember WHERE (MemberID = @MemberID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM dbo.LoyaltyMember"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.LoyaltyMemberDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.LoyaltyMemberDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim loyaltyMemberDataTable As RestaurantPOS14.RPOS_DBDataSet.LoyaltyMemberDataTable = New RestaurantPOS14.RPOS_DBDataSet.LoyaltyMemberDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.LoyaltyMemberDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_MemberID As Integer, Original_Name As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            ...
            If Original_RegistrationDate.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_RegistrationDate.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_Active
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(MemberID As Integer, Name As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String) As Integer
            ...
            If RegistrationDate.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = RegistrationDate.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(MemberID As Integer, Name As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String, Original_MemberID As Integer, Original_Name As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            ...
            If RegistrationDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = RegistrationDate.Value
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_MemberID
            If Equals(Original_Name, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_Name
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_ContactNo
            End If

            If Original_RegistrationDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_RegistrationDate.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Active
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(Name As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String, Original_MemberID As Integer, Original_Name As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            Return Me.Update(Original_MemberID, Name, ContactNo, Address, RegistrationDate, Active, Original_MemberID, Original_Name, Original_ContactNo, Original_RegistrationDate, Original_Active)
        End Function
    End Class
End Namespace
