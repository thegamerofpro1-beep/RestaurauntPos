...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class ProductTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.ProductTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT PID, ProductCode, ProductName, Category, Description, Unit, Price, ReorderPoint FROM dbo.Product"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.ProductDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.ProductDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim productDataTable As RestaurantPOS14.RPOS_DBDataSet.ProductDataTable = New RestaurantPOS14.RPOS_DBDataSet.ProductDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.ProductDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_PID As Integer, Original_ProductCode As String, Original_ProductName As String, Original_Category As String, Original_Unit As String, Original_Price As Decimal, Original_ReorderPoint As Integer) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(PID As Integer, ProductCode As String, ProductName As String, Category As String, Description As String, Unit As String, Price As Decimal, ReorderPoint As Integer) As Integer
        ...
        Public Overridable Function Update(PID As Integer, ProductCode As String, ProductName As String, Category As String, Description As String, Unit As String, Price As Decimal, ReorderPoint As Integer, Original_PID As Integer, Original_ProductCode As String, Original_ProductName As String, Original_Category As String, Original_Unit As String, Original_Price As Decimal, Original_ReorderPoint As Integer) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_PID
            If Equals(Original_ProductCode, Nothing) Then
                Throw New System.ArgumentNullException("Original_ProductCode")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = Original_ProductCode
            If Equals(Original_ProductName, Nothing) Then
                Throw New System.ArgumentNullException("Original_ProductName")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_ProductName
            If Equals(Original_Category, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_Category
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Unit
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_Price
            Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Original_ReorderPoint
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ProductCode As String, ProductName As String, Category As String, Description As String, Unit As String, Price As Decimal, ReorderPoint As Integer, Original_PID As Integer, Original_ProductCode As String, Original_ProductName As String, Original_Category As String, Original_Unit As String, Original_Price As Decimal, Original_ReorderPoint As Integer) As Integer
            Return Me.Update(Original_PID, ProductCode, ProductName, Category, Description, Unit, Price, ReorderPoint, Original_PID, Original_ProductCode, Original_ProductName, Original_Category, Original_Unit, Original_Price, Original_ReorderPoint)
        End Function
    End Class
End Namespace
