...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class MemberTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.MemberTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Member"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Member] WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Member] ([MemberID], [Name], [ContactNo], [Address], [RegistrationDate], [Active]) VALUES (@MemberID, @Name, @ContactNo, @Address, @RegistrationDate, @Active);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM Member WHERE (MemberID = @MemberID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Member] SET [MemberID] = @MemberID, [Name] = @Name, [ContactNo] = @ContactNo, [Address] = @Address, [RegistrationDate] = @RegistrationDate, [Active] = @Active WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM Member WHERE (MemberID = @MemberID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT MemberID, Name, ContactNo, Address, RegistrationDate, Active FROM dbo.Member"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.MemberDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.MemberDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim memberDataTable As RestaurantPOS14.RPOS_DBDataSet.MemberDataTable = New RestaurantPOS14.RPOS_DBDataSet.MemberDataTable()
            Me.Adapter.Fill(memberDataTable)
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.MemberDataTable) As Integer
