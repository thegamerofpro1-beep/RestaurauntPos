...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class PizzaMasterTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.PizzaMasterTableAdapter.__ENCAddToList(Me)
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.PizzaMasterDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.PizzaMasterDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim pizzaMasterDataTable As RestaurantPOS14.RPOS_DBDataSet.PizzaMasterDataTable = New RestaurantPOS14.RPOS_DBDataSet.PizzaMasterDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.PizzaMasterDataTable) As Integer
