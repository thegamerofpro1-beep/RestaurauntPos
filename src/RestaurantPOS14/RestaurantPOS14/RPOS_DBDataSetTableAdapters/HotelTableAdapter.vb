...
Namespace RestaurantPOS14.RPOS_DBDataSetTableAdapters
    ...
    Public Class HotelTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSetTableAdapters.HotelTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Hotel] ([HotelName], [AddressLine1], [AddressLine2], [AddressLine3], [ContactNo], [EmailID], [TIN], [STNo], [CIN], [Logo], [BaseCurrency], [CurrencyCode], [TicketFooterMessage]) VALUES (@HotelName, @AddressLine1, @AddressLine2, @AddressLine3, @ContactNo, @EmailID, @TIN, @STNo, @CIN, @Logo, @BaseCurrency, @CurrencyCode, @TicketFooterMessage);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, HotelName, AddressLine1, AddressLine2, AddressLine3, ContactNo, EmailID, TIN, STNo, CIN, Logo, BaseCurrency, CurrencyCode, TicketFooterMessage FROM Hotel WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Hotel] SET [HotelName] = @HotelName, [AddressLine1] = @AddressLine1, [AddressLine2] = @AddressLine2, [AddressLine3] = @AddressLine3, [ContactNo] = @ContactNo, [EmailID] = @EmailID, [TIN] = @TIN, [STNo] = @STNo, [CIN] = @CIN, [Logo] = @Logo, [BaseCurrency] = @BaseCurrency, [CurrencyCode] = @CurrencyCode, [TicketFooterMessage] = @TicketFooterMessage WHERE (([Id] = @Original_Id) AND ((@IsNull_HotelName = 1 AND [HotelName] IS NULL) OR ([HotelName] = @Original_HotelName)) AND ((@IsNull_AddressLine1 = 1 AND [AddressLine1] IS NULL) OR ([AddressLine1] = @Original_AddressLine1)) AND ((@IsNull_AddressLine2 = 1 AND [AddressLine2] IS NULL) OR ([AddressLine2] = @Original_AddressLine2)) AND ((@IsNull_AddressLine3 = 1 AND [AddressLine3] IS NULL) OR ([AddressLine3] = @Original_AddressLine3)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_EmailID = 1 AND [EmailID] IS NULL) OR ([EmailID] = @Original_EmailID)) AND ((@IsNull_TIN = 1 AND [TIN] IS NULL) OR ([TIN] = @Original_TIN)) AND ((@IsNull_STNo = 1 AND [STNo] IS NULL) OR ([STNo] = @Original_STNo)) AND ((@IsNull_CIN = 1 AND [CIN] IS NULL) OR ([CIN] = @Original_CIN)) AND ((@IsNull_BaseCurrency = 1 AND [BaseCurrency] IS NULL) OR ([BaseCurrency] = @Original_BaseCurrency)) AND ((@IsNull_CurrencyCode = 1 AND [CurrencyCode] IS NULL) OR ([CurrencyCode] = @Original_CurrencyCode)) AND ((@IsNull_TicketFooterMessage = 1 AND [TicketFooterMessage] IS NULL) OR ([TicketFooterMessage] = @Original_TicketFooterMessage)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, HotelName, AddressLine1, AddressLine2, AddressLine3, ContactNo, EmailID, TIN, STNo, CIN, Logo, BaseCurrency, CurrencyCode, TicketFooterMessage FROM Hotel WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, HotelName, AddressLine1, AddressLine2, AddressLine3, ContactNo, EmailID, TIN, STNo, CIN, Logo, BaseCurrency, CurrencyCode, TicketFooterMessage FROM dbo.Hotel"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet.HotelDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet.HotelDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim hotelDataTable As RestaurantPOS14.RPOS_DBDataSet.HotelDataTable = New RestaurantPOS14.RPOS_DBDataSet.HotelDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet.HotelDataTable) As Integer
        ...
        Public Overridable Function Update(HotelName As String, AddressLine1 As String, AddressLine2 As String, AddressLine3 As String, ContactNo As String, EmailID As String, TIN As String, STNo As String, CIN As String, Logo As Byte(), BaseCurrency As String, CurrencyCode As String, TicketFooterMessage As String, Original_Id As Integer, Original_HotelName As String, Original_AddressLine1 As String, Original_AddressLine2 As String, Original_AddressLine3 As String, Original_ContactNo As String, Original_EmailID As String, Original_TIN As String, Original_STNo As String, Original_CIN As String, Original_BaseCurrency As String, Original_CurrencyCode As String, Original_TicketFooterMessage As String, Id As Integer) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_Id
            If Equals(Original_HotelName, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_HotelName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_AddressLine1
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_AddressLine2
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = Original_AddressLine3
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = Original_ContactNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = Original_EmailID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((27))).Value = Original_TIN
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((29))).Value = Original_STNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((31))).Value = Original_CIN
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((33))).Value = Original_BaseCurrency
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((35))).Value = Original_CurrencyCode
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((37))).Value = Original_TicketFooterMessage
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((38))).Value = Id
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(HotelName As String, AddressLine1 As String, AddressLine2 As String, AddressLine3 As String, ContactNo As String, EmailID As String, TIN As String, STNo As String, CIN As String, Logo As Byte(), BaseCurrency As String, CurrencyCode As String, TicketFooterMessage As String, Original_Id As Integer, Original_HotelName As String, Original_AddressLine1 As String, Original_AddressLine2 As String, Original_AddressLine3 As String, Original_ContactNo As String, Original_EmailID As String, Original_TIN As String, Original_STNo As String, Original_CIN As String, Original_BaseCurrency As String, Original_CurrencyCode As String, Original_TicketFooterMessage As String) As Integer
            Return Me.Update(HotelName, AddressLine1, AddressLine2, AddressLine3, ContactNo, EmailID, TIN, STNo, CIN, Logo, BaseCurrency, CurrencyCode, TicketFooterMessage, Original_Id, Original_HotelName, Original_AddressLine1, Original_AddressLine2, Original_AddressLine3, Original_ContactNo, Original_EmailID, Original_TIN, Original_STNo, Original_CIN, Original_BaseCurrency, Original_CurrencyCode, Original_TicketFooterMessage, Original_Id)
        End Function
    End Class
End Namespace
