...
Namespace RestaurantPOS14
    ...
    Public Class frmOpenTicketsRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmOpenTicketsRecord_Load
            Call RestaurantPOS14.frmOpenTicketsRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmOpenTicketsRecord.__ENCList
                If RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Count = RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmOpenTicketsRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmOpenTicketsRecord.__ENCList(num) = RestaurantPOS14.frmOpenTicketsRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmOpenTicketsRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Capacity = RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmOpenTicketsRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                If(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Super Admin", TextCompare:=False) = 0) Or (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Admin", TextCompare:=False) = 0) Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnVoid.Enabled = True
                Else
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnVoid.Enabled = False
                End If

                RestaurantPOS14.My.MyProject.Forms.frmPOS.flpCategoriesKOT.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.flpItemsKOT.Enabled = True
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnKOTUpdate.Enabled = True
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnPizza1.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnOpenFoods1.Enabled = True
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                ...
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnCancelItem.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUpdateModeKOT.Text = ""
                Else
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnKOTUpdate.Enabled = True
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUpdateModeKOT.Text = "Update"
                End If

                RestaurantPOS14.ModClasses.con.Close()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes),Quantity,RTRIM(Category),RTRIM(DishNameArabic),RTRIM(ItemStatus) from RestaurantPOS_OrderInfoKOT,RestaurantPOS_OrderedProductKOT where RestaurantPOS_OrderInfoKOT.Id=RestaurantPOS_OrderedProductKOT.TicketID and ItemStatus in ('Old','New') and RestaurantPOS_OrderInfoKOT.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by op_id")), RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView1.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Call RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView1.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(5)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(6)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(7)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(8)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(9)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(10)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(11)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(12)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(13)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(14)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(15)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(16)), "Old")
                End While
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.txtColoredCustomerDisplay.Text, "Yes", TextCompare:=False) = 0 Then
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes),Quantity,RTRIM(Category) from RestaurantPOS_OrderInfoKOT,RestaurantPOS_OrderedProductKOT where RestaurantPOS_OrderInfoKOT.Id=RestaurantPOS_OrderedProductKOT.TicketID and ItemStatus in ('Old','New') and RestaurantPOS_OrderInfoKOT.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by op_id")), RestaurantPOS14.ModClasses.con)
        ...
        Private Sub cmbTicketNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_OrderInfoKOT.Id), RTRIM(TicketNo),BillDate,RTRIM(TableNo),(RestaurantPOS_OrderInfoKOT.GrandTotal),RTRIM(Operator),RTRIM(GroupName),RTRIM(TicketNote),RTRIM(KOT_Status),RTRIM(ODNX),NoOfPerson from RestaurantPOS_OrderInfoKOT where TicketNo=@d3 and KOT_Status in ('Open','Served','Prepared') order by BillDate desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_OrderInfoKOT.Id), RTRIM(TicketNo),BillDate,RTRIM(TableNo),(RestaurantPOS_OrderInfoKOT.GrandTotal),RTRIM(Operator),RTRIM(GroupName),RTRIM(TicketNote),RTRIM(KOT_Status),RTRIM(ODNX),NoOfPerson from RestaurantPOS_OrderInfoKOT where TicketNo=@d3 and KOT_Status in ('Open','Served','Prepared') and Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub frmOpenTicketsRecord_Load(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.fillTicketNo("SELECT RTRIM(TicketNo) FROM RestaurantPOS_OrderInfoKOT where KOT_Status in ('Open','Served','Prepared') order by 1")
            Else
                Me.fillTicketNo("SELECT RTRIM(TicketNo) FROM RestaurantPOS_OrderInfoKOT where KOT_Status in ('Open','Served','Prepared') and Operator=@d1 order by 1")
            End If
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmOpenTicketsRecord))
            ...
            size = New System.Drawing.Size(990, 34)
            label2.Size = size
            ...
            size = New System.Drawing.Size(995, 416)
            ...
            MyBase.Name = "frmOpenTicketsRecord"
