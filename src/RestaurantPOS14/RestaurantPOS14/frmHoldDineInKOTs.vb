...
Namespace RestaurantPOS14
    ...
    Public Class frmHoldDineInKOTs
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmHoldDineInKOTs.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmHoldDineInKOTs.__ENCList
                If RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Count = RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmHoldDineInKOTs.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmHoldDineInKOTs.__ENCList(num) = RestaurantPOS14.frmHoldDineInKOTs.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmHoldDineInKOTs.__ENCList.RemoveRange(num, RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Count - num)
                    RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Capacity = RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Count
                End If

                Call RestaurantPOS14.frmHoldDineInKOTs.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(HoldID),Date,RTRIM(UserID),RTRIM(TaxType),RTRIM(TableNo),RTRIM(CName) from HoldBill where BillType='Dine In' order by 2", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub DataGridView1_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.lblTableNo.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.cmbGroup.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.lblBalance.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(RestaurantPOS14.ModFunc.GetHoldBillTotal(dataGridViewRow.Cells(CInt((0))).Value.ToString()))
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.FillGroup()
                RestaurantPOS14.My.MyProject.Forms.frmPOS.cmbGroup.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Show()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes),Quantity,RTRIM(Category),RTRIM(DishNameArabic),RTRIM(ItemStatus) from HoldBill INNER JOIN HoldItems ON HoldBill.HoldID=HoldItems.BillID where HoldID=@d1 order by Dish", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmHoldDineInKOTs))
            ...
            Me.DataGridView1.Columns.AddRange(Me.Column1, Me.Column5, Me.Column4, Me.Column6, Me.Column7, Me.Column2)
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(685, 355)
            ...
            Me.Column7.Width = 80
            Me.Column2.HeaderText = "Group/Customer Name"
            ...
            size = New System.Drawing.Size(628, 46)
            panel2.Size = size
            ...
            size = New System.Drawing.Size(211, 32)
            label2.Size = size
            Me.Label2.TabIndex = 0
            Me.Label2.Text = "Hold Dine In KOTs"
            ...
            location = New System.Drawing.Point(635, 2)
            ...
            size = New System.Drawing.Size(688, 409)
