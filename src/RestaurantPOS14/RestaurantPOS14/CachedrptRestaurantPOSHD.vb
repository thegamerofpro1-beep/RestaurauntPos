...
Namespace RestaurantPOS14
    ...
    Public Class CachedrptRestaurantPOSHD
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList
                If RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Count = RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList(num) = RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.RemoveRange(num, RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Count - num)
                    RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Capacity = RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Count
                End If

                Call RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.CachedrptRestaurantPOSHD.__ENCAddToList(Me)
        End Sub

        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument
            Return New RestaurantPOS14.rptRestaurantPOSHD With {.Site = MyBase.Site}
        End Function
