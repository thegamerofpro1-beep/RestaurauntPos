...
Namespace RestaurantPOS14
    ...
    Public Class frmNotes
        ...
        Public Sub New()
            ...
            AddHandler MyBase.FormClosing, AddressOf Me.frmNotes_FormClosing
            AddHandler MyBase.Shown, AddressOf Me.frmNotes_Shown
            Call RestaurantPOS14.frmNotes.__ENCAddToList(Me)
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmNotes.__ENCList
                If RestaurantPOS14.frmNotes.__ENCList.Count = RestaurantPOS14.frmNotes.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmNotes.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmNotes.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmNotes.__ENCList(num) = RestaurantPOS14.frmNotes.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmNotes.__ENCList.RemoveRange(num, RestaurantPOS14.frmNotes.__ENCList.Count - num)
                    RestaurantPOS14.frmNotes.__ENCList.Capacity = RestaurantPOS14.frmNotes.__ENCList.Count
                End If

                Call RestaurantPOS14.frmNotes.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "KOT", TextCompare:=False) = 0 Then
                ...
                For Each selectedRow As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView1.SelectedRows
                    selectedRow.Cells(CInt((13))).Value = Me.txtNotes.Text.Trim()
                    Me.txtNotes.Text = ""
                Next
            End If
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "TA", TextCompare:=False) = 0 Then
                MyBase.Hide()
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Show()
                For Each selectedRow2 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView3.SelectedRows
                    selectedRow2.Cells(CInt((13))).Value = Me.txtNotes.Text.Trim()
                    Me.txtNotes.Text = ""
                Next
            End If
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "HD", TextCompare:=False) = 0 Then
                MyBase.Hide()
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Show()
                For Each selectedRow3 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView4.SelectedRows
                    selectedRow3.Cells(CInt((13))).Value = Me.txtNotes.Text.Trim()
                    Me.txtNotes.Text = ""
                Next
            End If
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "EB", TextCompare:=False) = 0 Then
                MyBase.Hide()
                Call RestaurantPOS14.My.MyProject.Forms.frmPOS.Show()
                For Each selectedRow4 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmPOS.DataGridView5.SelectedRows
                    selectedRow4.Cells(CInt((13))).Value = Me.txtNotes.Text.Trim()
                    Me.txtNotes.Text = ""
                Next
            End If

            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "PizzaPOS", TextCompare:=False) <> 0 Then
                Return
            End If

            MyBase.Hide()
            Call RestaurantPOS14.My.MyProject.Forms.frmPizzaPOS.Show()
            For Each selectedRow5 As System.Windows.Forms.DataGridViewRow In RestaurantPOS14.My.MyProject.Forms.frmPizzaPOS.DataGridView2.SelectedRows
                selectedRow5.Cells(CInt((10))).Value = Me.txtNotes.Text.Trim()
                Me.txtNotes.Text = ""
            Next
        End Sub
        ...
        Private Sub frmNotes_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs)
            Me.txtNotes.Text = ""
        End Sub

        Private Sub frmNotes_Shown(sender As Object, e As System.EventArgs)
            Me.txtNotes.Focus()
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmNotes))
            ...
            location = New System.Drawing.Point(226, 243)
            ...
            location = New System.Drawing.Point(319, 1)
            ...
            location = New System.Drawing.Point(1, 293)
            ...
            size = New System.Drawing.Size(806, 357)
            radVirtualKeyboard2.Size = size
            Me.RadVirtualKeyboard1.TabIndex = 375
            ...
            size = New System.Drawing.Size(812, 653)
