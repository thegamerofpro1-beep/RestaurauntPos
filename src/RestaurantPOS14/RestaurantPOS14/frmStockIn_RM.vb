...
Namespace RestaurantPOS14
    ...
    Public Class frmStockIn_RM
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmStockIn_RM.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockIn_RM.__ENCList
                If RestaurantPOS14.frmStockIn_RM.__ENCList.Count = RestaurantPOS14.frmStockIn_RM.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockIn_RM.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockIn_RM.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockIn_RM.__ENCList(num) = RestaurantPOS14.frmStockIn_RM.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockIn_RM.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockIn_RM.__ENCList.Count - num)
                    RestaurantPOS14.frmStockIn_RM.__ENCList.Capacity = RestaurantPOS14.frmStockIn_RM.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockIn_RM.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(ProductCode),RTRIM(ProductName),RTRIM(Convert(nvarchar(50),Qty) + ' ' + Convert(Nvarchar(50),Unit)),Price*Qty from temp_stock_RM,Product where Temp_Stock_RM.ProductID=Product.PID and Qty > 0 order by ProductName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockIn_RM))
            ...
            Me.Label1.Text = "Available Items (Raw Materials at Kitchen/Section)"
            ...
            location = New System.Drawing.Point(271, 41)
            ...
            location = New System.Drawing.Point(131, 31)
