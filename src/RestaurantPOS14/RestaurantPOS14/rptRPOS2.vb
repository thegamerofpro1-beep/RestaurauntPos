...
Namespace RestaurantPOS14
    Public Class rptRPOS2
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRPOS2.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRPOS2.__ENCList
                If RestaurantPOS14.rptRPOS2.__ENCList.Count = RestaurantPOS14.rptRPOS2.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRPOS2.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRPOS2.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRPOS2.__ENCList(num) = RestaurantPOS14.rptRPOS2.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRPOS2.__ENCList.RemoveRange(num, RestaurantPOS14.rptRPOS2.__ENCList.Count - num)
                    RestaurantPOS14.rptRPOS2.__ENCList.Capacity = RestaurantPOS14.rptRPOS2.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRPOS2.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRPOS2.__ENCAddToList(Me)
                ...
                For Each reportObject As CrystalDecisions.CrystalReports.Engine.ReportObject In section.ReportObjects
                    ...
                    If textObject IsNot Nothing AndAlso text IsNot Nothing Then
                        ...
                        If text.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                            textObject.Text = text.Replace(CStr(("service charge% :")), CStr(("service charge"))).Replace(CStr(("service charge")), CStr(("service charge"))).Replace("service charge%", "service charge")
                            text = textObject.Text
                        End If
                    ...
                    For Each reportObject2 As CrystalDecisions.CrystalReports.Engine.ReportObject In section2.ReportObjects
                        ...
                        If textObject2 IsNot Nothing AndAlso text2 IsNot Nothing Then
                            ...
                            If text2.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) >= 0 AndAlso text2.IndexOf("service charge", System.StringComparison.OrdinalIgnoreCase) < 0 Then
                                textObject2.Text = text2.Replace(CStr(("service charge% :")), CStr(("service charge"))).Replace(CStr(("service charge")), CStr(("service charge"))).Replace("service charge%", "service charge")
                                text2 = textObject2.Text
                            End If
            ...
            Catch reportInitializationException As System.Exception
                RestaurantPOS14.Diagnostics.ApplicationDiagnostics.ReportNonFatal("Initialize rptRPOS2", reportInitializationException)
            End Try
        End Sub
