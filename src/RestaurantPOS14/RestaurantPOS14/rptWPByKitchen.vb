...
Namespace RestaurantPOS14
    ...
    Public Class rptWPByKitchen
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptWPByKitchen.rpt"
            End Get
            Set(value As String)
            End Set
        End Property
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptWPByKitchen.__ENCList
                If RestaurantPOS14.rptWPByKitchen.__ENCList.Count = RestaurantPOS14.rptWPByKitchen.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptWPByKitchen.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If num4 > num5 Then
                            Exit While
                        End If
                        If RestaurantPOS14.rptWPByKitchen.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptWPByKitchen.__ENCList(num) = RestaurantPOS14.rptWPByKitchen.__ENCList(num3)
                            End If
                            num += 1
                        End If
                        num3 += 1
                    End While
                    Call RestaurantPOS14.rptWPByKitchen.__ENCList.RemoveRange(num, RestaurantPOS14.rptWPByKitchen.__ENCList.Count - num)
                    RestaurantPOS14.rptWPByKitchen.__ENCList.Capacity = RestaurantPOS14.rptWPByKitchen.__ENCList.Count
                End If
                Call RestaurantPOS14.rptWPByKitchen.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptWPByKitchen.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
