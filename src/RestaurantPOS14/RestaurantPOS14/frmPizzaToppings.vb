    ...
    Public Class frmPizzaToppings
        ...
        Private Sub txtFirstName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT T_ID, RTRIM(ToppingName), RTRIM(PizzaSize),RTRIM(ToppingSize), RTRIM(Rate),BackColor from PizzaTopping where ToppingName like N'%" & Me.txtSearchByTopping.Text & "%' order by ToppingName", RestaurantPOS14.ModClasses.con)
