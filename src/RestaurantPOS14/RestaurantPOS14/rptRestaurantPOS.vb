...
Namespace RestaurantPOS14
    Public Class rptRestaurantPOS
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOS.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOS.__ENCList
                If RestaurantPOS14.rptRestaurantPOS.__ENCList.Count = RestaurantPOS14.rptRestaurantPOS.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOS.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOS.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOS.__ENCList(num) = RestaurantPOS14.rptRestaurantPOS.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOS.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOS.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOS.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOS.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOS.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRestaurantPOS.__ENCAddToList(Me)
            ...
            Catch reportInitializationException As System.Exception
                RestaurantPOS14.Diagnostics.ApplicationDiagnostics.ReportNonFatal("Initialize rptRestaurantPOS", reportInitializationException)
            End Try
        End Sub
