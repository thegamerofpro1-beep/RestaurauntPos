...
Namespace RestaurantPOS14
    ...
    Public Class frmMenuItemsModifiers
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtMIM_ID")>
        Private _txtMIM_ID As System.Windows.Forms.TextBox
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSearchByItem")>
        Private _txtSearchByItem As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtMIM_ID As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtMIM_ID
            End Get
        ...
        Friend Overridable Property txtSearchByItem As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSearchByItem
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtSearchByItem_TextChanged
                If Me._txtSearchByItem IsNot Nothing Then
                    RemoveHandler Me._txtSearchByItem.TextChanged, value2
                End If

                Me._txtSearchByItem = value
                If Me._txtSearchByItem IsNot Nothing Then
                    AddHandler Me._txtSearchByItem.TextChanged, value2
                End If
            End Set
        End Property
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmMenuItemsModifiers.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmMenuItemsModifiers.__ENCList
                If RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Count = RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmMenuItemsModifiers.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmMenuItemsModifiers.__ENCList(num) = RestaurantPOS14.frmMenuItemsModifiers.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmMenuItemsModifiers.__ENCList.RemoveRange(num, RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Count - num)
                    RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Capacity = RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Count
                End If

                Call RestaurantPOS14.frmMenuItemsModifiers.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(MIM_ID) FROM Modifiers")
                ...
                Else
                    ...
                    Me.txtMIM_ID.Text = num.ToString()
                End If
        ...
        Public Sub Reset()
            Me.cmbItemName.Text = ""
            Me.txtSearchByItem.Text = ""
            Me.txtRate.Text = ""
            Me.txtSearchByModifier.Text = ""
            Me.txtModifierName.Text = ""
            Me.txtModifierName.Focus()
            If RestaurantPOS14.ModFunc.IsSaveAllowed(Me.lblUser.Text, "Modifiers") Then
            ...
            If RestaurantPOS14.ModFunc.IsViewAllowed(Me.lblUser.Text, "Modifiers") Then
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select ModifierName,Item from Modifiers where ModifierName=@d1 and Item=@d2")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbItemName.Text)
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into Modifiers(MIM_ID,ModifierName,Item,Rate,BackColor) VALUES (" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtMIM_ID.Text)) & ",@d1,@d2," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",@d3)")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbItemName.Text)
                ...
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "added the new modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtMIM_ID.Text & "'"
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from Modifiers where MIM_ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtMIM_ID.Text))
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtMIM_ID.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update Modifiers set ModifierName=@d1,Item=@d2,Rate=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtRate.Text)) & ",BackColor=@d4 where MIM_ID=@d3")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtModifierName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbItemName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Microsoft.VisualBasic.Conversion.Val(Me.txtMIM_ID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d4", Me.btnUIColor.BackColor.ToArgb())
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "Updated the modifier '" & Me.txtModifierName.Text & "' having modifier id='" & Me.txtMIM_ID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MIM_ID, RTRIM(ModifierName), RTRIM(Item), RTRIM(Rate),BackColor from Modifiers order by 3,1", RestaurantPOS14.ModClasses.con)
        ...
        Public Sub AutoComplete()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Distinct (ModifierName) FROM Modifiers order by 1", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtMIM_ID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    Me.cmbItemName.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    Me.txtRate.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    Dim backColor As System.Drawing.Color = System.Drawing.Color.FromArgb(Microsoft.VisualBasic.CompilerServices.Conversions.ToInteger(dataGridViewRow.Cells(CInt((4))).Value))
        ...
        Private Sub txtFirstName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MIM_ID, RTRIM(ModifierName), RTRIM(Item), RTRIM(Rate),BackColor from Modifiers where ModifierName like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByModifier.Text) & "%' order by 3,1", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub btnExportExcel_Click(sender As Object, e As System.EventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmModifiersExportImport.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmModifiersExportImport.ShowDialog()
        End Sub
        ...
        Private Sub btnAdd_Click(sender As Object, e As System.EventArgs)
            ...
            RestaurantPOS14.My.MyProject.Forms.frmMenuItem.lblSet.Text = "Modifier"
            Call RestaurantPOS14.My.MyProject.Forms.frmMenuItem.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmMenuItem.ShowDialog()
        End Sub

        Private Sub txtSearchByItem_TextChanged(sender As Object, e As System.EventArgs)
            Try
                Call System.Data.SqlClient.SqlConnection.ClearAllPools()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MIM_ID, RTRIM(ModifierName), RTRIM(Item), RTRIM(Rate),BackColor from Modifiers where Item like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByItem.Text) & "%' order by 3,1", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmMenuItemsModifiers))
            ...
            Me.txtSearchByItem = New System.Windows.Forms.TextBox()
            ...
            location = New System.Drawing.Point(374, 238)
            button.Location = location
            Me.btnExportExcel.Name = "btnExportExcel"
            Dim button2 As System.Windows.Forms.Button = Me.btnExportExcel
            size = New System.Drawing.Size(168, 39)
            button2.Size = size
            ...
            size = New System.Drawing.Size(432, 165)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(380, 51)
            ...
            location = New System.Drawing.Point(124, 130)
            ...
            location = New System.Drawing.Point(125, 81)
            ...
            size = New System.Drawing.Size(252, 23)
            comboBox2.Size = size
            ...
            location = New System.Drawing.Point(4, 209)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(179, 68)
            groupBox6.Size = size
            ...
            Dim textBox5 As System.Windows.Forms.TextBox = Me.txtSearchByModifier
            location = New System.Drawing.Point(22, 29)
            textBox5.Location = location
            Me.txtSearchByModifier.Name = "txtSearchByModifier"
            Dim textBox6 As System.Windows.Forms.TextBox = Me.txtSearchByModifier
            ...
            Me.dgw.Columns.AddRange(Me.Column4, Me.Column1, Me.Column2, Me.Column3, Me.Column5)
            Me.dgw.Cursor = System.Windows.Forms.Cursors.Hand
            Me.dgw.EnableHeadersVisualStyles = False
            Me.dgw.GridColor = System.Drawing.Color.White
            Dim dataGridView As System.Windows.Forms.DataGridView = Me.dgw
            location = New System.Drawing.Point(4, 283)
            ...
            size = New System.Drawing.Size(538, 361)
            ...
            Me.GroupBox4.Controls.Add(Me.txtSearchByItem)
            ...
            location = New System.Drawing.Point(189, 209)
            ...
            Me.txtSearchByItem.BackColor = System.Drawing.Color.White
            Me.txtSearchByItem.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtSearchByItem
            location = New System.Drawing.Point(22, 29)
            textBox9.Location = location
            Me.txtSearchByItem.Name = "txtSearchByItem"
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtSearchByItem
            size = New System.Drawing.Size(147, 23)
            textBox10.Size = size
            Me.txtSearchByItem.TabIndex = 0
            ...
            MyBase.Name = "frmMenuItemsModifiers"
