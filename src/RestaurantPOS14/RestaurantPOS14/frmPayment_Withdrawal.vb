...
Namespace RestaurantPOS14
    ...
    Public Class frmPayment_Withdrawal
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtR_W")>
        Private _txtR_W As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtR_W As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtR_W
            End Get
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmPayment_Withdrawal.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPayment_Withdrawal.__ENCList
                If RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Count = RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmPayment_Withdrawal.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPayment_Withdrawal.__ENCList(num) = RestaurantPOS14.frmPayment_Withdrawal.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmPayment_Withdrawal.__ENCList.RemoveRange(num, RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Count - num)
                    RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Capacity = RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Count
                End If

                Call RestaurantPOS14.frmPayment_Withdrawal.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(ID) FROM Payment_Withdraw")
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.txtR_W.Text, "", TextCompare:=False) = 0 Then
                MetroFramework.MetroMessageBox.Show(Me, "Please enter receiver/withdrawer name", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtR_W.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into Payment_Withdraw( id, AccountFrom, PaymentMode, Date, Amount, ReceiverName, PhoneNo, Notes) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8)")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.cmbPaymentMode.Text)
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d6", Me.txtR_W.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d7", Me.txtContactNo.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d8", Me.txtNotes.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "added the new Payment/Withdrawal from account no. '" & Me.cmbAccountNo.Text & "' having Transaction ID '" & Me.txtID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                RestaurantPOS14.ModFunc.BankAccountLedgerSave(System.DateTime.Now, Me.cmbAccountNo.Text, Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text)), "Payment/Withdrawal", New Decimal(Microsoft.VisualBasic.Conversion.Val(Me.txtAmount.Text)), 0D)
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Payment_Withdraw.Id, RTRIM(ReceiverName),RTRIM(PhoneNo), Amount, Payment_Withdraw.Date, RTRIM(PaymentMode),RTRIM(Payment_Withdraw.Notes),RTRIM(AccountFrom) from Payment_Withdraw order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from Payment_Withdraw where ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text))
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "Deleted the Payment/Withdrawal record having account no. '" & Me.cmbAccountNo.Text & "' and Transaction ID '" & Me.txtID.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                    RestaurantPOS14.ModFunc.BankAccountLedgerDelete(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text)), "Payment/Withdrawal")
        ...
        Private Sub frmPayment_Withdraw_Load(sender As Object, e As System.EventArgs)
            Me.fillAccountNo()
        End Sub
        ...
        Private Sub DataGridView1_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.DataGridView1.Rows.Count > 0 Then
                    ...
                    Me.txtAmount.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    Me.dtpDate.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    Me.cmbPaymentMode.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    Me.txtNotes.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                    Me.cmbAccountNo.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    Me.btnSave.Enabled = False
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Payment_Withdraw.Id, RTRIM(ReceiverName),RTRIM(PhoneNo), Amount, Payment_Withdraw.Date, RTRIM(PaymentMode),RTRIM(Payment_Withdraw.Notes),RTRIM(AccountFrom) from Payment_Withdraw where Date between @d1 and @d2 order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub btnPrint_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                Dim sqlDataAdapter2 As System.Data.SqlClient.SqlDataAdapter = New System.Data.SqlClient.SqlDataAdapter(New System.Data.SqlClient.SqlCommand("SELECT Payment_Withdraw.Id, ReceiverName,PhoneNo, Amount, Payment_Withdraw.Date,PaymentMode,Payment_Withdraw.Notes,AccountFrom from Payment_Withdraw where Payment_Withdraw.ID=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text)), RestaurantPOS14.ModClasses.con))
                ...
                Dim rptPayment_WithdrawalReceipt2 As RestaurantPOS14.rptPayment_WithdrawalReceipt = New RestaurantPOS14.rptPayment_WithdrawalReceipt()
                rptPayment_WithdrawalReceipt2.SetDataSource(dataSet)
                RestaurantPOS14.My.MyProject.Forms.frmReport.CrystalReportViewer1.ReportSource = rptPayment_WithdrawalReceipt2
                Call RestaurantPOS14.My.MyProject.Forms.frmReport.ShowDialog()
                rptPayment_WithdrawalReceipt2.Close()
                rptPayment_WithdrawalReceipt2.Dispose()
            Catch ex As System.Exception
                MetroFramework.MetroMessageBox.Show(Me, ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPayment_Withdrawal))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(889, 667)
            panel2.Size = size
            ...
            location = New System.Drawing.Point(205, 321)
            ...
            location = New System.Drawing.Point(4, 323)
            ...
            location = New System.Drawing.Point(594, 326)
            ...
            size = New System.Drawing.Size(368, 274)
            groupBox6.Size = size
            ...
            location = New System.Drawing.Point(11, 129)
            ...
            Me.cmbPaymentMode.Items.AddRange(New Object(2) {"By Online Transfer", "By Cheque", "By Cash"})
            Dim comboBox As System.Windows.Forms.ComboBox = Me.cmbPaymentMode
            location = New System.Drawing.Point(109, 133)
            ...
            Dim label7 As System.Windows.Forms.Label = Me.Label13
            location = New System.Drawing.Point(11, 54)
            label7.Location = location
            Me.Label13.Name = "Label13"
            Dim label8 As System.Windows.Forms.Label = Me.Label13
            ...
            location = New System.Drawing.Point(109, 54)
            ...
            location = New System.Drawing.Point(109, 107)
            ...
            location = New System.Drawing.Point(109, 80)
            ...
            location = New System.Drawing.Point(11, 80)
            ...
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtNotes
            location = New System.Drawing.Point(109, 160)
            textBox7.Location = location
            Me.txtNotes.Multiline = True
            Me.txtNotes.Name = "txtNotes"
            Me.txtNotes.ScrollBars = System.Windows.Forms.ScrollBars.Both
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtNotes
            ...
            Dim label13 As System.Windows.Forms.Label = Me.Label10
            location = New System.Drawing.Point(11, 23)
            label13.Location = location
            Me.Label10.Name = "Label10"
            Dim label14 As System.Windows.Forms.Label = Me.Label10
            size = New System.Drawing.Size(98, 26)
            label14.Size = size
            Me.Label10.TabIndex = 33
            Me.Label10.Text = "Receiver/" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Withdrawer Name :"
            Me.txtR_W.BackColor = System.Drawing.Color.White
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtR_W
            location = New System.Drawing.Point(109, 25)
            textBox9.Location = location
            Me.txtR_W.Name = "txtR_W"
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtR_W
            ...
            location = New System.Drawing.Point(807, 3)
            ...
            size = New System.Drawing.Size(368, 218)
            groupBox8.Size = size
            Me.GroupBox2.TabIndex = 1
            Me.GroupBox2.TabStop = False
            Me.GroupBox2.Text = "From Bank Account"
            Me.Label20.AutoSize = True
            Dim label17 As System.Windows.Forms.Label = Me.Label20
            location = New System.Drawing.Point(14, 187)
            label17.Location = location
            Me.Label20.Name = "Label20"
            Dim label18 As System.Windows.Forms.Label = Me.Label20
            ...
            Dim textBox11 As System.Windows.Forms.TextBox = Me.txtBalanceAmount
            location = New System.Drawing.Point(112, 187)
            textBox11.Location = location
            Me.txtBalanceAmount.Name = "txtBalanceAmount"
            Me.txtBalanceAmount.[ReadOnly] = True
            Dim textBox12 As System.Windows.Forms.TextBox = Me.txtBalanceAmount
            size = New System.Drawing.Size(155, 21)
            textBox12.Size = size
            ...
            Dim textBox13 As System.Windows.Forms.TextBox = Me.txtBank
            location = New System.Drawing.Point(112, 75)
            textBox13.Location = location
            Me.txtBank.Name = "txtBank"
            Me.txtBank.[ReadOnly] = True
            Dim textBox14 As System.Windows.Forms.TextBox = Me.txtBank
            ...
            Dim label21 As System.Windows.Forms.Label = Me.Label5
            location = New System.Drawing.Point(14, 23)
            label21.Location = location
            Me.Label5.Name = "Label5"
            Dim label22 As System.Windows.Forms.Label = Me.Label5
            ...
            Dim textBox15 As System.Windows.Forms.TextBox = Me.txtSwiftCode
            ...
            Dim textBox16 As System.Windows.Forms.TextBox = Me.txtSwiftCode
            ...
            Dim textBox17 As System.Windows.Forms.TextBox = Me.txtIFSCCode
            ...
            Dim textBox18 As System.Windows.Forms.TextBox = Me.txtIFSCCode
            size = New System.Drawing.Size(134, 21)
            textBox18.Size = size
            ...
            Dim textBox19 As System.Windows.Forms.TextBox = Me.txtBranchName
            location = New System.Drawing.Point(112, 102)
            textBox19.Location = location
            Me.txtBranchName.Name = "txtBranchName"
            Me.txtBranchName.[ReadOnly] = True
            Dim textBox20 As System.Windows.Forms.TextBox = Me.txtBranchName
            size = New System.Drawing.Size(246, 21)
            textBox20.Size = size
            ...
            Dim label27 As System.Windows.Forms.Label = Me.Label12
            location = New System.Drawing.Point(14, 51)
            label27.Location = location
            Me.Label12.Name = "Label12"
            Dim label28 As System.Windows.Forms.Label = Me.Label12
            size = New System.Drawing.Size(84, 13)
            label28.Size = size
            Me.Label12.TabIndex = 33
            Me.Label12.Text = "Account Name :"
            Dim textBox21 As System.Windows.Forms.TextBox = Me.txtAccountName
            location = New System.Drawing.Point(112, 47)
            textBox21.Location = location
            Me.txtAccountName.Name = "txtAccountName"
            Me.txtAccountName.[ReadOnly] = True
            Dim textBox22 As System.Windows.Forms.TextBox = Me.txtAccountName
            size = New System.Drawing.Size(237, 20)
            textBox22.Size = size
            Me.txtAccountName.TabIndex = 1
            Me.Label3.AutoSize = True
            Dim label29 As System.Windows.Forms.Label = Me.Label3
            location = New System.Drawing.Point(14, 106)
            label29.Location = location
            Me.Label3.Name = "Label3"
            Dim label30 As System.Windows.Forms.Label = Me.Label3
            ...
            Me.DataGridView1.Columns.AddRange(Me.Column1, Me.Column2, Me.Column12, Me.Column3, Me.Column4, Me.Column13, Me.Column5, Me.Column6)
            Me.DataGridView1.Cursor = System.Windows.Forms.Cursors.Hand
            Me.DataGridView1.EnableHeadersVisualStyles = False
            Me.DataGridView1.GridColor = System.Drawing.Color.White
            Dim dataGridView As System.Windows.Forms.DataGridView = Me.DataGridView1
            location = New System.Drawing.Point(4, 404)
            ...
            size = New System.Drawing.Size(879, 258)
            ...
            location = New System.Drawing.Point(9, 144)
            ...
            Dim button15 As System.Windows.Forms.Button = Me.btnSave
            location = New System.Drawing.Point(9, 62)
            button15.Location = location
            Me.btnSave.Name = "btnSave"
            Dim button16 As System.Windows.Forms.Button = Me.btnSave
            size = New System.Drawing.Size(82, 38)
            button16.Size = size
            ...
            size = New System.Drawing.Size(797, 32)
            panel6.Size = size
            ...
            location = New System.Drawing.Point(342, 4)
            ...
            Dim label33 As System.Windows.Forms.Label = Me.lblUser
            location = New System.Drawing.Point(198, 7)
            label33.Location = location
            Me.lblUser.Name = "lblUser"
            Dim label34 As System.Windows.Forms.Label = Me.lblUser
            ...
            location = New System.Drawing.Point(243, 9)
            ...
            size = New System.Drawing.Size(897, 673)
