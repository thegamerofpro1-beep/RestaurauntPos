...
Namespace RestaurantPOS14
    ...
    Public Class frmTableMapping_Waiter
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSearchByUserID")>
        Private _txtSearchByUserID As System.Windows.Forms.TextBox
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtSearchByTableNo")>
        Private _txtSearchByTableNo As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtSearchByUserID As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSearchByUserID
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtSearchByUserID_TextChanged
                If Me._txtSearchByUserID IsNot Nothing Then
                    RemoveHandler Me._txtSearchByUserID.TextChanged, value2
                End If

                Me._txtSearchByUserID = value
                If Me._txtSearchByUserID IsNot Nothing Then
                    AddHandler Me._txtSearchByUserID.TextChanged, value2
                End If
            End Set
        End Property
        ...
        Friend Overridable Property txtSearchByTableNo As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtSearchByTableNo
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtSearchByTableNo_TextChanged
                If Me._txtSearchByTableNo IsNot Nothing Then
                    RemoveHandler Me._txtSearchByTableNo.TextChanged, value2
                End If

                Me._txtSearchByTableNo = value
                If Me._txtSearchByTableNo IsNot Nothing Then
                    AddHandler Me._txtSearchByTableNo.TextChanged, value2
                End If
            End Set
        End Property
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmTableMapping_Waiter.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmTableMapping_Waiter.__ENCList
                If RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Count = RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmTableMapping_Waiter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmTableMapping_Waiter.__ENCList(num) = RestaurantPOS14.frmTableMapping_Waiter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmTableMapping_Waiter.__ENCList.RemoveRange(num, RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Count - num)
                    RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Capacity = RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Count
                End If

                Call RestaurantPOS14.frmTableMapping_Waiter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub fillTableNo()
            Try
                ...
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(TableNo) FROM R_Table where Status='Activate' order by 1", sqlConnection)
                ...
                For Each dataRow As System.Data.DataRow In dataTable.Rows
                    Me.cmbTableNo.Items.Add(dataRow(CInt((0))).ToString())
                Next
        ...
        Public Sub fillUserID()
            Try
                ...
                sqlConnection.Open()
                RestaurantPOS14.ModClasses.adp = New System.Data.SqlClient.SqlDataAdapter()
                RestaurantPOS14.ModClasses.adp.SelectCommand = New System.Data.SqlClient.SqlCommand("SELECT distinct RTRIM(UserID) FROM Registration where Active='Yes' and UserType='Waiter' order by 1", sqlConnection)
                RestaurantPOS14.ModClasses.ds = New System.Data.DataSet("ds")
                RestaurantPOS14.ModClasses.adp.Fill(RestaurantPOS14.ModClasses.ds)
                Dim dataTable As System.Data.DataTable = RestaurantPOS14.ModClasses.ds.Tables(0)
        ...
        Public Sub Reset()
            ...
            Me.txtSearchByTableNo.Text = ""
            Me.txtSearchByUserID.Text = ""
            Me.cmbUserID.Focus()
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.cmbTableNo.Text, "", TextCompare:=False) = 0 Then
                MetroFramework.MetroMessageBox.Show(Me, "Please select Table No.", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.cmbTableNo.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select TableNo,UserID from TableMapping where UserID=@d1 and TableNo=@d2")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbUserID.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbTableNo.Text)
                ...
                Else
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into TableMapping(UserID,TableNo) VALUES (@d1,@d2)")
                    RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbUserID.Text)
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbTableNo.Text)
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from TableMapping where ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update TableMapping set UserID=@d1,TableNo=@d2 where ID=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text)))
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.cmbUserID.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.cmbTableNo.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ID,RTRIM(UserID),RTRIM(TableNo) from TableMapping order by 2,3", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.cmbUserID.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
                    Me.cmbTableNo.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
        ...
        Private Sub txtSearchByTableNo_TextChanged(sender As Object, e As System.EventArgs)
            Try
                Call System.Data.SqlClient.SqlConnection.ClearAllPools()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ID,RTRIM(UserID),RTRIM(TableNo) from TableMapping where TableNo like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByTableNo.Text) & "%' order by 2,3", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub txtSearchByUserID_TextChanged(sender As Object, e As System.EventArgs)
            Try
                Call System.Data.SqlClient.SqlConnection.ClearAllPools()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select ID,RTRIM(UserID),RTRIM(TableNo) from TableMapping where UserID like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByUserID.Text) & "%' order by 2,3", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmTableMapping_Waiter))
            ...
            Me.txtSearchByUserID = New System.Windows.Forms.TextBox()
            Me.GroupBox3 = New System.Windows.Forms.GroupBox()
            Me.txtSearchByTableNo = New System.Windows.Forms.TextBox()
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(480, 648)
            panel2.Size = size
            Me.Panel1.TabIndex = 0
            Me.lblUser.AutoSize = True
            Dim label As System.Windows.Forms.Label = Me.lblUser
            location = New System.Drawing.Point(404, 314)
            ...
            Me.txtID.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox As System.Windows.Forms.TextBox = Me.txtID
            location = New System.Drawing.Point(383, 260)
            ...
            Me.GroupBox4.Controls.Add(Me.txtSearchByUserID)
            ...
            location = New System.Drawing.Point(175, 132)
            groupBox.Location = location
            Me.GroupBox4.Name = "GroupBox4"
            Dim groupBox2 As System.Windows.Forms.GroupBox = Me.GroupBox4
            size = New System.Drawing.Size(191, 68)
            groupBox2.Size = size
            Me.GroupBox4.TabIndex = 6
            Me.GroupBox4.TabStop = False
            Me.GroupBox4.Text = "Search By User ID :"
            Me.txtSearchByUserID.BackColor = System.Drawing.Color.White
            Me.txtSearchByUserID.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox3 As System.Windows.Forms.TextBox = Me.txtSearchByUserID
            location = New System.Drawing.Point(22, 29)
            textBox3.Location = location
            Me.txtSearchByUserID.Name = "txtSearchByUserID"
            Dim textBox4 As System.Windows.Forms.TextBox = Me.txtSearchByUserID
            size = New System.Drawing.Size(149, 23)
            textBox4.Size = size
            Me.txtSearchByUserID.TabIndex = 0
            Me.GroupBox3.Controls.Add(Me.txtSearchByTableNo)
            Me.GroupBox3.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim groupBox3 As System.Windows.Forms.GroupBox = Me.GroupBox3
            location = New System.Drawing.Point(7, 132)
            groupBox3.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox4 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(161, 68)
            groupBox4.Size = size
            Me.GroupBox3.TabIndex = 5
            Me.GroupBox3.TabStop = False
            Me.GroupBox3.Text = "Search By Table No. :"
            Me.txtSearchByTableNo.BackColor = System.Drawing.Color.White
            Me.txtSearchByTableNo.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox5 As System.Windows.Forms.TextBox = Me.txtSearchByTableNo
            location = New System.Drawing.Point(22, 29)
            textBox5.Location = location
            Me.txtSearchByTableNo.Name = "txtSearchByTableNo"
            Dim textBox6 As System.Windows.Forms.TextBox = Me.txtSearchByTableNo
            size = New System.Drawing.Size(133, 23)
            textBox6.Size = size
            Me.txtSearchByTableNo.TabIndex = 0
            ...
            Me.GroupBox1.Controls.Add(Me.cmbTableNo)
            ...
            size = New System.Drawing.Size(362, 86)
            groupBox8.Size = size
            Me.GroupBox1.TabIndex = 0
            Me.GroupBox1.TabStop = False
            Me.cmbUserID.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
            Me.cmbUserID.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Me.cmbUserID.FormattingEnabled = True
            Dim comboBox As System.Windows.Forms.ComboBox = Me.cmbUserID
            location = New System.Drawing.Point(119, 25)
            ...
            Me.cmbTableNo.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Me.cmbTableNo.FormattingEnabled = True
            Dim comboBox3 As System.Windows.Forms.ComboBox = Me.cmbTableNo
            location = New System.Drawing.Point(119, 54)
            comboBox3.Location = location
            Me.cmbTableNo.Name = "cmbTableNo"
            Dim comboBox4 As System.Windows.Forms.ComboBox = Me.cmbTableNo
            ...
            Me.dgw.Columns.AddRange(Me.Column2, Me.Column1, Me.Column6)
            ...
            location = New System.Drawing.Point(7, 206)
            ...
            size = New System.Drawing.Size(359, 434)
            ...
            Me.Column6.HeaderText = "Table No."
            ...
            MyBase.Name = "frmTableMapping_Waiter"
