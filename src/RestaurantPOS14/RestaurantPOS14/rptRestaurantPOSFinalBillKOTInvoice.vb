...
Namespace RestaurantPOS14
    Public Class rptRestaurantPOSFinalBillKOTInvoice
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList
                If RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Count = RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList(num) = RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptRestaurantPOSFinalBillKOTInvoice.__ENCAddToList(Me)
            ...
            Catch reportInitializationException As System.Exception
                RestaurantPOS14.Diagnostics.ApplicationDiagnostics.ReportNonFatal("Initialize rptRestaurantPOSFinalBillKOTInvoice", reportInitializationException)
            End Try
        End Sub
