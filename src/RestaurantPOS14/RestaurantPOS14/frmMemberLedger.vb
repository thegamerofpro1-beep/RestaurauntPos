...
Namespace RestaurantPOS14
    ...
    Public Class frmMemberLedger
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmMemberLedger.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmMemberLedger.__ENCList
                If RestaurantPOS14.frmMemberLedger.__ENCList.Count = RestaurantPOS14.frmMemberLedger.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmMemberLedger.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmMemberLedger.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmMemberLedger.__ENCList(num) = RestaurantPOS14.frmMemberLedger.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmMemberLedger.__ENCList.RemoveRange(num, RestaurantPOS14.frmMemberLedger.__ENCList.Count - num)
                    RestaurantPOS14.frmMemberLedger.__ENCList.Capacity = RestaurantPOS14.frmMemberLedger.__ENCList.Count
                End If

                Call RestaurantPOS14.frmMemberLedger.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select MemberID from MemberLedger where MemberID=@d1 and Date >=@d2 and Date < @d3")
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select Date, LedgerNo, Label, Credit, Debit from MemberLedger where Date >=@d1 and Date < @d2 and MemberID=@d3 order by ID", RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.ModClasses.ds.WriteXmlSchema("MemberLedger.xml")
                Dim rptMemberLedger2 As RestaurantPOS14.rptMemberLedger = New RestaurantPOS14.rptMemberLedger()
                rptMemberLedger2.SetDataSource(RestaurantPOS14.ModClasses.ds)
                rptMemberLedger2.SetParameterValue("p1", Me.dtpDateFrom.Value.[Date])
                rptMemberLedger2.SetParameterValue("p2", Me.dtpDateTo.Value.[Date])
                rptMemberLedger2.SetParameterValue("p3", Me.txtMemberID.Text)
                rptMemberLedger2.SetParameterValue("p4", Me.txtMemberName.Text)
                RestaurantPOS14.My.MyProject.Forms.frmReport.CrystalReportViewer1.ReportSource = rptMemberLedger2
        ...
        Private Sub btnNavigation_Click(sender As Object, e As System.EventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmMemberList.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmMemberList.ShowDialog()
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select MemberID from MemberLedger where Date >=@d2 and Date < @d3")
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select Date, LedgerNo, Label, Credit, Debit,Name from MemberLedger,Member where MemberLedger.MemberID=Member.MemberID and Date >=@d1 and Date < @d2 order by ID", RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.ModClasses.ds = New System.Data.DataSet()
                RestaurantPOS14.ModClasses.ds.Tables.Add(RestaurantPOS14.ModClasses.dtable)
                RestaurantPOS14.ModClasses.ds.WriteXmlSchema("MemberLedger1.xml")
                Dim rptMemberLedger2 As RestaurantPOS14.rptMemberLedger1 = New RestaurantPOS14.rptMemberLedger1()
                rptMemberLedger2.SetDataSource(RestaurantPOS14.ModClasses.ds)
                rptMemberLedger2.SetParameterValue("p1", Me.DateTimePicker2.Value.[Date])
                rptMemberLedger2.SetParameterValue("p2", Me.DateTimePicker1.Value.[Date])
                RestaurantPOS14.My.MyProject.Forms.frmReport.CrystalReportViewer1.ReportSource = rptMemberLedger2
                Call RestaurantPOS14.My.MyProject.Forms.frmReport.ShowDialog()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
        ...
        Private Sub Button3_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Member.MemberID,Name,ContactNo,IsNull(sum(Credit)-sum(Debit),0) as Balance FROM Member Inner join MemberLedger on Member.MemberID=MemberLedger.MemberID group by Member.MemberID,name,ContactNo having (sum(Credit)-sum(Debit))> 0 order by Name", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.adp = New System.Data.SqlClient.SqlDataAdapter(RestaurantPOS14.ModClasses.cmd)
                RestaurantPOS14.ModClasses.dtable = New System.Data.DataTable()
                RestaurantPOS14.ModClasses.adp.Fill(RestaurantPOS14.ModClasses.dtable)
                ...
                RestaurantPOS14.ModClasses.ds = New System.Data.DataSet()
                RestaurantPOS14.ModClasses.ds.Tables.Add(RestaurantPOS14.ModClasses.dtable)
                RestaurantPOS14.ModClasses.ds.WriteXmlSchema("MemberBalance.xml")
                Dim rptMemberBalance2 As RestaurantPOS14.rptMemberBalance = New RestaurantPOS14.rptMemberBalance()
                rptMemberBalance2.SetDataSource(RestaurantPOS14.ModClasses.ds)
                RestaurantPOS14.My.MyProject.Forms.frmReport.CrystalReportViewer1.ReportSource = rptMemberBalance2
                Call RestaurantPOS14.My.MyProject.Forms.frmReport.ShowDialog()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmMemberLedger))
