...
Namespace RestaurantPOS14
    ...
    Public Class frmCustomDialog7
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmCustomDialog7.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCustomDialog7.__ENCList
                If RestaurantPOS14.frmCustomDialog7.__ENCList.Count = RestaurantPOS14.frmCustomDialog7.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCustomDialog7.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCustomDialog7.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCustomDialog7.__ENCList(num) = RestaurantPOS14.frmCustomDialog7.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCustomDialog7.__ENCList.RemoveRange(num, RestaurantPOS14.frmCustomDialog7.__ENCList.Count - num)
                    RestaurantPOS14.frmCustomDialog7.__ENCList.Capacity = RestaurantPOS14.frmCustomDialog7.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCustomDialog7.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(361, 80)
            label2.Size = size
            Me.Label2.TabIndex = 31
            Me.Label2.Text = "Please select Work Period " & Global.Microsoft.VisualBasic.Constants.vbCrLf & "Start Time."
