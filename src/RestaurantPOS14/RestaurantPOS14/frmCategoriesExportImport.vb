...
Namespace RestaurantPOS14
    ...
    Public Class frmCategoriesExportImport
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmCategoriesExportImport.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCategoriesExportImport.__ENCList
                If RestaurantPOS14.frmCategoriesExportImport.__ENCList.Count = RestaurantPOS14.frmCategoriesExportImport.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCategoriesExportImport.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCategoriesExportImport.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCategoriesExportImport.__ENCList(num) = RestaurantPOS14.frmCategoriesExportImport.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCategoriesExportImport.__ENCList.RemoveRange(num, RestaurantPOS14.frmCategoriesExportImport.__ENCList.Count - num)
                    RestaurantPOS14.frmCategoriesExportImport.__ENCList.Capacity = RestaurantPOS14.frmCategoriesExportImport.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCategoriesExportImport.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(CategoryName), RTRIM(Kitchen),VAT from Category order by Cat_ID", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(Me.DataGridView1.Rows, System.Collections.IEnumerable)
                    ...
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update Category set Kitchen=@d2,VAT=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow.Cells(CInt((2))).Value))) & " where CategoryName=@d1")
        ...
        Private Sub frmMenuItemsExportImport_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmMenuItemsCategory.Getdata()
        End Sub
                ...
                For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(Me.DataGridView1.Rows, System.Collections.IEnumerable)
                    If Not dataGridViewRow.IsNewRow Then
                        ...
                        If Not RestaurantPOS14.ModClasses.rdr.Read() Then
                            ...
                            RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                            RestaurantPOS14.ModClasses.con.Open()
                            RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Insert Into Category (CategoryName,Kitchen,VAT,ST,SC,BackColor) Values(@d1,@d2," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow.Cells(CInt((2))).Value))) & ",0,0,-2354116)")
                            RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", dataGridViewRow.Cells(CInt((0))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", dataGridViewRow.Cells(CInt((1))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.ExecuteReader()
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmCategoriesExportImport))
            ...
            location = New System.Drawing.Point(305, 42)
            ...
            location = New System.Drawing.Point(399, 41)
            ...
            MyBase.Name = "frmCategoriesExportImport"
