...
Namespace RestaurantPOS14
    ...
    Public Class frmSetDiscount
        Inherits System.Windows.Forms.Form

        Private Shared __ENCList As System.Collections.Generic.List(Of System.WeakReference) = New System.Collections.Generic.List(Of System.WeakReference)()

        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtDiscount")>
        Private _txtDiscount As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtDiscount As System.Windows.Forms.TextBox
            ...
            Set(value As System.Windows.Forms.TextBox)
                ...
                If Me._txtDiscount IsNot Nothing Then
                    RemoveHandler Me._txtDiscount.KeyPress, value2
                End If

                Me._txtDiscount = value
                If Me._txtDiscount IsNot Nothing Then
                    AddHandler Me._txtDiscount.KeyPress, value2
                End If
            End Set
        End Property
        ...
        Public Sub New()
            Call RestaurantPOS14.frmSetDiscount.__ENCAddToList(Me)
            Me.sign_Indicator = 0
            Me.fl = False
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmSetDiscount.__ENCList
                If RestaurantPOS14.frmSetDiscount.__ENCList.Count = RestaurantPOS14.frmSetDiscount.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmSetDiscount.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmSetDiscount.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmSetDiscount.__ENCList(num) = RestaurantPOS14.frmSetDiscount.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmSetDiscount.__ENCList.RemoveRange(num, RestaurantPOS14.frmSetDiscount.__ENCList.Count - num)
                    RestaurantPOS14.frmSetDiscount.__ENCList.Capacity = RestaurantPOS14.frmSetDiscount.__ENCList.Count
                End If

                Call RestaurantPOS14.frmSetDiscount.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Private Sub btnOkay_Click(sender As Object, e As System.EventArgs)
            Try
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.txtDiscount.Text, "", TextCompare:=False) = 0 Then
                    Call System.Windows.Forms.MessageBox.Show("Please enter the discount", "Info", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk)
                    Me.txtDiscount.Focus()
                    Return
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "DIB DiscPer", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtKOTDiscPer.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "DIB DiscAmt", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtKOTDiscountAmount.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Bill SplitDP", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmBillSplit.txtKOTDiscPer.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Bill SplitDA", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmBillSplit.txtKOTDiscountAmount.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "TA DiscPer", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtTADiscountPer.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "TA DiscAmt", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtTADiscountAmount.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "HD DiscPer", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtHDDiscountPer.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "HD DiscAmt", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtHDDiscountAmount.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "EB DiscPer", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBDiscountPer.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If

                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "EB DiscAmt", TextCompare:=False) = 0 Then
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.txtEBDiscountAmount.Text = Me.txtDiscount.Text
                    MyBase.Close()
                End If
        ...
        Private Sub btnTA1_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(1)
        ...
        Private Sub btnTA2_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(2)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(2)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA3_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(3)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(3)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA4_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(4)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(4)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA5_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(5)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(5)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA6_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(6)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(6)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA7_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(7)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(7)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA8_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(8)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(8)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA9_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(9)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(9)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnTA0_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString(0)
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString(0)
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub btnDOT_Click(sender As Object, e As System.EventArgs)
            ...
            While True
                ...
                If Me.txtDiscount.Text(num4) = "."c Then
                    num = 1
                End If
            ...
            If num <> 1 Then
                Me.txtDiscount.Text += System.Convert.ToString(".")
            End If
        End Sub

        Private Sub btn00_Click(sender As Object, e As System.EventArgs)
            If Me.sign_Indicator = 0 Then
                Me.txtDiscount.Text += System.Convert.ToString("00")
            ElseIf Me.sign_Indicator = 1 Then
                Me.txtDiscount.Text = System.Convert.ToString("00")
                Me.sign_Indicator = 0
            End If
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmSetDiscount))
            ...
            Me.txtDiscount.Font = New System.Drawing.Font("Segoe UI Black", 27.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Me.txtDiscount.ForeColor = System.Drawing.Color.Black
            Dim textBox As System.Windows.Forms.TextBox = Me.txtDiscount
            Dim location As System.Drawing.Point = New System.Drawing.Point(14, 52)
            textBox.Location = location
            Me.txtDiscount.Name = "txtDiscount"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtDiscount
            Dim size As System.Drawing.Size = New System.Drawing.Size(489, 57)
            textBox2.Size = size
            ...
            location = New System.Drawing.Point(145, 9)
            ...
            MyBase.Controls.Add(Me.txtDiscount)
