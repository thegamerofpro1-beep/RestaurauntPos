...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class SMSSettingTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.SMSSettingTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SMSSetting] ([APIURL], [IsDefault], [IsEnabled]) VALUES (@APIURL, @IsDefault, @IsEnabled);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, APIURL, IsDefault, IsEnabled FROM SMSSetting WHERE (Id = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@APIURL", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "APIURL", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[SMSSetting] SET [APIURL] = @APIURL, [IsDefault] = @IsDefault, [IsEnabled] = @IsEnabled WHERE (([Id] = @Original_Id) AND ([IsDefault] = @Original_IsDefault) AND ([IsEnabled] = @Original_IsEnabled));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, APIURL, IsDefault, IsEnabled FROM SMSSetting WHERE (Id = @Id)"
            Me._adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@APIURL", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "APIURL", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, APIURL, IsDefault, IsEnabled FROM dbo.SMSSetting"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.SMSSettingDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.SMSSettingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim smssettingDataTable As RestaurantPOS14.RPOS_DBDataSet1.SMSSettingDataTable = New RestaurantPOS14.RPOS_DBDataSet1.SMSSettingDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.SMSSettingDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_IsDefault As String, Original_IsEnabled As String) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = Original_IsDefault
        ...
        Public Overridable Function Insert(APIURL As String, IsDefault As String, IsEnabled As String) As Integer
            If Equals(APIURL, Nothing) Then
                Throw New System.ArgumentNullException("APIURL")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = APIURL
            If Equals(IsDefault, Nothing) Then
                Throw New System.ArgumentNullException("IsDefault")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = IsDefault
        ...
        Public Overridable Function Update(APIURL As String, IsDefault As String, IsEnabled As String, Original_Id As Integer, Original_IsDefault As String, Original_IsEnabled As String, Id As Integer) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = APIURL
            If Equals(IsDefault, Nothing) Then
                Throw New System.ArgumentNullException("IsDefault")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = IsDefault
            If Equals(IsEnabled, Nothing) Then
                Throw New System.ArgumentNullException("IsEnabled")
            End If
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_IsDefault
            If Equals(Original_IsEnabled, Nothing) Then
                Throw New System.ArgumentNullException("Original_IsEnabled")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Original_IsEnabled
            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Id
