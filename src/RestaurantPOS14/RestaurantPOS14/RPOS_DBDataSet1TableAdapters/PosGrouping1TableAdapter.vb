...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class PosGrouping1TableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosGrouping1TableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col3", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "Col3", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Col18", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col18", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PosGrouping1] ([Col1], [Col2], [Col3], [Col4], [Col5], [Col6], [Col7], [Col8], [Col9], [Col10], [Col11], [Col12], [Col13], [Col14], [Col15], [Col16], [Col17], [Col18]) VALUES (@Col1, @Col2, @Col3, @Col4, @Col5, @Col6, @Col7, @Col8, @Col9, @Col10, @Col11, @Col12, @Col13, @Col14, @Col15, @Col16, @Col17, @Col18);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT id, Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9, Col10, Col11, Col12, Col13, Col14, Col15, Col16, Col17, Col18 FROM PosGrouping1 WHERE (id = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col3", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "Col3", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col17", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col17", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col18", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PosGrouping1] SET [Col1] = @Col1, [Col2] = @Col2, [Col3] = @Col3, [Col4] = @Col4, [Col5] = @Col5, [Col6] = @Col6, [Col7] = @Col7, [Col8] = @Col8, [Col9] = @Col9, [Col10] = @Col10, [Col11] = @Col11, [Col12] = @Col12, [Col13] = @Col13, [Col14] = @Col14, [Col15] = @Col15, [Col16] = @Col16, [Col17] = @Col17, [Col18] = @Col18 WHERE (([id] = @Original_id) AND ((@IsNull_Col1 = 1 AND [Col1] IS NULL) OR ([Col1] = @Original_Col1)) AND ((@IsNull_Col2 = 1 AND [Col2] IS NULL) OR ([Col2] = @Original_Col2)) AND ((@IsNull_Col3 = 1 AND [Col3] IS NULL) OR ([Col3] = @Original_Col3)) AND ((@IsNull_Col4 = 1 AND [Col4] IS NULL) OR ([Col4] = @Original_Col4)) AND ((@IsNull_Col5 = 1 AND [Col5] IS NULL) OR ([Col5] = @Original_Col5)) AND ((@IsNull_Col6 = 1 AND [Col6] IS NULL) OR ([Col6] = @Original_Col6)) AND ((@IsNull_Col7 = 1 AND [Col7] IS NULL) OR ([Col7] = @Original_Col7)) AND ((@IsNull_Col8 = 1 AND [Col8] IS NULL) OR ([Col8] = @Original_Col8)) AND ((@IsNull_Col9 = 1 AND [Col9] IS NULL) OR ([Col9] = @Original_Col9)) AND ((@IsNull_Col10 = 1 AND [Col10] IS NULL) OR ([Col10] = @Original_Col10)) AND ((@IsNull_Col11 = 1 AND [Col11] IS NULL) OR ([Col11] = @Original_Col11)) AND ((@IsNull_Col12 = 1 AND [Col12] IS NULL) OR ([Col12] = @Original_Col12)) AND ((@IsNull_Col13 = 1 AND [Col13] IS NULL) OR ([Col13] = @Original_Col13)) AND ((@IsNull_Col15 = 1 AND [Col15] IS NULL) OR ([Col15] = @Original_Col15)) AND ((@IsNull_Col16 = 1 AND [Col16] IS NULL) OR ([Col16] = @Original_Col16)) AND ((@IsNull_Col18 = 1 AND [Col18] IS NULL) OR ([Col18] = @Original_Col18)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT id, Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9, Col10, Col11, Col12, Col13, Col14, Col15, Col16, Col17, Col18 FROM PosGrouping1 WHERE (id = @id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col3", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "Col3", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col17", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col17", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col18", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col3", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "Col3", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Col18", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col18", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Col18", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT id, Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9, Col10, Col11, Col12, Col13, Col14, Col15, Col16, Col17, Col18 FROM dbo.PosGrouping1"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PosGrouping1DataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.PosGrouping1DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim posGrouping1DataTable As RestaurantPOS14.RPOS_DBDataSet1.PosGrouping1DataTable = New RestaurantPOS14.RPOS_DBDataSet1.PosGrouping1DataTable()
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PosGrouping1DataTable) As Integer
        ...
        Public Overridable Function Delete(Original_id As Integer, Original_Col1 As String, Original_Col2 As Decimal?, Original_Col3 As Decimal?, Original_Col4 As Decimal?, Original_Col5 As Decimal?, Original_Col6 As Decimal?, Original_Col7 As Decimal?, Original_Col8 As Decimal?, Original_Col9 As Decimal?, Original_Col10 As Decimal?, Original_Col11 As Decimal?, Original_Col12 As Decimal?, Original_Col13 As Decimal?, Original_Col15 As Integer?, Original_Col16 As String, Original_Col18 As String) As Integer
            ...
            If Equals(Original_Col18, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = Original_Col18
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(Col1 As String, Col2 As Decimal?, Col3 As Decimal?, Col4 As Decimal?, Col5 As Decimal?, Col6 As Decimal?, Col7 As Decimal?, Col8 As Decimal?, Col9 As Decimal?, Col10 As Decimal?, Col11 As Decimal?, Col12 As Decimal?, Col13 As Decimal?, Col14 As String, Col15 As Integer?, Col16 As String, Col17 As String, Col18 As String) As Integer
            ...
            If Equals(Col17, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((16))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((16))).Value = Col17
            End If

            If Equals(Col18, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((17))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((17))).Value = Col18
            End If
        ...
        Public Overridable Function Update(Col1 As String, Col2 As Decimal?, Col3 As Decimal?, Col4 As Decimal?, Col5 As Decimal?, Col6 As Decimal?, Col7 As Decimal?, Col8 As Decimal?, Col9 As Decimal?, Col10 As Decimal?, Col11 As Decimal?, Col12 As Decimal?, Col13 As Decimal?, Col14 As String, Col15 As Integer?, Col16 As String, Col17 As String, Col18 As String, Original_id As Integer, Original_Col1 As String, Original_Col2 As Decimal?, Original_Col3 As Decimal?, Original_Col4 As Decimal?, Original_Col5 As Decimal?, Original_Col6 As Decimal?, Original_Col7 As Decimal?, Original_Col8 As Decimal?, Original_Col9 As Decimal?, Original_Col10 As Decimal?, Original_Col11 As Decimal?, Original_Col12 As Decimal?, Original_Col13 As Decimal?, Original_Col15 As Integer?, Original_Col16 As String, Original_Col18 As String, id As Integer) As Integer
            If Equals(Col1, Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Col17
            End If

            If Equals(Col18, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Col18
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = Original_Col1
            End If

            If Original_Col2.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = Original_Col2.Value
            Else
            ...
            If Original_Col3.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = Original_Col3.Value
            Else
            ...
            If Original_Col4.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = Original_Col4.Value
            Else
            ...
            If Original_Col5.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Original_Col5.Value
            Else
            ...
            If Original_Col6.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((30))).Value = Original_Col6.Value
            Else
            ...
            If Original_Col7.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((32))).Value = Original_Col7.Value
            Else
            ...
            If Original_Col8.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((34))).Value = Original_Col8.Value
            Else
            ...
            If Original_Col9.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((36))).Value = Original_Col9.Value
            Else
            ...
            If Original_Col10.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((38))).Value = Original_Col10.Value
            Else
            ...
            If Original_Col11.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((40))).Value = Original_Col11.Value
            Else
            ...
            If Original_Col12.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((42))).Value = Original_Col12.Value
            Else
            ...
            If Original_Col13.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((44))).Value = Original_Col13.Value
            Else
            ...
            If Original_Col15.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((46))).Value = Original_Col15.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((48))).Value = Original_Col16
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((50))).Value = Original_Col18
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((51))).Value = id
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(Col1 As String, Col2 As Decimal?, Col3 As Decimal?, Col4 As Decimal?, Col5 As Decimal?, Col6 As Decimal?, Col7 As Decimal?, Col8 As Decimal?, Col9 As Decimal?, Col10 As Decimal?, Col11 As Decimal?, Col12 As Decimal?, Col13 As Decimal?, Col14 As String, Col15 As Integer?, Col16 As String, Col17 As String, Col18 As String, Original_id As Integer, Original_Col1 As String, Original_Col2 As Decimal?, Original_Col3 As Decimal?, Original_Col4 As Decimal?, Original_Col5 As Decimal?, Original_Col6 As Decimal?, Original_Col7 As Decimal?, Original_Col8 As Decimal?, Original_Col9 As Decimal?, Original_Col10 As Decimal?, Original_Col11 As Decimal?, Original_Col12 As Decimal?, Original_Col13 As Decimal?, Original_Col15 As Integer?, Original_Col16 As String, Original_Col18 As String) As Integer
            Return Me.Update(Col1, Col2, Col3, Col4, Col5, Col6, Col7, Col8, Col9, Col10, Col11, Col12, Col13, Col14, Col15, Col16, Col17, Col18, Original_id, Original_Col1, Original_Col2, Original_Col3, Original_Col4, Original_Col5, Original_Col6, Original_Col7, Original_Col8, Original_Col9, Original_Col10, Original_Col11, Original_Col12, Original_Col13, Original_Col15, Original_Col16, Original_Col18, Original_id)
        End Function
    End Class
End Namespace
