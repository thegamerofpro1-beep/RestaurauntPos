...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class UnitMasterTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.UnitMasterTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[UnitMaster] ([Unit]) VALUES (@Unit);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Unit FROM UnitMaster WHERE (Unit = @Unit)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[UnitMaster] SET [Unit] = @Unit WHERE (([Unit] = @Original_Unit));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Unit FROM UnitMaster WHERE (Unit = @Unit)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Unit FROM dbo.UnitMaster"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.UnitMasterDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.UnitMasterDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim unitMasterDataTable As RestaurantPOS14.RPOS_DBDataSet1.UnitMasterDataTable = New RestaurantPOS14.RPOS_DBDataSet1.UnitMasterDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.UnitMasterDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Unit As String) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_Unit
        ...
        Public Overridable Function Insert(Unit As String) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = Unit
        ...
        Public Overridable Function Update(Unit As String, Original_Unit As String) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Unit
            If Equals(Original_Unit, Nothing) Then
                Throw New System.ArgumentNullException("Original_Unit")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Original_Unit
