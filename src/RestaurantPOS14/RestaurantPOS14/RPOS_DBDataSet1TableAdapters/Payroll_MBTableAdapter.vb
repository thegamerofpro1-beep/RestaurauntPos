...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class Payroll_MBTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Payroll_MBTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Payroll_MB"
            ...
            dataTableMapping.ColumnMappings.Add("Year", "Year")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Payroll_MB] WHERE (([ID] = @Original_ID) AND ((@IsNull_PaymentID = 1 AND [PaymentID] IS NULL) OR ([PaymentID] = @Original_PaymentID)) AND ((@IsNull_PaymentDate = 1 AND [PaymentDate] IS NULL) OR ([PaymentDate] = @Original_PaymentDate)) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_GrossSalary = 1 AND [GrossSalary] IS NULL) OR ([GrossSalary] = @Original_GrossSalary)) AND ((@IsNull_CPPPer = 1 AND [CPPPer] IS NULL) OR ([CPPPer] = @Original_CPPPer)) AND ((@IsNull_CPP = 1 AND [CPP] IS NULL) OR ([CPP] = @Original_CPP)) AND ((@IsNull_EIPer = 1 AND [EIPer] IS NULL) OR ([EIPer] = @Original_EIPer)) AND ((@IsNull_EI = 1 AND [EI] IS NULL) OR ([EI] = @Original_EI)) AND ((@IsNull_FedTaxPer = 1 AND [FedTaxPer] IS NULL) OR ([FedTaxPer] = @Original_FedTaxPer)) AND ((@IsNull_FedTax = 1 AND [FedTax] IS NULL) OR ([FedTax] = @Original_FedTax)) AND ((@IsNull_NetPay = 1 AND [NetPay] IS NULL) OR ([NetPay] = @Original_NetPay)) AND ((@IsNull_Month = 1 AND [Month] IS NULL) OR ([Month] = @Original_Month)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)) AND ((@IsNull_VPPer = 1 AND [VPPer] IS NULL) OR ([VPPer] = @Original_VPPer)) AND ((@IsNull_VP = 1 AND [VP] IS NULL) OR ([VP] = @Original_VP)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Month", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Month", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payroll_MB] ([ID], [PaymentID], [PaymentDate], [PaymentMode], [UserID], [GrossSalary], [CPPPer], [CPP], [EIPer], [EI], [FedTaxPer], [FedTax], [NetPay], [Month], [Year], [Remarks], [VPPer], [VP]) VALUES (@ID, @PaymentID, @PaymentDate, @PaymentMode, @UserID, @GrossSalary, @CPPPer, @CPP, @EIPer, @EI, @FedTaxPer, @FedTax, @NetPay, @Month, @Year, @Remarks, @VPPer, @VP);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, PaymentID, PaymentDate, PaymentMode, UserID, GrossSalary, CPPPer, CPP, EIPer, EI, FedTaxPer, FedTax, NetPay, Month, Year, Remarks, VPPer, VP FROM Payroll_MB WHERE (ID = @ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Month", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Payroll_MB] SET [ID] = @ID, [PaymentID] = @PaymentID, [PaymentDate] = @PaymentDate, [PaymentMode] = @PaymentMode, [UserID] = @UserID, [GrossSalary] = @GrossSalary, [CPPPer] = @CPPPer, [CPP] = @CPP, [EIPer] = @EIPer, [EI] = @EI, [FedTaxPer] = @FedTaxPer, [FedTax] = @FedTax, [NetPay] = @NetPay, [Month] = @Month, [Year] = @Year, [Remarks] = @Remarks, [VPPer] = @VPPer, [VP] = @VP WHERE (([ID] = @Original_ID) AND ((@IsNull_PaymentID = 1 AND [PaymentID] IS NULL) OR ([PaymentID] = @Original_PaymentID)) AND ((@IsNull_PaymentDate = 1 AND [PaymentDate] IS NULL) OR ([PaymentDate] = @Original_PaymentDate)) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_GrossSalary = 1 AND [GrossSalary] IS NULL) OR ([GrossSalary] = @Original_GrossSalary)) AND ((@IsNull_CPPPer = 1 AND [CPPPer] IS NULL) OR ([CPPPer] = @Original_CPPPer)) AND ((@IsNull_CPP = 1 AND [CPP] IS NULL) OR ([CPP] = @Original_CPP)) AND ((@IsNull_EIPer = 1 AND [EIPer] IS NULL) OR ([EIPer] = @Original_EIPer)) AND ((@IsNull_EI = 1 AND [EI] IS NULL) OR ([EI] = @Original_EI)) AND ((@IsNull_FedTaxPer = 1 AND [FedTaxPer] IS NULL) OR ([FedTaxPer] = @Original_FedTaxPer)) AND ((@IsNull_FedTax = 1 AND [FedTax] IS NULL) OR ([FedTax] = @Original_FedTax)) AND ((@IsNull_NetPay = 1 AND [NetPay] IS NULL) OR ([NetPay] = @Original_NetPay)) AND ((@IsNull_Month = 1 AND [Month] IS NULL) OR ([Month] = @Original_Month)) AND ((@IsNull_Year = 1 AND [Year] IS NULL) OR ([Year] = @Original_Year)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)) AND ((@IsNull_VPPer = 1 AND [VPPer] IS NULL) OR ([VPPer] = @Original_VPPer)) AND ((@IsNull_VP = 1 AND [VP] IS NULL) OR ([VP] = @Original_VP)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, PaymentID, PaymentDate, PaymentMode, UserID, GrossSalary, CPPPer, CPP, EIPer, EI, FedTaxPer, FedTax, NetPay, Month, Year, Remarks, VPPer, VP FROM Payroll_MB WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Month", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Month", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Month", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Month", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Year", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Year", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ID, PaymentID, PaymentDate, PaymentMode, UserID, GrossSalary, CPPPer, CPP, EIPer, EI, FedTaxPer, FedTax, NetPay, Month, Year, Remarks, VPPer, VP FROM dbo.Payroll_MB"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Payroll_MBDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.Payroll_MBDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim payroll_MBDataTable As RestaurantPOS14.RPOS_DBDataSet1.Payroll_MBDataTable = New RestaurantPOS14.RPOS_DBDataSet1.Payroll_MBDataTable()
            Me.Adapter.Fill(payroll_MBDataTable)
            Return payroll_MBDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Payroll_MBDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "Payroll_MB")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_ID As Integer, Original_PaymentID As String, Original_PaymentDate As System.DateTime?, Original_PaymentMode As String, Original_UserID As String, Original_GrossSalary As Decimal?, Original_CPPPer As Decimal?, Original_CPP As Decimal?, Original_EIPer As Decimal?, Original_EI As Decimal?, Original_FedTaxPer As Decimal?, Original_FedTax As Decimal?, Original_NetPay As Decimal?, Original_Month As String, Original_Year As Integer?, Original_Remarks As String, Original_VPPer As Decimal?, Original_VP As Decimal?) As Integer
            ...
            If Original_GrossSalary.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value = Original_GrossSalary.Value
            Else
            ...
            If Original_CPPPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_CPPPer.Value
            Else
            ...
            If Original_CPP.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((14))).Value = Original_CPP.Value
            Else
            ...
            If Original_EIPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((16))).Value = Original_EIPer.Value
            Else
            ...
            If Original_EI.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((18))).Value = Original_EI.Value
            Else
            ...
            If Original_FedTaxPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((20))).Value = Original_FedTaxPer.Value
            Else
            ...
            If Original_FedTax.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((22))).Value = Original_FedTax.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((26))).Value = Original_Month
            End If

            If Original_Year.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((27))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((28))).Value = Original_Year.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(ID As Integer, PaymentID As String, PaymentDate As System.DateTime?, PaymentMode As String, UserID As String, GrossSalary As Decimal?, CPPPer As Decimal?, CPP As Decimal?, EIPer As Decimal?, EI As Decimal?, FedTaxPer As Decimal?, FedTax As Decimal?, NetPay As Decimal?, Month As String, Year As Integer?, Remarks As String, VPPer As Decimal?, VP As Decimal?) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ID As Integer, PaymentID As String, PaymentDate As System.DateTime?, PaymentMode As String, UserID As String, GrossSalary As Decimal?, CPPPer As Decimal?, CPP As Decimal?, EIPer As Decimal?, EI As Decimal?, FedTaxPer As Decimal?, FedTax As Decimal?, NetPay As Decimal?, Month As String, Year As Integer?, Remarks As String, VPPer As Decimal?, VP As Decimal?, Original_ID As Integer, Original_PaymentID As String, Original_PaymentDate As System.DateTime?, Original_PaymentMode As String, Original_UserID As String, Original_GrossSalary As Decimal?, Original_CPPPer As Decimal?, Original_CPP As Decimal?, Original_EIPer As Decimal?, Original_EI As Decimal?, Original_FedTaxPer As Decimal?, Original_FedTax As Decimal?, Original_NetPay As Decimal?, Original_Month As String, Original_Year As Integer?, Original_Remarks As String, Original_VPPer As Decimal?, Original_VP As Decimal?) As Integer
            ...
            If GrossSalary.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = GrossSalary.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = System.DBNull.Value
            End If

            If CPPPer.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = CPPPer.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = System.DBNull.Value
            End If

            If CPP.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = CPP.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = System.DBNull.Value
            End If

            If EIPer.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = EIPer.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = System.DBNull.Value
            End If

            If EI.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = EI.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = System.DBNull.Value
            End If

            If FedTaxPer.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = FedTaxPer.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = System.DBNull.Value
            End If

            If FedTax.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = FedTax.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = System.DBNull.Value
            End If

            If NetPay.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = NetPay.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Month
            End If

            If Year.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Year.Value
            Else
            ...
            If Original_GrossSalary.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Original_GrossSalary.Value
            Else
            ...
            If Original_CPPPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((30))).Value = Original_CPPPer.Value
            Else
            ...
            If Original_CPP.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((32))).Value = Original_CPP.Value
            Else
            ...
            If Original_EIPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((34))).Value = Original_EIPer.Value
            Else
            ...
            If Original_EI.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((36))).Value = Original_EI.Value
            Else
            ...
            If Original_FedTaxPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((38))).Value = Original_FedTaxPer.Value
            Else
            ...
            If Original_FedTax.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((40))).Value = Original_FedTax.Value
            Else
            ...
            If Original_NetPay.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((42))).Value = Original_NetPay.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((44))).Value = Original_Month
            End If

            If Original_Year.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((45))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((46))).Value = Original_Year.Value
            Else
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(PaymentID As String, PaymentDate As System.DateTime?, PaymentMode As String, UserID As String, GrossSalary As Decimal?, CPPPer As Decimal?, CPP As Decimal?, EIPer As Decimal?, EI As Decimal?, FedTaxPer As Decimal?, FedTax As Decimal?, NetPay As Decimal?, Month As String, Year As Integer?, Remarks As String, VPPer As Decimal?, VP As Decimal?, Original_ID As Integer, Original_PaymentID As String, Original_PaymentDate As System.DateTime?, Original_PaymentMode As String, Original_UserID As String, Original_GrossSalary As Decimal?, Original_CPPPer As Decimal?, Original_CPP As Decimal?, Original_EIPer As Decimal?, Original_EI As Decimal?, Original_FedTaxPer As Decimal?, Original_FedTax As Decimal?, Original_NetPay As Decimal?, Original_Month As String, Original_Year As Integer?, Original_Remarks As String, Original_VPPer As Decimal?, Original_VP As Decimal?) As Integer
            Return Me.Update(Original_ID, PaymentID, PaymentDate, PaymentMode, UserID, GrossSalary, CPPPer, CPP, EIPer, EI, FedTaxPer, FedTax, NetPay, Month, Year, Remarks, VPPer, VP, Original_ID, Original_PaymentID, Original_PaymentDate, Original_PaymentMode, Original_UserID, Original_GrossSalary, Original_CPPPer, Original_CPP, Original_EIPer, Original_EI, Original_FedTaxPer, Original_FedTax, Original_NetPay, Original_Month, Original_Year, Original_Remarks, Original_VPPer, Original_VP)
        End Function
    End Class
End Namespace
