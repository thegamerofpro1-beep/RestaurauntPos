...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class LedgerBookTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LedgerBookTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.ColumnMappings.Add("AccLedger", "AccLedger")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LedgerBook] WHERE (([Id] = @Original_Id) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_LedgerNo = 1 AND [LedgerNo] IS NULL) OR ([LedgerNo] = @Original_LedgerNo)) AND ((@IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsNull_AccLedger = 1 AND [AccLedger] IS NULL) OR ([AccLedger] = @Original_AccLedger)) AND ((@IsNull_Debit = 1 AND [Debit] IS NULL) OR ([Debit] = @Original_Debit)) AND ((@IsNull_Credit = 1 AND [Credit] IS NULL) OR ([Credit] = @Original_Credit)) AND ((@IsNull_PartyID = 1 AND [PartyID] IS NULL) OR ([PartyID] = @Original_PartyID)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AccLedger", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AccLedger", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LedgerBook] ([Date], [Name], [LedgerNo], [Label], [AccLedger], [Debit], [Credit], [PartyID]) VALUES (@Date, @Name, @LedgerNo, @Label, @AccLedger, @Debit, @Credit, @PartyID);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Date, Name, LedgerNo, Label, AccLedger, Debit, Credit, PartyID FROM LedgerBook WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AccLedger", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LedgerBook] SET [Date] = @Date, [Name] = @Name, [LedgerNo] = @LedgerNo, [Label] = @Label, [AccLedger] = @AccLedger, [Debit] = @Debit, [Credit] = @Credit, [PartyID] = @PartyID WHERE (([Id] = @Original_Id) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_LedgerNo = 1 AND [LedgerNo] IS NULL) OR ([LedgerNo] = @Original_LedgerNo)) AND ((@IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsNull_AccLedger = 1 AND [AccLedger] IS NULL) OR ([AccLedger] = @Original_AccLedger)) AND ((@IsNull_Debit = 1 AND [Debit] IS NULL) OR ([Debit] = @Original_Debit)) AND ((@IsNull_Credit = 1 AND [Credit] IS NULL) OR ([Credit] = @Original_Credit)) AND ((@IsNull_PartyID = 1 AND [PartyID] IS NULL) OR ([PartyID] = @Original_PartyID)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Date, Name, LedgerNo, Label, AccLedger, Debit, Credit, PartyID FROM LedgerBook WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AccLedger", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AccLedger", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AccLedger", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AccLedger", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, Date, Name, LedgerNo, Label, AccLedger, Debit, Credit, PartyID FROM dbo.LedgerBook"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.LedgerBookDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.LedgerBookDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim ledgerBookDataTable As RestaurantPOS14.RPOS_DBDataSet1.LedgerBookDataTable = New RestaurantPOS14.RPOS_DBDataSet1.LedgerBookDataTable()
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.LedgerBookDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_Id As Integer, Original_Date As System.DateTime?, Original_Name As String, Original_LedgerNo As String, Original_Label As String, Original_AccLedger As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_PartyID As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_Name
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_LedgerNo
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_Label
            End If

            If Equals(Original_AccLedger, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value = Original_AccLedger
            End If

            If Original_Debit.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((11))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_Debit.Value
            Else
            ...
            If Original_Credit.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((14))).Value = Original_Credit.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((16))).Value = Original_PartyID
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(_Date As System.DateTime?, Name As String, LedgerNo As String, Label As String, AccLedger As String, Debit As Decimal?, Credit As Decimal?, PartyID As String) As Integer
            ...
            If Equals(AccLedger, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = AccLedger
            End If

            If Debit.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = Debit.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = System.DBNull.Value
            End If

            If Credit.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = Credit.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((7))).Value = PartyID
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(_Date As System.DateTime?, Name As String, LedgerNo As String, Label As String, AccLedger As String, Debit As Decimal?, Credit As Decimal?, PartyID As String, Original_Id As Integer, Original_Date As System.DateTime?, Original_Name As String, Original_LedgerNo As String, Original_Label As String, Original_AccLedger As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_PartyID As String, Id As Integer) As Integer
            If _Date.HasValue Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = AccLedger
            End If

            If Debit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Debit.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = System.DBNull.Value
            End If

            If Credit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Credit.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = PartyID
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_Id
            If Original_Date.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_Date.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_LedgerNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Original_Label
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = Original_AccLedger
            End If

            If Original_Debit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = Original_Debit.Value
            Else
            ...
            If Original_Credit.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = Original_Credit.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = Original_PartyID
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(_Date As System.DateTime?, Name As String, LedgerNo As String, Label As String, AccLedger As String, Debit As Decimal?, Credit As Decimal?, PartyID As String, Original_Id As Integer, Original_Date As System.DateTime?, Original_Name As String, Original_LedgerNo As String, Original_Label As String, Original_AccLedger As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_PartyID As String) As Integer
            Return Me.Update(_Date, Name, LedgerNo, Label, AccLedger, Debit, Credit, PartyID, Original_Id, Original_Date, Original_Name, Original_LedgerNo, Original_Label, Original_AccLedger, Original_Debit, Original_Credit, Original_PartyID, Original_Id)
        End Function
    End Class
End Namespace
