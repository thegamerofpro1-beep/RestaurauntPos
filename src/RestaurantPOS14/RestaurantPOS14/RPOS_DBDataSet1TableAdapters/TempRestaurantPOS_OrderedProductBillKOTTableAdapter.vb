...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class TempRestaurantPOS_OrderedProductBillKOTTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TempRestaurantPOS_OrderedProductBillKOTTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "TempRestaurantPOS_OrderedProductBillKOT"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TempRestaurantPOS_OrderedProductBillKOT] ([BillID], [Dish], [Rate], [Quantity], [Amount], [VATPer], [VATAmount], [STPer], [STAmount], [SCPer], [SCAmount], [DiscountPer], [DiscountAmount], [TotalAmount], [TableNo], [Category], [RCost], [DishNameArabic]) VALUES (@BillID, @Dish, @Rate, @Quantity, @Amount, @VATPer, @VATAmount, @STPer, @STAmount, @SCPer, @SCAmount, @DiscountPer, @DiscountAmount, @TotalAmount, @TableNo, @Category, @RCost, @DishNameArabic);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, TableNo, Category, RCost, DishNameArabic FROM TempRestaurantPOS_OrderedProductBillKOT WHERE (OP_ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TempRestaurantPOS_OrderedProductBillKOT] SET [BillID] = @BillID, [Dish] = @Dish, [Rate] = @Rate, [Quantity] = @Quantity, [Amount] = @Amount, [VATPer] = @VATPer, [VATAmount] = @VATAmount, [STPer] = @STPer, [STAmount] = @STAmount, [SCPer] = @SCPer, [SCAmount] = @SCAmount, [DiscountPer] = @DiscountPer, [DiscountAmount] = @DiscountAmount, [TotalAmount] = @TotalAmount, [TableNo] = @TableNo, [Category] = @Category, [RCost] = @RCost, [DishNameArabic] = @DishNameArabic WHERE (([OP_ID] = @Original_OP_ID) AND ((@IsNull_BillID = 1 AND [BillID] IS NULL) OR ([BillID] = @Original_BillID)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_VATPer = 1 AND [VATPer] IS NULL) OR ([VATPer] = @Original_VATPer)) AND ((@IsNull_VATAmount = 1 AND [VATAmount] IS NULL) OR ([VATAmount] = @Original_VATAmount)) AND ((@IsNull_STPer = 1 AND [STPer] IS NULL) OR ([STPer] = @Original_STPer)) AND ((@IsNull_STAmount = 1 AND [STAmount] IS NULL) OR ([STAmount] = @Original_STAmount)) AND ((@IsNull_SCPer = 1 AND [SCPer] IS NULL) OR ([SCPer] = @Original_SCPer)) AND ((@IsNull_SCAmount = 1 AND [SCAmount] IS NULL) OR ([SCAmount] = @Original_SCAmount)) AND ((@IsNull_DiscountPer = 1 AND [DiscountPer] IS NULL) OR ([DiscountPer] = @Original_DiscountPer)) AND ((@IsNull_DiscountAmount = 1 AND [DiscountAmount] IS NULL) OR ([DiscountAmount] = @Original_DiscountAmount)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)) AND ((@IsNull_TableNo = 1 AND [TableNo] IS NULL) OR ([TableNo] = @Original_TableNo)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_RCost = 1 AND [RCost] IS NULL) OR ([RCost] = @Original_RCost)) AND ((@IsNull_DishNameArabic = 1 AND [DishNameArabic] IS NULL) OR ([DishNameArabic] = @Original_DishNameArabic)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, TableNo, Category, RCost, DishNameArabic FROM TempRestaurantPOS_OrderedProductBillKOT WHERE (OP_ID = @OP_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, TableNo, Category, RCost, DishNameArabic FROM dbo.TempRestaurantPOS_OrderedProductBillKOT"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TempRestaurantPOS_OrderedProductBillKOTDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.TempRestaurantPOS_OrderedProductBillKOTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim tempRestaurantPOS_OrderedProductBillKOTDataTable As RestaurantPOS14.RPOS_DBDataSet1.TempRestaurantPOS_OrderedProductBillKOTDataTable = New RestaurantPOS14.RPOS_DBDataSet1.TempRestaurantPOS_OrderedProductBillKOTDataTable()
            Me.Adapter.Fill(tempRestaurantPOS_OrderedProductBillKOTDataTable)
            Return tempRestaurantPOS_OrderedProductBillKOTDataTable
        End Function

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TempRestaurantPOS_OrderedProductBillKOTDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "TempRestaurantPOS_OrderedProductBillKOT")
        End Function
        ...
        Public Overridable Function Delete(Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_TableNo As String, Original_Category As String, Original_RCost As Decimal?, Original_DishNameArabic As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((28))).Value = Original_TableNo
            End If
            ...
            If Original_RCost.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = Original_RCost.Value
            Else
        ...
        Public Overridable Function Insert(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, TableNo As String, Category As String, RCost As Decimal?, DishNameArabic As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((14))).Value = TableNo
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, TableNo As String, Category As String, RCost As Decimal?, DishNameArabic As String, Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_TableNo As String, Original_Category As String, Original_RCost As Decimal?, Original_DishNameArabic As String, OP_ID As Integer) As Integer
            If BillID.HasValue Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = TableNo
            End If
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = Original_OP_ID
            If Original_BillID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = Original_BillID.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((46))).Value = Original_TableNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((48))).Value = Original_Category
            End If

            If Original_RCost.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((49))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((50))).Value = Original_RCost.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((52))).Value = Original_DishNameArabic
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((53))).Value = OP_ID
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, TableNo As String, Category As String, RCost As Decimal?, DishNameArabic As String, Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_TableNo As String, Original_Category As String, Original_RCost As Decimal?, Original_DishNameArabic As String) As Integer
            Return Me.Update(BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, TableNo, Category, RCost, DishNameArabic, Original_OP_ID, Original_BillID, Original_Rate, Original_Quantity, Original_Amount, Original_VATPer, Original_VATAmount, Original_STPer, Original_STAmount, Original_SCPer, Original_SCAmount, Original_DiscountPer, Original_DiscountAmount, Original_TotalAmount, Original_TableNo, Original_Category, Original_RCost, Original_DishNameArabic, Original_OP_ID)
        End Function
    End Class
End Namespace
