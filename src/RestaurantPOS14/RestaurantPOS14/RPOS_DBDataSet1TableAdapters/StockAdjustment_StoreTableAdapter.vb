...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class StockAdjustment_StoreTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_StoreTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "StockAdjustment_Store"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[StockAdjustment_Store] ([SA_ID], [Date], [ProductID], [AdjustmentType], [Qty], [Reason]) VALUES (@SA_ID, @Date, @ProductID, @AdjustmentType, @Qty, @Reason);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT SA_ID, Date, ProductID, AdjustmentType, Qty, Reason FROM StockAdjustment_Store WHERE (SA_ID = @SA_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[StockAdjustment_Store] SET [SA_ID] = @SA_ID, [Date] = @Date, [ProductID] = @ProductID, [AdjustmentType] = @AdjustmentType, [Qty] = @Qty, [Reason] = @Reason WHERE (([SA_ID] = @Original_SA_ID) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_ProductID = 1 AND [ProductID] IS NULL) OR ([ProductID] = @Original_ProductID)) AND ((@IsNull_AdjustmentType = 1 AND [AdjustmentType] IS NULL) OR ([AdjustmentType] = @Original_AdjustmentType)) AND ((@IsNull_Qty = 1 AND [Qty] IS NULL) OR ([Qty] = @Original_Qty)) AND ((@IsNull_Reason = 1 AND [Reason] IS NULL) OR ([Reason] = @Original_Reason)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT SA_ID, Date, ProductID, AdjustmentType, Qty, Reason FROM StockAdjustment_Store WHERE (SA_ID = @SA_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT SA_ID, Date, ProductID, AdjustmentType, Qty, Reason FROM dbo.StockAdjustment_Store"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_StoreDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_StoreDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim stockAdjustment_StoreDataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_StoreDataTable = New RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_StoreDataTable()
            Me.Adapter.Fill(stockAdjustment_StoreDataTable)
            Return stockAdjustment_StoreDataTable
        End Function

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_StoreDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "StockAdjustment_Store")
        End Function
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_ProductID As Integer?, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_AdjustmentType
            End If

            If Original_Qty.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((7))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_Qty.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value = Original_Reason
            End If
        ...
        Public Overridable Function Insert(SA_ID As Integer, _Date As System.DateTime?, ProductID As Integer?, AdjustmentType As String, Qty As Decimal?, Reason As String) As Integer
            ...
            If ProductID.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = ProductID.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = AdjustmentType
            End If

            If Qty.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = Qty.Value
            Else
        ...
        Public Overridable Function Update(SA_ID As Integer, _Date As System.DateTime?, ProductID As Integer?, AdjustmentType As String, Qty As Decimal?, Reason As String, Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_ProductID As Integer?, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
            ...
            If ProductID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = ProductID.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = AdjustmentType
            End If

            If Qty.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Qty.Value
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_SA_ID
            If Original_Date.HasValue Then
            ...
            If Original_ProductID.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_ProductID.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_AdjustmentType
            End If

            If Original_Qty.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Qty.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Original_Reason
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(_Date As System.DateTime?, ProductID As Integer?, AdjustmentType As String, Qty As Decimal?, Reason As String, Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_ProductID As Integer?, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
            Return Me.Update(Original_SA_ID, _Date, ProductID, AdjustmentType, Qty, Reason, Original_SA_ID, Original_Date, Original_ProductID, Original_AdjustmentType, Original_Qty, Original_Reason)
        End Function
    End Class
End Namespace
