...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class BankAccountLedgerTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankAccountLedgerTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BankAccountLedger] ([Date], [AccNo], [LedgerNo], [Label], [Debit], [Credit]) VALUES (@Date, @AccNo, @LedgerNo, @Label, @Debit, @Credit);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Date, AccNo, LedgerNo, Label, Debit, Credit FROM BankAccountLedger WHERE (Id = SCOPE_IDENTITY())"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, Date, AccNo, LedgerNo, Label, Debit, Credit FROM dbo.BankAccountLedger"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.BankAccountLedgerDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.BankAccountLedgerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim bankAccountLedgerDataTable As RestaurantPOS14.RPOS_DBDataSet1.BankAccountLedgerDataTable = New RestaurantPOS14.RPOS_DBDataSet1.BankAccountLedgerDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.BankAccountLedgerDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_Date As System.DateTime?, Original_AccNo As String, Original_LedgerNo As String, Original_Label As String, Original_Debit As Decimal?, Original_Credit As Decimal?) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_AccNo
            End If
            ...
            If Original_Debit.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value = Original_Debit.Value
            Else
            ...
            If Original_Credit.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_Credit.Value
            Else
        ...
        Public Overridable Function Insert(_Date As System.DateTime?, AccNo As String, LedgerNo As String, Label As String, Debit As Decimal?, Credit As Decimal?) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = AccNo
            End If
            ...
            If Debit.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = Debit.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = System.DBNull.Value
            End If

            If Credit.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = Credit.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(_Date As System.DateTime?, AccNo As String, LedgerNo As String, Label As String, Debit As Decimal?, Credit As Decimal?, Original_Id As Integer, Original_Date As System.DateTime?, Original_AccNo As String, Original_LedgerNo As String, Original_Label As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Id As Integer) As Integer
            If _Date.HasValue Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = AccNo
            End If
            ...
            If Debit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Debit.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = System.DBNull.Value
            End If

            If Credit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Credit.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_AccNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_LedgerNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Label
            End If

            If Original_Debit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Original_Debit.Value
            Else
            ...
            If Original_Credit.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = Original_Credit.Value
            Else
