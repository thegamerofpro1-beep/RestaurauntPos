...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class ClockINTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.ClockINTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "ClockIN"
            dataTableMapping.ColumnMappings.Add("ID", "ID")
            dataTableMapping.ColumnMappings.Add("UserID", "UserID")
            dataTableMapping.ColumnMappings.Add("ClockINDate", "ClockINDate")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ClockIN] WHERE (([ID] = @Original_ID) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_ClockINDate = 1 AND [ClockINDate] IS NULL) OR ([ClockINDate] = @Original_ClockINDate)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ClockINDate", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ClockINDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ClockIN] ([UserID], [ClockINDate]) VALUES (@UserID, @ClockINDate);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, UserID, ClockINDate FROM ClockIN WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ClockINDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[ClockIN] SET [UserID] = @UserID, [ClockINDate] = @ClockINDate WHERE (([ID] = @Original_ID) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_ClockINDate = 1 AND [ClockINDate] IS NULL) OR ([ClockINDate] = @Original_ClockINDate)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, UserID, ClockINDate FROM ClockIN WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ClockINDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ClockINDate", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ClockINDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "ClockINDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ID, UserID, ClockINDate FROM dbo.ClockIN"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.ClockINDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.ClockINDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim clockINDataTable As RestaurantPOS14.RPOS_DBDataSet1.ClockINDataTable = New RestaurantPOS14.RPOS_DBDataSet1.ClockINDataTable()
            Me.Adapter.Fill(clockINDataTable)
            Return clockINDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.ClockINDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "ClockIN")
        End Function
        ...
        Public Overridable Function Delete(Original_ID As Integer, Original_UserID As String, Original_ClockINDate As System.DateTime?) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_UserID
            End If

            If Original_ClockINDate.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((3))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_ClockINDate.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(UserID As String, ClockINDate As System.DateTime?) As Integer
            ...
            If ClockINDate.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = ClockINDate.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(UserID As String, ClockINDate As System.DateTime?, Original_ID As Integer, Original_UserID As String, Original_ClockINDate As System.DateTime?, ID As Integer) As Integer
            If Equals(UserID, Nothing) Then
            ...
            If ClockINDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = ClockINDate.Value
            Else
            ...
            If Original_ClockINDate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_ClockINDate.Value
            Else
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(UserID As String, ClockINDate As System.DateTime?, Original_ID As Integer, Original_UserID As String, Original_ClockINDate As System.DateTime?) As Integer
            Return Me.Update(UserID, ClockINDate, Original_ID, Original_UserID, Original_ClockINDate, Original_ID)
        End Function
    End Class
End Namespace
