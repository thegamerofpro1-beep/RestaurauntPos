...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class BankTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.BankTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Bank] ([BankName]) VALUES (@BankName);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT BankName FROM Bank WHERE (BankName = @BankName)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Bank] SET [BankName] = @BankName WHERE (([BankName] = @Original_BankName));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT BankName FROM Bank WHERE (BankName = @BankName)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT BankName FROM dbo.Bank"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.BankDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.BankDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim bankDataTable As RestaurantPOS14.RPOS_DBDataSet1.BankDataTable = New RestaurantPOS14.RPOS_DBDataSet1.BankDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.BankDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_BankName As String) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_BankName
        ...
        Public Overridable Function Insert(BankName As String) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = BankName
        ...
        Public Overridable Function Update(BankName As String, Original_BankName As String) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = BankName
            If Equals(Original_BankName, Nothing) Then
                Throw New System.ArgumentNullException("Original_BankName")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Original_BankName
