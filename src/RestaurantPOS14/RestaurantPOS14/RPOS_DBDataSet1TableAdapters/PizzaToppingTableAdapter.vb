...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class PizzaToppingTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaToppingTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.ColumnMappings.Add("ToppingSize", "ToppingSize")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PizzaTopping] WHERE (([T_ID] = @Original_T_ID) AND ((@IsNull_ToppingName = 1 AND [ToppingName] IS NULL) OR ([ToppingName] = @Original_ToppingName)) AND ((@IsNull_ToppingSize = 1 AND [ToppingSize] IS NULL) OR ([ToppingSize] = @Original_ToppingSize)) AND ((@IsNull_PizzaSize = 1 AND [PizzaSize] IS NULL) OR ([PizzaSize] = @Original_PizzaSize)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_BackColor = 1 AND [BackColor] IS NULL) OR ([BackColor] = @Original_BackColor)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ToppingSize", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ToppingSize", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PizzaTopping] ([T_ID], [ToppingName], [ToppingSize], [PizzaSize], [Rate], [BackColor]) VALUES (@T_ID, @ToppingName, @ToppingSize, @PizzaSize, @Rate, @BackColor);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, ToppingName, ToppingSize, PizzaSize, Rate, BackColor FROM PizzaTopping WHERE (T_ID = @T_ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ToppingSize", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PizzaTopping] SET [T_ID] = @T_ID, [ToppingName] = @ToppingName, [ToppingSize] = @ToppingSize, [PizzaSize] = @PizzaSize, [Rate] = @Rate, [BackColor] = @BackColor WHERE (([T_ID] = @Original_T_ID) AND ((@IsNull_ToppingName = 1 AND [ToppingName] IS NULL) OR ([ToppingName] = @Original_ToppingName)) AND ((@IsNull_ToppingSize = 1 AND [ToppingSize] IS NULL) OR ([ToppingSize] = @Original_ToppingSize)) AND ((@IsNull_PizzaSize = 1 AND [PizzaSize] IS NULL) OR ([PizzaSize] = @Original_PizzaSize)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_BackColor = 1 AND [BackColor] IS NULL) OR ([BackColor] = @Original_BackColor)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, ToppingName, ToppingSize, PizzaSize, Rate, BackColor FROM PizzaTopping WHERE (T_ID = @T_ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ToppingSize", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ToppingSize", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ToppingSize", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ToppingSize", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT T_ID, ToppingName, ToppingSize, PizzaSize, Rate, BackColor FROM dbo.PizzaTopping"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaToppingDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.PizzaToppingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim pizzaToppingDataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaToppingDataTable = New RestaurantPOS14.RPOS_DBDataSet1.PizzaToppingDataTable()
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaToppingDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_T_ID As Integer, Original_ToppingName As String, Original_ToppingSize As String, Original_PizzaSize As String, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            ...
            If Equals(Original_ToppingSize, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_ToppingSize
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_PizzaSize
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(T_ID As Integer, ToppingName As String, ToppingSize As String, PizzaSize As String, Rate As Decimal?, BackColor As Integer?) As Integer
            ...
            If Equals(ToppingSize, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = ToppingSize
            End If

            If Equals(PizzaSize, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = PizzaSize
            End If

            If Rate.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = Rate.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(T_ID As Integer, ToppingName As String, ToppingSize As String, PizzaSize As String, Rate As Decimal?, BackColor As Integer?, Original_T_ID As Integer, Original_ToppingName As String, Original_ToppingSize As String, Original_PizzaSize As String, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = ToppingSize
            End If

            If Equals(PizzaSize, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = PizzaSize
            End If

            If Rate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Rate.Value
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_T_ID
            If Equals(Original_ToppingName, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_ToppingName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_ToppingSize
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_PizzaSize
            End If

            If Original_Rate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Rate.Value
            Else
            ...
            If Original_BackColor.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = Original_BackColor.Value
            Else
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(ToppingName As String, ToppingSize As String, PizzaSize As String, Rate As Decimal?, BackColor As Integer?, Original_T_ID As Integer, Original_ToppingName As String, Original_ToppingSize As String, Original_PizzaSize As String, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            Return Me.Update(Original_T_ID, ToppingName, ToppingSize, PizzaSize, Rate, BackColor, Original_T_ID, Original_ToppingName, Original_ToppingSize, Original_PizzaSize, Original_Rate, Original_BackColor)
        End Function
    End Class
End Namespace
