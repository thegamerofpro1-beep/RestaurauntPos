...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class StockAdjustment_MITableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockAdjustment_MITableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "StockAdjustment_MI"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[StockAdjustment_MI] WHERE (([SA_ID] = @Original_SA_ID) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Dish = 1 AND [Dish] IS NULL) OR ([Dish] = @Original_Dish)) AND ((@IsNull_AdjustmentType = 1 AND [AdjustmentType] IS NULL) OR ([AdjustmentType] = @Original_AdjustmentType)) AND ((@IsNull_Qty = 1 AND [Qty] IS NULL) OR ([Qty] = @Original_Qty)) AND ((@IsNull_Reason = 1 AND [Reason] IS NULL) OR ([Reason] = @Original_Reason)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[StockAdjustment_MI] ([SA_ID], [Date], [Dish], [AdjustmentType], [Qty], [Reason]) VALUES (@SA_ID, @Date, @Dish, @AdjustmentType, @Qty, @Reason);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT SA_ID, Date, Dish, AdjustmentType, Qty, Reason FROM StockAdjustment_MI WHERE (SA_ID = @SA_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[StockAdjustment_MI] SET [SA_ID] = @SA_ID, [Date] = @Date, [Dish] = @Dish, [AdjustmentType] = @AdjustmentType, [Qty] = @Qty, [Reason] = @Reason WHERE (([SA_ID] = @Original_SA_ID) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Dish = 1 AND [Dish] IS NULL) OR ([Dish] = @Original_Dish)) AND ((@IsNull_AdjustmentType = 1 AND [AdjustmentType] IS NULL) OR ([AdjustmentType] = @Original_AdjustmentType)) AND ((@IsNull_Qty = 1 AND [Qty] IS NULL) OR ([Qty] = @Original_Qty)) AND ((@IsNull_Reason = 1 AND [Reason] IS NULL) OR ([Reason] = @Original_Reason)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT SA_ID, Date, Dish, AdjustmentType, Qty, Reason FROM StockAdjustment_MI WHERE (SA_ID = @SA_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT SA_ID, Date, Dish, AdjustmentType, Qty, Reason FROM dbo.StockAdjustment_MI"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_MIDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_MIDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim stockAdjustment_MIDataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_MIDataTable = New RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_MIDataTable()
            Me.Adapter.Fill(stockAdjustment_MIDataTable)
            Return stockAdjustment_MIDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockAdjustment_MIDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "StockAdjustment_MI")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_Dish As String, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(SA_ID As Integer, _Date As System.DateTime?, Dish As String, AdjustmentType As String, Qty As Decimal?, Reason As String) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(SA_ID As Integer, _Date As System.DateTime?, Dish As String, AdjustmentType As String, Qty As Decimal?, Reason As String, Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_Dish As String, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_Dish
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(_Date As System.DateTime?, Dish As String, AdjustmentType As String, Qty As Decimal?, Reason As String, Original_SA_ID As Integer, Original_Date As System.DateTime?, Original_Dish As String, Original_AdjustmentType As String, Original_Qty As Decimal?, Original_Reason As String) As Integer
            Return Me.Update(Original_SA_ID, _Date, Dish, AdjustmentType, Qty, Reason, Original_SA_ID, Original_Date, Original_Dish, Original_AdjustmentType, Original_Qty, Original_Reason)
        End Function
    End Class
End Namespace
