...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class JournalTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.JournalTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Journal"
            dataTableMapping.ColumnMappings.Add("ID", "ID")
            dataTableMapping.ColumnMappings.Add("DebitAccount", "DebitAccount")
            dataTableMapping.ColumnMappings.Add("CreditAccount", "CreditAccount")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Journal] WHERE (([ID] = @Original_ID) AND ((@IsNull_DebitAccount = 1 AND [DebitAccount] IS NULL) OR ([DebitAccount] = @Original_DebitAccount)) AND ((@IsNull_CreditAccount = 1 AND [CreditAccount] IS NULL) OR ([CreditAccount] = @Original_CreditAccount)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_DebitAccount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DebitAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CreditAccount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CreditAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Journal] ([ID], [DebitAccount], [CreditAccount], [Date], [Amount], [Remarks]) VALUES (@ID, @DebitAccount, @CreditAccount, @Date, @Amount, @Remarks);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, DebitAccount, CreditAccount, Date, Amount, Remarks FROM Journal WHERE (ID = @ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DebitAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CreditAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Journal] SET [ID] = @ID, [DebitAccount] = @DebitAccount, [CreditAccount] = @CreditAccount, [Date] = @Date, [Amount] = @Amount, [Remarks] = @Remarks WHERE (([ID] = @Original_ID) AND ((@IsNull_DebitAccount = 1 AND [DebitAccount] IS NULL) OR ([DebitAccount] = @Original_DebitAccount)) AND ((@IsNull_CreditAccount = 1 AND [CreditAccount] IS NULL) OR ([CreditAccount] = @Original_CreditAccount)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, DebitAccount, CreditAccount, Date, Amount, Remarks FROM Journal WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DebitAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CreditAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_DebitAccount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DebitAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DebitAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CreditAccount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CreditAccount", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CreditAccount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ID, DebitAccount, CreditAccount, Date, Amount, Remarks FROM dbo.Journal"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.JournalDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.JournalDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim journalDataTable As RestaurantPOS14.RPOS_DBDataSet1.JournalDataTable = New RestaurantPOS14.RPOS_DBDataSet1.JournalDataTable()
            Me.Adapter.Fill(journalDataTable)
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.JournalDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_ID As Integer, Original_DebitAccount As String, Original_CreditAccount As String, Original_Date As System.DateTime?, Original_Amount As Decimal?) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_ID
            If Equals(Original_DebitAccount, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_DebitAccount
            End If

            If Equals(Original_CreditAccount, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_CreditAccount
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(ID As Integer, DebitAccount As String, CreditAccount As String, _Date As System.DateTime?, Amount As Decimal?, Remarks As String) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = ID
            If Equals(DebitAccount, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = DebitAccount
            End If

            If Equals(CreditAccount, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = CreditAccount
            End If
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = Remarks
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(ID As Integer, DebitAccount As String, CreditAccount As String, _Date As System.DateTime?, Amount As Decimal?, Remarks As String, Original_ID As Integer, Original_DebitAccount As String, Original_CreditAccount As String, Original_Date As System.DateTime?, Original_Amount As Decimal?) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = ID
            If Equals(DebitAccount, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = DebitAccount
            End If

            If Equals(CreditAccount, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = CreditAccount
            End If
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Remarks
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_DebitAccount
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_CreditAccount
            End If
            ...
            If Original_Amount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Amount.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(DebitAccount As String, CreditAccount As String, _Date As System.DateTime?, Amount As Decimal?, Remarks As String, Original_ID As Integer, Original_DebitAccount As String, Original_CreditAccount As String, Original_Date As System.DateTime?, Original_Amount As Decimal?) As Integer
            Return Me.Update(Original_ID, DebitAccount, CreditAccount, _Date, Amount, Remarks, Original_ID, Original_DebitAccount, Original_CreditAccount, Original_Date, Original_Amount)
        End Function
    End Class
End Namespace
