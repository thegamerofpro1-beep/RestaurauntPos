...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class GiftCardTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GiftCardTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "GiftCard"
            dataTableMapping.ColumnMappings.Add("ID", "ID")
            dataTableMapping.ColumnMappings.Add("Amount", "Amount")
            dataTableMapping.ColumnMappings.Add("CustomerName", "CustomerName")
            dataTableMapping.ColumnMappings.Add("EntryDate", "EntryDate")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[GiftCard] WHERE (([ID] = @Original_ID) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_EntryDate = 1 AND [EntryDate] IS NULL) OR ([EntryDate] = @Original_EntryDate)))"
            Me._adapter.DeleteCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_EntryDate", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_EntryDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[GiftCard] ([ID], [Amount], [CustomerName], [EntryDate]) VALUES (@ID, @Amount, @CustomerName, @EntryDate);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, Amount, CustomerName, EntryDate FROM GiftCard WHERE (ID = @ID)"
            Me._adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EntryDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[GiftCard] SET [ID] = @ID, [Amount] = @Amount, [CustomerName] = @CustomerName, [EntryDate] = @EntryDate WHERE (([ID] = @Original_ID) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_EntryDate = 1 AND [EntryDate] IS NULL) OR ([EntryDate] = @Original_EntryDate)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, Amount, CustomerName, EntryDate FROM GiftCard WHERE (ID = @ID)"
            Me._adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EntryDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_EntryDate", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_EntryDate", System.Data.SqlDbType.DateTime, 0, System.Data.ParameterDirection.Input, 0, 0, "EntryDate", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ID, Amount, CustomerName, EntryDate FROM dbo.GiftCard"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.GiftCardDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.GiftCardDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim giftCardDataTable As RestaurantPOS14.RPOS_DBDataSet1.GiftCardDataTable = New RestaurantPOS14.RPOS_DBDataSet1.GiftCardDataTable()
            Me.Adapter.Fill(giftCardDataTable)
            Return giftCardDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.GiftCardDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "GiftCard")
        End Function
        ...
        Public Overridable Function Delete(Original_ID As String, Original_Amount As Decimal?, Original_CustomerName As String, Original_EntryDate As System.DateTime?) As Integer
            If Equals(Original_ID, Nothing) Then
            ...
            If Original_Amount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_Amount.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_CustomerName
            End If

            If Original_EntryDate.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((5))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_EntryDate.Value
            Else
        ...
        Public Overridable Function Insert(ID As String, Amount As Decimal?, CustomerName As String, EntryDate As System.DateTime?) As Integer
            ...
            If Amount.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = Amount.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = CustomerName
            End If

            If EntryDate.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = EntryDate.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(ID As String, Amount As Decimal?, CustomerName As String, EntryDate As System.DateTime?, Original_ID As String, Original_Amount As Decimal?, Original_CustomerName As String, Original_EntryDate As System.DateTime?) As Integer
            If Equals(ID, Nothing) Then
                Throw New System.ArgumentNullException("ID")
            End If
            ...
            If Amount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Amount.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = CustomerName
            End If

            If EntryDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = EntryDate.Value
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_ID
            If Original_Amount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_Amount.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_CustomerName
            End If

            If Original_EntryDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_EntryDate.Value
            Else
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(Amount As Decimal?, CustomerName As String, EntryDate As System.DateTime?, Original_ID As String, Original_Amount As Decimal?, Original_CustomerName As String, Original_EntryDate As System.DateTime?) As Integer
            Return Me.Update(Original_ID, Amount, CustomerName, EntryDate, Original_ID, Original_Amount, Original_CustomerName, Original_EntryDate)
        End Function
    End Class
End Namespace
