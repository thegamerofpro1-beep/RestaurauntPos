...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class CreditCustomerPaymentTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.CreditCustomerPaymentTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CreditCustomerPayment] ([T_ID], [TransactionID], [Date], [PaymentMode], [CreditCustomer_ID], [Amount], [Remarks], [PaymentModeDetails]) VALUES (@T_ID, @TransactionID, @Date, @PaymentMode, @CreditCustomer_ID, @Amount, @Remarks, @PaymentModeDetails);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, TransactionID, Date, PaymentMode, CreditCustomer_ID, Amount, Remarks, PaymentModeDetails FROM CreditCustomerPayment WHERE (T_ID = @T_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CreditCustomerPayment] SET [T_ID] = @T_ID, [TransactionID] = @TransactionID, [Date] = @Date, [PaymentMode] = @PaymentMode, [CreditCustomer_ID] = @CreditCustomer_ID, [Amount] = @Amount, [Remarks] = @Remarks, [PaymentModeDetails] = @PaymentModeDetails WHERE (([T_ID] = @Original_T_ID) AND ((@IsNull_TransactionID = 1 AND [TransactionID] IS NULL) OR ([TransactionID] = @Original_TransactionID)) AND ([Date] = @Original_Date) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ([CreditCustomer_ID] = @Original_CreditCustomer_ID) AND ([Amount] = @Original_Amount) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)) AND ((@IsNull_PaymentModeDetails = 1 AND [PaymentModeDetails] IS NULL) OR ([PaymentModeDetails] = @Original_PaymentModeDetails)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, TransactionID, Date, PaymentMode, CreditCustomer_ID, Amount, Remarks, PaymentModeDetails FROM CreditCustomerPayment WHERE (T_ID = @T_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT T_ID, TransactionID, Date, PaymentMode, CreditCustomer_ID, Amount, Remarks, PaymentModeDetails FROM dbo.CreditCustomerPayment"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.CreditCustomerPaymentDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.CreditCustomerPaymentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim creditCustomerPaymentDataTable As RestaurantPOS14.RPOS_DBDataSet1.CreditCustomerPaymentDataTable = New RestaurantPOS14.RPOS_DBDataSet1.CreditCustomerPaymentDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.CreditCustomerPaymentDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_CreditCustomer_ID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_CreditCustomer_ID
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(T_ID As Integer, TransactionID As String, _Date As System.DateTime, PaymentMode As String, CreditCustomer_ID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = CreditCustomer_ID
        ...
        Public Overridable Function Update(T_ID As Integer, TransactionID As String, _Date As System.DateTime, PaymentMode As String, CreditCustomer_ID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String, Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_CreditCustomer_ID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = CreditCustomer_ID
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_CreditCustomer_ID
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(TransactionID As String, _Date As System.DateTime, PaymentMode As String, CreditCustomer_ID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String, Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_CreditCustomer_ID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
            Return Me.Update(Original_T_ID, TransactionID, _Date, PaymentMode, CreditCustomer_ID, Amount, Remarks, PaymentModeDetails, Original_T_ID, Original_TransactionID, Original_Date, Original_PaymentMode, Original_CreditCustomer_ID, Original_Amount, Original_Remarks, Original_PaymentModeDetails)
        End Function
    End Class
End Namespace
