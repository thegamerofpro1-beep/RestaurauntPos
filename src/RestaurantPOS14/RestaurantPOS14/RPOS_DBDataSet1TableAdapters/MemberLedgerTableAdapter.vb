...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class MemberLedgerTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.MemberLedgerTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "MemberLedger"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MemberLedger] WHERE (([Id] = @Original_Id) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_LedgerNo = 1 AND [LedgerNo] IS NULL) OR ([LedgerNo] = @Original_LedgerNo)) AND ((@IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsNull_Debit = 1 AND [Debit] IS NULL) OR ([Debit] = @Original_Debit)) AND ((@IsNull_Credit = 1 AND [Credit] IS NULL) OR ([Credit] = @Original_Credit)) AND ((@IsNull_MemberID = 1 AND [MemberID] IS NULL) OR ([MemberID] = @Original_MemberID)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MemberLedger] ([Id], [Date], [LedgerNo], [Label], [Debit], [Credit], [MemberID]) VALUES (@Id, @Date, @LedgerNo, @Label, @Debit, @Credit, @MemberID);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Date, LedgerNo, Label, Debit, Credit, MemberID FROM MemberLedger WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[MemberLedger] SET [Id] = @Id, [Date] = @Date, [LedgerNo] = @LedgerNo, [Label] = @Label, [Debit] = @Debit, [Credit] = @Credit, [MemberID] = @MemberID WHERE (([Id] = @Original_Id) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_LedgerNo = 1 AND [LedgerNo] IS NULL) OR ([LedgerNo] = @Original_LedgerNo)) AND ((@IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) AND ((@IsNull_Debit = 1 AND [Debit] IS NULL) OR ([Debit] = @Original_Debit)) AND ((@IsNull_Credit = 1 AND [Credit] IS NULL) OR ([Credit] = @Original_Credit)) AND ((@IsNull_MemberID = 1 AND [MemberID] IS NULL) OR ([MemberID] = @Original_MemberID)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Date, LedgerNo, Label, Debit, Credit, MemberID FROM MemberLedger WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, Date, LedgerNo, Label, Debit, Credit, MemberID FROM dbo.MemberLedger"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.MemberLedgerDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.MemberLedgerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim memberLedgerDataTable As RestaurantPOS14.RPOS_DBDataSet1.MemberLedgerDataTable = New RestaurantPOS14.RPOS_DBDataSet1.MemberLedgerDataTable()
            Me.Adapter.Fill(memberLedgerDataTable)
            Return memberLedgerDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.MemberLedgerDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "MemberLedger")
        End Function
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_Date As System.DateTime?, Original_LedgerNo As String, Original_Label As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_MemberID As Integer?) As Integer
            ...
            If Original_MemberID.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_MemberID.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(Id As Integer, _Date As System.DateTime?, LedgerNo As String, Label As String, Debit As Decimal?, Credit As Decimal?, MemberID As Integer?) As Integer
            ...
            If MemberID.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = MemberID.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Id As Integer, _Date As System.DateTime?, LedgerNo As String, Label As String, Debit As Decimal?, Credit As Decimal?, MemberID As Integer?, Original_Id As Integer, Original_Date As System.DateTime?, Original_LedgerNo As String, Original_Label As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_MemberID As Integer?) As Integer
            ...
            If MemberID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = MemberID.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_LedgerNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_Label
            End If

            If Original_Debit.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_Debit.Value
            Else
            ...
            If Original_Credit.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_Credit.Value
            Else
            ...
            If Original_MemberID.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_MemberID.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(_Date As System.DateTime?, LedgerNo As String, Label As String, Debit As Decimal?, Credit As Decimal?, MemberID As Integer?, Original_Id As Integer, Original_Date As System.DateTime?, Original_LedgerNo As String, Original_Label As String, Original_Debit As Decimal?, Original_Credit As Decimal?, Original_MemberID As Integer?) As Integer
            Return Me.Update(Original_Id, _Date, LedgerNo, Label, Debit, Credit, MemberID, Original_Id, Original_Date, Original_LedgerNo, Original_Label, Original_Debit, Original_Credit, Original_MemberID)
        End Function
    End Class
End Namespace
