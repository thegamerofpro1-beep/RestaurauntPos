...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class PizzaMasterTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PizzaMasterTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "PizzaMaster"
            dataTableMapping.ColumnMappings.Add("Pizza_ID", "Pizza_ID")
            dataTableMapping.ColumnMappings.Add("PizzaName", "PizzaName")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PizzaMaster] WHERE (([Pizza_ID] = @Original_Pizza_ID) AND ((@IsNull_PizzaName = 1 AND [PizzaName] IS NULL) OR ([PizzaName] = @Original_PizzaName)) AND ((@IsNull_PizzaSize = 1 AND [PizzaSize] IS NULL) OR ([PizzaSize] = @Original_PizzaSize)) AND ((@IsNull_Discount = 1 AND [Discount] IS NULL) OR ([Discount] = @Original_Discount)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_BackColor = 1 AND [BackColor] IS NULL) OR ([BackColor] = @Original_BackColor)))"
            Me._adapter.DeleteCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Pizza_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Pizza_ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PizzaName", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PizzaName", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Discount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Discount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PizzaMaster] ([Pizza_ID], [PizzaName], [PizzaSize], [Description], [Discount], [Rate], [BackColor]) VALUES (@Pizza_ID, @PizzaName, @PizzaSize, @Description, @Discount, @Rate, @BackColor);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Pizza_ID, PizzaName, PizzaSize, Description, Discount, Rate, BackColor FROM PizzaMaster WHERE (Pizza_ID = @Pizza_ID)"
            Me._adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Pizza_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Pizza_ID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PizzaName", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PizzaMaster] SET [Pizza_ID] = @Pizza_ID, [PizzaName] = @PizzaName, [PizzaSize] = @PizzaSize, [Description] = @Description, [Discount] = @Discount, [Rate] = @Rate, [BackColor] = @BackColor WHERE (([Pizza_ID] = @Original_Pizza_ID) AND ((@IsNull_PizzaName = 1 AND [PizzaName] IS NULL) OR ([PizzaName] = @Original_PizzaName)) AND ((@IsNull_PizzaSize = 1 AND [PizzaSize] IS NULL) OR ([PizzaSize] = @Original_PizzaSize)) AND ((@IsNull_Discount = 1 AND [Discount] IS NULL) OR ([Discount] = @Original_Discount)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_BackColor = 1 AND [BackColor] IS NULL) OR ([BackColor] = @Original_BackColor)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Pizza_ID, PizzaName, PizzaSize, Description, Discount, Rate, BackColor FROM PizzaMaster WHERE (Pizza_ID = @Pizza_ID)"
            Me._adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Pizza_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Pizza_ID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PizzaName", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Pizza_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Pizza_ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PizzaName", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PizzaName", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PizzaName", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Discount", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Discount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Pizza_ID, PizzaName, PizzaSize, Description, Discount, Rate, BackColor FROM dbo.PizzaMaster"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaMasterDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.PizzaMasterDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim pizzaMasterDataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaMasterDataTable = New RestaurantPOS14.RPOS_DBDataSet1.PizzaMasterDataTable()
            Me.Adapter.Fill(pizzaMasterDataTable)
            Return pizzaMasterDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PizzaMasterDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "PizzaMaster")
        End Function
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_Pizza_ID As Integer, Original_PizzaName As String, Original_PizzaSize As String, Original_Discount As Decimal?, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_Pizza_ID
            If Equals(Original_PizzaName, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_PizzaName
            End If
            ...
            If Original_Discount.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((5))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_Discount.Value
            Else
            ...
            If Original_Rate.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_Rate.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(Pizza_ID As Integer, PizzaName As String, PizzaSize As String, Description As String, Discount As Decimal?, Rate As Decimal?, BackColor As Integer?) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = Pizza_ID
            If Equals(PizzaName, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = PizzaName
            End If
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = Description
            End If

            If Discount.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = Discount.Value
            Else
            ...
            If BackColor.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = BackColor.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(Pizza_ID As Integer, PizzaName As String, PizzaSize As String, Description As String, Discount As Decimal?, Rate As Decimal?, BackColor As Integer?, Original_Pizza_ID As Integer, Original_PizzaName As String, Original_PizzaSize As String, Original_Discount As Decimal?, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Pizza_ID
            If Equals(PizzaName, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = PizzaName
            End If
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = Description
            End If

            If Discount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Discount.Value
            Else
            ...
            If BackColor.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = BackColor.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = System.DBNull.Value
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = Original_Pizza_ID
            If Equals(Original_PizzaName, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = Original_PizzaName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_PizzaSize
            End If

            If Original_Discount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_Discount.Value
            Else
            ...
            If Original_Rate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_Rate.Value
            Else
            ...
            If Original_BackColor.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_BackColor.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(PizzaName As String, PizzaSize As String, Description As String, Discount As Decimal?, Rate As Decimal?, BackColor As Integer?, Original_Pizza_ID As Integer, Original_PizzaName As String, Original_PizzaSize As String, Original_Discount As Decimal?, Original_Rate As Decimal?, Original_BackColor As Integer?) As Integer
            Return Me.Update(Original_Pizza_ID, PizzaName, PizzaSize, Description, Discount, Rate, BackColor, Original_Pizza_ID, Original_PizzaName, Original_PizzaSize, Original_Discount, Original_Rate, Original_BackColor)
        End Function
    End Class
End Namespace
