...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class GridGroupingTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.GridGroupingTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "GridGrouping"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[GridGrouping] WHERE (([Id] = @Original_Id) AND ([Col1] = @Original_Col1) AND ([Col2] = @Original_Col2))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col2", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col2", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[GridGrouping] ([Id], [Col1], [Col2]) VALUES (@Id, @Col1, @Col2);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Col1, Col2 FROM GridGrouping WHERE (Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col2", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col2", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[GridGrouping] SET [Id] = @Id, [Col1] = @Col1, [Col2] = @Col2 WHERE (([Id] = @Original_Id) AND ([Col1] = @Original_Col1) AND ([Col2] = @Original_Col2));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Col1, Col2 FROM GridGrouping WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Col2", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col2", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Col2", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Col2", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, Col1, Col2 FROM dbo.GridGrouping"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.GridGroupingDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.GridGroupingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim gridGroupingDataTable As RestaurantPOS14.RPOS_DBDataSet1.GridGroupingDataTable = New RestaurantPOS14.RPOS_DBDataSet1.GridGroupingDataTable()
            Me.Adapter.Fill(gridGroupingDataTable)
            Return gridGroupingDataTable
        End Function

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.GridGroupingDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "GridGrouping")
        End Function
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_Id As Integer, Original_Col1 As String, Original_Col2 As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_Id
            If Equals(Original_Col1, Nothing) Then
                Throw New System.ArgumentNullException("Original_Col1")
            End If

            Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = Original_Col1
            Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_Col2
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(Id As Integer, Col1 As String, Col2 As Integer) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = Id
            If Equals(Col1, Nothing) Then
                Throw New System.ArgumentNullException("Col1")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = Col1
            Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = Col2
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Id As Integer, Col1 As String, Col2 As Integer, Original_Id As Integer, Original_Col1 As String, Original_Col2 As Integer) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Id
            If Equals(Col1, Nothing) Then
                Throw New System.ArgumentNullException("Col1")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Col1
            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Col2
            Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = Original_Id
            If Equals(Original_Col1, Nothing) Then
                Throw New System.ArgumentNullException("Original_Col1")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_Col1
            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Original_Col2
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(Col1 As String, Col2 As Integer, Original_Id As Integer, Original_Col1 As String, Original_Col2 As Integer) As Integer
            Return Me.Update(Original_Id, Col1, Col2, Original_Id, Original_Col1, Original_Col2)
        End Function
    End Class
End Namespace
