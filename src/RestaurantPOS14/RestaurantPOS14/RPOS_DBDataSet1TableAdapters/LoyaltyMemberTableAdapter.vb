...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class LoyaltyMemberTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.LoyaltyMemberTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "LoyaltyMember"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoyaltyMember] WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_CardNo = 1 AND [CardNo] IS NULL) OR ([CardNo] = @Original_CardNo)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LoyaltyMember] ([MemberID], [Name], [CardNo], [ContactNo], [Address], [RegistrationDate], [Active]) VALUES (@MemberID, @Name, @CardNo, @ContactNo, @Address, @RegistrationDate, @Active);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, CardNo, ContactNo, Address, RegistrationDate, Active FROM LoyaltyMember WHERE (MemberID = @MemberID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LoyaltyMember] SET [MemberID] = @MemberID, [Name] = @Name, [CardNo] = @CardNo, [ContactNo] = @ContactNo, [Address] = @Address, [RegistrationDate] = @RegistrationDate, [Active] = @Active WHERE (([MemberID] = @Original_MemberID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_CardNo = 1 AND [CardNo] IS NULL) OR ([CardNo] = @Original_CardNo)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_RegistrationDate = 1 AND [RegistrationDate] IS NULL) OR ([RegistrationDate] = @Original_RegistrationDate)) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT MemberID, Name, CardNo, ContactNo, Address, RegistrationDate, Active FROM LoyaltyMember WHERE (MemberID = @MemberID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT MemberID, Name, CardNo, ContactNo, Address, RegistrationDate, Active FROM dbo.LoyaltyMember"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.LoyaltyMemberDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.LoyaltyMemberDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim loyaltyMemberDataTable As RestaurantPOS14.RPOS_DBDataSet1.LoyaltyMemberDataTable = New RestaurantPOS14.RPOS_DBDataSet1.LoyaltyMemberDataTable()
            Me.Adapter.Fill(loyaltyMemberDataTable)
            Return loyaltyMemberDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.LoyaltyMemberDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "LoyaltyMember")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_MemberID As Integer, Original_Name As String, Original_CardNo As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_MemberID
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_CardNo
            End If
            ...
            If Original_RegistrationDate.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_RegistrationDate.Value
            Else
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(MemberID As Integer, Name As String, CardNo As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = MemberID
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = CardNo
            End If
            ...
            If RegistrationDate.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = RegistrationDate.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = Active
            End If
        ...
        Public Overridable Function Update(MemberID As Integer, Name As String, CardNo As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String, Original_MemberID As Integer, Original_Name As String, Original_CardNo As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = MemberID
            If Equals(Name, Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = CardNo
            End If
            ...
            If RegistrationDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = RegistrationDate.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Active
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = Original_MemberID
            If Equals(Original_Name, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_CardNo
            End If
            ...
            If Original_RegistrationDate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_RegistrationDate.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_Active
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Name As String, CardNo As String, ContactNo As String, Address As String, RegistrationDate As System.DateTime?, Active As String, Original_MemberID As Integer, Original_Name As String, Original_CardNo As String, Original_ContactNo As String, Original_RegistrationDate As System.DateTime?, Original_Active As String) As Integer
            Return Me.Update(Original_MemberID, Name, CardNo, ContactNo, Address, RegistrationDate, Active, Original_MemberID, Original_Name, Original_CardNo, Original_ContactNo, Original_RegistrationDate, Original_Active)
        End Function
    End Class
End Namespace
