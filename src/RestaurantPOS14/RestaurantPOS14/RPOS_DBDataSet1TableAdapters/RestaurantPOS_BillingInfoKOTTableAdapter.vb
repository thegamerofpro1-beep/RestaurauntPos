...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RestaurantPOS_BillingInfoKOTTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoKOTTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.ColumnMappings.Add("DIB_Status", "DIB_Status")
            dataTableMapping.ColumnMappings.Add("NpPaid", "NpPaid")
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_DIB_Status", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DIB_Status", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_BillingInfoKOT] ([Id], [BillNo], [BillDate], [ODN], [KOTDiscountPer], [KOTDiscountAmt], [GrandTotal], [Cash], [Change], [Operator], [PaymentMode], [ExchangeRate], [CurrencyCode], [Member_ID], [Waiter], [GiftCardID], [GiftCardAmount], [LP], [LA], [CustomerName], [PhoneNo], [EmailID], [TaxType], [Card], [NoofPerson], [DIB_Status], [NpPaid], [BillType], [Tip]) VALUES (@Id, @BillNo, @BillDate, @ODN, @KOTDiscountPer, @KOTDiscountAmt, @GrandTotal, @Cash, @Change, @Operator, @PaymentMode, @ExchangeRate, @CurrencyCode, @Member_ID, @Waiter, @GiftCardID, @GiftCardAmount, @LP, @LA, @CustomerName, @PhoneNo, @EmailID, @TaxType, @Card, @NoofPerson, @DIB_Status, @NpPaid, @BillType, @Tip);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, BillDate, ODN, KOTDiscountPer, KOTDiscountAmt, GrandTotal, Cash, Change, Operator, PaymentMode, ExchangeRate, CurrencyCode, Member_ID, Waiter, GiftCardID, GiftCardAmount, LP, LA, CustomerName, PhoneNo, EmailID, TaxType, Card, NoofPerson, DIB_Status, NpPaid, BillType, Tip FROM RestaurantPOS_BillingInfoKOT WHERE (Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DIB_Status", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_BillingInfoKOT] SET [Id] = @Id, [BillNo] = @BillNo, [BillDate] = @BillDate, [ODN] = @ODN, [KOTDiscountPer] = @KOTDiscountPer, [KOTDiscountAmt] = @KOTDiscountAmt, [GrandTotal] = @GrandTotal, [Cash] = @Cash, [Change] = @Change, [Operator] = @Operator, [PaymentMode] = @PaymentMode, [ExchangeRate] = @ExchangeRate, [CurrencyCode] = @CurrencyCode, [Member_ID] = @Member_ID, [Waiter] = @Waiter, [GiftCardID] = @GiftCardID, [GiftCardAmount] = @GiftCardAmount, [LP] = @LP, [LA] = @LA, [CustomerName] = @CustomerName, [PhoneNo] = @PhoneNo, [EmailID] = @EmailID, [TaxType] = @TaxType, [Card] = @Card, [NoofPerson] = @NoofPerson, [DIB_Status] = @DIB_Status, [NpPaid] = @NpPaid, [BillType] = @BillType, [Tip] = @Tip WHERE (([Id] = @Original_Id) AND ((@IsNull_BillNo = 1 AND [BillNo] IS NULL) OR ([BillNo] = @Original_BillNo)) AND ((@IsNull_BillDate = 1 AND [BillDate] IS NULL) OR ([BillDate] = @Original_BillDate)) AND ((@IsNull_ODN = 1 AND [ODN] IS NULL) OR ([ODN] = @Original_ODN)) AND ((@IsNull_KOTDiscountPer = 1 AND [KOTDiscountPer] IS NULL) OR ([KOTDiscountPer] = @Original_KOTDiscountPer)) AND ((@IsNull_KOTDiscountAmt = 1 AND [KOTDiscountAmt] IS NULL) OR ([KOTDiscountAmt] = @Original_KOTDiscountAmt)) AND ((@IsNull_GrandTotal = 1 AND [GrandTotal] IS NULL) OR ([GrandTotal] = @Original_GrandTotal)) AND ((@IsNull_Cash = 1 AND [Cash] IS NULL) OR ([Cash] = @Original_Cash)) AND ((@IsNull_Change = 1 AND [Change] IS NULL) OR ([Change] = @Original_Change)) AND ((@IsNull_Operator = 1 AND [Operator] IS NULL) OR ([Operator] = @Original_Operator)) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ((@IsNull_ExchangeRate = 1 AND [ExchangeRate] IS NULL) OR ([ExchangeRate] = @Original_ExchangeRate)) AND ((@IsNull_CurrencyCode = 1 AND [CurrencyCode] IS NULL) OR ([CurrencyCode] = @Original_CurrencyCode)) AND ((@IsNull_Member_ID = 1 AND [Member_ID] IS NULL) OR ([Member_ID] = @Original_Member_ID)) AND ((@IsNull_Waiter = 1 AND [Waiter] IS NULL) OR ([Waiter] = @Original_Waiter)) AND ((@IsNull_GiftCardID = 1 AND [GiftCardID] IS NULL) OR ([GiftCardID] = @Original_GiftCardID)) AND ((@IsNull_GiftCardAmount = 1 AND [GiftCardAmount] IS NULL) OR ([GiftCardAmount] = @Original_GiftCardAmount)) AND ((@IsNull_LP = 1 AND [LP] IS NULL) OR ([LP] = @Original_LP)) AND ((@IsNull_LA = 1 AND [LA] IS NULL) OR ([LA] = @Original_LA)) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)) AND ((@IsNull_EmailID = 1 AND [EmailID] IS NULL) OR ([EmailID] = @Original_EmailID)) AND ((@IsNull_TaxType = 1 AND [TaxType] IS NULL) OR ([TaxType] = @Original_TaxType)) AND ((@IsNull_Card = 1 AND [Card] IS NULL) OR ([Card] = @Original_Card)) AND ((@IsNull_NoofPerson = 1 AND [NoofPerson] IS NULL) OR ([NoofPerson] = @Original_NoofPerson)) AND ((@IsNull_DIB_Status = 1 AND [DIB_Status] IS NULL) OR ([DIB_Status] = @Original_DIB_Status)) AND ((@IsNull_NpPaid = 1 AND [NpPaid] IS NULL) OR ([NpPaid] = @Original_NpPaid)) AND ((@IsNull_BillType = 1 AND [BillType] IS NULL) OR ([BillType] = @Original_BillType)) AND ((@IsNull_Tip = 1 AND [Tip] IS NULL) OR ([Tip] = @Original_Tip)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, BillDate, ODN, KOTDiscountPer, KOTDiscountAmt, GrandTotal, Cash, Change, Operator, PaymentMode, ExchangeRate, CurrencyCode, Member_ID, Waiter, GiftCardID, GiftCardAmount, LP, LA, CustomerName, PhoneNo, EmailID, TaxType, Card, NoofPerson, DIB_Status, NpPaid, BillType, Tip FROM RestaurantPOS_BillingInfoKOT WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DIB_Status", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_DIB_Status", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DIB_Status", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "DIB_Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_NpPaid", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NpPaid", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoKOTDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoKOTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_BillingInfoKOTDataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoKOTDataTable = New RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoKOTDataTable()
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoKOTDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_BillNo As String, Original_BillDate As System.DateTime?, Original_ODN As String, Original_KOTDiscountPer As Decimal?, Original_KOTDiscountAmt As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_Waiter As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_CustomerName As String, Original_PhoneNo As String, Original_EmailID As String, Original_TaxType As String, Original_Card As Decimal?, Original_NoofPerson As Integer?, Original_DIB_Status As String, Original_NpPaid As Integer?, Original_BillType As String, Original_Tip As Decimal?) As Integer
            ...
            If Original_NoofPerson.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((47))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((48))).Value = Original_NoofPerson.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((47))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((48))).Value = System.DBNull.Value
            End If

            If Equals(Original_DIB_Status, Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(CInt((49))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((50))).Value = System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((49))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((50))).Value = Original_DIB_Status
            End If

            If Original_NpPaid.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((51))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((52))).Value = Original_NpPaid.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((51))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((52))).Value = System.DBNull.Value
            End If

            If Equals(Original_BillType, Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(CInt((53))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((54))).Value = System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((53))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((54))).Value = Original_BillType
            End If

            If Original_Tip.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((55))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((56))).Value = Original_Tip.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((55))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((56))).Value = System.DBNull.Value
            End If
        ...
        Public Overridable Function Insert(Id As Integer, BillNo As String, BillDate As System.DateTime?, ODN As String, KOTDiscountPer As Decimal?, KOTDiscountAmt As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, Waiter As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, CustomerName As String, PhoneNo As String, EmailID As String, TaxType As String, Card As Decimal?, NoofPerson As Integer?, DIB_Status As String, NpPaid As Integer?, BillType As String, Tip As Decimal?) As Integer
            ...
            If NoofPerson.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((24))).Value = NoofPerson.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((24))).Value = System.DBNull.Value
            End If

            If Equals(DIB_Status, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((25))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((25))).Value = DIB_Status
            End If

            If NpPaid.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((26))).Value = NpPaid.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((26))).Value = System.DBNull.Value
            End If

            If Equals(BillType, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((27))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((27))).Value = BillType
            End If

            If Tip.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((28))).Value = Tip.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((28))).Value = System.DBNull.Value
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(Id As Integer, BillNo As String, BillDate As System.DateTime?, ODN As String, KOTDiscountPer As Decimal?, KOTDiscountAmt As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, Waiter As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, CustomerName As String, PhoneNo As String, EmailID As String, TaxType As String, Card As Decimal?, NoofPerson As Integer?, DIB_Status As String, NpPaid As Integer?, BillType As String, Tip As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_BillDate As System.DateTime?, Original_ODN As String, Original_KOTDiscountPer As Decimal?, Original_KOTDiscountAmt As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_Waiter As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_CustomerName As String, Original_PhoneNo As String, Original_EmailID As String, Original_TaxType As String, Original_Card As Decimal?, Original_NoofPerson As Integer?, Original_DIB_Status As String, Original_NpPaid As Integer?, Original_BillType As String, Original_Tip As Decimal?) As Integer
            ...
            If NoofPerson.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = NoofPerson.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = DIB_Status
            End If

            If NpPaid.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = NpPaid.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((27))).Value = BillType
            End If

            If Tip.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Tip.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = System.DBNull.Value
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((29))).Value = Original_Id
            If Equals(Original_BillNo, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((31))).Value = Original_BillNo
            End If

            If Original_BillDate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((32))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((33))).Value = Original_BillDate.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((35))).Value = Original_ODN
            End If

            If Original_KOTDiscountPer.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((36))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((37))).Value = Original_KOTDiscountPer.Value
            Else
            ...
            If Original_KOTDiscountAmt.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((39))).Value = Original_KOTDiscountAmt.Value
            Else
            ...
            If Original_GrandTotal.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((41))).Value = Original_GrandTotal.Value
            Else
            ...
            If Original_Cash.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((43))).Value = Original_Cash.Value
            Else
            ...
            If Original_Change.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((45))).Value = Original_Change.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((47))).Value = Original_Operator
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((49))).Value = Original_PaymentMode
            End If

            If Original_ExchangeRate.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((50))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((51))).Value = Original_ExchangeRate.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((53))).Value = Original_CurrencyCode
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((55))).Value = Original_Member_ID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((57))).Value = Original_Waiter
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((59))).Value = Original_GiftCardID
            End If

            If Original_GiftCardAmount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((60))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((61))).Value = Original_GiftCardAmount.Value
            Else
            ...
            If Original_LP.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((63))).Value = Original_LP.Value
            Else
            ...
            If Original_LA.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((65))).Value = Original_LA.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((67))).Value = Original_CustomerName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((69))).Value = Original_PhoneNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((71))).Value = Original_EmailID
            End If

            If Equals(Original_TaxType, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((72))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((73))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((72))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((73))).Value = Original_TaxType
            End If

            If Original_Card.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((74))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((75))).Value = Original_Card.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((74))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((75))).Value = System.DBNull.Value
            End If

            If Original_NoofPerson.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((76))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((77))).Value = Original_NoofPerson.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((76))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((77))).Value = System.DBNull.Value
            End If

            If Equals(Original_DIB_Status, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((78))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((79))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((78))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((79))).Value = Original_DIB_Status
            End If

            If Original_NpPaid.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((80))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((81))).Value = Original_NpPaid.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((80))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((81))).Value = System.DBNull.Value
            End If

            If Equals(Original_BillType, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((82))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((83))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((82))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((83))).Value = Original_BillType
            End If

            If Original_Tip.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((84))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((85))).Value = Original_Tip.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((84))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((85))).Value = System.DBNull.Value
            End If
        ...
        Public Overridable Function Update(BillNo As String, BillDate As System.DateTime?, ODN As String, KOTDiscountPer As Decimal?, KOTDiscountAmt As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, Waiter As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, CustomerName As String, PhoneNo As String, EmailID As String, TaxType As String, Card As Decimal?, NoofPerson As Integer?, DIB_Status As String, NpPaid As Integer?, BillType As String, Tip As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_BillDate As System.DateTime?, Original_ODN As String, Original_KOTDiscountPer As Decimal?, Original_KOTDiscountAmt As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_Waiter As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_CustomerName As String, Original_PhoneNo As String, Original_EmailID As String, Original_TaxType As String, Original_Card As Decimal?, Original_NoofPerson As Integer?, Original_DIB_Status As String, Original_NpPaid As Integer?, Original_BillType As String, Original_Tip As Decimal?) As Integer
            Return Me.Update(Original_Id, BillNo, BillDate, ODN, KOTDiscountPer, KOTDiscountAmt, GrandTotal, Cash, Change, _Operator, PaymentMode, ExchangeRate, CurrencyCode, Member_ID, Waiter, GiftCardID, GiftCardAmount, LP, LA, CustomerName, PhoneNo, EmailID, TaxType, Card, NoofPerson, DIB_Status, NpPaid, BillType, Tip, Original_Id, Original_BillNo, Original_BillDate, Original_ODN, Original_KOTDiscountPer, Original_KOTDiscountAmt, Original_GrandTotal, Original_Cash, Original_Change, Original_Operator, Original_PaymentMode, Original_ExchangeRate, Original_CurrencyCode, Original_Member_ID, Original_Waiter, Original_GiftCardID, Original_GiftCardAmount, Original_LP, Original_LA, Original_CustomerName, Original_PhoneNo, Original_EmailID, Original_TaxType, Original_Card, Original_NoofPerson, Original_DIB_Status, Original_NpPaid, Original_BillType, Original_Tip)
        End Function
    End Class
End Namespace
