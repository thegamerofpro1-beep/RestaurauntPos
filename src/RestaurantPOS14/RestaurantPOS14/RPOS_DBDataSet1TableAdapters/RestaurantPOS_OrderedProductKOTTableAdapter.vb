...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RestaurantPOS_OrderedProductKOTTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductKOTTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "RestaurantPOS_OrderedProductKOT"
            dataTableMapping.ColumnMappings.Add("OP_ID", "OP_ID")
            dataTableMapping.ColumnMappings.Add("TicketID", "TicketID")
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_VATAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "VATAmount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DiscountAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "DiscountAmount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_T_Number", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_T_Number", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ItemStatus", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ItemStatus", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_OrderedProductKOT] ([TicketID], [Dish], [Rate], [Quantity], [Amount], [VATPer], [VATAmount], [STPer], [STAmount], [SCPer], [SCAmount], [DiscountPer], [DiscountAmount], [TotalAmount], [Notes], [Category], [T_Number], [DishNameArabic], [ItemStatus]) VALUES (@TicketID, @Dish, @Rate, @Quantity, @Amount, @VATPer, @VATAmount, @STPer, @STAmount, @SCPer, @SCAmount, @DiscountPer, @DiscountAmount, @TotalAmount, @Notes, @Category, @T_Number, @DishNameArabic, @ItemStatus);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, TicketID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, T_Number, DishNameArabic, ItemStatus FROM RestaurantPOS_OrderedProductKOT WHERE (OP_ID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@VATAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "VATAmount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DiscountAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "DiscountAmount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@T_Number", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ItemStatus", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_OrderedProductKOT] SET [TicketID] = @TicketID, [Dish] = @Dish, [Rate] = @Rate, [Quantity] = @Quantity, [Amount] = @Amount, [VATPer] = @VATPer, [VATAmount] = @VATAmount, [STPer] = @STPer, [STAmount] = @STAmount, [SCPer] = @SCPer, [SCAmount] = @SCAmount, [DiscountPer] = @DiscountPer, [DiscountAmount] = @DiscountAmount, [TotalAmount] = @TotalAmount, [Notes] = @Notes, [Category] = @Category, [T_Number] = @T_Number, [DishNameArabic] = @DishNameArabic, [ItemStatus] = @ItemStatus WHERE (([OP_ID] = @Original_OP_ID) AND ((@IsNull_TicketID = 1 AND [TicketID] IS NULL) OR ([TicketID] = @Original_TicketID)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_VATPer = 1 AND [VATPer] IS NULL) OR ([VATPer] = @Original_VATPer)) AND ((@IsNull_VATAmount = 1 AND [VATAmount] IS NULL) OR ([VATAmount] = @Original_VATAmount)) AND ((@IsNull_STPer = 1 AND [STPer] IS NULL) OR ([STPer] = @Original_STPer)) AND ((@IsNull_STAmount = 1 AND [STAmount] IS NULL) OR ([STAmount] = @Original_STAmount)) AND ((@IsNull_SCPer = 1 AND [SCPer] IS NULL) OR ([SCPer] = @Original_SCPer)) AND ((@IsNull_SCAmount = 1 AND [SCAmount] IS NULL) OR ([SCAmount] = @Original_SCAmount)) AND ((@IsNull_DiscountPer = 1 AND [DiscountPer] IS NULL) OR ([DiscountPer] = @Original_DiscountPer)) AND ((@IsNull_DiscountAmount = 1 AND [DiscountAmount] IS NULL) OR ([DiscountAmount] = @Original_DiscountAmount)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_T_Number = 1 AND [T_Number] IS NULL) OR ([T_Number] = @Original_T_Number)) AND ((@IsNull_DishNameArabic = 1 AND [DishNameArabic] IS NULL) OR ([DishNameArabic] = @Original_DishNameArabic)) AND ((@IsNull_ItemStatus = 1 AND [ItemStatus] IS NULL) OR ([ItemStatus] = @Original_ItemStatus)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, TicketID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, T_Number, DishNameArabic, ItemStatus FROM RestaurantPOS_OrderedProductKOT WHERE (OP_ID = @OP_ID)"
            Me._adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@VATAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "VATAmount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DiscountAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "DiscountAmount", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@T_Number", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ItemStatus", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TicketID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TicketID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_VATAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "VATAmount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DiscountAmount", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 3, "DiscountAmount", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_T_Number", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_T_Number", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "T_Number", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_ItemStatus", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ItemStatus", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemStatus", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT OP_ID, TicketID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, T_Number, DishNameArabic, ItemStatus FROM dbo.RestaurantPOS_OrderedProductKOT"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductKOTDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductKOTDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_OrderedProductKOTDataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductKOTDataTable = New RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductKOTDataTable()
            Me.Adapter.Fill(restaurantPOS_OrderedProductKOTDataTable)
            Return restaurantPOS_OrderedProductKOTDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductKOTDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "RestaurantPOS_OrderedProductKOT")
        End Function
        ...
        Public Overridable Function Delete(Original_OP_ID As Integer, Original_TicketID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_T_Number As String, Original_DishNameArabic As String, Original_ItemStatus As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_OP_ID
            If Original_TicketID.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_TicketID.Value
            Else
            ...
            If Original_Amount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((8))).Value = Original_Amount.Value
            Else
            ...
            If Original_VATPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((10))).Value = Original_VATPer.Value
            Else
            ...
            If Original_VATAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_VATAmount.Value
            Else
            ...
            If Original_STPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((14))).Value = Original_STPer.Value
            Else
            ...
            If Original_STAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((16))).Value = Original_STAmount.Value
            Else
            ...
            If Original_SCPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((18))).Value = Original_SCPer.Value
            Else
            ...
            If Original_SCAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((20))).Value = Original_SCAmount.Value
            Else
            ...
            If Original_DiscountPer.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((22))).Value = Original_DiscountPer.Value
            Else
            ...
            If Original_DiscountAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((24))).Value = Original_DiscountAmount.Value
            Else
            ...
            If Original_TotalAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((26))).Value = Original_TotalAmount.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((28))).Value = Original_Category
            End If

            If Equals(Original_T_Number, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((30))).Value = Original_T_Number
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = Original_DishNameArabic
            End If

            If Equals(Original_ItemStatus, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((34))).Value = Original_ItemStatus
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(TicketID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, T_Number As String, DishNameArabic As String, ItemStatus As String) As Integer
            If TicketID.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = TicketID.Value
            Else
            ...
            If Equals(T_Number, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((16))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((16))).Value = T_Number
            End If

            If Equals(DishNameArabic, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((17))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((17))).Value = DishNameArabic
            End If

            If Equals(ItemStatus, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((18))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((18))).Value = ItemStatus
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(TicketID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, T_Number As String, DishNameArabic As String, ItemStatus As String, Original_OP_ID As Integer, Original_TicketID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_T_Number As String, Original_DishNameArabic As String, Original_ItemStatus As String, OP_ID As Integer) As Integer
            If TicketID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = TicketID.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = T_Number
            End If

            If Equals(DishNameArabic, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = DishNameArabic
            End If

            If Equals(ItemStatus, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = ItemStatus
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_OP_ID
            If Original_TicketID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = Original_TicketID.Value
            Else
            ...
            If Original_Rate.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = Original_Rate.Value
            Else
            ...
            If Original_Quantity.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = Original_Quantity.Value
            Else
            ...
            If Original_Amount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((27))).Value = Original_Amount.Value
            Else
            ...
            If Original_VATPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((29))).Value = Original_VATPer.Value
            Else
            ...
            If Original_VATAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((31))).Value = Original_VATAmount.Value
            Else
            ...
            If Original_STPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((33))).Value = Original_STPer.Value
            Else
            ...
            If Original_STAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((35))).Value = Original_STAmount.Value
            Else
            ...
            If Original_SCPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((37))).Value = Original_SCPer.Value
            Else
            ...
            If Original_SCAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((39))).Value = Original_SCAmount.Value
            Else
            ...
            If Original_DiscountPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((41))).Value = Original_DiscountPer.Value
            Else
            ...
            If Original_DiscountAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((43))).Value = Original_DiscountAmount.Value
            Else
            ...
            If Original_TotalAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((45))).Value = Original_TotalAmount.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((47))).Value = Original_Category
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((49))).Value = Original_T_Number
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((51))).Value = Original_DishNameArabic
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((53))).Value = Original_ItemStatus
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((54))).Value = OP_ID
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(TicketID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, T_Number As String, DishNameArabic As String, ItemStatus As String, Original_OP_ID As Integer, Original_TicketID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_T_Number As String, Original_DishNameArabic As String, Original_ItemStatus As String) As Integer
            Return Me.Update(TicketID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, T_Number, DishNameArabic, ItemStatus, Original_OP_ID, Original_TicketID, Original_Rate, Original_Quantity, Original_Amount, Original_VATPer, Original_VATAmount, Original_STPer, Original_STAmount, Original_SCPer, Original_SCAmount, Original_DiscountPer, Original_DiscountAmount, Original_TotalAmount, Original_Category, Original_T_Number, Original_DishNameArabic, Original_ItemStatus, Original_OP_ID)
        End Function
    End Class
End Namespace
