...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RestaurantPOS_BillingInfoHDTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoHDTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AmtReceived", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AmtReceived", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AmtReceived", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "AmtReceived", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_BillingInfoHD] ([Id], [BillNo], [ODN], [BillDate], [Operator], [SubTotal], [HDDiscountPer], [HDDiscountAmt], [HomeDeliveryCharges], [GrandTotal], [CustomerName], [Address], [ContactNo], [Employee_ID], [PaymentMode], [BillNote], [Member_ID], [HD_Status], [GiftCardID], [GiftCardAmount], [LP], [LA], [TaxType], [Tip], [AmtReceived]) VALUES (@Id, @BillNo, @ODN, @BillDate, @Operator, @SubTotal, @HDDiscountPer, @HDDiscountAmt, @HomeDeliveryCharges, @GrandTotal, @CustomerName, @Address, @ContactNo, @Employee_ID, @PaymentMode, @BillNote, @Member_ID, @HD_Status, @GiftCardID, @GiftCardAmount, @LP, @LA, @TaxType, @Tip, @AmtReceived);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ODN, BillDate, Operator, SubTotal, HDDiscountPer, HDDiscountAmt, HomeDeliveryCharges, GrandTotal, CustomerName, Address, ContactNo, Employee_ID, PaymentMode, BillNote, Member_ID, HD_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Tip, AmtReceived FROM RestaurantPOS_BillingInfoHD WHERE (Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AmtReceived", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "AmtReceived", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_BillingInfoHD] SET [Id] = @Id, [BillNo] = @BillNo, [ODN] = @ODN, [BillDate] = @BillDate, [Operator] = @Operator, [SubTotal] = @SubTotal, [HDDiscountPer] = @HDDiscountPer, [HDDiscountAmt] = @HDDiscountAmt, [HomeDeliveryCharges] = @HomeDeliveryCharges, [GrandTotal] = @GrandTotal, [CustomerName] = @CustomerName, [Address] = @Address, [ContactNo] = @ContactNo, [Employee_ID] = @Employee_ID, [PaymentMode] = @PaymentMode, [BillNote] = @BillNote, [Member_ID] = @Member_ID, [HD_Status] = @HD_Status, [GiftCardID] = @GiftCardID, [GiftCardAmount] = @GiftCardAmount, [LP] = @LP, [LA] = @LA, [TaxType] = @TaxType, [Tip] = @Tip, [AmtReceived] = @AmtReceived WHERE (([Id] = @Original_Id) AND ([BillNo] = @Original_BillNo) AND ((@IsNull_ODN = 1 AND [ODN] IS NULL) OR ([ODN] = @Original_ODN)) AND ((@IsNull_BillDate = 1 AND [BillDate] IS NULL) OR ([BillDate] = @Original_BillDate)) AND ((@IsNull_Operator = 1 AND [Operator] IS NULL) OR ([Operator] = @Original_Operator)) AND ((@IsNull_SubTotal = 1 AND [SubTotal] IS NULL) OR ([SubTotal] = @Original_SubTotal)) AND ((@IsNull_HDDiscountPer = 1 AND [HDDiscountPer] IS NULL) OR ([HDDiscountPer] = @Original_HDDiscountPer)) AND ((@IsNull_HDDiscountAmt = 1 AND [HDDiscountAmt] IS NULL) OR ([HDDiscountAmt] = @Original_HDDiscountAmt)) AND ((@IsNull_HomeDeliveryCharges = 1 AND [HomeDeliveryCharges] IS NULL) OR ([HomeDeliveryCharges] = @Original_HomeDeliveryCharges)) AND ((@IsNull_GrandTotal = 1 AND [GrandTotal] IS NULL) OR ([GrandTotal] = @Original_GrandTotal)) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ([Employee_ID] = @Original_Employee_ID) AND ([PaymentMode] = @Original_PaymentMode) AND ((@IsNull_Member_ID = 1 AND [Member_ID] IS NULL) OR ([Member_ID] = @Original_Member_ID)) AND ((@IsNull_HD_Status = 1 AND [HD_Status] IS NULL) OR ([HD_Status] = @Original_HD_Status)) AND ((@IsNull_GiftCardID = 1 AND [GiftCardID] IS NULL) OR ([GiftCardID] = @Original_GiftCardID)) AND ((@IsNull_GiftCardAmount = 1 AND [GiftCardAmount] IS NULL) OR ([GiftCardAmount] = @Original_GiftCardAmount)) AND ((@IsNull_LP = 1 AND [LP] IS NULL) OR ([LP] = @Original_LP)) AND ((@IsNull_LA = 1 AND [LA] IS NULL) OR ([LA] = @Original_LA)) AND ((@IsNull_TaxType = 1 AND [TaxType] IS NULL) OR ([TaxType] = @Original_TaxType)) AND ((@IsNull_Tip = 1 AND [Tip] IS NULL) OR ([Tip] = @Original_Tip)) AND ((@IsNull_AmtReceived = 1 AND [AmtReceived] IS NULL) OR ([AmtReceived] = @Original_AmtReceived)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ODN, BillDate, Operator, SubTotal, HDDiscountPer, HDDiscountAmt, HomeDeliveryCharges, GrandTotal, CustomerName, Address, ContactNo, Employee_ID, PaymentMode, BillNote, Member_ID, HD_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Tip, AmtReceived FROM RestaurantPOS_BillingInfoHD WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AmtReceived", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "AmtReceived", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AmtReceived", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AmtReceived", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AmtReceived", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "AmtReceived", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, BillNo, ODN, BillDate, Operator, SubTotal, HDDiscountPer, HDDiscountAmt, HomeDeliveryCharges, GrandTotal, CustomerName, Address, ContactNo, Employee_ID, PaymentMode, BillNote, Member_ID, HD_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Tip, AmtReceived FROM dbo.RestaurantPOS_BillingInfoHD"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoHDDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoHDDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_BillingInfoHDDataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoHDDataTable = New RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoHDDataTable()
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoHDDataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime?, Original_Operator As String, Original_SubTotal As Decimal?, Original_HDDiscountPer As Decimal?, Original_HDDiscountAmt As Decimal?, Original_HomeDeliveryCharges As Decimal?, Original_GrandTotal As Decimal?, Original_CustomerName As String, Original_Address As String, Original_ContactNo As String, Original_Employee_ID As Integer, Original_PaymentMode As String, Original_Member_ID As String, Original_HD_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Tip As Decimal?, Original_AmtReceived As Decimal?) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((31))).Value = Original_GiftCardID
            End If

            If Original_GiftCardAmount.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((33))).Value = Original_GiftCardAmount.Value
            Else
            ...
            If Original_LP.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((35))).Value = Original_LP.Value
            Else
            ...
            If Original_LA.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((37))).Value = Original_LA.Value
            Else
            ...
            If Equals(Original_TaxType, Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(CInt((38))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((39))).Value = System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((38))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((39))).Value = Original_TaxType
            End If

            If Original_Tip.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((40))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((41))).Value = Original_Tip.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((40))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((41))).Value = System.DBNull.Value
            End If

            If Original_AmtReceived.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((42))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((43))).Value = Original_AmtReceived.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(CInt((42))).Value = 1
                Me.Adapter.DeleteCommand.Parameters(CInt((43))).Value = System.DBNull.Value
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(Id As Integer, BillNo As String, ODN As String, BillDate As System.DateTime?, _Operator As String, SubTotal As Decimal?, HDDiscountPer As Decimal?, HDDiscountAmt As Decimal?, HomeDeliveryCharges As Decimal?, GrandTotal As Decimal?, CustomerName As String, Address As String, ContactNo As String, Employee_ID As Integer, PaymentMode As String, BillNote As String, Member_ID As String, HD_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Tip As Decimal?, AmtReceived As Decimal?) As Integer
            ...
            If Tip.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((23))).Value = Tip.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((23))).Value = System.DBNull.Value
            End If

            If AmtReceived.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((24))).Value = AmtReceived.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Id As Integer, BillNo As String, ODN As String, BillDate As System.DateTime?, _Operator As String, SubTotal As Decimal?, HDDiscountPer As Decimal?, HDDiscountAmt As Decimal?, HomeDeliveryCharges As Decimal?, GrandTotal As Decimal?, CustomerName As String, Address As String, ContactNo As String, Employee_ID As Integer, PaymentMode As String, BillNote As String, Member_ID As String, HD_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Tip As Decimal?, AmtReceived As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime?, Original_Operator As String, Original_SubTotal As Decimal?, Original_HDDiscountPer As Decimal?, Original_HDDiscountAmt As Decimal?, Original_HomeDeliveryCharges As Decimal?, Original_GrandTotal As Decimal?, Original_CustomerName As String, Original_Address As String, Original_ContactNo As String, Original_Employee_ID As Integer, Original_PaymentMode As String, Original_Member_ID As String, Original_HD_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Tip As Decimal?, Original_AmtReceived As Decimal?) As Integer
            ...
            If Tip.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = Tip.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = System.DBNull.Value
            End If

            If AmtReceived.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = AmtReceived.Value
            Else
            ...
            If Original_SubTotal.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((34))).Value = Original_SubTotal.Value
            Else
            ...
            If Original_HDDiscountPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((36))).Value = Original_HDDiscountPer.Value
            Else
            ...
            If Original_HDDiscountAmt.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((38))).Value = Original_HDDiscountAmt.Value
            Else
            ...
            If Original_HomeDeliveryCharges.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((40))).Value = Original_HomeDeliveryCharges.Value
            Else
            ...
            If Original_GrandTotal.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((42))).Value = Original_GrandTotal.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((44))).Value = Original_CustomerName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((46))).Value = Original_Address
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((48))).Value = Original_ContactNo
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((49))).Value = Original_Employee_ID
            If Equals(Original_PaymentMode, Nothing) Then
                Throw New System.ArgumentNullException("Original_PaymentMode")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((50))).Value = Original_PaymentMode
            If Equals(Original_Member_ID, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((52))).Value = Original_Member_ID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((54))).Value = Original_HD_Status
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((56))).Value = Original_GiftCardID
            End If

            If Original_GiftCardAmount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((57))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((58))).Value = Original_GiftCardAmount.Value
            Else
            ...
            If Original_LP.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((60))).Value = Original_LP.Value
            Else
            ...
            If Original_LA.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((61))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((62))).Value = Original_LA.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((61))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((62))).Value = System.DBNull.Value
            End If

            If Equals(Original_TaxType, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((63))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((64))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((63))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((64))).Value = Original_TaxType
            End If

            If Original_Tip.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((65))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((66))).Value = Original_Tip.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((65))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((66))).Value = System.DBNull.Value
            End If

            If Original_AmtReceived.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((67))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((68))).Value = Original_AmtReceived.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((67))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((68))).Value = System.DBNull.Value
            End If
        ...
        Public Overridable Function Update(BillNo As String, ODN As String, BillDate As System.DateTime?, _Operator As String, SubTotal As Decimal?, HDDiscountPer As Decimal?, HDDiscountAmt As Decimal?, HomeDeliveryCharges As Decimal?, GrandTotal As Decimal?, CustomerName As String, Address As String, ContactNo As String, Employee_ID As Integer, PaymentMode As String, BillNote As String, Member_ID As String, HD_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Tip As Decimal?, AmtReceived As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime?, Original_Operator As String, Original_SubTotal As Decimal?, Original_HDDiscountPer As Decimal?, Original_HDDiscountAmt As Decimal?, Original_HomeDeliveryCharges As Decimal?, Original_GrandTotal As Decimal?, Original_CustomerName As String, Original_Address As String, Original_ContactNo As String, Original_Employee_ID As Integer, Original_PaymentMode As String, Original_Member_ID As String, Original_HD_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Tip As Decimal?, Original_AmtReceived As Decimal?) As Integer
            Return Me.Update(Original_Id, BillNo, ODN, BillDate, _Operator, SubTotal, HDDiscountPer, HDDiscountAmt, HomeDeliveryCharges, GrandTotal, CustomerName, Address, ContactNo, Employee_ID, PaymentMode, BillNote, Member_ID, HD_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Tip, AmtReceived, Original_Id, Original_BillNo, Original_ODN, Original_BillDate, Original_Operator, Original_SubTotal, Original_HDDiscountPer, Original_HDDiscountAmt, Original_HomeDeliveryCharges, Original_GrandTotal, Original_CustomerName, Original_Address, Original_ContactNo, Original_Employee_ID, Original_PaymentMode, Original_Member_ID, Original_HD_Status, Original_GiftCardID, Original_GiftCardAmount, Original_LP, Original_LA, Original_TaxType, Original_Tip, Original_AmtReceived)
        End Function
    End Class
End Namespace
