...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class Stock_StoreTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Stock_StoreTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Stock_Store"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Stock_Store] WHERE (([St_ID] = @Original_St_ID) AND ([Date] = @Original_Date) AND ([Remarks] = @Original_Remarks))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Stock_Store] ([St_ID], [Date], [Remarks]) VALUES (@St_ID, @Date, @Remarks);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT St_ID, Date, Remarks FROM Stock_Store WHERE (St_ID = @St_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Stock_Store] SET [St_ID] = @St_ID, [Date] = @Date, [Remarks] = @Remarks WHERE (([St_ID] = @Original_St_ID) AND ([Date] = @Original_Date) AND ([Remarks] = @Original_Remarks));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT St_ID, Date, Remarks FROM Stock_Store WHERE (St_ID = @St_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT St_ID, Date, Remarks FROM dbo.Stock_Store"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Stock_StoreDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.Stock_StoreDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim stock_StoreDataTable As RestaurantPOS14.RPOS_DBDataSet1.Stock_StoreDataTable = New RestaurantPOS14.RPOS_DBDataSet1.Stock_StoreDataTable()
            Me.Adapter.Fill(stock_StoreDataTable)
            Return stock_StoreDataTable
        End Function

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Stock_StoreDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "Stock_Store")
        End Function
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_St_ID As Integer, Original_Date As System.DateTime, Original_Remarks As String) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_Remarks
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(St_ID As Integer, _Date As System.DateTime, Remarks As String) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = St_ID
            Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = _Date
            If Equals(Remarks, Nothing) Then
                Throw New System.ArgumentNullException("Remarks")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = Remarks
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(St_ID As Integer, _Date As System.DateTime, Remarks As String, Original_St_ID As Integer, Original_Date As System.DateTime, Original_Remarks As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = St_ID
            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = _Date
            If Equals(Remarks, Nothing) Then
                Throw New System.ArgumentNullException("Remarks")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Remarks
            Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = Original_St_ID
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_Date
            If Equals(Original_Remarks, Nothing) Then
                Throw New System.ArgumentNullException("Original_Remarks")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Original_Remarks
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(_Date As System.DateTime, Remarks As String, Original_St_ID As Integer, Original_Date As System.DateTime, Original_Remarks As String) As Integer
            Return Me.Update(Original_St_ID, _Date, Remarks, Original_St_ID, Original_Date, Original_Remarks)
        End Function
    End Class
End Namespace
