...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class PaymentTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PaymentTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_TransactionID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TransactionID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SupplierID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SupplierID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Remarks", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Remarks", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PaymentModeDetails", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PaymentModeDetails", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Payment] ([T_ID], [TransactionID], [Date], [PaymentMode], [SupplierID], [Amount], [Remarks], [PaymentModeDetails]) VALUES (@T_ID, @TransactionID, @Date, @PaymentMode, @SupplierID, @Amount, @Remarks, @PaymentModeDetails);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, TransactionID, Date, PaymentMode, SupplierID, Amount, Remarks, PaymentModeDetails FROM Payment WHERE (T_ID = @T_ID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TransactionID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SupplierID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SupplierID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PaymentModeDetails", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Payment] SET [T_ID] = @T_ID, [TransactionID] = @TransactionID, [Date] = @Date, [PaymentMode] = @PaymentMode, [SupplierID] = @SupplierID, [Amount] = @Amount, [Remarks] = @Remarks, [PaymentModeDetails] = @PaymentModeDetails WHERE (([T_ID] = @Original_T_ID) AND ((@IsNull_TransactionID = 1 AND [TransactionID] IS NULL) OR ([TransactionID] = @Original_TransactionID)) AND ([Date] = @Original_Date) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ([SupplierID] = @Original_SupplierID) AND ([Amount] = @Original_Amount) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)) AND ((@IsNull_PaymentModeDetails = 1 AND [PaymentModeDetails] IS NULL) OR ([PaymentModeDetails] = @Original_PaymentModeDetails)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT T_ID, TransactionID, Date, PaymentMode, SupplierID, Amount, Remarks, PaymentModeDetails FROM Payment WHERE (T_ID = @T_ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TransactionID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SupplierID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SupplierID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PaymentModeDetails", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_TransactionID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TransactionID", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "TransactionID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SupplierID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SupplierID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Remarks", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Remarks", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PaymentModeDetails", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PaymentModeDetails", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PaymentModeDetails", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT T_ID, TransactionID, Date, PaymentMode, SupplierID, Amount, Remarks, PaymentModeDetails FROM dbo.Payment"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PaymentDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.PaymentDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim paymentDataTable As RestaurantPOS14.RPOS_DBDataSet1.PaymentDataTable = New RestaurantPOS14.RPOS_DBDataSet1.PaymentDataTable()
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PaymentDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_SupplierID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_T_ID
            If Equals(Original_TransactionID, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_TransactionID
            End If
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_SupplierID
            Me.Adapter.DeleteCommand.Parameters(CInt((7))).Value = Original_Amount
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((9))).Value = Original_Remarks
            End If

            If Equals(Original_PaymentModeDetails, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((11))).Value = Original_PaymentModeDetails
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(T_ID As Integer, TransactionID As String, _Date As System.DateTime, PaymentMode As String, SupplierID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = T_ID
            If Equals(TransactionID, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = TransactionID
            End If
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = SupplierID
            Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = Amount
            If Equals(Remarks, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = Remarks
            End If

            If Equals(PaymentModeDetails, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((7))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((7))).Value = PaymentModeDetails
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(T_ID As Integer, TransactionID As String, _Date As System.DateTime, PaymentMode As String, SupplierID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String, Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_SupplierID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = TransactionID
            End If
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = SupplierID
            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Amount
            If Equals(Remarks, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Remarks
            End If

            If Equals(PaymentModeDetails, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = PaymentModeDetails
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_T_ID
            If Equals(Original_TransactionID, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_TransactionID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_PaymentMode
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_SupplierID
            Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_Amount
            If Equals(Original_Remarks, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_Remarks
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_PaymentModeDetails
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(TransactionID As String, _Date As System.DateTime, PaymentMode As String, SupplierID As Integer, Amount As Decimal, Remarks As String, PaymentModeDetails As String, Original_T_ID As Integer, Original_TransactionID As String, Original_Date As System.DateTime, Original_PaymentMode As String, Original_SupplierID As Integer, Original_Amount As Decimal, Original_Remarks As String, Original_PaymentModeDetails As String) As Integer
