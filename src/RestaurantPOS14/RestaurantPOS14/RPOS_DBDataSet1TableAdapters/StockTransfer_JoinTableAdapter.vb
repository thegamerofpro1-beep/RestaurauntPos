...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class StockTransfer_JoinTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransfer_JoinTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "StockTransfer_Join"
            dataTableMapping.ColumnMappings.Add("STJ_ID", "STJ_ID")
            dataTableMapping.ColumnMappings.Add("StockTransferID", "StockTransferID")
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[StockTransfer_Join] WHERE (([STJ_ID] = @Original_STJ_ID) AND ([StockTransferID] = @Original_StockTransferID) AND ([Warehouse] = @Original_Warehouse) AND ([ProductID] = @Original_ProductID) AND ((@IsNull_ExpiryDate = 1 AND [ExpiryDate] IS NULL) OR ([ExpiryDate] = @Original_ExpiryDate)) AND ([Qty] = @Original_Qty))"
            Me._adapter.DeleteCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_STJ_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "STJ_ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_StockTransferID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "StockTransferID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[StockTransfer_Join] ([StockTransferID], [Warehouse], [ProductID], [ExpiryDate], [Qty]) VALUES (@StockTransferID, @Warehouse, @ProductID, @ExpiryDate, @Qty);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT STJ_ID, StockTransferID, Warehouse, ProductID, ExpiryDate, Qty FROM StockTransfer_Join WHERE (STJ_ID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@StockTransferID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "StockTransferID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[StockTransfer_Join] SET [StockTransferID] = @StockTransferID, [Warehouse] = @Warehouse, [ProductID] = @ProductID, [ExpiryDate] = @ExpiryDate, [Qty] = @Qty WHERE (([STJ_ID] = @Original_STJ_ID) AND ([StockTransferID] = @Original_StockTransferID) AND ([Warehouse] = @Original_Warehouse) AND ([ProductID] = @Original_ProductID) AND ((@IsNull_ExpiryDate = 1 AND [ExpiryDate] IS NULL) OR ([ExpiryDate] = @Original_ExpiryDate)) AND ([Qty] = @Original_Qty));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT STJ_ID, StockTransferID, Warehouse, ProductID, ExpiryDate, Qty FROM StockTransfer_Join WHERE (STJ_ID = @STJ_ID)"
            Me._adapter.UpdateCommand.CommandType = System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@StockTransferID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "StockTransferID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_STJ_ID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "STJ_ID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_StockTransferID", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "StockTransferID", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@STJ_ID", System.Data.SqlDbType.Int, 4, System.Data.ParameterDirection.Input, 0, 0, "STJ_ID", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT STJ_ID, StockTransferID, Warehouse, ProductID, ExpiryDate, Qty FROM dbo.StockTransfer_Join"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransfer_JoinDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.StockTransfer_JoinDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim stockTransfer_JoinDataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransfer_JoinDataTable = New RestaurantPOS14.RPOS_DBDataSet1.StockTransfer_JoinDataTable()
            Me.Adapter.Fill(stockTransfer_JoinDataTable)
            Return stockTransfer_JoinDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransfer_JoinDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "StockTransfer_Join")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_STJ_ID As Integer, Original_StockTransferID As Integer, Original_Warehouse As String, Original_ProductID As Integer, Original_ExpiryDate As String, Original_Qty As Decimal) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_STJ_ID
            Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = Original_StockTransferID
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((3))).Value = Original_ProductID
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((5))).Value = Original_ExpiryDate
            End If

            Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_Qty
        ...
        Public Overridable Function Insert(StockTransferID As Integer, Warehouse As String, ProductID As Integer, ExpiryDate As String, Qty As Decimal) As Integer
            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = StockTransferID
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = ProductID
            If Equals(ExpiryDate, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = ExpiryDate
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = Qty
        ...
        Public Overridable Function Update(StockTransferID As Integer, Warehouse As String, ProductID As Integer, ExpiryDate As String, Qty As Decimal, Original_STJ_ID As Integer, Original_StockTransferID As Integer, Original_Warehouse As String, Original_ProductID As Integer, Original_ExpiryDate As String, Original_Qty As Decimal, STJ_ID As Integer) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = StockTransferID
            If Equals(Warehouse, Nothing) Then
                Throw New System.ArgumentNullException("Warehouse")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Warehouse
            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = ProductID
            If Equals(ExpiryDate, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = ExpiryDate
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Qty
            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Original_STJ_ID
            Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_StockTransferID
            If Equals(Original_Warehouse, Nothing) Then
                Throw New System.ArgumentNullException("Original_Warehouse")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = Original_Warehouse
            Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_ProductID
            If Equals(Original_ExpiryDate, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_ExpiryDate
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_Qty
            Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = STJ_ID
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(StockTransferID As Integer, Warehouse As String, ProductID As Integer, ExpiryDate As String, Qty As Decimal, Original_STJ_ID As Integer, Original_StockTransferID As Integer, Original_Warehouse As String, Original_ProductID As Integer, Original_ExpiryDate As String, Original_Qty As Decimal) As Integer
            Return Me.Update(StockTransferID, Warehouse, ProductID, ExpiryDate, Qty, Original_STJ_ID, Original_StockTransferID, Original_Warehouse, Original_ProductID, Original_ExpiryDate, Original_Qty, Original_STJ_ID)
        End Function
    End Class
End Namespace
