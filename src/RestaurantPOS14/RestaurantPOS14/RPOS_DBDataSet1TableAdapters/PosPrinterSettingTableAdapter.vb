...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class PosPrinterSettingTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.PosPrinterSettingTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.ColumnMappings.Add("SMII", "SMII")
            dataTableMapping.ColumnMappings.Add("CCD", "CCD")
            dataTableMapping.ColumnMappings.Add("FilePath", "FilePath")
            dataTableMapping.ColumnMappings.Add("PT", "PT")
            dataTableMapping.ColumnMappings.Add("PTipAddress", "PTipAddress")
            dataTableMapping.ColumnMappings.Add("PTPortNo", "PTPortNo")
            dataTableMapping.ColumnMappings.Add("WS", "WS")
            dataTableMapping.ColumnMappings.Add("WSPortNo", "WSPortNo")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PosPrinterSetting] WHERE (([Id] = @Original_Id) AND ((@IsNull_TillID = 1 AND [TillID] IS NULL) OR ([TillID] = @Original_TillID)) AND ((@IsNull_PrinterName = 1 AND [PrinterName] IS NULL) OR ([PrinterName] = @Original_PrinterName)) AND ((@IsNull_IsEnabled = 1 AND [IsEnabled] IS NULL) OR ([IsEnabled] = @Original_IsEnabled)) AND ((@IsNull_CashDrawer = 1 AND [CashDrawer] IS NULL) OR ([CashDrawer] = @Original_CashDrawer)) AND ((@IsNull_CustomerDisplay = 1 AND [CustomerDisplay] IS NULL) OR ([CustomerDisplay] = @Original_CustomerDisplay)) AND ((@IsNull_CDPort = 1 AND [CDPort] IS NULL) OR ([CDPort] = @Original_CDPort)) AND ((@IsNull_CallerID = 1 AND [CallerID] IS NULL) OR ([CallerID] = @Original_CallerID)) AND ((@IsNull_CallerIDPort = 1 AND [CallerIDPort] IS NULL) OR ([CallerIDPort] = @Original_CallerIDPort)) AND ((@IsNull_SMII = 1 AND [SMII] IS NULL) OR ([SMII] = @Original_SMII)) AND ((@IsNull_CCD = 1 AND [CCD] IS NULL) OR ([CCD] = @Original_CCD)) AND ((@IsNull_PT = 1 AND [PT] IS NULL) OR ([PT] = @Original_PT)) AND ((@IsNull_PTipAddress = 1 AND [PTipAddress] IS NULL) OR ([PTipAddress] = @Original_PTipAddress)) AND ((@IsNull_PTPortNo = 1 AND [PTPortNo] IS NULL) OR ([PTPortNo] = @Original_PTPortNo)) AND ((@IsNull_WS = 1 AND [WS] IS NULL) OR ([WS] = @Original_WS)) AND ((@IsNull_WSPortNo = 1 AND [WSPortNo] IS NULL) OR ([WSPortNo] = @Original_WSPortNo)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_SMII", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SMII", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CCD", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CCD", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PT", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PT", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PTipAddress", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PTipAddress", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PTPortNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PTPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_WS", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_WS", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_WSPortNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_WSPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[PosPrinterSetting] ([TillID], [PrinterName], [IsEnabled], [CashDrawer], [CustomerDisplay], [CDPort], [CallerID], [CallerIDPort], [SMII], [CCD], [FilePath], [PT], [PTipAddress], [PTPortNo], [WS], [WSPortNo]) VALUES (@TillID, @PrinterName, @IsEnabled, @CashDrawer, @CustomerDisplay, @CDPort, @CallerID, @CallerIDPort, @SMII, @CCD, @FilePath, @PT, @PTipAddress, @PTPortNo, @WS, @WSPortNo);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, TillID, PrinterName, IsEnabled, CashDrawer, CustomerDisplay, CDPort, CallerID, CallerIDPort, SMII, CCD, FilePath, PT, PTipAddress, PTPortNo, WS, WSPortNo FROM PosPrinterSetting WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SMII", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CCD", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@FilePath", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FilePath", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PT", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PTipAddress", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PTPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@WS", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@WSPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[PosPrinterSetting] SET [TillID] = @TillID, [PrinterName] = @PrinterName, [IsEnabled] = @IsEnabled, [CashDrawer] = @CashDrawer, [CustomerDisplay] = @CustomerDisplay, [CDPort] = @CDPort, [CallerID] = @CallerID, [CallerIDPort] = @CallerIDPort, [SMII] = @SMII, [CCD] = @CCD, [FilePath] = @FilePath, [PT] = @PT, [PTipAddress] = @PTipAddress, [PTPortNo] = @PTPortNo, [WS] = @WS, [WSPortNo] = @WSPortNo WHERE (([Id] = @Original_Id) AND ((@IsNull_TillID = 1 AND [TillID] IS NULL) OR ([TillID] = @Original_TillID)) AND ((@IsNull_PrinterName = 1 AND [PrinterName] IS NULL) OR ([PrinterName] = @Original_PrinterName)) AND ((@IsNull_IsEnabled = 1 AND [IsEnabled] IS NULL) OR ([IsEnabled] = @Original_IsEnabled)) AND ((@IsNull_CashDrawer = 1 AND [CashDrawer] IS NULL) OR ([CashDrawer] = @Original_CashDrawer)) AND ((@IsNull_CustomerDisplay = 1 AND [CustomerDisplay] IS NULL) OR ([CustomerDisplay] = @Original_CustomerDisplay)) AND ((@IsNull_CDPort = 1 AND [CDPort] IS NULL) OR ([CDPort] = @Original_CDPort)) AND ((@IsNull_CallerID = 1 AND [CallerID] IS NULL) OR ([CallerID] = @Original_CallerID)) AND ((@IsNull_CallerIDPort = 1 AND [CallerIDPort] IS NULL) OR ([CallerIDPort] = @Original_CallerIDPort)) AND ((@IsNull_SMII = 1 AND [SMII] IS NULL) OR ([SMII] = @Original_SMII)) AND ((@IsNull_CCD = 1 AND [CCD] IS NULL) OR ([CCD] = @Original_CCD)) AND ((@IsNull_PT = 1 AND [PT] IS NULL) OR ([PT] = @Original_PT)) AND ((@IsNull_PTipAddress = 1 AND [PTipAddress] IS NULL) OR ([PTipAddress] = @Original_PTipAddress)) AND ((@IsNull_PTPortNo = 1 AND [PTPortNo] IS NULL) OR ([PTPortNo] = @Original_PTPortNo)) AND ((@IsNull_WS = 1 AND [WS] IS NULL) OR ([WS] = @Original_WS)) AND ((@IsNull_WSPortNo = 1 AND [WSPortNo] IS NULL) OR ([WSPortNo] = @Original_WSPortNo)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, TillID, PrinterName, IsEnabled, CashDrawer, CustomerDisplay, CDPort, CallerID, CallerIDPort, SMII, CCD, FilePath, PT, PTipAddress, PTPortNo, WS, WSPortNo FROM PosPrinterSetting WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SMII", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CCD", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@FilePath", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "FilePath", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PT", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PTipAddress", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PTPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@WS", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@WSPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_SMII", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SMII", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SMII", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CCD", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CCD", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CCD", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PT", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PT", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PT", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PTipAddress", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PTipAddress", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTipAddress", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PTPortNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PTPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PTPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_WS", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_WS", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WS", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_WSPortNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_WSPortNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "WSPortNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, TillID, PrinterName, IsEnabled, CashDrawer, CustomerDisplay, CDPort, CallerID, CallerIDPort, SMII, CCD, FilePath, PT, PTipAddress, PTPortNo, WS, WSPortNo FROM dbo.PosPrinterSetting"
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PosPrinterSettingDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.PosPrinterSettingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim posPrinterSettingDataTable As RestaurantPOS14.RPOS_DBDataSet1.PosPrinterSettingDataTable = New RestaurantPOS14.RPOS_DBDataSet1.PosPrinterSettingDataTable()
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.PosPrinterSettingDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_Id As Integer, Original_TillID As String, Original_PrinterName As String, Original_IsEnabled As String, Original_CashDrawer As String, Original_CustomerDisplay As String, Original_CDPort As String, Original_CallerID As String, Original_CallerIDPort As String, Original_SMII As String, Original_CCD As String, Original_PT As String, Original_PTipAddress As String, Original_PTPortNo As String, Original_WS As String, Original_WSPortNo As String) As Integer
            ...
            If Equals(Original_SMII, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((18))).Value = Original_SMII
            End If

            If Equals(Original_CCD, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((20))).Value = Original_CCD
            End If

            If Equals(Original_PT, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((22))).Value = Original_PT
            End If

            If Equals(Original_PTipAddress, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((24))).Value = Original_PTipAddress
            End If

            If Equals(Original_PTPortNo, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((26))).Value = Original_PTPortNo
            End If

            If Equals(Original_WS, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((28))).Value = Original_WS
            End If

            If Equals(Original_WSPortNo, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((30))).Value = Original_WSPortNo
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(TillID As String, PrinterName As String, IsEnabled As String, CashDrawer As String, CustomerDisplay As String, CDPort As String, CallerID As String, CallerIDPort As String, SMII As String, CCD As String, FilePath As String, PT As String, PTipAddress As String, PTPortNo As String, WS As String, WSPortNo As String) As Integer
            ...
            If Equals(SMII, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((8))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((8))).Value = SMII
            End If

            If Equals(CCD, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((9))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((9))).Value = CCD
            End If

            If Equals(FilePath, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((10))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((10))).Value = FilePath
            End If

            If Equals(PT, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((11))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((11))).Value = PT
            End If

            If Equals(PTipAddress, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((12))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((12))).Value = PTipAddress
            End If

            If Equals(PTPortNo, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((13))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((13))).Value = PTPortNo
            End If

            If Equals(WS, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((14))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((14))).Value = WS
            End If

            If Equals(WSPortNo, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((15))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((15))).Value = WSPortNo
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(TillID As String, PrinterName As String, IsEnabled As String, CashDrawer As String, CustomerDisplay As String, CDPort As String, CallerID As String, CallerIDPort As String, SMII As String, CCD As String, FilePath As String, PT As String, PTipAddress As String, PTPortNo As String, WS As String, WSPortNo As String, Original_Id As Integer, Original_TillID As String, Original_PrinterName As String, Original_IsEnabled As String, Original_CashDrawer As String, Original_CustomerDisplay As String, Original_CDPort As String, Original_CallerID As String, Original_CallerIDPort As String, Original_SMII As String, Original_CCD As String, Original_PT As String, Original_PTipAddress As String, Original_PTPortNo As String, Original_WS As String, Original_WSPortNo As String, Id As Integer) As Integer
            If Equals(TillID, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = Original_TillID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = Original_PrinterName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = Original_IsEnabled
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = Original_CashDrawer
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = Original_CustomerDisplay
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Original_CDPort
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((30))).Value = Original_CallerID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((32))).Value = Original_CallerIDPort
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((34))).Value = Original_SMII
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((36))).Value = Original_CCD
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((38))).Value = Original_PT
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((40))).Value = Original_PTipAddress
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((42))).Value = Original_PTPortNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((44))).Value = Original_WS
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((46))).Value = Original_WSPortNo
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(TillID As String, PrinterName As String, IsEnabled As String, CashDrawer As String, CustomerDisplay As String, CDPort As String, CallerID As String, CallerIDPort As String, SMII As String, CCD As String, FilePath As String, PT As String, PTipAddress As String, PTPortNo As String, WS As String, WSPortNo As String, Original_Id As Integer, Original_TillID As String, Original_PrinterName As String, Original_IsEnabled As String, Original_CashDrawer As String, Original_CustomerDisplay As String, Original_CDPort As String, Original_CallerID As String, Original_CallerIDPort As String, Original_SMII As String, Original_CCD As String, Original_PT As String, Original_PTipAddress As String, Original_PTPortNo As String, Original_WS As String, Original_WSPortNo As String) As Integer
            Return Me.Update(TillID, PrinterName, IsEnabled, CashDrawer, CustomerDisplay, CDPort, CallerID, CallerIDPort, SMII, CCD, FilePath, PT, PTipAddress, PTPortNo, WS, WSPortNo, Original_Id, Original_TillID, Original_PrinterName, Original_IsEnabled, Original_CashDrawer, Original_CustomerDisplay, Original_CDPort, Original_CallerID, Original_CallerIDPort, Original_SMII, Original_CCD, Original_PT, Original_PTipAddress, Original_PTPortNo, Original_WS, Original_WSPortNo, Original_Id)
        End Function
    End Class
End Namespace
