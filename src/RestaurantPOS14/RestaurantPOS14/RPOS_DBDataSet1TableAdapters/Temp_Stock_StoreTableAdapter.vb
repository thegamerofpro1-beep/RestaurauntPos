...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class Temp_Stock_StoreTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_StoreTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Temp_Stock_Store"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Temp_Stock_Store] WHERE (([Id] = @Original_Id) AND ([Dish] = @Original_Dish) AND ([Qty] = @Original_Qty))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Temp_Stock_Store] ([Dish], [Qty]) VALUES (@Dish, @Qty);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Dish, Qty FROM Temp_Stock_Store WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Temp_Stock_Store] SET [Dish] = @Dish, [Qty] = @Qty WHERE (([Id] = @Original_Id) AND ([Dish] = @Original_Dish) AND ([Qty] = @Original_Qty));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, Dish, Qty FROM Temp_Stock_Store WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, Dish, Qty FROM dbo.Temp_Stock_Store"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_StoreDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_StoreDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim temp_Stock_StoreDataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_StoreDataTable = New RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_StoreDataTable()
            Me.Adapter.Fill(temp_Stock_StoreDataTable)
            Return temp_Stock_StoreDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_StoreDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "Temp_Stock_Store")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_Id As Integer, Original_Dish As String, Original_Qty As Decimal) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = Original_Dish
            Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_Qty
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(Dish As String, Qty As Decimal) As Integer
            ...
            Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = Qty
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(Dish As String, Qty As Decimal, Original_Id As Integer, Original_Dish As String, Original_Qty As Decimal, Id As Integer) As Integer
            If Equals(Dish, Nothing) Then
                Throw New System.ArgumentNullException("Dish")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Dish
            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Qty
            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Original_Id
            If Equals(Original_Dish, Nothing) Then
                Throw New System.ArgumentNullException("Original_Dish")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = Original_Dish
            Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_Qty
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(Dish As String, Qty As Decimal, Original_Id As Integer, Original_Dish As String, Original_Qty As Decimal) As Integer
            Return Me.Update(Dish, Qty, Original_Id, Original_Dish, Original_Qty, Original_Id)
        End Function
    End Class
End Namespace
