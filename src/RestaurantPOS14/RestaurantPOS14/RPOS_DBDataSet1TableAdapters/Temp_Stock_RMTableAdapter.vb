...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class Temp_Stock_RMTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.Temp_Stock_RMTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "Temp_Stock_RM"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Temp_Stock_RM] WHERE (([Id] = @Original_Id) AND ([ProductID] = @Original_ProductID) AND ([Qty] = @Original_Qty))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Temp_Stock_RM] ([ProductID], [Qty]) VALUES (@ProductID, @Qty);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, ProductID, Qty FROM Temp_Stock_RM WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Temp_Stock_RM] SET [ProductID] = @ProductID, [Qty] = @Qty WHERE (([Id] = @Original_Id) AND ([ProductID] = @Original_ProductID) AND ([Qty] = @Original_Qty));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, ProductID, Qty FROM Temp_Stock_RM WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, ProductID, Qty FROM dbo.Temp_Stock_RM"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_RMDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_RMDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim temp_Stock_RMDataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_RMDataTable = New RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_RMDataTable()
            Me.Adapter.Fill(temp_Stock_RMDataTable)
            Return temp_Stock_RMDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.Temp_Stock_RMDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "Temp_Stock_RM")
        End Function
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_Id As Integer, Original_ProductID As Integer, Original_Qty As Decimal) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(ProductID As Integer, Qty As Decimal) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(ProductID As Integer, Qty As Decimal, Original_Id As Integer, Original_ProductID As Integer, Original_Qty As Decimal, Id As Integer) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = Original_ProductID
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(ProductID As Integer, Qty As Decimal, Original_Id As Integer, Original_ProductID As Integer, Original_Qty As Decimal) As Integer
            Return Me.Update(ProductID, Qty, Original_Id, Original_ProductID, Original_Qty, Original_Id)
        End Function
    End Class
End Namespace
