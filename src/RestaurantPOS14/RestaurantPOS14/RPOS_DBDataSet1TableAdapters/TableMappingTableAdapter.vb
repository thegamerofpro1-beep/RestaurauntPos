...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class TableMappingTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableMappingTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "TableMapping"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TableMapping] WHERE (([Id] = @Original_Id) AND ((@IsNull_TableNo = 1 AND [TableNo] IS NULL) OR ([TableNo] = @Original_TableNo)) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TableMapping] ([TableNo], [UserID]) VALUES (@TableNo, @UserID);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, TableNo, UserID FROM TableMapping WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TableMapping] SET [TableNo] = @TableNo, [UserID] = @UserID WHERE (([Id] = @Original_Id) AND ((@IsNull_TableNo = 1 AND [TableNo] IS NULL) OR ([TableNo] = @Original_TableNo)) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, TableNo, UserID FROM TableMapping WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, TableNo, UserID FROM dbo.TableMapping"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TableMappingDataTable) As Integer
        ...
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.TableMappingDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim tableMappingDataTable As RestaurantPOS14.RPOS_DBDataSet1.TableMappingDataTable = New RestaurantPOS14.RPOS_DBDataSet1.TableMappingDataTable()
            Me.Adapter.Fill(tableMappingDataTable)
            Return tableMappingDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TableMappingDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "TableMapping")
        End Function
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_Id As Integer, Original_TableNo As String, Original_UserID As String) As Integer
        ...
        Public Overridable Function Insert(TableNo As String, UserID As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = UserID
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(TableNo As String, UserID As String, Original_Id As Integer, Original_TableNo As String, Original_UserID As String, Id As Integer) As Integer
            If Equals(TableNo, Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = UserID
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = Original_TableNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_UserID
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(TableNo As String, UserID As String, Original_Id As Integer, Original_TableNo As String, Original_UserID As String) As Integer
            Return Me.Update(TableNo, UserID, Original_Id, Original_TableNo, Original_UserID, Original_Id)
        End Function
    End Class
End Namespace
