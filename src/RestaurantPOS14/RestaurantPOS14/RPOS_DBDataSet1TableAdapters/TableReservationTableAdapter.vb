...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class TableReservationTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.TableReservationTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "TableReservation"
            ...
            dataTableMapping.ColumnMappings.Add("NoOfGuests", "NoOfGuests")
            dataTableMapping.ColumnMappings.Add("Status", "Status")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TableReservation] WHERE (([Id] = @Original_Id) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_TimeFrom = 1 AND [TimeFrom] IS NULL) OR ([TimeFrom] = @Original_TimeFrom)) AND ((@IsNull_TimeTo = 1 AND [TimeTo] IS NULL) OR ([TimeTo] = @Original_TimeTo)) AND ((@IsNull_TableNo = 1 AND [TableNo] IS NULL) OR ([TableNo] = @Original_TableNo)) AND ((@IsNull_NoOfGuests = 1 AND [NoOfGuests] IS NULL) OR ([NoOfGuests] = @Original_NoOfGuests)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Status", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TableReservation] ([Id], [CustomerName], [ContactNo], [Date], [TimeFrom], [TimeTo], [TableNo], [NoOfGuests], [Status]) VALUES (@Id, @CustomerName, @ContactNo, @Date, @TimeFrom, @TimeTo, @TableNo, @NoOfGuests, @Status);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, CustomerName, ContactNo, Date, TimeFrom, TimeTo, TableNo, NoOfGuests, Status FROM TableReservation WHERE (Id = @Id)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TableReservation] SET [Id] = @Id, [CustomerName] = @CustomerName, [ContactNo] = @ContactNo, [Date] = @Date, [TimeFrom] = @TimeFrom, [TimeTo] = @TimeTo, [TableNo] = @TableNo, [NoOfGuests] = @NoOfGuests, [Status] = @Status WHERE (([Id] = @Original_Id) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_TimeFrom = 1 AND [TimeFrom] IS NULL) OR ([TimeFrom] = @Original_TimeFrom)) AND ((@IsNull_TimeTo = 1 AND [TimeTo] IS NULL) OR ([TimeTo] = @Original_TimeTo)) AND ((@IsNull_TableNo = 1 AND [TableNo] IS NULL) OR ([TableNo] = @Original_TableNo)) AND ((@IsNull_NoOfGuests = 1 AND [NoOfGuests] IS NULL) OR ([NoOfGuests] = @Original_NoOfGuests)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, CustomerName, ContactNo, Date, TimeFrom, TimeTo, TableNo, NoOfGuests, Status FROM TableReservation WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_NoOfGuests", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "NoOfGuests", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_Status", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "Status", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, CustomerName, ContactNo, Date, TimeFrom, TimeTo, TableNo, NoOfGuests, Status FROM dbo.TableReservation"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TableReservationDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.TableReservationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim tableReservationDataTable As RestaurantPOS14.RPOS_DBDataSet1.TableReservationDataTable = New RestaurantPOS14.RPOS_DBDataSet1.TableReservationDataTable()
            Me.Adapter.Fill(tableReservationDataTable)
            Return tableReservationDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.TableReservationDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "TableReservation")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_Id As Integer, Original_CustomerName As String, Original_ContactNo As String, Original_Date As System.DateTime?, Original_TimeFrom As System.DateTime?, Original_TimeTo As System.DateTime?, Original_TableNo As String, Original_NoOfGuests As Integer?, Original_Status As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_CustomerName
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_ContactNo
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_TableNo
            End If

            If Original_NoOfGuests.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((13))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((14))).Value = Original_NoOfGuests.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((16))).Value = Original_Status
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Insert(Id As Integer, CustomerName As String, ContactNo As String, _Date As System.DateTime?, TimeFrom As System.DateTime?, TimeTo As System.DateTime?, TableNo As String, NoOfGuests As Integer?, Status As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = CustomerName
            End If

            If Equals(ContactNo, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = ContactNo
            End If
            ...
            If TimeFrom.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = TimeFrom.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((4))).Value = System.DBNull.Value
            End If

            If TimeTo.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((5))).Value = TimeTo.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((6))).Value = TableNo
            End If

            If NoOfGuests.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((7))).Value = NoOfGuests.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((8))).Value = Status
            End If
        ...
        Public Overridable Function Update(Id As Integer, CustomerName As String, ContactNo As String, _Date As System.DateTime?, TimeFrom As System.DateTime?, TimeTo As System.DateTime?, TableNo As String, NoOfGuests As Integer?, Status As String, Original_Id As Integer, Original_CustomerName As String, Original_ContactNo As String, Original_Date As System.DateTime?, Original_TimeFrom As System.DateTime?, Original_TimeTo As System.DateTime?, Original_TableNo As String, Original_NoOfGuests As Integer?, Original_Status As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Id
            If Equals(CustomerName, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = CustomerName
            End If

            If Equals(ContactNo, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = ContactNo
            End If
            ...
            If TimeFrom.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = TimeFrom.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((4))).Value = System.DBNull.Value
            End If

            If TimeTo.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = TimeTo.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = TableNo
            End If

            If NoOfGuests.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = NoOfGuests.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Status
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Original_CustomerName
            End If
            ...
            If Original_TimeFrom.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_TimeFrom.Value
            Else
            ...
            If Original_TimeTo.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_TimeTo.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = Original_TableNo
            End If

            If Original_NoOfGuests.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = Original_NoOfGuests.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = Original_Status
            End If
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(CustomerName As String, ContactNo As String, _Date As System.DateTime?, TimeFrom As System.DateTime?, TimeTo As System.DateTime?, TableNo As String, NoOfGuests As Integer?, Status As String, Original_Id As Integer, Original_CustomerName As String, Original_ContactNo As String, Original_Date As System.DateTime?, Original_TimeFrom As System.DateTime?, Original_TimeTo As System.DateTime?, Original_TableNo As String, Original_NoOfGuests As Integer?, Original_Status As String) As Integer
            Return Me.Update(Original_Id, CustomerName, ContactNo, _Date, TimeFrom, TimeTo, TableNo, NoOfGuests, Status, Original_Id, Original_CustomerName, Original_ContactNo, Original_Date, Original_TimeFrom, Original_TimeTo, Original_TableNo, Original_NoOfGuests, Original_Status)
        End Function
    End Class
End Namespace
