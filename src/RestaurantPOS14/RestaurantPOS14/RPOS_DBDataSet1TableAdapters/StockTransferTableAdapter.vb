...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class StockTransferTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.StockTransferTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "StockTransfer"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[StockTransfer] WHERE (([ST_ID] = @Original_ST_ID) AND ([Date] = @Original_Date) AND ([Kitchen] = @Original_Kitchen))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[StockTransfer] ([ST_ID], [Date], [Kitchen]) VALUES (@ST_ID, @Date, @Kitchen);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ST_ID, Date, Kitchen FROM StockTransfer WHERE (ST_ID = @ST_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[StockTransfer] SET [ST_ID] = @ST_ID, [Date] = @Date, [Kitchen] = @Kitchen WHERE (([ST_ID] = @Original_ST_ID) AND ([Date] = @Original_Date) AND ([Kitchen] = @Original_Kitchen));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ST_ID, Date, Kitchen FROM StockTransfer WHERE (ST_ID = @ST_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ST_ID, Date, Kitchen FROM dbo.StockTransfer"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransferDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.StockTransferDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim stockTransferDataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransferDataTable = New RestaurantPOS14.RPOS_DBDataSet1.StockTransferDataTable()
            Me.Adapter.Fill(stockTransferDataTable)
            Return stockTransferDataTable
        End Function

        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.StockTransferDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Delete(Original_ST_ID As Integer, Original_Date As System.DateTime, Original_Kitchen As String) As Integer
            ...
            If Equals(Original_Kitchen, Nothing) Then
                Throw New System.ArgumentNullException("Original_Kitchen")
            End If

            Me.Adapter.DeleteCommand.Parameters(CInt((2))).Value = Original_Kitchen
        ...
        Public Overridable Function Insert(ST_ID As Integer, _Date As System.DateTime, Kitchen As String) As Integer
            ...
            If Equals(Kitchen, Nothing) Then
                Throw New System.ArgumentNullException("Kitchen")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = Kitchen
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(ST_ID As Integer, _Date As System.DateTime, Kitchen As String, Original_ST_ID As Integer, Original_Date As System.DateTime, Original_Kitchen As String) As Integer
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Kitchen
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((5))).Value = Original_Kitchen
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(_Date As System.DateTime, Kitchen As String, Original_ST_ID As Integer, Original_Date As System.DateTime, Original_Kitchen As String) As Integer
            Return Me.Update(Original_ST_ID, _Date, Kitchen, Original_ST_ID, Original_Date, Original_Kitchen)
        End Function
    End Class
End Namespace
