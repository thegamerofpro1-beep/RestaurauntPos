...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class DeletedInvoices_JoinTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.DeletedInvoices_JoinTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "DeletedInvoices_Join"
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[DeletedInvoices_Join] WHERE (([Id] = @Original_Id) AND ((@IsNull_BillNo = 1 AND [BillNo] IS NULL) OR ([BillNo] = @Original_BillNo)) AND ((@IsNull_Qty = 1 AND [Qty] IS NULL) OR ([Qty] = @Original_Qty)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DeletedInvoices_Join] ([BillNo], [ItemName], [Qty], [TotalAmount]) VALUES (@BillNo, @ItemName, @Qty, @TotalAmount);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ItemName, Qty, TotalAmount FROM DeletedInvoices_Join WHERE (Id = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ItemName", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemName", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[DeletedInvoices_Join] SET [BillNo] = @BillNo, [ItemName] = @ItemName, [Qty] = @Qty, [TotalAmount] = @TotalAmount WHERE (([Id] = @Original_Id) AND ((@IsNull_BillNo = 1 AND [BillNo] IS NULL) OR ([BillNo] = @Original_BillNo)) AND ((@IsNull_Qty = 1 AND [Qty] IS NULL) OR ([Qty] = @Original_Qty)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ItemName, Qty, TotalAmount FROM DeletedInvoices_Join WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ItemName", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "ItemName", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, BillNo, ItemName, Qty, TotalAmount FROM dbo.DeletedInvoices_Join"
        ...
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.DeletedInvoices_JoinDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.DeletedInvoices_JoinDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim deletedInvoices_JoinDataTable As RestaurantPOS14.RPOS_DBDataSet1.DeletedInvoices_JoinDataTable = New RestaurantPOS14.RPOS_DBDataSet1.DeletedInvoices_JoinDataTable()
            Me.Adapter.Fill(deletedInvoices_JoinDataTable)
            Return deletedInvoices_JoinDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.DeletedInvoices_JoinDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "DeletedInvoices_Join")
        End Function
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_Id As Integer, Original_BillNo As String, Original_Qty As Decimal?, Original_TotalAmount As Decimal?) As Integer
            ...
            If Original_Qty.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((4))).Value = Original_Qty.Value
            Else
            ...
            If Original_TotalAmount.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((6))).Value = Original_TotalAmount.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(BillNo As String, ItemName As String, Qty As Decimal?, TotalAmount As Decimal?) As Integer
            ...
            If Equals(ItemName, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((1))).Value = ItemName
            End If

            If Qty.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = Qty.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            End If

            If TotalAmount.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((3))).Value = TotalAmount.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(BillNo As String, ItemName As String, Qty As Decimal?, TotalAmount As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_Qty As Decimal?, Original_TotalAmount As Decimal?, Id As Integer) As Integer
            If Equals(BillNo, Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = ItemName
            End If

            If Qty.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Qty.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = System.DBNull.Value
            End If

            If TotalAmount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = TotalAmount.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((6))).Value = Original_BillNo
            End If

            If Original_Qty.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((7))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = Original_Qty.Value
            Else
            ...
            If Original_TotalAmount.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = Original_TotalAmount.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = 1
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = System.DBNull.Value
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = Id
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(BillNo As String, ItemName As String, Qty As Decimal?, TotalAmount As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_Qty As Decimal?, Original_TotalAmount As Decimal?) As Integer
            Return Me.Update(BillNo, ItemName, Qty, TotalAmount, Original_Id, Original_BillNo, Original_Qty, Original_TotalAmount, Original_Id)
        End Function
    End Class
End Namespace
