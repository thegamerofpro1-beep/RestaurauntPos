...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RestaurantPOS_BillingInfoTATableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_BillingInfoTATableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_BillingInfoTA] ([Id], [BillNo], [ODN], [BillDate], [SubTotal], [TADiscountPer], [TADiscountAmt], [ParcelCharges], [GrandTotal], [Cash], [Change], [Operator], [PaymentMode], [BillNote], [ExchangeRate], [CurrencyCode], [Member_ID], [CustomerName], [PhoneNo], [TA_Status], [GiftCardID], [GiftCardAmount], [LP], [LA], [TaxType], [Card], [Tip]) VALUES (@Id, @BillNo, @ODN, @BillDate, @SubTotal, @TADiscountPer, @TADiscountAmt, @ParcelCharges, @GrandTotal, @Cash, @Change, @Operator, @PaymentMode, @BillNote, @ExchangeRate, @CurrencyCode, @Member_ID, @CustomerName, @PhoneNo, @TA_Status, @GiftCardID, @GiftCardAmount, @LP, @LA, @TaxType, @Card, @Tip);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ODN, BillDate, SubTotal, TADiscountPer, TADiscountAmt, ParcelCharges, GrandTotal, Cash, Change, Operator, PaymentMode, BillNote, ExchangeRate, CurrencyCode, Member_ID, CustomerName, PhoneNo, TA_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Card, Tip FROM RestaurantPOS_BillingInfoTA WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_BillingInfoTA] SET [Id] = @Id, [BillNo] = @BillNo, [ODN] = @ODN, [BillDate] = @BillDate, [SubTotal] = @SubTotal, [TADiscountPer] = @TADiscountPer, [TADiscountAmt] = @TADiscountAmt, [ParcelCharges] = @ParcelCharges, [GrandTotal] = @GrandTotal, [Cash] = @Cash, [Change] = @Change, [Operator] = @Operator, [PaymentMode] = @PaymentMode, [BillNote] = @BillNote, [ExchangeRate] = @ExchangeRate, [CurrencyCode] = @CurrencyCode, [Member_ID] = @Member_ID, [CustomerName] = @CustomerName, [PhoneNo] = @PhoneNo, [TA_Status] = @TA_Status, [GiftCardID] = @GiftCardID, [GiftCardAmount] = @GiftCardAmount, [LP] = @LP, [LA] = @LA, [TaxType] = @TaxType, [Card] = @Card, [Tip] = @Tip WHERE (([Id] = @Original_Id) AND ([BillNo] = @Original_BillNo) AND ((@IsNull_ODN = 1 AND [ODN] IS NULL) OR ([ODN] = @Original_ODN)) AND ([BillDate] = @Original_BillDate) AND ((@IsNull_SubTotal = 1 AND [SubTotal] IS NULL) OR ([SubTotal] = @Original_SubTotal)) AND ((@IsNull_TADiscountPer = 1 AND [TADiscountPer] IS NULL) OR ([TADiscountPer] = @Original_TADiscountPer)) AND ((@IsNull_TADiscountAmt = 1 AND [TADiscountAmt] IS NULL) OR ([TADiscountAmt] = @Original_TADiscountAmt)) AND ((@IsNull_ParcelCharges = 1 AND [ParcelCharges] IS NULL) OR ([ParcelCharges] = @Original_ParcelCharges)) AND ((@IsNull_GrandTotal = 1 AND [GrandTotal] IS NULL) OR ([GrandTotal] = @Original_GrandTotal)) AND ((@IsNull_Cash = 1 AND [Cash] IS NULL) OR ([Cash] = @Original_Cash)) AND ((@IsNull_Change = 1 AND [Change] IS NULL) OR ([Change] = @Original_Change)) AND ((@IsNull_Operator = 1 AND [Operator] IS NULL) OR ([Operator] = @Original_Operator)) AND ((@IsNull_PaymentMode = 1 AND [PaymentMode] IS NULL) OR ([PaymentMode] = @Original_PaymentMode)) AND ((@IsNull_ExchangeRate = 1 AND [ExchangeRate] IS NULL) OR ([ExchangeRate] = @Original_ExchangeRate)) AND ((@IsNull_CurrencyCode = 1 AND [CurrencyCode] IS NULL) OR ([CurrencyCode] = @Original_CurrencyCode)) AND ((@IsNull_Member_ID = 1 AND [Member_ID] IS NULL) OR ([Member_ID] = @Original_Member_ID)) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_PhoneNo = 1 AND [PhoneNo] IS NULL) OR ([PhoneNo] = @Original_PhoneNo)) AND ((@IsNull_TA_Status = 1 AND [TA_Status] IS NULL) OR ([TA_Status] = @Original_TA_Status)) AND ((@IsNull_GiftCardID = 1 AND [GiftCardID] IS NULL) OR ([GiftCardID] = @Original_GiftCardID)) AND ((@IsNull_GiftCardAmount = 1 AND [GiftCardAmount] IS NULL) OR ([GiftCardAmount] = @Original_GiftCardAmount)) AND ((@IsNull_LP = 1 AND [LP] IS NULL) OR ([LP] = @Original_LP)) AND ((@IsNull_LA = 1 AND [LA] IS NULL) OR ([LA] = @Original_LA)) AND ((@IsNull_TaxType = 1 AND [TaxType] IS NULL) OR ([TaxType] = @Original_TaxType)) AND ((@IsNull_Card = 1 AND [Card] IS NULL) OR ([Card] = @Original_Card)) AND ((@IsNull_Tip = 1 AND [Tip] IS NULL) OR ([Tip] = @Original_Tip)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT Id, BillNo, ODN, BillDate, SubTotal, TADiscountPer, TADiscountAmt, ParcelCharges, GrandTotal, Cash, Change, Operator, PaymentMode, BillNote, ExchangeRate, CurrencyCode, Member_ID, CustomerName, PhoneNo, TA_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Card, Tip FROM RestaurantPOS_BillingInfoTA WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT Id, BillNo, ODN, BillDate, SubTotal, TADiscountPer, TADiscountAmt, ParcelCharges, GrandTotal, Cash, Change, Operator, PaymentMode, BillNote, ExchangeRate, CurrencyCode, Member_ID, CustomerName, PhoneNo, TA_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Card, Tip FROM dbo.RestaurantPOS_BillingInfoTA"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoTADataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoTADataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_BillingInfoTADataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoTADataTable = New RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoTADataTable()
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_BillingInfoTADataTable) As Integer
        ...
        Public Overridable Function Delete(Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime, Original_SubTotal As Decimal?, Original_TADiscountPer As Decimal?, Original_TADiscountAmt As Decimal?, Original_ParcelCharges As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_CustomerName As String, Original_PhoneNo As String, Original_TA_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Card As Decimal?, Original_Tip As Decimal?) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((30))).Value = Original_CustomerName
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = Original_PhoneNo
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((34))).Value = Original_TA_Status
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((36))).Value = Original_GiftCardID
            End If

            If Original_GiftCardAmount.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((37))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((38))).Value = Original_GiftCardAmount.Value
            Else
            ...
            If Original_LP.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((40))).Value = Original_LP.Value
            Else
            ...
            If Original_LA.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((42))).Value = Original_LA.Value
            Else
            ...
            If Original_Tip.HasValue Then
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((48))).Value = Original_Tip.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(Id As Integer, BillNo As String, ODN As String, BillDate As System.DateTime, SubTotal As Decimal?, TADiscountPer As Decimal?, TADiscountAmt As Decimal?, ParcelCharges As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, BillNote As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, CustomerName As String, PhoneNo As String, TA_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Card As Decimal?, Tip As Decimal?) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((24))).Value = TaxType
            End If

            If Card.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((25))).Value = Card.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((25))).Value = System.DBNull.Value
            End If

            If Tip.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((26))).Value = Tip.Value
            Else
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Id As Integer, BillNo As String, ODN As String, BillDate As System.DateTime, SubTotal As Decimal?, TADiscountPer As Decimal?, TADiscountAmt As Decimal?, ParcelCharges As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, BillNote As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, CustomerName As String, PhoneNo As String, TA_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Card As Decimal?, Tip As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime, Original_SubTotal As Decimal?, Original_TADiscountPer As Decimal?, Original_TADiscountAmt As Decimal?, Original_ParcelCharges As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_CustomerName As String, Original_PhoneNo As String, Original_TA_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Card As Decimal?, Original_Tip As Decimal?) As Integer
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = CustomerName
            End If

            If Equals(PhoneNo, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = PhoneNo
            End If

            If Equals(TA_Status, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = TA_Status
            End If

            If Equals(GiftCardID, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = GiftCardID
            End If

            If GiftCardAmount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = GiftCardAmount.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = System.DBNull.Value
            End If

            If LP.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = LP.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((22))).Value = System.DBNull.Value
            End If

            If LA.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((23))).Value = LA.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = TaxType
            End If

            If Card.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = Card.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((25))).Value = System.DBNull.Value
            End If

            If Tip.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = Tip.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = System.DBNull.Value
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((27))).Value = Original_Id
            If Equals(Original_BillNo, Nothing) Then
                Throw New System.ArgumentNullException("Original_BillNo")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Original_BillNo
            If Equals(Original_ODN, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((30))).Value = Original_ODN
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((31))).Value = Original_BillDate
            If Original_SubTotal.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((32))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((33))).Value = Original_SubTotal.Value
            Else
            ...
            If Original_TADiscountPer.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((35))).Value = Original_TADiscountPer.Value
            Else
            ...
            If Original_TADiscountAmt.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((37))).Value = Original_TADiscountAmt.Value
            Else
            ...
            If Original_ParcelCharges.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((39))).Value = Original_ParcelCharges.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((57))).Value = Original_CustomerName
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((59))).Value = Original_PhoneNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((61))).Value = Original_TA_Status
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((63))).Value = Original_GiftCardID
            End If

            If Original_GiftCardAmount.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((64))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((65))).Value = Original_GiftCardAmount.Value
            Else
            ...
            If Original_LP.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((67))).Value = Original_LP.Value
            Else
            ...
            If Original_LA.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((69))).Value = Original_LA.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((71))).Value = Original_TaxType
            End If

            If Original_Card.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((72))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((73))).Value = Original_Card.Value
            Else
            ...
            If Original_Tip.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((75))).Value = Original_Tip.Value
            Else
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(BillNo As String, ODN As String, BillDate As System.DateTime, SubTotal As Decimal?, TADiscountPer As Decimal?, TADiscountAmt As Decimal?, ParcelCharges As Decimal?, GrandTotal As Decimal?, Cash As Decimal?, Change As Decimal?, _Operator As String, PaymentMode As String, BillNote As String, ExchangeRate As Decimal?, CurrencyCode As String, Member_ID As String, CustomerName As String, PhoneNo As String, TA_Status As String, GiftCardID As String, GiftCardAmount As Decimal?, LP As Integer?, LA As Decimal?, TaxType As String, Card As Decimal?, Tip As Decimal?, Original_Id As Integer, Original_BillNo As String, Original_ODN As String, Original_BillDate As System.DateTime, Original_SubTotal As Decimal?, Original_TADiscountPer As Decimal?, Original_TADiscountAmt As Decimal?, Original_ParcelCharges As Decimal?, Original_GrandTotal As Decimal?, Original_Cash As Decimal?, Original_Change As Decimal?, Original_Operator As String, Original_PaymentMode As String, Original_ExchangeRate As Decimal?, Original_CurrencyCode As String, Original_Member_ID As String, Original_CustomerName As String, Original_PhoneNo As String, Original_TA_Status As String, Original_GiftCardID As String, Original_GiftCardAmount As Decimal?, Original_LP As Integer?, Original_LA As Decimal?, Original_TaxType As String, Original_Card As Decimal?, Original_Tip As Decimal?) As Integer
            Return Me.Update(Original_Id, BillNo, ODN, BillDate, SubTotal, TADiscountPer, TADiscountAmt, ParcelCharges, GrandTotal, Cash, Change, _Operator, PaymentMode, BillNote, ExchangeRate, CurrencyCode, Member_ID, CustomerName, PhoneNo, TA_Status, GiftCardID, GiftCardAmount, LP, LA, TaxType, Card, Tip, Original_Id, Original_BillNo, Original_ODN, Original_BillDate, Original_SubTotal, Original_TADiscountPer, Original_TADiscountAmt, Original_ParcelCharges, Original_GrandTotal, Original_Cash, Original_Change, Original_Operator, Original_PaymentMode, Original_ExchangeRate, Original_CurrencyCode, Original_Member_ID, Original_CustomerName, Original_PhoneNo, Original_TA_Status, Original_GiftCardID, Original_GiftCardAmount, Original_LP, Original_LA, Original_TaxType, Original_Card, Original_Tip)
        End Function
    End Class
End Namespace
