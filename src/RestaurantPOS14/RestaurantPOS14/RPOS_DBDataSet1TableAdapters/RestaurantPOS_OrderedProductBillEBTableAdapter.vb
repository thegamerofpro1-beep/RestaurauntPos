...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RestaurantPOS_OrderedProductBillEBTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RestaurantPOS_OrderedProductBillEBTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "RestaurantPOS_OrderedProductBillEB"
            ...
            dataTableMapping.ColumnMappings.Add("RCost", "RCost")
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_RCost", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "RCost", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_RCost", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "RCost", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[RestaurantPOS_OrderedProductBillEB] ([BillID], [Dish], [Rate], [Quantity], [Amount], [VATPer], [VATAmount], [STPer], [STAmount], [SCPer], [SCAmount], [DiscountPer], [DiscountAmount], [TotalAmount], [Notes], [Category], [RCost], [ItemStatus], [DishNameArabic]) VALUES (@BillID, @Dish, @Rate, @Quantity, @Amount, @VATPer, @VATAmount, @STPer, @STAmount, @SCPer, @SCAmount, @DiscountPer, @DiscountAmount, @TotalAmount, @Notes, @Category, @RCost, @ItemStatus, @DishNameArabic);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, RCost, ItemStatus, DishNameArabic FROM RestaurantPOS_OrderedProductBillEB WHERE (OP_ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@RCost", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "RCost", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[RestaurantPOS_OrderedProductBillEB] SET [BillID] = @BillID, [Dish] = @Dish, [Rate] = @Rate, [Quantity] = @Quantity, [Amount] = @Amount, [VATPer] = @VATPer, [VATAmount] = @VATAmount, [STPer] = @STPer, [STAmount] = @STAmount, [SCPer] = @SCPer, [SCAmount] = @SCAmount, [DiscountPer] = @DiscountPer, [DiscountAmount] = @DiscountAmount, [TotalAmount] = @TotalAmount, [Notes] = @Notes, [Category] = @Category, [RCost] = @RCost, [ItemStatus] = @ItemStatus, [DishNameArabic] = @DishNameArabic WHERE (([OP_ID] = @Original_OP_ID) AND ((@IsNull_BillID = 1 AND [BillID] IS NULL) OR ([BillID] = @Original_BillID)) AND ((@IsNull_Rate = 1 AND [Rate] IS NULL) OR ([Rate] = @Original_Rate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_VATPer = 1 AND [VATPer] IS NULL) OR ([VATPer] = @Original_VATPer)) AND ((@IsNull_VATAmount = 1 AND [VATAmount] IS NULL) OR ([VATAmount] = @Original_VATAmount)) AND ((@IsNull_STPer = 1 AND [STPer] IS NULL) OR ([STPer] = @Original_STPer)) AND ((@IsNull_STAmount = 1 AND [STAmount] IS NULL) OR ([STAmount] = @Original_STAmount)) AND ((@IsNull_SCPer = 1 AND [SCPer] IS NULL) OR ([SCPer] = @Original_SCPer)) AND ((@IsNull_SCAmount = 1 AND [SCAmount] IS NULL) OR ([SCAmount] = @Original_SCAmount)) AND ((@IsNull_DiscountPer = 1 AND [DiscountPer] IS NULL) OR ([DiscountPer] = @Original_DiscountPer)) AND ((@IsNull_DiscountAmount = 1 AND [DiscountAmount] IS NULL) OR ([DiscountAmount] = @Original_DiscountAmount)) AND ((@IsNull_TotalAmount = 1 AND [TotalAmount] IS NULL) OR ([TotalAmount] = @Original_TotalAmount)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_RCost = 1 AND [RCost] IS NULL) OR ([RCost] = @Original_RCost)) AND ((@IsNull_ItemStatus = 1 AND [ItemStatus] IS NULL) OR ([ItemStatus] = @Original_ItemStatus)) AND ((@IsNull_DishNameArabic = 1 AND [DishNameArabic] IS NULL) OR ([DishNameArabic] = @Original_DishNameArabic)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, RCost, ItemStatus, DishNameArabic FROM RestaurantPOS_OrderedProductBillEB WHERE (OP_ID = @OP_ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@RCost", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "RCost", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_RCost", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "RCost", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_RCost", System.Data.SqlDbType.[Decimal], 0, System.Data.ParameterDirection.Input, 18, 2, "RCost", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT OP_ID, BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, RCost, ItemStatus, DishNameArabic FROM dbo.RestaurantPOS_OrderedProductBillEB"
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductBillEBDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductBillEBDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim restaurantPOS_OrderedProductBillEBDataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductBillEBDataTable = New RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductBillEBDataTable()
            Me.Adapter.Fill(restaurantPOS_OrderedProductBillEBDataTable)
            Return restaurantPOS_OrderedProductBillEBDataTable
        End Function

        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RestaurantPOS_OrderedProductBillEBDataTable) As Integer
        ...
        Public Overridable Function Update(dataSet As RestaurantPOS14.RPOS_DBDataSet1) As Integer
            Return Me.Adapter.Update(dataSet, "RestaurantPOS_OrderedProductBillEB")
        End Function
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_RCost As Decimal?, Original_ItemStatus As String, Original_DishNameArabic As String) As Integer
            ...
            If Original_RCost.HasValue Then
                Me.Adapter.DeleteCommand.Parameters(CInt((29))).Value = 0
                Me.Adapter.DeleteCommand.Parameters(CInt((30))).Value = Original_RCost.Value
            Else
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((32))).Value = Original_ItemStatus
            End If
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((34))).Value = Original_DishNameArabic
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Insert(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, RCost As Decimal?, ItemStatus As String, DishNameArabic As String) As Integer
            ...
            If RCost.HasValue Then
                Me.Adapter.InsertCommand.Parameters(CInt((16))).Value = RCost.Value
            Else
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((17))).Value = ItemStatus
            End If

            If Equals(DishNameArabic, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((18))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((18))).Value = DishNameArabic
            End If
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, RCost As Decimal?, ItemStatus As String, DishNameArabic As String, Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_RCost As Decimal?, Original_ItemStatus As String, Original_DishNameArabic As String, OP_ID As Integer) As Integer
            If BillID.HasValue Then
            ...
            If RCost.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((16))).Value = RCost.Value
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = ItemStatus
            End If

            If Equals(DishNameArabic, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((18))).Value = DishNameArabic
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_OP_ID
            If Original_BillID.HasValue Then
                Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = 0
                Me.Adapter.UpdateCommand.Parameters(CInt((21))).Value = Original_BillID.Value
            Else
            ...
            If Original_RCost.HasValue Then
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((49))).Value = Original_RCost.Value
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((51))).Value = Original_ItemStatus
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((53))).Value = Original_DishNameArabic
            End If
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        Public Overridable Function Update(BillID As Integer?, Dish As String, Rate As Decimal?, Quantity As Decimal?, Amount As Decimal?, VATPer As Decimal?, VATAmount As Decimal?, STPer As Decimal?, STAmount As Decimal?, SCPer As Decimal?, SCAmount As Decimal?, DiscountPer As Decimal?, DiscountAmount As Decimal?, TotalAmount As Decimal?, Notes As String, Category As String, RCost As Decimal?, ItemStatus As String, DishNameArabic As String, Original_OP_ID As Integer, Original_BillID As Integer?, Original_Rate As Decimal?, Original_Quantity As Decimal?, Original_Amount As Decimal?, Original_VATPer As Decimal?, Original_VATAmount As Decimal?, Original_STPer As Decimal?, Original_STAmount As Decimal?, Original_SCPer As Decimal?, Original_SCAmount As Decimal?, Original_DiscountPer As Decimal?, Original_DiscountAmount As Decimal?, Original_TotalAmount As Decimal?, Original_Category As String, Original_RCost As Decimal?, Original_ItemStatus As String, Original_DishNameArabic As String) As Integer
            Return Me.Update(BillID, Dish, Rate, Quantity, Amount, VATPer, VATAmount, STPer, STAmount, SCPer, SCAmount, DiscountPer, DiscountAmount, TotalAmount, Notes, Category, RCost, ItemStatus, DishNameArabic, Original_OP_ID, Original_BillID, Original_Rate, Original_Quantity, Original_Amount, Original_VATPer, Original_VATAmount, Original_STPer, Original_STAmount, Original_SCPer, Original_SCAmount, Original_DiscountPer, Original_DiscountAmount, Original_TotalAmount, Original_Category, Original_RCost, Original_ItemStatus, Original_DishNameArabic, Original_OP_ID)
        End Function
    End Class
End Namespace
