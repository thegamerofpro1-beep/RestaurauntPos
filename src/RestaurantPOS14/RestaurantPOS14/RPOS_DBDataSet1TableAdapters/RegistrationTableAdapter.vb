...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class RegistrationTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.RegistrationTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.ColumnMappings.Add("SSN", "SSN")
            dataTableMapping.ColumnMappings.Add("PayrollType", "PayrollType")
            dataTableMapping.ColumnMappings.Add("CardNo", "CardNo")
            dataTableMapping.ColumnMappings.Add("AutoLogout", "AutoLogout")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Registration] WHERE (([UserID] = @Original_UserID) AND ([UserType] = @Original_UserType) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_EmailID = 1 AND [EmailID] IS NULL) OR ([EmailID] = @Original_EmailID)) AND ([JoiningDate] = @Original_JoiningDate) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)) AND ((@IsNull_SSN = 1 AND [SSN] IS NULL) OR ([SSN] = @Original_SSN)) AND ((@IsNull_PayrollType = 1 AND [PayrollType] IS NULL) OR ([PayrollType] = @Original_PayrollType)) AND ((@IsNull_CardNo = 1 AND [CardNo] IS NULL) OR ([CardNo] = @Original_CardNo)) AND ((@IsNull_AutoLogout = 1 AND [AutoLogout] IS NULL) OR ([AutoLogout] = @Original_AutoLogout)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_SSN", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SSN", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PayrollType", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PayrollType", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CardNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CardNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AutoLogout", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AutoLogout", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Registration] ([UserID], [UserType], [Password], [Name], [ContactNo], [EmailID], [JoiningDate], [Active], [SSN], [PayrollType], [CardNo], [AutoLogout]) VALUES (@UserID, @UserType, @Password, @Name, @ContactNo, @EmailID, @JoiningDate, @Active, @SSN, @PayrollType, @CardNo, @AutoLogout);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT UserID, UserType, Password, Name, ContactNo, EmailID, JoiningDate, Active, SSN, PayrollType, CardNo, AutoLogout FROM Registration WHERE (UserID = @UserID)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SSN", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PayrollType", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CardNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AutoLogout", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Registration] SET [UserID] = @UserID, [UserType] = @UserType, [Password] = @Password, [Name] = @Name, [ContactNo] = @ContactNo, [EmailID] = @EmailID, [JoiningDate] = @JoiningDate, [Active] = @Active, [SSN] = @SSN, [PayrollType] = @PayrollType, [CardNo] = @CardNo, [AutoLogout] = @AutoLogout WHERE (([UserID] = @Original_UserID) AND ([UserType] = @Original_UserType) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_ContactNo)) AND ((@IsNull_EmailID = 1 AND [EmailID] IS NULL) OR ([EmailID] = @Original_EmailID)) AND ([JoiningDate] = @Original_JoiningDate) AND ((@IsNull_Active = 1 AND [Active] IS NULL) OR ([Active] = @Original_Active)) AND ((@IsNull_SSN = 1 AND [SSN] IS NULL) OR ([SSN] = @Original_SSN)) AND ((@IsNull_PayrollType = 1 AND [PayrollType] IS NULL) OR ([PayrollType] = @Original_PayrollType)) AND ((@IsNull_CardNo = 1 AND [CardNo] IS NULL) OR ([CardNo] = @Original_CardNo)) AND ((@IsNull_AutoLogout = 1 AND [AutoLogout] IS NULL) OR ([AutoLogout] = @Original_AutoLogout)));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT UserID, UserType, Password, Name, ContactNo, EmailID, JoiningDate, Active, SSN, PayrollType, CardNo, AutoLogout FROM Registration WHERE (UserID = @UserID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@SSN", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@PayrollType", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@CardNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@AutoLogout", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Current, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_SSN", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_SSN", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "SSN", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_PayrollType", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_PayrollType", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "PayrollType", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_CardNo", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_CardNo", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "CardNo", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@IsNull_AutoLogout", System.Data.SqlDbType.Int, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=True, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_AutoLogout", System.Data.SqlDbType.NChar, 0, System.Data.ParameterDirection.Input, 0, 0, "AutoLogout", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT UserID, UserType, Password, Name, ContactNo, EmailID, JoiningDate, Active, SSN, PayrollType, CardNo, AutoLogout FROM dbo.Registration"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RegistrationDataTable) As Integer
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.RegistrationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim registrationDataTable As RestaurantPOS14.RPOS_DBDataSet1.RegistrationDataTable = New RestaurantPOS14.RPOS_DBDataSet1.RegistrationDataTable()
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.RegistrationDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Delete(Original_UserID As String, Original_UserType As String, Original_Password As String, Original_Name As String, Original_ContactNo As String, Original_EmailID As String, Original_JoiningDate As System.DateTime, Original_Active As String, Original_SSN As String, Original_PayrollType As String, Original_CardNo As String, Original_AutoLogout As String) As Integer
            ...
            If Equals(Original_SSN, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((12))).Value = Original_SSN
            End If

            If Equals(Original_PayrollType, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((14))).Value = Original_PayrollType
            End If

            If Equals(Original_CardNo, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((16))).Value = Original_CardNo
            End If

            If Equals(Original_AutoLogout, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(CInt((18))).Value = Original_AutoLogout
            End If
        ...
        Public Overridable Function Insert(UserID As String, UserType As String, Password As String, Name As String, ContactNo As String, EmailID As String, JoiningDate As System.DateTime, Active As String, SSN As String, PayrollType As String, CardNo As String, AutoLogout As String) As Integer
            ...
            If Equals(SSN, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((8))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((8))).Value = SSN
            End If

            If Equals(PayrollType, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((9))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((9))).Value = PayrollType
            End If

            If Equals(CardNo, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((10))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((10))).Value = CardNo
            End If

            If Equals(AutoLogout, Nothing) Then
                Me.Adapter.InsertCommand.Parameters(CInt((11))).Value = System.DBNull.Value
            Else
                Me.Adapter.InsertCommand.Parameters(CInt((11))).Value = AutoLogout
            End If
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(UserID As String, UserType As String, Password As String, Name As String, ContactNo As String, EmailID As String, JoiningDate As System.DateTime, Active As String, SSN As String, PayrollType As String, CardNo As String, AutoLogout As String, Original_UserID As String, Original_UserType As String, Original_Password As String, Original_Name As String, Original_ContactNo As String, Original_EmailID As String, Original_JoiningDate As System.DateTime, Original_Active As String, Original_SSN As String, Original_PayrollType As String, Original_CardNo As String, Original_AutoLogout As String) As Integer
            If Equals(UserID, Nothing) Then
                Throw New System.ArgumentNullException("UserID")
            End If
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((8))).Value = SSN
            End If

            If Equals(PayrollType, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((9))).Value = PayrollType
            End If

            If Equals(CardNo, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((10))).Value = CardNo
            End If

            If Equals(AutoLogout, Nothing) Then
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = System.DBNull.Value
            Else
                Me.Adapter.UpdateCommand.Parameters(CInt((11))).Value = AutoLogout
            End If
            ...
            Me.Adapter.UpdateCommand.Parameters(CInt((12))).Value = Original_UserID
            If Equals(Original_UserType, Nothing) Then
                Throw New System.ArgumentNullException("Original_UserType")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((13))).Value = Original_UserType
            If Equals(Original_Password, Nothing) Then
                Throw New System.ArgumentNullException("Original_Password")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((14))).Value = Original_Password
            If Equals(Original_Name, Nothing) Then
                Throw New System.ArgumentNullException("Original_Name")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((15))).Value = Original_Name
            If Equals(Original_ContactNo, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((17))).Value = Original_ContactNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((19))).Value = Original_EmailID
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((20))).Value = Original_JoiningDate
            If Equals(Original_Active, Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((24))).Value = Original_SSN
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((26))).Value = Original_PayrollType
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((28))).Value = Original_CardNo
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(CInt((30))).Value = Original_AutoLogout
            End If
        ...
        Public Overridable Function Update(UserType As String, Password As String, Name As String, ContactNo As String, EmailID As String, JoiningDate As System.DateTime, Active As String, SSN As String, PayrollType As String, CardNo As String, AutoLogout As String, Original_UserID As String, Original_UserType As String, Original_Password As String, Original_Name As String, Original_ContactNo As String, Original_EmailID As String, Original_JoiningDate As System.DateTime, Original_Active As String, Original_SSN As String, Original_PayrollType As String, Original_CardNo As String, Original_AutoLogout As String) As Integer
            Return Me.Update(Original_UserID, UserType, Password, Name, ContactNo, EmailID, JoiningDate, Active, SSN, PayrollType, CardNo, AutoLogout, Original_UserID, Original_UserType, Original_Password, Original_Name, Original_ContactNo, Original_EmailID, Original_JoiningDate, Original_Active, Original_SSN, Original_PayrollType, Original_CardNo, Original_AutoLogout)
        End Function
    End Class
End Namespace
