...
Namespace RestaurantPOS14.RPOS_DBDataSet1TableAdapters
    ...
    Public Class NotesMasterTableAdapter
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList
                If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Count = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList(num) = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.RemoveRange(num, RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Count - num)
                    RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Capacity = RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Count
                End If

                Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.RPOS_DBDataSet1TableAdapters.NotesMasterTableAdapter.__ENCAddToList(Me)
        ...
        Private Sub InitAdapter()
            ...
            dataTableMapping.DataSetTable = "NotesMaster"
            dataTableMapping.ColumnMappings.Add("ID", "ID")
            dataTableMapping.ColumnMappings.Add("Notes", "Notes")
            Me._adapter.TableMappings.Add(dataTableMapping)
            Me._adapter.DeleteCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NotesMaster] WHERE (([ID] = @Original_ID) AND ([Notes] = @Original_Notes))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Notes", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Notes", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NotesMaster] ([Notes]) VALUES (@Notes);" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, Notes FROM NotesMaster WHERE (ID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[NotesMaster] SET [Notes] = @Notes WHERE (([ID] = @Original_ID) AND ([Notes] = @Original_Notes));" & Global.Microsoft.VisualBasic.Constants.vbCrLf & "SELECT ID, Notes FROM NotesMaster WHERE (ID = @ID)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Notes", System.Data.SqlDbType.NVarChar, 0, System.Data.ParameterDirection.Input, 0, 0, "Notes", System.Data.DataRowVersion.Original, sourceColumnNullMapping:=False, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(CInt((0))).CommandText = "SELECT ID, Notes FROM dbo.NotesMaster"
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function Fill(dataTable As RestaurantPOS14.RPOS_DBDataSet1.NotesMasterDataTable) As Integer
        ...
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Overridable Function GetData() As RestaurantPOS14.RPOS_DBDataSet1.NotesMasterDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim notesMasterDataTable As RestaurantPOS14.RPOS_DBDataSet1.NotesMasterDataTable = New RestaurantPOS14.RPOS_DBDataSet1.NotesMasterDataTable()
            Me.Adapter.Fill(notesMasterDataTable)
            Return notesMasterDataTable
        End Function

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(dataTable As RestaurantPOS14.RPOS_DBDataSet1.NotesMasterDataTable) As Integer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Delete(Original_ID As Integer, Original_Notes As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(CInt((0))).Value = Original_ID
            If Equals(Original_Notes, Nothing) Then
                Throw New System.ArgumentNullException("Original_Notes")
            End If

            Me.Adapter.DeleteCommand.Parameters(CInt((1))).Value = Original_Notes
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Insert(Notes As String) As Integer
            If Equals(Notes, Nothing) Then
                Throw New System.ArgumentNullException("Notes")
            End If

            Me.Adapter.InsertCommand.Parameters(CInt((0))).Value = Notes
        ...
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
        Public Overridable Function Update(Notes As String, Original_ID As Integer, Original_Notes As String, ID As Integer) As Integer
            If Equals(Notes, Nothing) Then
                Throw New System.ArgumentNullException("Notes")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((0))).Value = Notes
            Me.Adapter.UpdateCommand.Parameters(CInt((1))).Value = Original_ID
            If Equals(Original_Notes, Nothing) Then
                Throw New System.ArgumentNullException("Original_Notes")
            End If

            Me.Adapter.UpdateCommand.Parameters(CInt((2))).Value = Original_Notes
            Me.Adapter.UpdateCommand.Parameters(CInt((3))).Value = ID
        ...
        <System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Update, True)>
        <System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
        Public Overridable Function Update(Notes As String, Original_ID As Integer, Original_Notes As String) As Integer
            Return Me.Update(Notes, Original_ID, Original_Notes, Original_ID)
        End Function
    End Class
End Namespace
