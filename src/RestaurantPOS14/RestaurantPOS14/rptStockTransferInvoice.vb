...
Namespace RestaurantPOS14
    ...
    Public Class rptStockTransferInvoice
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptStockTransferInvoice.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptStockTransferInvoice.__ENCList
                If RestaurantPOS14.rptStockTransferInvoice.__ENCList.Count = RestaurantPOS14.rptStockTransferInvoice.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptStockTransferInvoice.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptStockTransferInvoice.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptStockTransferInvoice.__ENCList(num) = RestaurantPOS14.rptStockTransferInvoice.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptStockTransferInvoice.__ENCList.RemoveRange(num, RestaurantPOS14.rptStockTransferInvoice.__ENCList.Count - num)
                    RestaurantPOS14.rptStockTransferInvoice.__ENCList.Capacity = RestaurantPOS14.rptStockTransferInvoice.__ENCList.Count
                End If

                Call RestaurantPOS14.rptStockTransferInvoice.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.rptStockTransferInvoice.__ENCAddToList(Me)
        End Sub
    End Class
End Namespace
