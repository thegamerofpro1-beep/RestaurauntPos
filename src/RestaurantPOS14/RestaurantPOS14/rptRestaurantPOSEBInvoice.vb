...
Namespace RestaurantPOS14
    Public Class rptRestaurantPOSEBInvoice
        ...
        Public Overrides Property FullResourceName As String
            Get
                Return "RestaurantPOS14.rptRestaurantPOSEBInvoice.rpt"
            End Get
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList
                If RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Count = RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList(num) = RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.RemoveRange(num, RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Count - num)
                    RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Capacity = RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Count
                End If

                Call RestaurantPOS14.rptRestaurantPOSEBInvoice.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
