...
Namespace RestaurantPOS14
    ...
    Public Class frmPOSReport_CRViewer
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmPOSReport_CRViewer.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmPOSReport_CRViewer.__ENCList
                If RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Count = RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If num4 > num5 Then
                            Exit While
                        End If
                        If RestaurantPOS14.frmPOSReport_CRViewer.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmPOSReport_CRViewer.__ENCList(num) = RestaurantPOS14.frmPOSReport_CRViewer.__ENCList(num3)
                            End If
                            num += 1
                        End If
                        num3 += 1
                    End While
                    Call RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.RemoveRange(num, RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Count - num)
                    RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Capacity = RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Count
                End If
                Call RestaurantPOS14.frmPOSReport_CRViewer.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnPrint_Click(sender As Object, e As System.EventArgs)
            Dim textObject As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text As String = Nothing, textObject2 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text2 As String = Nothing, textObject3 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text3 As String = Nothing, textObject4 As CrystalDecisions.CrystalReports.Engine.TextObject = Nothing, text4 As String = Nothing
            Try
                MyBase.Cursor = System.Windows.Forms.Cursors.WaitCursor
                Me.Timer1.Enabled = True
                ...
                For Each section3 As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.ReportDefinition.Sections
                    For Each reportObject3 As CrystalDecisions.CrystalReports.Engine.ReportObject In section3.ReportObjects
                        ...
                        text3 = If(textObject3 Is Nothing, Nothing, textObject3.Text)
                        If textObject3 IsNot Nothing AndAlso text3 IsNot Nothing AndAlso text3.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                            textObject3.Text = text3.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                        End If
                    Next
                Next
                For j As Integer = 0 To rptRPOS3.Subreports.Count - 1
                    For Each section4 As CrystalDecisions.CrystalReports.Engine.Section In rptRPOS3.Subreports(CInt((j))).ReportDefinition.Sections
                        For Each reportObject4 As CrystalDecisions.CrystalReports.Engine.ReportObject In section4.ReportObjects
                            ...
                            text4 = If(textObject4 Is Nothing, Nothing, textObject4.Text)
                            If textObject4 IsNot Nothing AndAlso text4 IsNot Nothing AndAlso text4.IndexOf("VAT", System.StringComparison.OrdinalIgnoreCase) >= 0 Then
                                textObject4.Text = text4.Replace(CStr(("VAT%")), CStr(("service charge"))).Replace(CStr(("VAT :")), CStr(("service charge"))).Replace("VAT", "service charge")
                            End If
                        Next
                    Next
                Next
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmPOSReport_CRViewer))
            ...
            location = New System.Drawing.Point(720, 12)
            ...
            location = New System.Drawing.Point(742, 22)
            ...
            MyBase.Name = "frmPOSReport_CRViewer"
            Me.Text = "POS Report"
