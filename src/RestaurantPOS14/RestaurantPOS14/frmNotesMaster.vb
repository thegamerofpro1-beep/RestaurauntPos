...
Namespace RestaurantPOS14
    ...
    Public Class frmNotesMaster
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmNotesMaster.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmNotesMaster.__ENCList
                If RestaurantPOS14.frmNotesMaster.__ENCList.Count = RestaurantPOS14.frmNotesMaster.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmNotesMaster.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmNotesMaster.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmNotesMaster.__ENCList(num) = RestaurantPOS14.frmNotesMaster.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmNotesMaster.__ENCList.RemoveRange(num, RestaurantPOS14.frmNotesMaster.__ENCList.Count - num)
                    RestaurantPOS14.frmNotesMaster.__ENCList.Capacity = RestaurantPOS14.frmNotesMaster.__ENCList.Count
                End If

                Call RestaurantPOS14.frmNotesMaster.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.txtNotes.Text)) = 0 Then
                Call System.Windows.Forms.MessageBox.Show("Please enter notes", "", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation)
                Me.txtNotes.Focus()
                Return
            End If
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("select Notes from NotesMaster where Notes=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtNotes.Text)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                If RestaurantPOS14.ModClasses.rdr.Read() Then
                    Call System.Windows.Forms.MessageBox.Show("Notes Already Exists", "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
                    Me.txtNotes.Text = ""
                    Me.txtNotes.Focus()
                ...
                Else
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into NotesMaster(Notes) VALUES (@d1)")
                    RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                    RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtNotes.Text)
                    RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                    RestaurantPOS14.ModClasses.con.Close()
                    Dim st As String = "added the new Notes '" & Me.txtNotes.Text & "'"
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from NotesMaster where ID=" & RestaurantPOS14.Security.SqlInput.RequireInteger(Me.txtID.Text, "Record ID"))
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the Notes '" & Me.txtNotes.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update NotesMaster set Notes=@d1 where ID=" & RestaurantPOS14.Security.SqlInput.RequireInteger(Me.txtID.Text, "Record ID"))
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtNotes.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "updated the Notes '" & Me.txtNotes.Text & "' details"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT ID,RTRIM(Notes) from NotesMaster order by Notes", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtNotes.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmNotesMaster))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(298, 508)
            panel2.Size = size
            ...
            size = New System.Drawing.Size(190, 217)
            ...
            location = New System.Drawing.Point(199, 47)
            ...
            location = New System.Drawing.Point(217, 3)
            button9.Location = location
            Me.btnClose.Name = "btnClose"
            Dim button10 As System.Windows.Forms.Button = Me.btnClose
            size = New System.Drawing.Size(75, 42)
            button10.Size = size
            ...
            Me.dgw.Columns.AddRange(Me.Column2, Me.Column1)
            Me.dgw.Cursor = System.Windows.Forms.Cursors.Hand
            Me.dgw.EnableHeadersVisualStyles = False
            Me.dgw.GridColor = System.Drawing.Color.White
            Dim dataGridView As System.Windows.Forms.DataGridView = Me.dgw
            location = New System.Drawing.Point(3, 263)
            ...
            size = New System.Drawing.Size(289, 235)
            ...
            size = New System.Drawing.Size(210, 31)
            panel4.Size = size
            ...
            location = New System.Drawing.Point(54, 4)
            ...
            location = New System.Drawing.Point(26, 8)
            ...
            size = New System.Drawing.Size(305, 513)
