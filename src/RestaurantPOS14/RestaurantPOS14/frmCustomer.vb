...
Namespace RestaurantPOS14
    ...
    Public Class frmCustomer
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmCustomer.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCustomer.__ENCList
                If RestaurantPOS14.frmCustomer.__ENCList.Count = RestaurantPOS14.frmCustomer.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCustomer.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCustomer.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCustomer.__ENCList(num) = RestaurantPOS14.frmCustomer.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCustomer.__ENCList.RemoveRange(num, RestaurantPOS14.frmCustomer.__ENCList.Count - num)
                    RestaurantPOS14.frmCustomer.__ENCList.Capacity = RestaurantPOS14.frmCustomer.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCustomer.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtCustomerName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtAddress.Text)
                ...
                Dim st As String = "added the new Customer '" & Me.txtCustomerName.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                Call System.Windows.Forms.MessageBox.Show("Successfully saved", "Customer", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk)
                Me.Reset()
        ...
        Private Sub DeleteRecord()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from HDCustomer where ID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                ...
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "deleted the Customer '" & Me.txtCustomerName.Text & "'"
                    RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("update HDCustomer set CustomerName=@d1,Address=@d2,ContactNo=@d3 where ID=" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtID.Text)))
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtCustomerName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtAddress.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.txtContactNo.Text)
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "updated the Customer '" & Me.txtCustomerName.Text & "' details"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
                Call System.Windows.Forms.MessageBox.Show("Successfully updated", "Customer Info", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Asterisk)
                Me.Reset()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT  ID, RTRIM(CustomerName),RTRIM(Address),RTRIM(ContactNo) from HDCustomer order by CustomerName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmCustomer_Load(sender As Object, e As System.EventArgs)
            Me.Getdata()
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    Me.txtContactNo.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    Me.txtAddress.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Home Delivery") Then
                        Me.btnDelete.Enabled = True
                    Else
                        Me.btnDelete.Enabled = False
                    End If

                    If RestaurantPOS14.ModFunc.IsUpdateAllowed(Me.lblUser.Text, "Home Delivery") Then
        ...
        Private Sub btnExportExcel_Click(sender As Object, e As System.EventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmCustomersExportImport.Reset()
            Call RestaurantPOS14.My.MyProject.Forms.frmCustomersExportImport.ShowDialog()
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT  ID, RTRIM(CustomerName),RTRIM(Address),RTRIM(ContactNo) from HDCustomer Where CustomerName like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByCustomer.Text) & "%' order by CustomerName", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT  ID, RTRIM(CustomerName),RTRIM(Address),RTRIM(ContactNo) from HDCustomer Where ContactNo like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtSearchByContactNo.Text) & "%' order by CustomerName", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmCustomer))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(612, 696)
            panel2.Size = size
            ...
            location = New System.Drawing.Point(7, 239)
            groupBox.Location = location
            Me.GroupBox4.Name = "GroupBox4"
            Dim groupBox2 As System.Windows.Forms.GroupBox = Me.GroupBox4
            size = New System.Drawing.Size(275, 68)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(197, 22)
            ...
            Me.txtSearchByContactNo.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            location = New System.Drawing.Point(4, 165)
            groupBox3.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox4 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(278, 68)
            groupBox4.Size = size
            ...
            Me.txtSearchByCustomer.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            location = New System.Drawing.Point(431, 242)
            button5.Location = location
            Me.btnExportExcel.Name = "btnExportExcel"
            Dim button6 As System.Windows.Forms.Button = Me.btnExportExcel
            size = New System.Drawing.Size(173, 81)
            button6.Size = size
            ...
            location = New System.Drawing.Point(476, 43)
            ...
            size = New System.Drawing.Size(464, 118)
            groupBox8.Size = size
            Me.GroupBox1.TabIndex = 0
            Me.GroupBox1.TabStop = False
            Me.GroupBox1.Text = "Customer Info :"
            Me.txtContactNo.BackColor = System.Drawing.Color.White
            Me.txtContactNo.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            ...
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtAddress
            location = New System.Drawing.Point(119, 52)
            textBox7.Location = location
            Me.txtAddress.Name = "txtAddress"
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtAddress
            ...
            Me.txtCustomerName.Font = New System.Drawing.Font("Segoe UI Semibold", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, 0)
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtCustomerName
            location = New System.Drawing.Point(119, 22)
            textBox9.Location = location
            Me.txtCustomerName.Name = "txtCustomerName"
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtCustomerName
            size = New System.Drawing.Size(206, 23)
            textBox10.Size = size
            ...
            location = New System.Drawing.Point(528, 4)
            ...
            Me.dgw.Columns.AddRange(Me.Column7, Me.Column1, Me.Column6, Me.Column2)
            ...
            location = New System.Drawing.Point(4, 329)
            ...
            size = New System.Drawing.Size(600, 357)
            ...
            size = New System.Drawing.Size(518, 31)
            panel4.Size = size
            ...
            size = New System.Drawing.Size(621, 703)
