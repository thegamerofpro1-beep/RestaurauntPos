...
Namespace RestaurantPOS14
    ...
    Public Class frmRestaurantPOSTARecord_Unpaid
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList
                If RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Count = RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList(num) = RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.RemoveRange(num, RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Count - num)
                    RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Capacity = RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Reset()
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where (DATEDIFF(d,BillDate,GetDate())= 0) and TA_Status in ('Unpaid','Prepared') Order by BillDate Desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where (DATEDIFF(d,BillDate,GetDate())= 0) and TA_Status in ('Unpaid','Prepared') and Operator=@d4 order by BillDate desc")
            End If
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.txtColoredCustomerDisplay.Text, "Yes", TextCompare:=False) = 0 Then
                    RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                    RestaurantPOS14.ModClasses.con.Open()
                    RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),RTRIM(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer), RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount),RTRIM(Notes),RTRIM(Category) from RestaurantPOS_BillingInfoTA,RestaurantPOS_OrderedProductBillTA where RestaurantPOS_BillingInfoTA.Id=RestaurantPOS_OrderedProductBillTA.BillID and RestaurantPOS_BillingInfoTA.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by op_id")), RestaurantPOS14.ModClasses.con)
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnSendOrder.Text = "Update Order"
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnUpdateTA.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlTA.Visible = False
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnSettleTA.Enabled = True
                Dim point As System.Drawing.Point = New System.Drawing.Point(CInt(System.Math.Round(CDbl(MyBase.ClientSize.Width) / 2.0 - CDbl(RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlTA.Size.Width) / 2.0)), CInt(System.Math.Round(CDbl(MyBase.ClientSize.Height) / 2.0 - CDbl(RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlEB.Size.Height) / 2.0)))
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlTA.Location = point
                p = point
                RestaurantPOS14.My.MyProject.Forms.frmPOS.pnlTA.Anchor = System.Windows.Forms.AnchorStyles.None
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnPizza2.Enabled = True
                RestaurantPOS14.My.MyProject.Forms.frmPOS.btnOpenFoods2.Enabled = True
                MyBase.Close()
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where  BillDate >=@d1 and BillDate < @d2 and TA_Status in ('Unpaid','Prepared') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where  BillDate >=@d1 and BillDate < @d2 and TA_Status in ('Unpaid','Prepared') and Operator=@d4 order by BillDate")
            End If
        End Sub

        Private Sub cmbBillNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where BillNo=@d3 and TA_Status in ('Unpaid','Prepared') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where BillNo=@d3 and TA_Status in ('Unpaid','Prepared') and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub btnViewReport_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where TA_Status in ('Unpaid','Prepared') Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoTA.Id), RTRIM(BillNo),BillDate,TADiscountPer,TADiscountAmt,SubTotal,ParcelCharges,(RestaurantPOS_BillingInfoTA.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(PhoneNo),RTRIM(TA_Status),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),Card,IsNULL(Tip,0) from RestaurantPOS_BillingInfoTA where TA_Status in ('Unpaid','Prepared') and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoTA where TA_Status in ('Unpaid','Prepared') order by 1")
            Else
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoTA where TA_Status in ('Unpaid','Prepared') and Operator=@d1 order by 1")
            End If
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRestaurantPOSTARecord_Unpaid))
            ...
            location = New System.Drawing.Point(504, 173)
            ...
            location = New System.Drawing.Point(369, 174)
            ...
            Me.Label1.Text = "List of Today's Unpaid Restaurant POS Bills(Takeaway)"
            ...
            location = New System.Drawing.Point(257, 173)
            ...
            size = New System.Drawing.Size(689, 109)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(129, 1)
            ...
            location = New System.Drawing.Point(290, 29)
            ...
            size = New System.Drawing.Size(266, 33)
            ...
            location = New System.Drawing.Point(563, 32)
            ...
            location = New System.Drawing.Point(703, 40)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(274, 109)
            groupBox6.Size = size
            ...
            location = New System.Drawing.Point(164, 50)
            ...
            size = New System.Drawing.Size(142, 33)
            comboBox2.Size = size
            ...
            MyBase.Name = "frmRestaurantPOSTARecord_Unpaid"
