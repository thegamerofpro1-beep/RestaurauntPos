    ...
    Public Class frmStockIn_StoreRecord
        ...
        Friend Overridable Property txtItemName As System.Windows.Forms.TextBox
            ...
            Set(value As System.Windows.Forms.TextBox)
                Dim value2 As System.EventHandler = AddressOf Me.txtItemName_TextChanged
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmStockIn_StoreRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockIn_StoreRecord.__ENCList
                If RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Count = RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockIn_StoreRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockIn_StoreRecord.__ENCList(num) = RestaurantPOS14.frmStockIn_StoreRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Capacity = RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockIn_StoreRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub GetData()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Dish),RTRIM(Category),Qty,DIRate * Qty from temp_stock_Store,Dish where Temp_Stock_Store.Dish=Dish.DishName and Qty > 0 order by Dish", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(Microsoft.VisualBasic.CompilerServices.NewLateBinding.LateGet(Nothing, GetType(System.Math), "Round", New Object(1) {System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), 2}, Nothing, Nothing, Nothing)))
                End While
        ...
        Private Sub txtItemName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                Call System.Data.SqlClient.SqlConnection.ClearAllPools()
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Select RTRIM(Dish),RTRIM(Category),Qty,DIRate * Qty from temp_stock_Store,Dish where Temp_Stock_Store.Dish=Dish.DishName and Qty > 0 and Dish like N'%" & Me.txtItemName.Text & "%' order by Dish", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockIn_StoreRecord))
            ...
            Me.Label1.Text = "Available Items Record(Store)"
            ...
            Me.dgw.Columns.AddRange(Me.Column2, Me.Column3, Me.Column5, Me.Column1)
            ...
            Me.Column1.HeaderText = "Total Stock Value"
            ...
            MyBase.Name = "frmStockIn_StoreRecord"
