    ...
    Public Class frmRestaurantPOSKOTFinalBillRecord
        ...
        Friend Overridable Property dgw As System.Windows.Forms.DataGridView
            ...
            Set(value As System.Windows.Forms.DataGridView)
                Dim value2 As System.Windows.Forms.DataGridViewCellMouseEventHandler = AddressOf Me.dgw_RowHeaderMouseClick
                ...
                If Me._dgw IsNot Nothing Then
                    RemoveHandler Me._dgw.RowHeaderMouseClick, value2
                    RemoveHandler Me._dgw.RowPostPaint, value3
                End If

                Me._dgw = value
                If Me._dgw IsNot Nothing Then
                    AddHandler Me._dgw.RowHeaderMouseClick, value2
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList
                If RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Count = RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList(num) = RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Capacity = RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Reset()
            ...
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where (DATEDIFF(d,BillDate,GetDate())= 0)  Order by BillDate Desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where (DATEDIFF(d,BillDate,GetDate())= 0) and Operator=@d4 order by BillDate desc")
            End If
        End Sub
        ...
        Private Sub dgw_RowHeaderMouseClick(sender As Object, e As System.Windows.Forms.DataGridViewCellMouseEventArgs)
            Try
                ...
                If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((23))).Value.ToString(), "Paid", TextCompare:=False) = 0 Then
                    If(Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Admin", TextCompare:=False) = 0) Or (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblUserType.Text, "Super Admin", TextCompare:=False) = 0) Then
                        RestaurantPOS14.My.MyProject.Forms.frmPOS.btnDelete1.Enabled = True
                    Else
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand(Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject("Select RTRIM(TableNo), RTRIM(Dish),RTRIM(Rate),RTRIM(Quantity),RTRIM(Amount),(DiscountPer), RTRIM(DiscountAmount), RTRIM(STPer), RTRIM(STAmount), RTRIM(VATPer),RTRIM(VATAmount),SCPer,SCAmount,RTRIM(TotalAmount) from RestaurantPOS_BillingInfoKOT,RestaurantPOS_OrderedProductBillKOT where RestaurantPOS_BillingInfoKOT.Id=RestaurantPOS_OrderedProductBillKOT.BillID and RestaurantPOS_BillingInfoKOT.ID=", dataGridViewRow.Cells(CInt((0))).Value), " order by TableNo,Dish")), RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                ...
                If Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow.Cells(CInt((6))).Value)) = 0.0 Then
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.flpKOT.Visible = True
                Else
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.btnUpdateFinalBill.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmPOS.flpKOT.Visible = False
                End If
                ...
                RestaurantPOS14.My.MyProject.Forms.frmPOS.txtTip.Text = dataGridViewRow.Cells(CInt((22))).Value.ToString()
        ...
        Private Sub Button1_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where  BillDate >=@d1 and BillDate < @d2 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where  BillDate >=@d1 and BillDate < @d2 and Operator=@d4 order by BillDate")
            End If
        End Sub

        Private Sub cmbBillNo_SelectedIndexChanged(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where BillNo=@d3 Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where BillNo=@d3 and Operator=@d4 order by BillDate")
            End If
        End Sub
        ...
        Private Sub Button2_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoKOT order by 1")
            Else
                Me.fillBillNo("SELECT distinct RTRIM(BillNo) FROM RestaurantPOS_BillingInfoKOT where Operator=@d1 order by 1")
            End If
        End Sub

        Private Sub btnShowAllBills_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT Order by BillDate")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where Operator=@d4 order by BillDate desc")
            End If
        End Sub

        Private Sub Button3_Click(sender As Object, e As System.EventArgs)
            If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(RestaurantPOS14.My.MyProject.Forms.frmPOS.lblUserType.Text, "Super Admin", TextCompare:=False) = 0 Then
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where PhoneNo like N'%" & Me.txtContactNo.Text & "%' Order by BillDate desc")
            Else
                Me.GetData("Select RTRIM(RestaurantPOS_BillingInfoKOT.Id), RTRIM(BillNo),BillDate,KOTDiscountPer,KOTDiscountAmt,(RestaurantPOS_BillingInfoKOT.GrandTotal),Cash,Change,RTRIM(PaymentMode),RTRIM(Operator),RTRIM(CurrencyCode),ExchangeRate,RTRIM(Member_ID),RTRIM(Waiter),LP,LA,RTRIM(GiftCardID),GiftCardAmount,RTRIM(CustomerName),RTRIM(PhoneNo),RTRIM(EmailID),Card,IsNULL(Tip,0),RTRIM(DIB_Status) from RestaurantPOS_BillingInfoKOT where PhoneNo like N'%" & Me.txtContactNo.Text & "%' and Operator=@d4 order by BillDate desc")
            End If
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmRestaurantPOSKOTFinalBillRecord))
            ...
            location = New System.Drawing.Point(3, 149)
            groupBox.Location = location
            Me.GroupBox3.Name = "GroupBox3"
            Dim groupBox2 As System.Windows.Forms.GroupBox = Me.GroupBox3
            size = New System.Drawing.Size(382, 72)
            groupBox2.Size = size
            ...
            location = New System.Drawing.Point(228, 27)
            button.Location = location
            Me.Button3.Name = "Button3"
            Dim button2 As System.Windows.Forms.Button = Me.Button3
            size = New System.Drawing.Size(140, 37)
            button2.Size = size
            ...
            size = New System.Drawing.Size(211, 33)
            textBox2.Size = size
            ...
            Dim button3 As System.Windows.Forms.Button = Me.btnShowAllBills
            location = New System.Drawing.Point(637, 161)
            button3.Location = location
            Me.btnShowAllBills.Name = "btnShowAllBills"
            Dim button4 As System.Windows.Forms.Button = Me.btnShowAllBills
            ...
            location = New System.Drawing.Point(502, 161)
            ...
            Me.Label1.Text = "List of Today's Restaurant POS Dine In Bills"
            ...
            location = New System.Drawing.Point(391, 161)
            ...
            size = New System.Drawing.Size(709, 109)
            groupBox4.Size = size
            ...
            location = New System.Drawing.Point(167, -18)
            ...
            location = New System.Drawing.Point(289, 29)
            ...
            size = New System.Drawing.Size(267, 33)
            ...
            location = New System.Drawing.Point(580, 29)
            ...
            location = New System.Drawing.Point(719, 41)
            groupBox5.Location = location
            Me.GroupBox1.Name = "GroupBox1"
            Dim groupBox6 As System.Windows.Forms.GroupBox = Me.GroupBox1
            size = New System.Drawing.Size(280, 109)
            groupBox6.Size = size
            ...
            location = New System.Drawing.Point(167, 50)
            ...
            size = New System.Drawing.Size(145, 33)
            comboBox2.Size = size
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column11, Me.Column12, Me.Column5, Me.Column7, Me.Column8, Me.Column4, Me.Column6, Me.Column9, Me.Column10, Me.Column13, Me.Column14, Me.Column15, Me.Column16, Me.Column17, Me.Column18, Me.Column19, Me.Column20, Me.Column21, Me.Column22, Me.Column24, Me.Column23)
            ...
            MyBase.Name = "frmRestaurantPOSKOTFinalBillRecord"
