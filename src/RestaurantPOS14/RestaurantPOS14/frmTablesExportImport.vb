...
Namespace RestaurantPOS14
    ...
    Public Class frmTablesExportImport
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmTablesExportImport.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmTablesExportImport.__ENCList
                If RestaurantPOS14.frmTablesExportImport.__ENCList.Count = RestaurantPOS14.frmTablesExportImport.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmTablesExportImport.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmTablesExportImport.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmTablesExportImport.__ENCList(num) = RestaurantPOS14.frmTablesExportImport.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmTablesExportImport.__ENCList.RemoveRange(num, RestaurantPOS14.frmTablesExportImport.__ENCList.Count - num)
                    RestaurantPOS14.frmTablesExportImport.__ENCList.Capacity = RestaurantPOS14.frmTablesExportImport.__ENCList.Count
                End If

                Call RestaurantPOS14.frmTablesExportImport.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(TableNo),RTRIM(FloorNo) from R_Table order by TableNo", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmMenuItemsExportImport_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmTable.GetData()
        End Sub
                ...
                For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(Me.DataGridView1.Rows, System.Collections.IEnumerable)
                    If Not dataGridViewRow.IsNewRow Then
                        ...
                        If Not RestaurantPOS14.ModClasses.rdr.Read() Then
                            ...
                            RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                            RestaurantPOS14.ModClasses.con.Open()
                            RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into R_Table(TableNo,Status,bkColor,FloorNo) VALUES (@d1,'Activate',@d2,@d3)")
                            RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", dataGridViewRow.Cells(CInt((0))).Value.ToString())
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmTablesExportImport))
            ...
            Me.Column2.HeaderText = "Floor No."
            ...
            MyBase.Name = "frmTablesExportImport"
