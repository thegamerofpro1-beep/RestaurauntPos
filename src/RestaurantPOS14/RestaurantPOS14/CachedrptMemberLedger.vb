...
Namespace RestaurantPOS14
    ...
    Public Class CachedrptMemberLedger
        ...
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.CachedrptMemberLedger.__ENCList
                If RestaurantPOS14.CachedrptMemberLedger.__ENCList.Count = RestaurantPOS14.CachedrptMemberLedger.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.CachedrptMemberLedger.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If num4 > num5 Then
                            Exit While
                        End If
                        If RestaurantPOS14.CachedrptMemberLedger.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.CachedrptMemberLedger.__ENCList(num) = RestaurantPOS14.CachedrptMemberLedger.__ENCList(num3)
                            End If
                            num += 1
                        End If
                        num3 += 1
                    End While
                    Call RestaurantPOS14.CachedrptMemberLedger.__ENCList.RemoveRange(num, RestaurantPOS14.CachedrptMemberLedger.__ENCList.Count - num)
                    RestaurantPOS14.CachedrptMemberLedger.__ENCList.Capacity = RestaurantPOS14.CachedrptMemberLedger.__ENCList.Count
                End If
                Call RestaurantPOS14.CachedrptMemberLedger.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub

        Public Sub New()
            Call RestaurantPOS14.CachedrptMemberLedger.__ENCAddToList(Me)
        End Sub

        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument
            Return New RestaurantPOS14.rptMemberLedger With {
        .Site = MyBase.Site
    }
        End Function
