...
Namespace RestaurantPOS14
    ...
    Public Class frmCreditCustomerReceiptRecord
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList
                If RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Count = RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList(num) = RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Capacity = RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmCreditCustomerReceiptRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 AndAlso Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "Payment", TextCompare:=False) = 0 Then
                    ...
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.dtpTranactionDate.Value = Microsoft.VisualBasic.CompilerServices.Conversions.ToDate(dataGridViewRow.Cells(CInt((2))).Value)
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.cmbPaymentMode.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtCustID.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtCustomerID.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtCustomerName.Text = dataGridViewRow.Cells(CInt((6))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtTransactionAmount.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtTempAmt.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtPaymentModeDetails.Text = dataGridViewRow.Cells(CInt((8))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.txtRemarks.Text = dataGridViewRow.Cells(CInt((9))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnSave.Enabled = False
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Credit Customer") Then
                        RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnDelete.Enabled = False
                    End If

                    If RestaurantPOS14.ModFunc.IsUpdateAllowed(Me.lblUser.Text, "Credit Customer") Then
                        RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnUpdate.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnUpdate.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnPrint.Enabled = True
                    Call RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.GetCustomerInfo()
                    RestaurantPOS14.My.MyProject.Forms.frmCreditCustomerReceipt.btnSelection.Enabled = False
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT T_ID, RTRIM(TransactionID), Date,RTRIM(PaymentMode),CC_ID, RTRIM(CreditCustomer.CreditCustomerID),RTRIM(Name),Amount,RTRIM(PaymentModeDetails), RTRIM(CreditCustomerPayment.Remarks) from CreditCustomer,CreditCustomerPayment where CreditCustomer.CC_ID=CreditCustomerPayment.creditCustomer_ID and Amount > 0  and Date >=@d1 and Date < @d2 order by [Date]", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmCreditCustomerReceiptRecord_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs)
        ...
        Private Sub GelButton1_Click(sender As Object, e As System.EventArgs)
            Try
                If Microsoft.VisualBasic.Strings.Len(Microsoft.VisualBasic.Strings.Trim(Me.txtCustomerName.Text)) = 0 Then
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmCreditCustomerReceiptRecord))
            ...
            Dim size As System.Drawing.Size = New System.Drawing.Size(1005, 618)
            panel2.Size = size
            ...
            location = New System.Drawing.Point(923, 7)
            ...
            location = New System.Drawing.Point(641, 54)
            ...
            Dim gelButton5 As GelButtons.GelButton = Me.btnExportExcel
            location = New System.Drawing.Point(95, 14)
            gelButton5.Location = location
            Me.btnExportExcel.Name = "btnExportExcel"
            Dim gelButton6 As GelButtons.GelButton = Me.btnExportExcel
            ...
            location = New System.Drawing.Point(267, 54)
            ...
            Dim gelButton7 As GelButtons.GelButton = Me.btnGetData
            location = New System.Drawing.Point(278, 26)
            gelButton7.Location = location
            Me.btnGetData.Name = "btnGetData"
            Dim gelButton8 As GelButtons.GelButton = Me.btnGetData
            ...
            size = New System.Drawing.Size(251, 70)
            panel8.Size = size
            ...
            Dim gelButton9 As GelButtons.GelButton = Me.GelButton1
            location = New System.Drawing.Point(163, 30)
            gelButton9.Location = location
            Me.GelButton1.Name = "GelButton1"
            Dim gelButton10 As GelButtons.GelButton = Me.GelButton1
            size = New System.Drawing.Size(76, 24)
            gelButton10.Size = size
            ...
            Dim textBox As System.Windows.Forms.TextBox = Me.txtCustomerName
            location = New System.Drawing.Point(13, 30)
            textBox.Location = location
            Me.txtCustomerName.Name = "txtCustomerName"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtCustomerName
            ...
            size = New System.Drawing.Size(991, 476)
            ...
            size = New System.Drawing.Size(908, 41)
            panel10.Size = size
            ...
            location = New System.Drawing.Point(408, 9)
            label11.Location = location
            Me.Label1.Name = "Label1"
            Dim label12 As System.Windows.Forms.Label = Me.Label1
            size = New System.Drawing.Size(230, 24)
            label12.Size = size
            Me.Label1.TabIndex = 0
            Me.Label1.Text = "List of Today's Receipts"
            Dim autoScaleDimensions As System.Drawing.SizeF = New System.Drawing.SizeF(6F, 13F)
            MyBase.AutoScaleDimensions = autoScaleDimensions
            MyBase.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
            Me.BackColor = System.Drawing.Color.FromArgb(58, 58, 56)
            size = New System.Drawing.Size(1019, 633)
            ...
            MyBase.Name = "frmCreditCustomerReceiptRecord"
