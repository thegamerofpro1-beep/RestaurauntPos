...
Namespace RestaurantPOS14
    ...
    Public Class frmMember
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            AddHandler MyBase.Load, AddressOf Me.frmMember_Load
            Call RestaurantPOS14.frmMember.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmMember.__ENCList
                If RestaurantPOS14.frmMember.__ENCList.Count = RestaurantPOS14.frmMember.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmMember.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmMember.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmMember.__ENCList(num) = RestaurantPOS14.frmMember.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmMember.__ENCList.RemoveRange(num, RestaurantPOS14.frmMember.__ENCList.Count - num)
                    RestaurantPOS14.frmMember.__ENCList.Capacity = RestaurantPOS14.frmMember.__ENCList.Count
                End If

                Call RestaurantPOS14.frmMember.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub DeleteRecord()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("delete from Member where Memberid='" & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(Me.txtMemberID.Text)) & "'")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                If RestaurantPOS14.ModClasses.cmd.ExecuteNonQuery() > 0 Then
                    Dim st As String = "Deleted the Member '" & Me.txtMemberID.Text & "' having Member ID '" & Me.txtMemberID.Text & "'"
        ...
        Public Sub Getdata()
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Memberid, RTRIM(Name), RTRIM(Address), RTRIM(ContactNo),RTRIM(Active),RegistrationDate from Member order by Name", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 Then
                    ...
                    If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((4))).Value.ToString(), "Yes", TextCompare:=False) = 0 Then
                        Me.chkActive.Checked = True
                    Else
        ...
        Private Sub btnUpdate_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Me.txtMemberID.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtMemName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.txtMemberName.Text)
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Update Member set Name=@d2, ContactNo=@d3, Address=@d4, Active=@d5 where MemberID=@d1")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtMemberID.Text))
                ...
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "Updated the Member '" & Me.txtMemberID.Text & "' having Member ID '" & Me.txtMemberID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub auto()
            RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
            RestaurantPOS14.ModClasses.con.Open()
            RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT MAX(MemberID) FROM Member")
            RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
            If Microsoft.VisualBasic.Information.IsDBNull(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.cmd.ExecuteScalar())) Then
                Me.txtMemberID.Text = Microsoft.VisualBasic.CompilerServices.Conversions.ToString(100000.0 + Microsoft.VisualBasic.CompilerServices.Conversions.ToDouble(1.ToString()))
            Else
        ...
        Private Sub btnSave_Click(sender As Object, e As System.EventArgs)
            ...
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("insert into Member(MemberID, Name, ContactNo, Address, RegistrationDate, Active) VALUES (@d1,@d2,@d3,@d4,@d5,@d6)")
                RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", Microsoft.VisualBasic.Conversion.Val(Me.txtMemberID.Text))
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", Me.txtMemberName.Text)
                RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Me.txtContactNo.Text)
                ...
                RestaurantPOS14.ModClasses.cmd.ExecuteReader()
                RestaurantPOS14.ModClasses.con.Close()
                Dim st As String = "added the new Member '" & Me.txtMemberID.Text & "' having Member ID '" & Me.txtMemberID.Text & "'"
                RestaurantPOS14.ModFunc.LogFunc(Me.lblUser.Text, st)
        ...
        Private Sub txtSearchByMemberName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT Memberid, RTRIM(Name), RTRIM(Address), RTRIM(ContactNo),RTRIM(Active),RegistrationDate from Member where Name like N'%" & Me.txtSearchByMemberName.Text & "%' order by Name", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(5)))
        ...
        Private Sub frmMember_Load(sender As Object, e As System.EventArgs)
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmMember))
            ...
            Dim textBox7 As System.Windows.Forms.TextBox = Me.txtMemberName
            location = New System.Drawing.Point(125, 38)
            textBox7.Location = location
            Me.txtMemberName.Name = "txtMemberName"
            Dim textBox8 As System.Windows.Forms.TextBox = Me.txtMemberName
            ...
            Dim textBox9 As System.Windows.Forms.TextBox = Me.txtMemberID
            location = New System.Drawing.Point(125, 11)
            textBox9.Location = location
            Me.txtMemberID.Name = "txtMemberID"
            Me.txtMemberID.[ReadOnly] = True
            Dim textBox10 As System.Windows.Forms.TextBox = Me.txtMemberID
            size = New System.Drawing.Size(157, 21)
            textBox10.Size = size
            ...
            size = New System.Drawing.Size(111, 201)
            panel6.Size = size
            ...
            Me.dgw.Columns.AddRange(Me.Description, Me.Column3, Me.Column2, Me.Column4, Me.Column7, Me.Column6)
