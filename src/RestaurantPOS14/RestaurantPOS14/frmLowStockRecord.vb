...
Namespace RestaurantPOS14
    ...
    Public Class frmLowStockRecord
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmLowStockRecord.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmLowStockRecord.__ENCList
                If RestaurantPOS14.frmLowStockRecord.__ENCList.Count = RestaurantPOS14.frmLowStockRecord.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmLowStockRecord.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmLowStockRecord.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmLowStockRecord.__ENCList(num) = RestaurantPOS14.frmLowStockRecord.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmLowStockRecord.__ENCList.RemoveRange(num, RestaurantPOS14.frmLowStockRecord.__ENCList.Count - num)
                    RestaurantPOS14.frmLowStockRecord.__ENCList.Capacity = RestaurantPOS14.frmLowStockRecord.__ENCList.Count
                End If

                Call RestaurantPOS14.frmLowStockRecord.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmLowStockRecord))
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column3, Me.Column5, Me.Column6, Me.Column4)
