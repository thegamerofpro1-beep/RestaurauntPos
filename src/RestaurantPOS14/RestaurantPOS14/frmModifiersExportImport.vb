...
Namespace RestaurantPOS14
    ...
    Public Class frmModifiersExportImport
        ...
        <System.Runtime.CompilerServices.AccessedThroughPropertyAttribute("txtModifierID")>
        Private _txtModifierID As System.Windows.Forms.TextBox
        ...
        Friend Overridable Property txtModifierID As System.Windows.Forms.TextBox
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Get
                Return Me._txtModifierID
            End Get

            <System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.Synchronized)>
            <System.Diagnostics.DebuggerNonUserCodeAttribute>
            Set(value As System.Windows.Forms.TextBox)
                Me._txtModifierID = value
            End Set
        End Property
        ...
        Public Sub New()
            ...
            Call RestaurantPOS14.frmModifiersExportImport.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmModifiersExportImport.__ENCList
                If RestaurantPOS14.frmModifiersExportImport.__ENCList.Count = RestaurantPOS14.frmModifiersExportImport.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmModifiersExportImport.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmModifiersExportImport.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmModifiersExportImport.__ENCList(num) = RestaurantPOS14.frmModifiersExportImport.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmModifiersExportImport.__ENCList.RemoveRange(num, RestaurantPOS14.frmModifiersExportImport.__ENCList.Count - num)
                    RestaurantPOS14.frmModifiersExportImport.__ENCList.Capacity = RestaurantPOS14.frmModifiersExportImport.__ENCList.Count
                End If

                Call RestaurantPOS14.frmModifiersExportImport.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub auto()
            Try
                ...
                If Microsoft.VisualBasic.Information.IsDBNull(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.cmd.ExecuteScalar())) Then
                    Me.txtModifierID.Text = 1.ToString()
                Else
                    ...
                    Me.txtModifierID.Text = num.ToString()
                End If
        ...
        Public Sub Getdata()
            Try
                ...
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT RTRIM(ModifierName), RTRIM(Item),Rate from Modifiers order by ModifierName", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub frmMenuItemsExportImport_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs)
            Call RestaurantPOS14.My.MyProject.Forms.frmMenuItemsModifiers.Getdata()
        End Sub
                ...
                For Each dataGridViewRow As System.Windows.Forms.DataGridViewRow In CType(Me.DataGridView1.Rows, System.Collections.IEnumerable)
                    If Not dataGridViewRow.IsNewRow Then
                        ...
                        If Not RestaurantPOS14.ModClasses.rdr.Read() Then
                            ...
                            RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                            RestaurantPOS14.ModClasses.con.Open()
                            RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("Insert Into Modifiers(MIM_ID,ModifierName,Item,Rate,BackColor) Values(@d3,@d1,@d2," & Microsoft.VisualBasic.CompilerServices.Conversions.ToString(Microsoft.VisualBasic.Conversion.Val(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(dataGridViewRow.Cells(CInt((2))).Value))) & ",-10065303)")
                            RestaurantPOS14.ModClasses.cmd.Connection = RestaurantPOS14.ModClasses.con
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d1", dataGridViewRow.Cells(CInt((0))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d2", dataGridViewRow.Cells(CInt((1))).Value.ToString())
                            RestaurantPOS14.ModClasses.cmd.Parameters.AddWithValue("@d3", Microsoft.VisualBasic.Conversion.Val(Me.txtModifierID.Text))
                            RestaurantPOS14.ModClasses.cmd.CommandTimeout = RestaurantPOS14.Configuration.SettingsHost.Current.Database.CommandTimeoutSeconds
        ...
        Private Sub InitializeComponent()
            ...
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmModifiersExportImport))
            ...
            Dim textBox As System.Windows.Forms.TextBox = Me.txtModifierID
            location = New System.Drawing.Point(558, 41)
            textBox.Location = location
            Me.txtModifierID.Name = "txtModifierID"
            Dim textBox2 As System.Windows.Forms.TextBox = Me.txtModifierID
            ...
            location = New System.Drawing.Point(209, 42)
            ...
            location = New System.Drawing.Point(110, 41)
            ...
            MyBase.Name = "frmModifiersExportImport"
