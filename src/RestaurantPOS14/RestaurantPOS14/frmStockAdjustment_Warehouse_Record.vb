...
Namespace RestaurantPOS14
    ...
    Public Class frmStockAdjustment_Warehouse_Record
        ...
        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Public Sub New()
            Call RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCAddToList(Me)
            Me.InitializeComponent()
        End Sub

        <System.Diagnostics.DebuggerNonUserCodeAttribute>
        Private Shared Sub __ENCAddToList(value As Object)
            SyncLock RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList
                If RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Count = RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Capacity Then
                    Dim num As Integer = 0
                    Dim num2 As Integer = RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Count - 1
                    ...
                    While True
                        ...
                        If RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList(CInt((num3))).IsAlive Then
                            If num3 <> num Then
                                RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList(num) = RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList(num3)
                            End If
                    ...
                    Call RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.RemoveRange(num, RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Count - num)
                    RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Capacity = RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Count
                End If

                Call RestaurantPOS14.frmStockAdjustment_Warehouse_Record.__ENCList.Add(New System.WeakReference(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(value)))
            End SyncLock
        End Sub
        ...
        Private Sub dgw_MouseClick(sender As Object, e As System.Windows.Forms.MouseEventArgs)
            Try
                If Me.dgw.Rows.Count > 0 AndAlso Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Me.lblSet.Text, "SA", TextCompare:=False) = 0 Then
                    ...
                    Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.Show()
                    MyBase.Hide()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtAdjustmentID.Text = dataGridViewRow.Cells(CInt((0))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.dtpDate.Text = dataGridViewRow.Cells(CInt((1))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.cmbWarehouse.Text = dataGridViewRow.Cells(CInt((2))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtProductID.Text = dataGridViewRow.Cells(CInt((3))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtProductCode.Text = dataGridViewRow.Cells(CInt((4))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.cmbProductName.Text = dataGridViewRow.Cells(CInt((5))).Value.ToString()
                    If Microsoft.VisualBasic.CompilerServices.Operators.CompareString(dataGridViewRow.Cells(CInt((6))).Value.ToString(), "Plus", TextCompare:=False) = 0 Then
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.rbPlus.Checked = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.rbMinus.Checked = True
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtQty.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtQ.Text = dataGridViewRow.Cells(CInt((7))).Value.ToString()
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.txtReason.Text = dataGridViewRow.Cells(CInt((9))).Value.ToString()
                    If RestaurantPOS14.ModFunc.IsDeleteAllowed(Me.lblUser.Text, "Stock Adjustment") Then
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.btnDelete.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.btnDelete.Enabled = False
                    End If

                    If RestaurantPOS14.ModFunc.IsUpdateAllowed(Me.lblUser.Text, "Stock Adjustment") Then
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.btnUpdate.Enabled = True
                    Else
                        RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.btnUpdate.Enabled = False
                    End If

                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.btnSave.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.cmbProductName.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.cmbWarehouse.Enabled = False
                    RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.gbAdjustment.Enabled = False
                    Call RestaurantPOS14.My.MyProject.Forms.frmStockAdjustment_Warehouse.GetQty_S()
                End If
            Catch ex As System.Exception
                Call System.Windows.Forms.MessageBox.Show(ex.Message, "Error", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Hand)
            End Try
        ...
        Private Sub btnGetData_Click(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT  StockAdjustment_Warehouse.SA_ID, StockAdjustment_Warehouse.Date,RTRIM(Warehouse), StockAdjustment_Warehouse.ProductID, RTRIM(Product.ProductCode),RTRIM(Product.ProductName), RTRIM(StockAdjustment_Warehouse.AdjustmentType),StockAdjustment_Warehouse.Qty,RTRIM(Unit), RTRIM(StockAdjustment_Warehouse.Reason) FROM StockAdjustment_Warehouse INNER JOIN Product ON StockAdjustment_Warehouse.ProductID = Product.PID where Date between @d1 and @d2 order by Date", RestaurantPOS14.ModClasses.con)
        ...
        Private Sub txtProductName_TextChanged(sender As Object, e As System.EventArgs)
            Try
                RestaurantPOS14.ModClasses.con = New System.Data.SqlClient.SqlConnection(RestaurantPOS14.ConnectionString.cs)
                RestaurantPOS14.ModClasses.con.Open()
                RestaurantPOS14.ModClasses.cmd = New System.Data.SqlClient.SqlCommand("SELECT  StockAdjustment_Warehouse.SA_ID, StockAdjustment_Warehouse.Date,RTRIM(Warehouse), StockAdjustment_Warehouse.ProductID, RTRIM(Product.ProductCode),RTRIM(Product.ProductName), RTRIM(StockAdjustment_Warehouse.AdjustmentType),StockAdjustment_Warehouse.Qty,RTRIM(Unit), RTRIM(StockAdjustment_Warehouse.Reason) FROM StockAdjustment_Warehouse INNER JOIN Product ON StockAdjustment_Warehouse.ProductID = Product.PID where ProductName like N'%" & RestaurantPOS14.Security.SqlInput.EscapeLiteral(Me.txtProductName.Text) & "%' order by Date", RestaurantPOS14.ModClasses.con)
                RestaurantPOS14.ModClasses.rdr = RestaurantPOS14.ModClasses.cmd.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
                Me.dgw.Rows.Clear()
                While RestaurantPOS14.ModClasses.rdr.Read()
                    Me.dgw.Rows.Add(System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(0)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(1)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(2)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(3)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(4)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(5)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(6)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(7)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(8)), System.Runtime.CompilerServices.RuntimeHelpers.GetObjectValue(RestaurantPOS14.ModClasses.rdr(9)))
        ...
        Private Sub InitializeComponent()
            Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RestaurantPOS14.frmStockAdjustment_Warehouse_Record))
            ...
            Me.dgw.Columns.AddRange(Me.Column1, Me.Column2, Me.Column10, Me.Column3, Me.Column4, Me.Column5, Me.Column7, Me.Column8, Me.Column6, Me.Column9)
            ...
            MyBase.Name = "frmStockAdjustment_Warehouse_Record"
