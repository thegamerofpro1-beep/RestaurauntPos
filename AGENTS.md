...
Before changing this application, read `README.md` and `docs/PROJECT_HANDOFF.md`. The handoff records the current product requirements, compatibility invariants, validated release workflow, and hardware checks that cannot be completed offsite.
